...
# instance fields
.field public final ignoreGeneratedIndex:Z

.field public final strictMethodVerification:Z
...
.method public findSubscriberMethods(Ljava/lang/Class;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->findUsingReflection(Ljava/lang/Class;)Ljava/util/List;
    ...
    :cond_1
    invoke-virtual {p0, p1}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->findUsingInfo(Ljava/lang/Class;)Ljava/util/List;
...
.method public final findUsingInfo(Ljava/lang/Class;)Ljava/util/List;
    .locals 6

    invoke-virtual {p0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->prepareFindState()Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;
    ...
    invoke-virtual {p0, v0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->getSubscriberInfo(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)Lorg/greenrobot/eventbus/meta/SubscriberInfo;
    ...
    :cond_1
    invoke-virtual {p0, v0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->findUsingReflectionInSingleClass(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)V
    ...
    :cond_3
    invoke-virtual {p0, v0}, Lorg/greenrobot/eventbus/SubscriberMethodFinder;->getMethodsAndRelease(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)Ljava/util/List;
...
.method public final findUsingReflection(Ljava/lang/Class;)Ljava/util/List;
    .locals 1
...
.method public final getSubscriberInfo(Lorg/greenrobot/eventbus/SubscriberMethodFinder$FindState;)Lorg/greenrobot/eventbus/meta/SubscriberInfo;
    .locals 3
