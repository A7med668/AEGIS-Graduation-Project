...
.field public final pesScratch:Landroidx/media3/common/util/ParsableBitArray;
...
.method public final consume(Landroidx/media3/common/util/ParsableByteArray;I)V
    ...
    :cond_3
    :goto_0
    invoke-virtual {p0, v4}, Landroidx/media3/extractor/ts/PesReader;->setState(I)V
    ...
    invoke-virtual {p0, p1, v6, v0}, Landroidx/media3/extractor/ts/PesReader;->continueRead(Landroidx/media3/common/util/ParsableByteArray;[BI)Z
    ...
    invoke-virtual {p0, p1, v0, v6}, Landroidx/media3/extractor/ts/PesReader;->continueRead(Landroidx/media3/common/util/ParsableByteArray;[BI)Z

    move-result v0

    if-eqz v0, :cond_4

    invoke-virtual {p0}, Landroidx/media3/extractor/ts/PesReader;->parseHeaderExtension()V
    ...
    invoke-virtual {p0, v2}, Landroidx/media3/extractor/ts/PesReader;->setState(I)V
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/PesReader;->parseHeader()Z
    ...
    :cond_b
    invoke-virtual {p0, v5}, Landroidx/media3/extractor/ts/PesReader;->setState(I)V
...
.method public final parseHeader()Z
    .locals 7
...
.method public final parseHeaderExtension()V
    .locals 10
