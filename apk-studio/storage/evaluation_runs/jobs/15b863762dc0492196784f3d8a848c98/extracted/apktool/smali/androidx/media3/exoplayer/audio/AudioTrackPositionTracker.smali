...
.method public getCurrentPositionUs(Z)J
    ...
    invoke-virtual {v0}, Landroidx/media3/exoplayer/audio/AudioTrackPositionTracker;->maybeSampleSyncParams()V
    ...
    invoke-virtual {v0}, Landroidx/media3/exoplayer/audio/AudioTrackPositionTracker;->getPlaybackHeadPositionUs()J
...
.method public final maybePollAndCheckTimestamp(J)V
    ...
    check-cast v9, Landroidx/media3/exoplayer/audio/AudioTimestampPoller;

    invoke-virtual {v9, v5, v6}, Landroidx/media3/exoplayer/audio/AudioTimestampPoller;->maybePollTimestamp(J)Z
    ...
    :cond_0
    invoke-virtual {v9}, Landroidx/media3/exoplayer/audio/AudioTimestampPoller;->getTimestampSystemTimeUs()J

    move-result-wide v3

    invoke-virtual {v9}, Landroidx/media3/exoplayer/audio/AudioTimestampPoller;->getTimestampPositionFrames()J
    ...
    invoke-interface/range {v0 .. v8}, Landroidx/media3/exoplayer/audio/AudioTrackPositionTracker$Listener;->onSystemTimeUsMismatch(JJJJ)V

    invoke-virtual {v9}, Landroidx/media3/exoplayer/audio/AudioTimestampPoller;->rejectTimestamp()V
    ...
    invoke-static {v1, v2, v0}, Landroidx/media3/common/util/Util;->sampleCountToDurationUs(JI)J
    ...
    invoke-interface/range {v0 .. v8}, Landroidx/media3/exoplayer/audio/AudioTrackPositionTracker$Listener;->onPositionFramesMismatch(JJJJ)V
    ...
    :cond_2
    invoke-virtual {v9}, Landroidx/media3/exoplayer/audio/AudioTimestampPoller;->acceptTimestamp()V
