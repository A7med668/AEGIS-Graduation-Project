...
.method public static resetOptions(Landroid/graphics/BitmapFactory$Options;)V
    ...
    invoke-static {p0, v0}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/BitmapFactory$Options;Landroid/graphics/ColorSpace;)V

    invoke-static {p0, v0}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler$$ExternalSyntheticApiModelOutline1;->m(Landroid/graphics/BitmapFactory$Options;Landroid/graphics/ColorSpace;)V

    invoke-static {p0, v0}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler$$ExternalSyntheticApiModelOutline2;->m(Landroid/graphics/BitmapFactory$Options;Landroid/graphics/Bitmap$Config;)V
...
.method public static setInBitmap(Landroid/graphics/BitmapFactory$Options;Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;II)V
    ...
    invoke-static {}, Lcom/bumptech/glide/load/engine/bitmap_recycle/LruBitmapPool$$ExternalSyntheticApiModelOutline0;->m()Landroid/graphics/Bitmap$Config;
    ...
    :cond_0
    invoke-static {p0}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler$$ExternalSyntheticApiModelOutline4;->m(Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap$Config;
...
# virtual methods
.method public final calculateConfig(Lcom/bumptech/glide/load/resource/bitmap/ImageReader;Lcom/bumptech/glide/load/DecodeFormat;ZZLandroid/graphics/BitmapFactory$Options;II)V
    .locals 6
...
.method public final decodeFromWrappedStreams(Lcom/bumptech/glide/load/resource/bitmap/ImageReader;Landroid/graphics/BitmapFactory$Options;Lcom/bumptech/glide/load/resource/bitmap/DownsampleStrategy;Lcom/bumptech/glide/load/DecodeFormat;Lcom/bumptech/glide/load/PreferredColorSpace;ZIIZLcom/bumptech/glide/load/resource/bitmap/Downsampler$DecodeCallbacks;)Landroid/graphics/Bitmap;
    ...
    invoke-virtual/range {v0 .. v7}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler;->calculateConfig(Lcom/bumptech/glide/load/resource/bitmap/ImageReader;Lcom/bumptech/glide/load/DecodeFormat;ZZLandroid/graphics/BitmapFactory$Options;II)V

    move-object v14, v0

    sget v0, Landroid/os/Build$VERSION;->SDK_INT:I

    invoke-virtual {v14, v11}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler;->shouldUsePool(Lcom/bumptech/glide/load/ImageHeaderParser$ImageType;)Z
    ...
    iget-object v2, v14, Lcom/bumptech/glide/load/resource/bitmap/Downsampler;->bitmapPool:Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;

    invoke-static {v5, v2, v6, v7}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler;->setInBitmap(Landroid/graphics/BitmapFactory$Options;Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;II)V
    ...
    invoke-static {v5}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler$$ExternalSyntheticApiModelOutline3;->m(Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/ColorSpace;
    ...
    invoke-static {v0}, Lcom/bumptech/glide/load/resource/DefaultOnHeaderDecodedListener$$ExternalSyntheticApiModelOutline9;->m(Landroid/graphics/ColorSpace;)Z

    move-result v0

    if-eqz v0, :cond_b

    invoke-static {}, Lcom/bumptech/glide/load/resource/DefaultOnHeaderDecodedListener$$ExternalSyntheticApiModelOutline10;->m()Landroid/graphics/ColorSpace$Named;
    ...
    :cond_b
    invoke-static {}, Lcom/bumptech/glide/load/resource/DefaultOnHeaderDecodedListener$$ExternalSyntheticApiModelOutline1;->m()Landroid/graphics/ColorSpace$Named;

    move-result-object v0

    :goto_8
    invoke-static {v0}, Lcom/bumptech/glide/load/resource/DefaultOnHeaderDecodedListener$$ExternalSyntheticApiModelOutline2;->m(Landroid/graphics/ColorSpace$Named;)Landroid/graphics/ColorSpace;

    move-result-object v0

    invoke-static {v5, v0}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/BitmapFactory$Options;Landroid/graphics/ColorSpace;)V
    ...
    invoke-static {v1, v5, v3, v0}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler;->decodeStream(Lcom/bumptech/glide/load/resource/bitmap/ImageReader;Landroid/graphics/BitmapFactory$Options;Lcom/bumptech/glide/load/resource/bitmap/Downsampler$DecodeCallbacks;Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;)Landroid/graphics/Bitmap;

    move-result-object v4

    iget-object v0, v14, Lcom/bumptech/glide/load/resource/bitmap/Downsampler;->bitmapPool:Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;

    invoke-interface {v3, v0, v4}, Lcom/bumptech/glide/load/resource/bitmap/Downsampler$DecodeCallbacks;->onDecodeComplete(Lcom/bumptech/glide/load/engine/bitmap_recycle/BitmapPool;Landroid/graphics/Bitmap;)V
...
.method public final shouldUsePool(Lcom/bumptech/glide/load/ImageHeaderParser$ImageType;)Z
    .locals 0
