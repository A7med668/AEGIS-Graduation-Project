...
.field public static final DEFAULT_CELL_RESOLUTION:Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;

.field public static final DEFAULT_FRAME_AND_TICK_RATE:Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;
...
.method public static parseCellResolution(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;
    .locals 7
...
.method public static parseFrameAndTickRates(Lorg/xmlpull/v1/XmlPullParser;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;
    .locals 6
...
.method public static parseHeader(Lorg/xmlpull/v1/XmlPullParser;Ljava/util/Map;Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;Landroidx/media3/extractor/text/ttml/TtmlDecoder$TtsExtent;Ljava/util/Map;Ljava/util/Map;)Ljava/util/Map;
    .locals 5
...
.method public static parseNode(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;)Landroidx/media3/extractor/text/ttml/TtmlNode;
    .locals 21
    ...
    :pswitch_1
    invoke-static {v2}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseStyleIds(Ljava/lang/String;)[Ljava/lang/String;
    ...
    :pswitch_2
    invoke-static {v2, v1}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseTimeExpression(Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;)J
...
.method public static parseRegionAttributes(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;Landroidx/media3/extractor/text/ttml/TtmlDecoder$TtsExtent;)Landroidx/media3/extractor/text/ttml/TtmlRegion;
    .locals 17
...
.method public static parseTimeExpression(Ljava/lang/String;Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;)J
    .locals 13
    ...
    iget v3, p1, Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;->effectiveFrameRate:F
...
.method public static parseTtsExtent(Lorg/xmlpull/v1/XmlPullParser;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$TtsExtent;
    .locals 5
...
.method public decode([BIZ)Landroidx/media3/extractor/text/Subtitle;
    ...
    sget-object v6, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->DEFAULT_FRAME_AND_TICK_RATE:Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;

    sget-object v10, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->DEFAULT_CELL_RESOLUTION:Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;
    ...
    check-cast v12, Landroidx/media3/extractor/text/ttml/TtmlNode;
    ...
    invoke-static {v3}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseFrameAndTickRates(Lorg/xmlpull/v1/XmlPullParser;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;
    ...
    invoke-static {v3, v0}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseCellResolution(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$CellResolution;

    move-result-object v11

    invoke-static {v3}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseTtsExtent(Lorg/xmlpull/v1/XmlPullParser;)Landroidx/media3/extractor/text/ttml/TtmlDecoder$TtsExtent;
    ...
    invoke-static {v13, v0}, Landroidx/media3/common/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_3
    :try_start_3
    invoke-static {v3, v12, v7, v11}, Landroidx/media3/extractor/text/ttml/TtmlDecoder;->parseNode(Lorg/xmlpull/v1/XmlPullParser;Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;Landroidx/media3/extractor/text/ttml/TtmlDecoder$FrameAndTickRate;)Landroidx/media3/extractor/text/ttml/TtmlNode;
    ...
    invoke-virtual {v12, v0}, Landroidx/media3/extractor/text/ttml/TtmlNode;->addChild(Landroidx/media3/extractor/text/ttml/TtmlNode;)V
    :try_end_3
    ...
    invoke-static {v13, v12, v0}, Landroidx/media3/common/util/Log;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {v12}, Landroidx/media3/extractor/text/ttml/TtmlNode;->buildTextNode(Ljava/lang/String;)Landroidx/media3/extractor/text/ttml/TtmlNode;

    move-result-object v12

    invoke-virtual {v0, v12}, Landroidx/media3/extractor/text/ttml/TtmlNode;->addChild(Landroidx/media3/extractor/text/ttml/TtmlNode;)V
    ...
    new-instance v10, Landroidx/media3/extractor/text/ttml/TtmlSubtitle;
    ...
    invoke-direct {v10, v0, v4, v7, v8}, Landroidx/media3/extractor/text/ttml/TtmlSubtitle;-><init>(Landroidx/media3/extractor/text/ttml/TtmlNode;Ljava/util/Map;Ljava/util/Map;Ljava/util/Map;)V
