...
.method public static cleanUpText(Landroid/text/SpannableStringBuilder;)V
    .locals 7
...
.method public final applyStyleToOutput(Ljava/util/Map;Landroidx/media3/common/text/Cue$Builder;III)V
    .locals 9
...
.method public getCues(JLjava/util/Map;Ljava/util/Map;Ljava/util/Map;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, p2, v1, v0}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForImage(JLjava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual/range {v2 .. v7}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForText(JZLjava/lang/String;Ljava/util/Map;)V
    ...
    invoke-virtual/range {v2 .. v8}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForStyle(JLjava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
...
.method public getEventTimesUs()[J
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/media3/extractor/text/ttml/TtmlNode;->getEventTimes(Ljava/util/TreeSet;Z)V
...
.method public final traverseForImage(JLjava/lang/String;Ljava/util/List;)V
    ...
    invoke-virtual {v1, p1, p2, p3, p4}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForImage(JLjava/lang/String;Ljava/util/List;)V
...
.method public final traverseForStyle(JLjava/util/Map;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/media3/extractor/text/ttml/TtmlNode;->applyStyleToOutput(Ljava/util/Map;Landroidx/media3/common/text/Cue$Builder;III)V
...
.method public final traverseForText(JZLjava/lang/String;Ljava/util/Map;)V
    ...
    :goto_6
    invoke-virtual/range {v0 .. v5}, Landroidx/media3/extractor/text/ttml/TtmlNode;->traverseForText(JZLjava/lang/String;Ljava/util/Map;)V
