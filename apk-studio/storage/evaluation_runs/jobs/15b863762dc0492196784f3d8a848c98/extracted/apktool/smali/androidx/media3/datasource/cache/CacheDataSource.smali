...
.field public final cache:Landroidx/media3/datasource/cache/Cache;

.field public final cacheKeyFactory:Landroidx/media3/datasource/cache/CacheKeyFactory;

.field public final cacheReadDataSource:Landroidx/media3/datasource/DataSource;

.field public final cacheWriteDataSource:Landroidx/media3/datasource/DataSource;

.field public checkCachePosition:J

.field public currentDataSource:Landroidx/media3/datasource/DataSource;

.field public currentDataSourceBytesRead:J

.field public currentDataSpec:Landroidx/media3/datasource/DataSpec;

.field public currentHoleSpan:Landroidx/media3/datasource/cache/CacheSpan;
...
.field public requestDataSpec:Landroidx/media3/datasource/DataSpec;

.field public seenCacheError:Z

.field public totalCachedBytesRead:J

.field public final upstreamDataSource:Landroidx/media3/datasource/DataSource;
...
.method public static getRedirectedUriOrDefault(Landroidx/media3/datasource/cache/Cache;Ljava/lang/String;Landroid/net/Uri;)Landroid/net/Uri;
    .locals 0
...
.method public close()V
    ...
    invoke-virtual {p0}, Landroidx/media3/datasource/cache/CacheDataSource;->notifyBytesRead()V

    :try_start_0
    invoke-virtual {p0}, Landroidx/media3/datasource/cache/CacheDataSource;->closeCurrentSource()V
    :try_end_0
    ...
    invoke-virtual {p0, v0}, Landroidx/media3/datasource/cache/CacheDataSource;->handleBeforeThrow(Ljava/lang/Throwable;)V
...
.method public getResponseHeaders()Ljava/util/Map;
    ...
    invoke-virtual {p0}, Landroidx/media3/datasource/cache/CacheDataSource;->isReadingFromUpstream()Z
...
.method public final handleBeforeThrow(Ljava/lang/Throwable;)V
    .locals 1

    invoke-virtual {p0}, Landroidx/media3/datasource/cache/CacheDataSource;->isReadingFromCache()Z
...
.method public final isBypassingCache()Z
    .locals 2
...
.method public final isReadingFromCache()Z
    .locals 2
...
.method public final isReadingFromUpstream()Z
    .locals 1
...
.method public final isWritingToCache()Z
    .locals 2
...
.method public final notifyBytesRead()V
    .locals 0

    return-void
.end method

.method public final notifyCacheIgnored(I)V
    .locals 0
...
.method public open(Landroidx/media3/datasource/DataSpec;)J
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/datasource/cache/CacheDataSource;->shouldIgnoreCacheForRequest(Landroidx/media3/datasource/DataSpec;)I
    ...
    invoke-virtual {p0, v2}, Landroidx/media3/datasource/cache/CacheDataSource;->notifyCacheIgnored(I)V
    ...
    :cond_7
    invoke-virtual {p0, v1, v4}, Landroidx/media3/datasource/cache/CacheDataSource;->openNextSource(Landroidx/media3/datasource/DataSpec;Z)V
    ...
    :goto_4
    invoke-virtual {p0, p1}, Landroidx/media3/datasource/cache/CacheDataSource;->handleBeforeThrow(Ljava/lang/Throwable;)V

    throw p1
.end method

.method public final openNextSource(Landroidx/media3/datasource/DataSpec;Z)V
    .locals 17
    ...
    invoke-virtual {v1}, Landroidx/media3/datasource/cache/CacheDataSource;->isBypassingCache()Z
    ...
    :cond_9
    :try_start_1
    invoke-virtual {v1}, Landroidx/media3/datasource/cache/CacheDataSource;->closeCurrentSource()V
    :try_end_1
    ...
    :cond_d
    invoke-virtual {v1}, Landroidx/media3/datasource/cache/CacheDataSource;->isReadingFromUpstream()Z
    ...
    :cond_f
    invoke-virtual {v1}, Landroidx/media3/datasource/cache/CacheDataSource;->isWritingToCache()Z
...
.method public read([BII)I
    ...
    invoke-virtual {p0, v1, v6}, Landroidx/media3/datasource/cache/CacheDataSource;->openNextSource(Landroidx/media3/datasource/DataSpec;Z)V
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/datasource/cache/CacheDataSource;->setNoBytesRemainingAndMaybeStoreLength(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v1, v0}, Landroidx/media3/datasource/cache/CacheDataSource;->openNextSource(Landroidx/media3/datasource/DataSpec;Z)V
...
.method public final setNoBytesRemainingAndMaybeStoreLength(Ljava/lang/String;)V
    .locals 3
    ...
    invoke-virtual {p0}, Landroidx/media3/datasource/cache/CacheDataSource;->isWritingToCache()Z
...
.method public final shouldIgnoreCacheForRequest(Landroidx/media3/datasource/DataSpec;)I
    .locals 4
