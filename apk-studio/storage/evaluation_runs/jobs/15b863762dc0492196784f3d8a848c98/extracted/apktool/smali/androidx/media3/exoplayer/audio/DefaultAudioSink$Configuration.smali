...
.method public buildAudioTrack(ZLandroidx/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration;->createAudioTrack(ZLandroidx/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
...
.method public final createAudioTrack(ZLandroidx/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    .locals 2
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration;->createAudioTrackV29(ZLandroidx/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    ...
    invoke-virtual {p0, p1, p2, p3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration;->createAudioTrackV21(ZLandroidx/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    ...
    :cond_1
    invoke-virtual {p0, p2, p3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration;->createAudioTrackV9(Landroidx/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
...
.method public final createAudioTrackV21(ZLandroidx/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    .locals 6
    ...
    invoke-static {p1, p2, v2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->access$1600(III)Landroid/media/AudioFormat;
...
.method public final createAudioTrackV29(ZLandroidx/media3/common/AudioAttributes;I)Landroid/media/AudioTrack;
    .locals 3
    ...
    invoke-static {}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline0;->m()Landroid/media/AudioTrack$Builder;

    move-result-object p2

    invoke-static {p2, p1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    invoke-static {p1, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/AudioTrack$Builder;Landroid/media/AudioFormat;)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    const/4 p2, 0x1

    invoke-static {p1, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    iget v0, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration;->bufferSize:I

    invoke-static {p1, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    invoke-static {p1, p3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/AudioTrack$Builder;I)Landroid/media/AudioTrack$Builder;
    ...
    :goto_0
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/AudioTrack$Builder;Z)Landroid/media/AudioTrack$Builder;

    move-result-object p1

    invoke-static {p1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration$$ExternalSyntheticApiModelOutline7;->m(Landroid/media/AudioTrack$Builder;)Landroid/media/AudioTrack;
