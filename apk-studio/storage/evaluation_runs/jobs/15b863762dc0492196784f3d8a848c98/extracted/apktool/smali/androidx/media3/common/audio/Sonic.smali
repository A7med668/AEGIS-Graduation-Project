...
# virtual methods
.method public final adjustRate(FI)V
    .locals 8
    ...
    :cond_1
    invoke-virtual {p0, p2}, Landroidx/media3/common/audio/Sonic;->moveNewSamplesToPitchBuffer(I)V
    ...
    invoke-virtual {p0, v2, v3, v4}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S
    ...
    invoke-virtual {p0, v7, v3, v0, p1}, Landroidx/media3/common/audio/Sonic;->interpolate([SIII)S
    ...
    invoke-virtual {p0, v2}, Landroidx/media3/common/audio/Sonic;->removePitchFrames(I)V
...
.method public final changeSpeed(F)V
    ...
    invoke-virtual {p0, v1}, Landroidx/media3/common/audio/Sonic;->copyInputToOutput(I)I
    ...
    invoke-virtual {p0, v2, v1}, Landroidx/media3/common/audio/Sonic;->findPitchPeriod([SI)I
    ...
    invoke-virtual {p0, v3, v1, p1, v2}, Landroidx/media3/common/audio/Sonic;->skipPitchPeriod([SIFI)I
    ...
    invoke-virtual {p0, v3, v1, p1, v2}, Landroidx/media3/common/audio/Sonic;->insertPitchPeriod([SIFI)I
    ...
    invoke-virtual {p0, v1}, Landroidx/media3/common/audio/Sonic;->removeProcessedInputFrames(I)V

    return-void
.end method

.method public final copyInputToOutput(I)I
    .locals 2
    ...
    invoke-virtual {p0, v1, p1, v0}, Landroidx/media3/common/audio/Sonic;->copyToOutput([SII)V
...
.method public final findPitchPeriod([SI)I
    .locals 6
    ...
    invoke-virtual {p0, p1, p2, v0, v1}, Landroidx/media3/common/audio/Sonic;->findPitchPeriodInRange([SIII)I
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, v0}, Landroidx/media3/common/audio/Sonic;->downSampleInput([SII)V
    ...
    invoke-virtual {p0, v2, v5, v3, v4}, Landroidx/media3/common/audio/Sonic;->findPitchPeriodInRange([SIII)I
    ...
    invoke-virtual {p0, p1, p2, v3, v2}, Landroidx/media3/common/audio/Sonic;->findPitchPeriodInRange([SIII)I
    ...
    :cond_4
    invoke-virtual {p0, p1, p2, v1}, Landroidx/media3/common/audio/Sonic;->downSampleInput([SII)V

    iget-object p1, p0, Landroidx/media3/common/audio/Sonic;->downSampleBuffer:[S

    invoke-virtual {p0, p1, v5, v3, v2}, Landroidx/media3/common/audio/Sonic;->findPitchPeriodInRange([SIII)I
    ...
    invoke-virtual {p0, p2, v0}, Landroidx/media3/common/audio/Sonic;->previousPeriodBetter(II)Z
...
.method public final insertPitchPeriod([SIFI)I
    .locals 9
    ...
    invoke-virtual {p0, p3, v1, v8}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S
...
.method public final interpolate([SIII)S
    .locals 2
...
.method public final moveNewSamplesToPitchBuffer(I)V
    .locals 6
    ...
    invoke-virtual {p0, v1, v2, v0}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S
...
.method public final previousPeriodBetter(II)Z
    .locals 2
...
.method public final processStreamInput()V
    ...
    invoke-virtual {p0, v1, v4, v2}, Landroidx/media3/common/audio/Sonic;->copyToOutput([SII)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p0, v1}, Landroidx/media3/common/audio/Sonic;->changeSpeed(F)V
    ...
    invoke-virtual {p0, v3, v0}, Landroidx/media3/common/audio/Sonic;->adjustRate(FI)V
...
.method public queueEndOfStream()V
    ...
    invoke-virtual {p0, v1, v0, v3}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S
    ...
    invoke-virtual {p0}, Landroidx/media3/common/audio/Sonic;->processStreamInput()V
...
.method public queueInput(Ljava/nio/ShortBuffer;)V
    ...
    invoke-virtual {p0, v2, v3, v0}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S
...
.method public final removePitchFrames(I)V
    .locals 4
...
.method public final removeProcessedInputFrames(I)V
    .locals 4
...
.method public final skipPitchPeriod([SIFI)I
    .locals 8
    ...
    invoke-virtual {p0, p3, v1, v0}, Landroidx/media3/common/audio/Sonic;->ensureSpaceForAdditionalFrames([SII)[S
