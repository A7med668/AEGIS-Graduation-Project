.class public final Landroidx/media3/datasource/cache/CachedContentIndex$DatabaseStorage;
...
# instance fields
.field public final databaseProvider:Landroidx/media3/database/DatabaseProvider;
...
.method public static delete(Landroidx/media3/database/DatabaseProvider;Ljava/lang/String;)V
    .locals 2
...
# virtual methods
.method public final addOrUpdateRow(Landroid/database/sqlite/SQLiteDatabase;Landroidx/media3/datasource/cache/CachedContent;)V
    .locals 4
...
.method public final deleteRow(Landroid/database/sqlite/SQLiteDatabase;I)V
    .locals 2
...
.method public load(Ljava/util/HashMap;Landroid/util/SparseArray;)V
    ...
    :try_start_1
    invoke-virtual {p0, v0}, Landroidx/media3/datasource/cache/CachedContentIndex$DatabaseStorage;->initializeTable(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    :cond_1
    :goto_1
    invoke-virtual {p0}, Landroidx/media3/datasource/cache/CachedContentIndex$DatabaseStorage;->getCursor()Landroid/database/Cursor;
...
.method public storeFully(Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/media3/datasource/cache/CachedContentIndex$DatabaseStorage;->addOrUpdateRow(Landroid/database/sqlite/SQLiteDatabase;Landroidx/media3/datasource/cache/CachedContent;)V
...
.method public storeIncremental(Ljava/util/HashMap;)V
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/media3/datasource/cache/CachedContentIndex$DatabaseStorage;->deleteRow(Landroid/database/sqlite/SQLiteDatabase;I)V
    ...
    :cond_1
    invoke-virtual {p0, p1, v1}, Landroidx/media3/datasource/cache/CachedContentIndex$DatabaseStorage;->addOrUpdateRow(Landroid/database/sqlite/SQLiteDatabase;Landroidx/media3/datasource/cache/CachedContent;)V
