...
# direct methods
.method public static synthetic $r8$lambda$X380K0TdPp8J3ZTOYkW4814bo2w(Landroidx/media3/extractor/mp4/Track;)Landroidx/media3/extractor/mp4/Track;
    .locals 0

    return-object p0
.end method

.method public static synthetic $r8$lambda$hnjY4I3GksBxoHD4rwc_-8mCu-w()[Landroidx/media3/extractor/Extractor;
    .locals 3
...
.method public final processMoovAtom(Landroidx/media3/extractor/mp4/Atom$ContainerAtom;)V
    ...
    invoke-static {v3}, Landroidx/media3/extractor/mp4/AtomParsers;->parseUdta(Landroidx/media3/extractor/mp4/Atom$LeafAtom;)Landroidx/media3/extractor/mp4/AtomParsers$UdtaInfo;

    move-result-object v3

    iget-object v4, v3, Landroidx/media3/extractor/mp4/AtomParsers$UdtaInfo;->metaMetadata:Landroidx/media3/common/Metadata;

    iget-object v5, v3, Landroidx/media3/extractor/mp4/AtomParsers$UdtaInfo;->smtaMetadata:Landroidx/media3/common/Metadata;

    iget-object v3, v3, Landroidx/media3/extractor/mp4/AtomParsers$UdtaInfo;->xyzMetadata:Landroidx/media3/common/Metadata;

    if-eqz v4, :cond_1

    invoke-virtual {v2, v4}, Landroidx/media3/extractor/GaplessInfoHolder;->setFromMetadata(Landroidx/media3/common/Metadata;)Z
    ...
    iget-object v4, v4, Landroidx/media3/extractor/mp4/AtomParsers$MvhdInfo;->metadata:Landroidx/media3/common/Metadata;
    ...
    iget v4, v10, Landroidx/media3/extractor/mp4/TrackSampleTable;->sampleCount:I
    ...
    :cond_5
    iget-object v4, v10, Landroidx/media3/extractor/mp4/TrackSampleTable;->track:Landroidx/media3/extractor/mp4/Track;

    move-object/from16 v21, v12

    iget-wide v11, v4, Landroidx/media3/extractor/mp4/Track;->durationUs:J
    ...
    :cond_6
    iget-wide v11, v10, Landroidx/media3/extractor/mp4/TrackSampleTable;->durationUs:J
    ...
    iget v5, v4, Landroidx/media3/extractor/mp4/Track;->type:I

    invoke-interface {v3, v7, v5}, Landroidx/media3/extractor/ExtractorOutput;->track(II)Landroidx/media3/extractor/TrackOutput;

    move-result-object v3

    invoke-direct {v1, v4, v10, v3}, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;-><init>(Landroidx/media3/extractor/mp4/Track;Landroidx/media3/extractor/mp4/TrackSampleTable;Landroidx/media3/extractor/TrackOutput;)V

    iget-object v3, v4, Landroidx/media3/extractor/mp4/Track;->format:Landroidx/media3/common/Format;
    ...
    iget v3, v10, Landroidx/media3/extractor/mp4/TrackSampleTable;->maximumSize:I
    ...
    :goto_6
    iget-object v5, v4, Landroidx/media3/extractor/mp4/Track;->format:Landroidx/media3/common/Format;

    invoke-virtual {v5}, Landroidx/media3/common/Format;->buildUpon()Landroidx/media3/common/Format$Builder;

    move-result-object v5

    invoke-virtual {v5, v3}, Landroidx/media3/common/Format$Builder;->setMaxInputSize(I)Landroidx/media3/common/Format$Builder;

    iget v3, v4, Landroidx/media3/extractor/mp4/Track;->type:I
    ...
    iget v3, v10, Landroidx/media3/extractor/mp4/TrackSampleTable;->sampleCount:I
    ...
    invoke-virtual {v5, v3}, Landroidx/media3/common/Format$Builder;->setFrameRate(F)Landroidx/media3/common/Format$Builder;

    :cond_8
    iget v3, v4, Landroidx/media3/extractor/mp4/Track;->type:I

    invoke-static {v3, v2, v5}, Landroidx/media3/extractor/mp4/MetadataUtil;->setFormatGaplessInfo(ILandroidx/media3/extractor/GaplessInfoHolder;Landroidx/media3/common/Format$Builder;)V
    ...
    invoke-direct {v10, v11}, Landroidx/media3/common/Metadata;-><init>(Ljava/util/List;)V
    ...
    invoke-static {v3, v14, v12, v5, v11}, Landroidx/media3/extractor/mp4/MetadataUtil;->setFormatMetadata(ILandroidx/media3/common/Metadata;Landroidx/media3/common/Metadata;Landroidx/media3/common/Format$Builder;[Landroidx/media3/common/Metadata;)V

    iget-object v3, v1, Landroidx/media3/extractor/mp4/Mp4Extractor$Mp4Track;->trackOutput:Landroidx/media3/extractor/TrackOutput;
    ...
    iput-wide v5, v0, Landroidx/media3/extractor/mp4/Mp4Extractor;->durationUs:J
