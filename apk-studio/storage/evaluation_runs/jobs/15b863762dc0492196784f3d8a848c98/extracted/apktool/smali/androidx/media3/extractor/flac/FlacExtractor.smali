...
# instance fields
.field public binarySearchSeeker:Landroidx/media3/extractor/flac/FlacBinarySearchSeeker;
...
.field public final sampleNumberHolder:Landroidx/media3/extractor/FlacFrameReader$SampleNumberHolder;
...
# direct methods
.method public static synthetic $r8$lambda$WFdhFS2w9xcH8MtglVnuJ0Dti4M()[Landroidx/media3/extractor/Extractor;
    .locals 3
...
# virtual methods
.method public final findFrame(Landroidx/media3/common/util/ParsableByteArray;Z)J
    .locals 4
...
.method public final getFrameStartMarker(Landroidx/media3/extractor/ExtractorInput;)V
    .locals 5
    ...
    invoke-virtual {p0, v1, v2, v3, v4}, Landroidx/media3/extractor/flac/FlacExtractor;->getSeekMap(JJ)Landroidx/media3/extractor/SeekMap;
...
.method public final getSeekMap(JJ)Landroidx/media3/extractor/SeekMap;
    .locals 8
...
.method public final getStreamMarkerAndInfoBlockBytes(Landroidx/media3/extractor/ExtractorInput;)V
    .locals 3
...
.method public read(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)I
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/media3/extractor/flac/FlacExtractor;->readFrames(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)I
    ...
    :cond_1
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/flac/FlacExtractor;->getFrameStartMarker(Landroidx/media3/extractor/ExtractorInput;)V

    return v1

    :cond_2
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/flac/FlacExtractor;->readMetadataBlocks(Landroidx/media3/extractor/ExtractorInput;)V

    return v1

    :cond_3
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/flac/FlacExtractor;->readStreamMarker(Landroidx/media3/extractor/ExtractorInput;)V

    return v1

    :cond_4
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/flac/FlacExtractor;->getStreamMarkerAndInfoBlockBytes(Landroidx/media3/extractor/ExtractorInput;)V

    return v1

    :cond_5
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/flac/FlacExtractor;->readId3Metadata(Landroidx/media3/extractor/ExtractorInput;)V

    return v1
.end method

.method public final readFrames(Landroidx/media3/extractor/ExtractorInput;Landroidx/media3/extractor/PositionHolder;)I
    .locals 6
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/flac/FlacExtractor;->outputSampleMetadata()V
    ...
    invoke-virtual {p0, v0, v4}, Landroidx/media3/extractor/flac/FlacExtractor;->findFrame(Landroidx/media3/common/util/ParsableByteArray;Z)J
...
.method public final readId3Metadata(Landroidx/media3/extractor/ExtractorInput;)V
    .locals 2
...
.method public final readMetadataBlocks(Landroidx/media3/extractor/ExtractorInput;)V
    .locals 3
...
.method public final readStreamMarker(Landroidx/media3/extractor/ExtractorInput;)V
    .locals 0
