...
# instance fields
.field public final adtsScratch:Landroidx/media3/common/util/ParsableBitArray;
...
.method public constructor <init>(ZLjava/lang/String;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/AdtsReader;->setFindingSampleState()V
...
# virtual methods
.method public final assertTracksCreated()V
    .locals 1
...
.method public final checkAdtsHeader(Landroidx/media3/common/util/ParsableByteArray;)V
    .locals 2
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/AdtsReader;->resetSync()V
    ...
    :cond_2
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/AdtsReader;->setReadingAdtsHeaderState()V

    return-void
.end method

.method public final checkSyncPositionValid(Landroidx/media3/common/util/ParsableByteArray;I)Z
    .locals 8
    ...
    invoke-virtual {p0, p1, v0, v1}, Landroidx/media3/extractor/ts/AdtsReader;->tryRead(Landroidx/media3/common/util/ParsableByteArray;[BI)Z
    ...
    invoke-virtual {p0, p1, v4, v1}, Landroidx/media3/extractor/ts/AdtsReader;->tryRead(Landroidx/media3/common/util/ParsableByteArray;[BI)Z
    ...
    invoke-virtual {p0, p1, v4, v3}, Landroidx/media3/extractor/ts/AdtsReader;->tryRead(Landroidx/media3/common/util/ParsableByteArray;[BI)Z
    ...
    invoke-virtual {p0, v5, p1}, Landroidx/media3/extractor/ts/AdtsReader;->isAdtsSyncBytes(BB)Z
...
.method public consume(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/AdtsReader;->assertTracksCreated()V
    ...
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/ts/AdtsReader;->readSample(Landroidx/media3/common/util/ParsableByteArray;)V
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/AdtsReader;->parseAdtsHeader()V
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/AdtsReader;->parseId3Header()V

    goto :goto_0

    :cond_5
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/ts/AdtsReader;->checkAdtsHeader(Landroidx/media3/common/util/ParsableByteArray;)V

    goto :goto_0

    :cond_6
    invoke-virtual {p0, p1}, Landroidx/media3/extractor/ts/AdtsReader;->findNextSample(Landroidx/media3/common/util/ParsableByteArray;)V
...
.method public final findNextSample(Landroidx/media3/common/util/ParsableByteArray;)V
    .locals 9
    ...
    invoke-virtual {p0, v8, v6}, Landroidx/media3/extractor/ts/AdtsReader;->isAdtsSyncBytes(BB)Z
    ...
    invoke-virtual {p0, p1, v6}, Landroidx/media3/extractor/ts/AdtsReader;->checkSyncPositionValid(Landroidx/media3/common/util/ParsableByteArray;I)Z
    ...
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/AdtsReader;->setCheckingAdtsHeaderState()V
    ...
    :cond_4
    invoke-virtual {p0}, Landroidx/media3/extractor/ts/AdtsReader;->setReadingId3HeaderState()V
...
.method public final isAdtsSyncBytes(BB)Z
    .locals 0
...
.method public final parseAdtsHeader()V
    .locals 8
    ...
    invoke-virtual/range {v2 .. v7}, Landroidx/media3/extractor/ts/AdtsReader;->setReadingSampleState(Landroidx/media3/extractor/TrackOutput;JII)V

    return-void
.end method

.method public final parseId3Header()V
    .locals 9
    ...
    invoke-virtual/range {v3 .. v8}, Landroidx/media3/extractor/ts/AdtsReader;->setReadingSampleState(Landroidx/media3/extractor/TrackOutput;JII)V

    return-void
.end method

.method public final readSample(Landroidx/media3/common/util/ParsableByteArray;)V
    .locals 7
...
.method public final resetSync()V
    .locals 1
...
.method public final setCheckingAdtsHeaderState()V
    .locals 1
...
.method public final setReadingAdtsHeaderState()V
    .locals 1
...
.method public final setReadingId3HeaderState()V
    .locals 2
...
.method public final setReadingSampleState(Landroidx/media3/extractor/TrackOutput;JII)V
    .locals 1
...
.method public final tryRead(Landroidx/media3/common/util/ParsableByteArray;[BI)Z
    .locals 2
