...
.method public final abandonAudioFocusV26()V
    ...
    invoke-static {v1, v0}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline8;->m(Landroid/media/AudioManager;Landroid/media/AudioFocusRequest;)I
...
.method public final requestAudioFocusV26()I
    ...
    invoke-static {}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline2;->m()V

    iget v0, p0, Landroidx/media3/exoplayer/AudioFocusManager;->focusGainToRequest:I

    invoke-static {v0}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline0;->m(I)Landroid/media/AudioFocusRequest$Builder;
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/AudioFocusRequest;)Landroid/media/AudioFocusRequest$Builder;
    ...
    invoke-static {v0, v2}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioFocusRequest$Builder;Landroid/media/AudioAttributes;)Landroid/media/AudioFocusRequest$Builder;

    move-result-object v0

    invoke-static {v0, v1}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioFocusRequest$Builder;Z)Landroid/media/AudioFocusRequest$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/media3/exoplayer/AudioFocusManager;->focusListener:Landroidx/media3/exoplayer/AudioFocusManager$AudioFocusListener;

    invoke-static {v0, v1}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/AudioFocusRequest$Builder;Landroid/media/AudioManager$OnAudioFocusChangeListener;)Landroid/media/AudioFocusRequest$Builder;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/AudioFocusRequest$Builder;)Landroid/media/AudioFocusRequest;
    ...
    invoke-static {v0, v1}, Landroidx/media3/exoplayer/AudioFocusManager$$ExternalSyntheticApiModelOutline7;->m(Landroid/media/AudioManager;Landroid/media/AudioFocusRequest;)I
