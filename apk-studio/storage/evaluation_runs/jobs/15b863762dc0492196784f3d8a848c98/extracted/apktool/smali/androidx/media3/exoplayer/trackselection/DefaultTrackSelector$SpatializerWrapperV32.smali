...
.field public listener:Landroid/media/Spatializer$OnSpatializerStateChangedListener;

.field public final spatializationSupported:Z
...
.method public constructor <init>(Landroid/media/Spatializer;)V
    ...
    invoke-static {p1}, Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector$SpatializerWrapperV32$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/Spatializer;)I
...
.method public static tryCreateInstance(Landroid/content/Context;)Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector$SpatializerWrapperV32;
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector$SpatializerWrapperV32$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioManager;)Landroid/media/Spatializer;
...
.method public canBeSpatialized(Landroidx/media3/common/AudioAttributes;Landroidx/media3/common/Format;)Z
    ...
    invoke-static {p2, p1, v0}, Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector$SpatializerWrapperV32$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/Spatializer;Landroid/media/AudioAttributes;Landroid/media/AudioFormat;)Z
...
.method public ensureInitialized(Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector;Landroid/os/Looper;)V
    ...
    invoke-static {p2, v0, p1}, Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector$SpatializerWrapperV32$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/Spatializer;Ljava/util/concurrent/Executor;Landroid/media/Spatializer$OnSpatializerStateChangedListener;)V
...
.method public isAvailable()Z
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector$SpatializerWrapperV32$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/Spatializer;)Z
...
.method public isEnabled()Z
    ...
    invoke-static {v0}, Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector$SpatializerWrapperV32$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/Spatializer;)Z
...
.method public release()V
    ...
    invoke-static {v1, v0}, Landroidx/media3/exoplayer/trackselection/DefaultTrackSelector$SpatializerWrapperV32$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/Spatializer;Landroid/media/Spatializer$OnSpatializerStateChangedListener;)V
