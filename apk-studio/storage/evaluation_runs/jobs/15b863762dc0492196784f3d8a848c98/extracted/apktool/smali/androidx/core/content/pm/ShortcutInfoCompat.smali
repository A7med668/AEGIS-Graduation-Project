...
.method public final buildLegacyExtrasBundle()Landroid/os/PersistableBundle;
    ...
    invoke-static {v0, v1, v2}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline15;->m(Landroid/os/PersistableBundle;Ljava/lang/String;Z)V
...
.method public toShortcutInfo()Landroid/content/pm/ShortcutInfo;
    ...
    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline2;->m(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;

    move-result-object v0

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIntents:[Landroid/content/Intent;

    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline7;->m(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/content/Intent;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline8;->m(Landroid/content/pm/ShortcutInfo$Builder;Landroid/graphics/drawable/Icon;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline9;->m(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline10;->m(Landroid/content/pm/ShortcutInfo$Builder;Ljava/lang/CharSequence;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline11;->m(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/ComponentName;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline12;->m(Landroid/content/pm/ShortcutInfo$Builder;Ljava/util/Set;)Landroid/content/pm/ShortcutInfo$Builder;

    :cond_4
    iget v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mRank:I

    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline13;->m(Landroid/content/pm/ShortcutInfo$Builder;I)Landroid/content/pm/ShortcutInfo$Builder;

    iget-object v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mExtras:Landroid/os/PersistableBundle;

    if-eqz v1, :cond_5

    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline5;->m(Landroid/content/pm/ShortcutInfo$Builder;Landroid/os/PersistableBundle;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    :cond_6
    invoke-static {v0, v2}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline14;->m(Landroid/content/pm/ShortcutInfo$Builder;[Landroid/app/Person;)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline3;->m(Landroid/content/pm/ShortcutInfo$Builder;Landroid/content/LocusId;)Landroid/content/pm/ShortcutInfo$Builder;

    :cond_8
    iget-boolean v1, p0, Landroidx/core/content/pm/ShortcutInfoCompat;->mIsLongLived:Z

    invoke-static {v0, v1}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline4;->m(Landroid/content/pm/ShortcutInfo$Builder;Z)Landroid/content/pm/ShortcutInfo$Builder;
    ...
    :cond_a
    invoke-static {v0}, Landroidx/core/content/pm/ShortcutInfoCompat$$ExternalSyntheticApiModelOutline6;->m(Landroid/content/pm/ShortcutInfo$Builder;)Landroid/content/pm/ShortcutInfo;
