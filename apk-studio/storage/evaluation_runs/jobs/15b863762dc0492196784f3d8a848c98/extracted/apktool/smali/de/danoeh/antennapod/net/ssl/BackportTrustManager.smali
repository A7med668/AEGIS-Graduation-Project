.class public Lde/danoeh/antennapod/net/ssl/BackportTrustManager;
.super Ljava/lang/Object;
.source "SourceFile"


# static fields
.field private static final TAG:Ljava/lang/String; = "BackportTrustManager"
...
.method public static create()Ljavax/net/ssl/X509TrustManager;
    .locals 8
    ...
    const-string v4, "BACKPORT_COMODO_ROOT_CA"
    ...
    const-string v4, "SECTIGO_USER_TRUST_CA"
    ...
    const-string v4, "LETSENCRYPT_ISRG_CA"
    ...
    const-string v4, "SECTIGO_ROOT_E46"
    ...
    invoke-virtual {v2, v4, v0}, Ljava/security/KeyStore;->setCertificateEntry(Ljava/lang/String;Ljava/security/cert/Certificate;)V

    new-instance v0, Ljava/util/ArrayList;

    invoke-direct {v0}, Ljava/util/ArrayList;-><init>()V

    invoke-static {v2}, Lde/danoeh/antennapod/net/ssl/BackportTrustManager;->getSystemTrustManager(Ljava/security/KeyStore;)Ljavax/net/ssl/X509TrustManager;

    move-result-object v2

    invoke-interface {v0, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-static {v1}, Lde/danoeh/antennapod/net/ssl/BackportTrustManager;->getSystemTrustManager(Ljava/security/KeyStore;)Ljavax/net/ssl/X509TrustManager;

    move-result-object v2

    invoke-interface {v0, v2}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v2, Lde/danoeh/antennapod/net/ssl/CompositeX509TrustManager;

    invoke-direct {v2, v0}, Lde/danoeh/antennapod/net/ssl/CompositeX509TrustManager;-><init>(Ljava/util/List;)V
    :try_end_0
    ...
    :goto_0
    const-string v2, "BackportTrustManager"
...
.method private static getSystemTrustManager(Ljava/security/KeyStore;)Ljavax/net/ssl/X509TrustManager;
    .locals 4
