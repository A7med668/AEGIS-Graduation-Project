...
.method public static createCue(Ljava/lang/String;Landroidx/media3/extractor/text/ssa/SsaStyle;Landroidx/media3/extractor/text/ssa/SsaStyle$Overrides;FF)Landroidx/media3/common/text/Cue;
    .locals 8
    ...
    :goto_1
    invoke-static {v0}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->toTextAlignment(I)Landroid/text/Layout$Alignment;
    ...
    invoke-static {v0}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->toPositionAnchor(I)I
    ...
    invoke-static {v0}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->toLineAnchor(I)I
...
.method public static parseStyles(Landroidx/media3/common/util/ParsableByteArray;Ljava/nio/charset/Charset;)Ljava/util/Map;
    .locals 5
...
.method public static toLineAnchor(I)I
    .locals 3
...
.method public static toPositionAnchor(I)I
    .locals 3
...
.method public static toTextAlignment(I)Landroid/text/Layout$Alignment;
    .locals 3
...
.method public decode([BIZ)Landroidx/media3/extractor/text/Subtitle;
    ...
    invoke-virtual {p0, v1}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->detectUtfCharset(Landroidx/media3/common/util/ParsableByteArray;)Ljava/nio/charset/Charset;
    ...
    invoke-virtual {p0, v1, p1}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->parseHeader(Landroidx/media3/common/util/ParsableByteArray;Ljava/nio/charset/Charset;)V

    :cond_0
    invoke-virtual {p0, v1, p3, v0, p1}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->parseEventBody(Landroidx/media3/common/util/ParsableByteArray;Ljava/util/List;Ljava/util/List;Ljava/nio/charset/Charset;)V

    new-instance p1, Landroidx/media3/extractor/text/ssa/SsaSubtitle;

    invoke-direct {p1, p3, v0}, Landroidx/media3/extractor/text/ssa/SsaSubtitle;-><init>(Ljava/util/List;Ljava/util/List;)V

    return-object p1
.end method

.method public final detectUtfCharset(Landroidx/media3/common/util/ParsableByteArray;)Ljava/nio/charset/Charset;
    .locals 0
...
.method public final parseDialogueLine(Ljava/lang/String;Landroidx/media3/extractor/text/ssa/SsaDialogueFormat;Ljava/util/List;Ljava/util/List;)V
    .locals 10
    ...
    invoke-static {v7}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->parseTimecodeUs(Ljava/lang/String;)J
    ...
    iget v4, p0, Landroidx/media3/extractor/text/ssa/SsaDecoder;->screenHeight:F

    invoke-static {p2, p1, v0, v3, v4}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->createCue(Ljava/lang/String;Landroidx/media3/extractor/text/ssa/SsaStyle;Landroidx/media3/extractor/text/ssa/SsaStyle$Overrides;FF)Landroidx/media3/common/text/Cue;
    ...
    invoke-static {v7, v8, p4, p3}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->addCuePlacerholderByTime(JLjava/util/List;Ljava/util/List;)I
...
.method public final parseEventBody(Landroidx/media3/common/util/ParsableByteArray;Ljava/util/List;Ljava/util/List;Ljava/nio/charset/Charset;)V
    .locals 4
    ...
    :cond_3
    invoke-virtual {p0, v1, v0, p2, p3}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->parseDialogueLine(Ljava/lang/String;Landroidx/media3/extractor/text/ssa/SsaDialogueFormat;Ljava/util/List;Ljava/util/List;)V
...
.method public final parseHeader(Landroidx/media3/common/util/ParsableByteArray;Ljava/nio/charset/Charset;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/media3/extractor/text/ssa/SsaDecoder;->parseScriptInfo(Landroidx/media3/common/util/ParsableByteArray;Ljava/nio/charset/Charset;)V
...
.method public final parseScriptInfo(Landroidx/media3/common/util/ParsableByteArray;Ljava/nio/charset/Charset;)V
    .locals 4
