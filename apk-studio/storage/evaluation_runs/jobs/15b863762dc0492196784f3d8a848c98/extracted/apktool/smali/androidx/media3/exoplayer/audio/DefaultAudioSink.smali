...
.field public final audioOffloadListener:Landroidx/media3/exoplayer/ExoPlayer$AudioOffloadListener;

.field public audioProcessingPipeline:Landroidx/media3/common/audio/AudioProcessingPipeline;

.field public final audioProcessorChain:Landroidx/media3/common/audio/AudioProcessorChain;

.field public audioSessionId:I

.field public audioTrack:Landroid/media/AudioTrack;

.field public final audioTrackBufferSizeProvider:Landroidx/media3/exoplayer/audio/DefaultAudioSink$AudioTrackBufferSizeProvider;
...
.field public listener:Landroidx/media3/exoplayer/audio/AudioSink$Listener;
...
.field public preferredDevice:Landroidx/media3/exoplayer/audio/DefaultAudioSink$AudioDeviceInfoApi23;

.field public final releasingConditionVariable:Landroidx/media3/common/util/ConditionVariable;
...
.field public final toFloatPcmAvailableAudioProcessors:Lcom/google/common/collect/ImmutableList;

.field public final toIntPcmAvailableAudioProcessors:Lcom/google/common/collect/ImmutableList;
...
# direct methods
.method public static synthetic $r8$lambda$VloBApgvTBY7oQbfg1P44RjFbJ0(Landroid/media/AudioTrack;Landroidx/media3/common/util/ConditionVariable;)V
    .locals 2
...
.method public static synthetic access$1000(Landroidx/media3/exoplayer/audio/DefaultAudioSink;)Landroidx/media3/exoplayer/audio/AudioSink$Listener;
    .locals 0
...
.method public static synthetic access$1100(Landroidx/media3/exoplayer/audio/DefaultAudioSink;)Z
    .locals 0
...
.method public static synthetic access$1200(Landroidx/media3/exoplayer/audio/DefaultAudioSink;)J
    .locals 2

    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->getSubmittedFrames()J
...
.method public static synthetic access$1300(Landroidx/media3/exoplayer/audio/DefaultAudioSink;)J
    .locals 2
...
.method public static synthetic access$900(Landroidx/media3/exoplayer/audio/DefaultAudioSink;)Landroid/media/AudioTrack;
    .locals 0
...
.method public static getAudioTrackMinBufferSize(III)I
    .locals 0
...
.method public static isAudioTrackDeadObject(I)Z
    .locals 2
...
.method public static isOffloadedPlayback(Landroid/media/AudioTrack;)Z
    ...
    invoke-static {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline14;->m(Landroid/media/AudioTrack;)Z
...
.method public static releaseAudioTrackAsync(Landroid/media/AudioTrack;Landroidx/media3/common/util/ConditionVariable;)V
    .locals 3
    ...
    invoke-direct {v2, p0, p1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticLambda16;-><init>(Landroid/media/AudioTrack;Landroidx/media3/common/util/ConditionVariable;)V
...
.method public final applyAudioProcessorPlaybackParametersAndSkipSilence(J)V
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->shouldApplyAudioProcessorPlaybackParameters()Z
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->setupAudioProcessors()V
...
.method public final applyMediaPositionParameters(J)J
    .locals 4
...
.method public final applySkipping(J)J
    .locals 3
...
.method public final buildAudioTrackWithRetry()Landroid/media/AudioTrack;
    .locals 4
    ...
    invoke-virtual {p0, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->buildAudioTrack(Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration;)Landroid/media/AudioTrack;
    ...
    :try_start_1
    invoke-virtual {p0, v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->buildAudioTrack(Landroidx/media3/exoplayer/audio/DefaultAudioSink$Configuration;)Landroid/media/AudioTrack;
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->maybeDisableOffload()V
...
.method public configure(Landroidx/media3/common/Format;I[I)V
    ...
    invoke-virtual {v1, v7}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->shouldUseFloatOutput(I)Z
    ...
    invoke-virtual {v1, v3, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->useOffloadedPlayback(Landroidx/media3/common/Format;Landroidx/media3/common/AudioAttributes;)Z
    ...
    iget-object v6, v3, Landroidx/media3/common/Format;->codecs:Ljava/lang/String;

    invoke-static {v0, v6}, Landroidx/media3/common/MimeTypes;->getEncoding(Ljava/lang/String;Ljava/lang/String;)I
    ...
    :cond_5
    invoke-virtual {v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->getAudioCapabilities()Landroidx/media3/exoplayer/audio/AudioCapabilities;
    ...
    invoke-static {v7, v8, v14}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->getAudioTrackMinBufferSize(III)I
...
.method public final drainToEndOfStream()Z
    ...
    :cond_0
    invoke-virtual {p0, v0, v2, v3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->writeBuffer(Ljava/nio/ByteBuffer;J)V
    ...
    invoke-virtual {p0, v2, v3}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->processBuffers(J)V
...
.method public experimentalFlushWithoutAudioTrackRelease()V
    ...
    :cond_1
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->resetSinkStateForFlush()V
...
.method public final getAudioCapabilities()Landroidx/media3/exoplayer/audio/AudioCapabilities;
    .locals 3
...
.method public getCurrentPositionUs(Z)J
    ...
    invoke-virtual {p0, v0, v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->applyMediaPositionParameters(J)J

    move-result-wide v0

    invoke-virtual {p0, v0, v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->applySkipping(J)J
...
.method public getFormatSupport(Landroidx/media3/common/Format;)I
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->useOffloadedPlayback(Landroidx/media3/common/Format;Landroidx/media3/common/AudioAttributes;)Z
    ...
    :cond_4
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->getAudioCapabilities()Landroidx/media3/exoplayer/audio/AudioCapabilities;
...
.method public final getOffloadedPlaybackSupport(Landroid/media/AudioFormat;Landroid/media/AudioAttributes;)I
    .locals 2
    ...
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline1;->m(Landroid/media/AudioFormat;Landroid/media/AudioAttributes;)I
    ...
    :cond_0
    invoke-static {p1, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline2;->m(Landroid/media/AudioFormat;Landroid/media/AudioAttributes;)Z
...
.method public handleBuffer(Ljava/nio/ByteBuffer;JI)Z
    ...
    invoke-virtual {v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->drainToEndOfStream()Z
    ...
    invoke-virtual {v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->playPendingData()V
    ...
    invoke-static {v5}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline3;->m(Landroid/media/AudioTrack;)V
    ...
    invoke-static {v5, v10, v9}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioTrack;II)V
    ...
    :try_start_0
    invoke-virtual {v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->initializeAudioTrack()Z
    ...
    invoke-virtual {v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->setAudioTrackPlaybackParametersV23()V
...
.method public final initializeAudioTrack()Z
    ...
    :cond_0
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->buildAudioTrackWithRetry()Landroid/media/AudioTrack;
    ...
    invoke-virtual {p0, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->registerStreamEventCallbackV29(Landroid/media/AudioTrack;)V
    ...
    invoke-static {v0, v3, v2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline4;->m(Landroid/media/AudioTrack;II)V
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->setVolumeInternal()V
...
.method public final maybeDisableOffload()V
    .locals 1
...
.method public playToEndOfStream()V
    ...
    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->drainToEndOfStream()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->playPendingData()V
...
.method public final registerStreamEventCallbackV29(Landroid/media/AudioTrack;)V
    .locals 1
...
.method public final setAudioProcessorPlaybackParameters(Landroidx/media3/common/PlaybackParameters;)V
    .locals 7
...
.method public final setAudioTrackPlaybackParametersV23()V
    ...
    invoke-static {}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline0;->m()Landroid/media/PlaybackParams;

    move-result-object v0

    invoke-static {v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline5;->m(Landroid/media/PlaybackParams;)Landroid/media/PlaybackParams;
    ...
    invoke-static {v0, v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline6;->m(Landroid/media/PlaybackParams;F)Landroid/media/PlaybackParams;
    ...
    invoke-static {v0, v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline7;->m(Landroid/media/PlaybackParams;F)Landroid/media/PlaybackParams;

    move-result-object v0

    const/4 v1, 0x2

    invoke-static {v0, v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline8;->m(Landroid/media/PlaybackParams;I)Landroid/media/PlaybackParams;
    ...
    invoke-static {v1, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline9;->m(Landroid/media/AudioTrack;Landroid/media/PlaybackParams;)V
    :try_end_0
    ...
    invoke-static {v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline10;->m(Landroid/media/AudioTrack;)Landroid/media/PlaybackParams;

    move-result-object v1

    invoke-static {v1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline11;->m(Landroid/media/PlaybackParams;)F

    move-result v1

    iget-object v2, p0, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->audioTrack:Landroid/media/AudioTrack;

    invoke-static {v2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline10;->m(Landroid/media/AudioTrack;)Landroid/media/PlaybackParams;

    move-result-object v2

    invoke-static {v2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline12;->m(Landroid/media/PlaybackParams;)F
...
.method public setPlaybackParameters(Landroidx/media3/common/PlaybackParameters;)V
    ...
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->setAudioProcessorPlaybackParameters(Landroidx/media3/common/PlaybackParameters;)V
...
.method public final setupAudioProcessors()V
    .locals 1
...
.method public final shouldApplyAudioProcessorPlaybackParameters()Z
    ...
    invoke-virtual {p0, v0}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->shouldUseFloatOutput(I)Z
...
.method public final shouldUseFloatOutput(I)Z
    .locals 1
...
.method public final useOffloadedPlayback(Landroidx/media3/common/Format;Landroidx/media3/common/AudioAttributes;)Z
    .locals 4
    ...
    invoke-virtual {p0, v0, p2}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->getOffloadedPlaybackSupport(Landroid/media/AudioFormat;Landroid/media/AudioAttributes;)I
...
.method public final writeBuffer(Ljava/nio/ByteBuffer;J)V
    ...
    invoke-virtual/range {v6 .. v11}, Landroidx/media3/exoplayer/audio/DefaultAudioSink;->writeNonBlockingWithAvSyncV21(Landroid/media/AudioTrack;Ljava/nio/ByteBuffer;IJ)I
...
.method public final writeNonBlockingWithAvSyncV21(Landroid/media/AudioTrack;Ljava/nio/ByteBuffer;IJ)I
    .locals 10
    ...
    invoke-static/range {v4 .. v9}, Landroidx/media3/exoplayer/audio/DefaultAudioSink$$ExternalSyntheticApiModelOutline13;->m(Landroid/media/AudioTrack;Ljava/nio/ByteBuffer;IIJ)I
