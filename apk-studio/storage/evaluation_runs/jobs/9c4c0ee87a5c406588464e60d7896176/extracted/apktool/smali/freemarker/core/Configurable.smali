...
.method static constructor <clinit>()V
    ...
    const-string v26, "truncate_builtin_algorithm"

    const-string v27, "url_escaping_charset"

    const-string v28, "wrap_unchecked_exceptions"
...
.method private getNullBooleanFormatErrorDescription()Lfreemarker/core/_ErrorDescriptionBuilder;
    ...
    const-string v5, ", which is the legacy deprecated default, and we treat it as if no format was set. This is the default configuration; you should provide the format explicitly for each place where you print a boolean."
    ...
    const-string v5, "Write something like myBool?string(\'yes\', \'no\') to specify boolean formatting in place."

    aput-object v5, v1, v3

    new-array v5, v7, [Ljava/lang/Object;

    const-string v8, "If you want \"true\"/\"false\" result as you are generating computer-language output (not for direct human consumption), then use \"?c\", like ${myBool?c}. (If you always generate computer-language output, then it\'s might be reasonable to set the \""

    aput-object v8, v5, v3

    aput-object v4, v5, v2

    const-string v8, "\" setting to \"c\" instead.)"
    ...
    const-string v7, "If you need the same two values on most places, the programmers can set the \""

    aput-object v7, v5, v3

    aput-object v4, v5, v2

    const-string v2, "\" setting to something like \"yes,no\". However, then it will be easy to unwillingly format booleans like that."
...
.method public setSetting(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :goto_4
    invoke-virtual {p0, v8}, Lfreemarker/core/Configurable;->setLazyAutoImports(Ljava/lang/Boolean;)V
    ...
    invoke-direct {v5, v0, v6, v6}, Lfreemarker/core/ParseException;-><init>(Ljava/lang/String;II)V
    ...
    invoke-direct {v0, v8, v7}, Lfreemarker/core/OptInTemplateClassResolver;-><init>(Ljava/util/Set;Ljava/util/List;)V
    ...
    :goto_1e
    invoke-virtual {p0, v0}, Lfreemarker/core/Configurable;->setClassicCompatible(Z)V
    ...
    :goto_21
    invoke-virtual {p0, v8}, Lfreemarker/core/Configurable;->setSQLDateAndTimeTimeZone(Ljava/util/TimeZone;)V
    ...
    invoke-static {v8, v1, v2}, Lfreemarker/core/_CoreAPI;->checkSettingValueItemsType(Ljava/lang/String;Ljava/lang/Class;Ljava/util/Collection;)V
