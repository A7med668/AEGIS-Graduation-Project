...
.method public static newKeyValuePairListingNonStringKeyExceptionMessage(Lfreemarker/template/TemplateModel;Lfreemarker/template/TemplateHashModelEx;)Lfreemarker/template/TemplateModelException;
    ...
    new-instance v4, Lfreemarker/core/_DelayedAOrAn;

    new-instance v6, Lfreemarker/core/_DelayedFTLTypeDescription;

    invoke-direct {v6, p0}, Lfreemarker/core/_DelayedFTLTypeDescription;-><init>(Lfreemarker/template/TemplateModel;)V

    invoke-direct {v4, v6}, Lfreemarker/core/_DelayedAOrAn;-><init>(Ljava/lang/Object;)V
    ...
    invoke-direct {v1, v3}, Lfreemarker/core/_ErrorDescriptionBuilder;-><init>([Ljava/lang/Object;)V
    ...
    const-class p1, Lfreemarker/template/TemplateHashModelEx2;
    ...
    invoke-virtual {v1, v3}, Lfreemarker/core/_ErrorDescriptionBuilder;->tip([Ljava/lang/Object;)Lfreemarker/core/_ErrorDescriptionBuilder;
...
.method public static newLazilyGeneratedCollectionMustBeSequenceException(Lfreemarker/core/Expression;)Lfreemarker/template/TemplateException;
    ...
    const-string v3, "<#list transformedListable as x>"

    aput-object v3, v1, v2

    const/4 v2, 0x2

    const-string v3, "), or, if you know that you don\'t have too many elements, use transformedListable?sequence to allow it to be treated as an FTL sequence."
