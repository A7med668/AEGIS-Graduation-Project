...
.method private process(Ljava/io/File;Ljava/lang/String;Ljava/io/File;)V
    ...
    iget-object v4, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->extension:Ljava/lang/String;
    ...
    invoke-direct {p1, p3, v3}, Ljava/io/File;-><init>(Ljava/io/File;Ljava/lang/String;)V
    :try_end_1
    ...
    iget-wide v3, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->templateFileLastModified:J
    ...
    iget-wide v3, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->projectFileLastModified:J
    ...
    iget-object v4, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->projectFile:Ljava/io/File;
    ...
    invoke-virtual {p0, v4}, Lfreemarker/ext/ant/FreemarkerXmlTask;->insertDefaults(Ljava/util/Map;)V
    ...
    iget-object v7, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->encoding:Ljava/lang/String;
    ...
    :try_start_3
    iget-object v5, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->parsedTemplate:Lfreemarker/template/Template;

    if-eqz v5, :cond_7

    iget-object v5, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->prepareModel:Lfreemarker/ext/ant/JythonAntTask;
    :try_end_3
    ...
    iget-object v8, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->projectNode:Lfreemarker/template/TemplateNodeModel;

    if-eqz v8, :cond_2

    check-cast v8, Lfreemarker/ext/dom/NodeModel;

    invoke-virtual {v8}, Lfreemarker/ext/dom/NodeModel;->getNode()Lorg/w3c/dom/Node;
    ...
    :cond_2
    iget-object v8, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->prepareModel:Lfreemarker/ext/ant/JythonAntTask;

    invoke-virtual {v8, v5}, Lfreemarker/ext/ant/JythonAntTask;->execute(Ljava/util/Map;)V

    :cond_3
    iget-object v5, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->parsedTemplate:Lfreemarker/template/Template;

    invoke-virtual {v5, v4, v1}, Lfreemarker/template/Template;->createProcessingEnvironment(Ljava/lang/Object;Ljava/io/Writer;)Lfreemarker/core/Environment;

    move-result-object v4

    invoke-virtual {v4, v3}, Lfreemarker/core/Environment;->setCurrentVisitorNode(Lfreemarker/template/TemplateNodeModel;)V
    ...
    :cond_5
    invoke-virtual {v4}, Lfreemarker/core/Environment;->process()V
    ...
    const-string v2, "XML parsing error in "
    ...
    invoke-virtual {p0, p3, v0}, Lfreemarker/ext/ant/FreemarkerXmlTask;->log(Ljava/lang/String;I)V
...
.method public execute()V
    ...
    const-string v3, "Could not create document builder"

    invoke-direct {v1, v3, v0, v2}, Lorg/apache/tools/ant/BuildException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;Lorg/apache/tools/ant/Location;)V
...
.method protected insertDefaults(Ljava/util/Map;)V
    ...
    iget-object v0, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->propertiesTemplate:Lfreemarker/template/TemplateModel;

    const-string v1, "properties"

    invoke-interface {p1, v1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    iget-object v0, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->userPropertiesTemplate:Lfreemarker/template/TemplateModel;
    ...
    iget-object v0, p0, Lfreemarker/ext/ant/FreemarkerXmlTask;->projectNode:Lfreemarker/template/TemplateNodeModel;

    const-string v1, "project_node"
