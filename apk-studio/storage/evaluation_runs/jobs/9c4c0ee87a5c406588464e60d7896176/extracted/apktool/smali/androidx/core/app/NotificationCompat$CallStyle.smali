...
.method private static getActionFromActionCompat(Landroidx/core/app/NotificationCompat$Action;)Landroid/app/Notification$Action;
    ...
    invoke-static {v0, v2, v3}, Landroidx/core/app/NotificationCompat$CallStyle$Api23Impl;->createActionBuilder(Landroid/graphics/drawable/Icon;Ljava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Action$Builder;
    ...
    invoke-static {v0, v2, v3}, Landroidx/core/app/NotificationCompat$CallStyle$Api20Impl;->createActionBuilder(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)Landroid/app/Notification$Action$Builder;
    ...
    invoke-static {v0, v3}, Landroidx/core/app/NotificationCompat$CallStyle$Api24Impl;->setAllowGeneratedReplies(Landroid/app/Notification$Action$Builder;Z)Landroid/app/Notification$Action$Builder;
    ...
    invoke-static {v0, v3}, Landroidx/core/app/NotificationCompat$CallStyle$Api31Impl;->setAuthenticationRequired(Landroid/app/Notification$Action$Builder;Z)Landroid/app/Notification$Action$Builder;

    :cond_5
    invoke-static {v0, v2}, Landroidx/core/app/NotificationCompat$CallStyle$Api20Impl;->addExtras(Landroid/app/Notification$Action$Builder;Landroid/os/Bundle;)Landroid/app/Notification$Action$Builder;
...
.method public apply(Landroidx/core/app/NotificationBuilderWithBuilderAccessor;)V
    ...
    invoke-static {v2}, Landroidx/core/app/NotificationCompat$CallStyle;->getActionFromActionCompat(Landroidx/core/app/NotificationCompat$Action;)Landroid/app/Notification$Action;

    move-result-object v2

    invoke-static {p1, v2}, Landroidx/core/app/NotificationCompat$CallStyle$Api20Impl;->addAction(Landroid/app/Notification$Builder;Landroid/app/Notification$Action;)Landroid/app/Notification$Builder;
