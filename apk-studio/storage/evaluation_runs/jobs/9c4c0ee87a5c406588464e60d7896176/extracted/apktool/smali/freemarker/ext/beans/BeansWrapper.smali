...
.method protected constructor <init>(Lfreemarker/ext/beans/BeansWrapperConfiguration;ZZ)V
    ...
    const-class p3, Lfreemarker/ext/beans/BeansWrapper;
    ...
    iput-boolean v0, p0, Lfreemarker/ext/beans/BeansWrapper;->methodsShadowItems:Z

    new-instance v1, Lfreemarker/ext/beans/BeansWrapper$3;

    invoke-direct {v1, p0}, Lfreemarker/ext/beans/BeansWrapper$3;-><init>(Lfreemarker/ext/beans/BeansWrapper;)V

    iput-object v1, p0, Lfreemarker/ext/beans/BeansWrapper;->BOOLEAN_FACTORY:Lfreemarker/ext/util/ModelFactory;
    ...
    invoke-virtual {v4, v1, v3}, Lfreemarker/log/Logger;->info(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    sget-boolean v1, Lfreemarker/ext/beans/BeansWrapper;->ftmaDeprecationWarnLogged:Z

    if-nez v1, :cond_1

    sget-object v1, Lfreemarker/ext/beans/BeansWrapper;->LOG:Lfreemarker/log/Logger;
    ...
    invoke-virtual {v1, p3}, Lfreemarker/log/Logger;->warn(Ljava/lang/String;)V

    sput-boolean v0, Lfreemarker/ext/beans/BeansWrapper;->ftmaDeprecationWarnLogged:Z

    :cond_1
    invoke-virtual {p1, v2}, Lfreemarker/ext/beans/BeansWrapperConfiguration;->clone(Z)Ljava/lang/Object;
    ...
    invoke-direct {v0, v1, p3, v2, v2}, Lfreemarker/ext/beans/ClassIntrospector;-><init>(Lfreemarker/ext/beans/ClassIntrospectorBuilder;Ljava/lang/Object;ZZ)V
...
.method public newInstance(Ljava/lang/Class;Ljava/util/List;)Ljava/lang/Object;
    ...
    invoke-virtual {v0, p1}, Lfreemarker/ext/beans/ClassIntrospector;->get(Ljava/lang/Class;)Ljava/util/Map;
    ...
    invoke-virtual {v0}, Lfreemarker/ext/beans/SimpleMethod;->getMember()Ljava/lang/reflect/Member;

    move-result-object v1

    check-cast v1, Ljava/lang/reflect/Constructor;

    invoke-virtual {v0, p2, p0}, Lfreemarker/ext/beans/SimpleMethod;->unwrapArguments(Ljava/util/List;Lfreemarker/ext/beans/BeansWrapper;)[Ljava/lang/Object;
    ...
    :cond_0
    invoke-static {v2, v1, p2}, Lfreemarker/ext/beans/_MethodUtil;->newInvocationTemplateModelException(Ljava/lang/Object;Ljava/lang/reflect/Member;Ljava/lang/Throwable;)Lfreemarker/template/TemplateModelException;
    ...
    invoke-virtual {v0, p2, p0}, Lfreemarker/ext/beans/OverloadedMethods;->getMemberAndArguments(Ljava/util/List;Lfreemarker/ext/beans/BeansWrapper;)Lfreemarker/ext/beans/MemberAndArguments;
...
.method unwrapSequenceToArray(Lfreemarker/template/TemplateSequenceModel;Ljava/lang/Class;ZLjava/util/Map;)Ljava/lang/Object;
    ...
    invoke-direct {v2, v1}, Lfreemarker/core/_DelayedShortClassName;-><init>(Ljava/lang/Class;)V
    ...
    invoke-direct {v1, v4}, Lfreemarker/core/_DelayedFTLTypeDescription;-><init>(Lfreemarker/template/TemplateModel;)V
