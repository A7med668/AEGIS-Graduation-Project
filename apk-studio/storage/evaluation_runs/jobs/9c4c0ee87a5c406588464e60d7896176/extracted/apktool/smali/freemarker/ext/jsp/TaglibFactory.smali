...
.method private addTldLocationsFromMetaInfTlds()V
    ...
    iget-object v1, p0, Lfreemarker/ext/jsp/TaglibFactory;->metaInfTldSources:Ljava/util/List;
    ...
    instance-of v3, v3, Lfreemarker/ext/jsp/TaglibFactory$ClearMetaInfTldSource;
    ...
    invoke-static {v7}, Lfreemarker/ext/jsp/TaglibFactory;->isJarUrl(Ljava/net/URL;)Z
    ...
    invoke-direct {p0, v7}, Lfreemarker/ext/jsp/TaglibFactory;->urlToFileOrNull(Ljava/net/URL;)Ljava/io/File;

    move-result-object v9

    if-eqz v9, :cond_9

    invoke-direct {p0, v9}, Lfreemarker/ext/jsp/TaglibFactory;->addTldLocationsFromFileDirectory(Ljava/io/File;)V
    ...
    invoke-direct {p0, v7}, Lfreemarker/ext/jsp/TaglibFactory;->addTldLocationsFromJarDirectoryEntryURL(Ljava/net/URL;)V

    goto :goto_2

    :cond_a
    sget-object v7, Lfreemarker/ext/jsp/TaglibFactory;->LOG:Lfreemarker/log/Logger;
    ...
    invoke-virtual {v7, v5}, Lfreemarker/log/Logger;->debug(Ljava/lang/String;)V
...
.method private static tryGetThreadContextClassLoader()Ljava/lang/ClassLoader;
    ...
    sget-object v2, Lfreemarker/ext/jsp/TaglibFactory;->LOG:Lfreemarker/log/Logger;

    const-string v3, "Can\'t access Thread Context ClassLoader"
...
.method public get(Ljava/lang/String;)Lfreemarker/template/TemplateModel;
    ...
    const-string v6, "Locating TLD for taglib URI "
    ...
    invoke-direct {v4, p0, v2, v5, v3}, Lfreemarker/ext/jsp/TaglibFactory$ServletContextJarEntryTldLocation;-><init>(Lfreemarker/ext/jsp/TaglibFactory;Ljava/lang/String;Ljava/lang/String;Lfreemarker/ext/jsp/TaglibFactory$1;)V
    ...
    invoke-direct {v4, p0, v2}, Lfreemarker/ext/jsp/TaglibFactory$ServletContextTldLocation;-><init>(Lfreemarker/ext/jsp/TaglibFactory;Ljava/lang/String;)V
    :try_end_5
    ...
    :goto_2
    :try_start_6
    invoke-direct {p0, v4, p1}, Lfreemarker/ext/jsp/TaglibFactory;->loadTaglib(Lfreemarker/ext/jsp/TaglibFactory$TldLocation;Ljava/lang/String;)Lfreemarker/template/TemplateHashModel;
    ...
    const-string v3, " from TLD location "
    ...
    const-string v6, " JSP taglib URI. (TLD-s are searched according the JSP 2.2 specification. In development- and embedded-servlet-container setups you may also need the \""
    ...
    const-class v6, Lfreemarker/ext/servlet/FreemarkerServlet;
    ...
    const-string v6, " init-params or the similar system properites."
    ...
    invoke-direct {v4, v1}, Lfreemarker/ext/jsp/TaglibFactory$TaglibGettingException;-><init>(Ljava/lang/String;)V
    ...
    invoke-direct {v4, v5, v2}, Lfreemarker/ext/jsp/TaglibFactory$TaglibGettingException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-direct {v1, p1, v2}, Lfreemarker/template/TemplateModelException;-><init>(Ljava/lang/String;Ljava/lang/Exception;)V
