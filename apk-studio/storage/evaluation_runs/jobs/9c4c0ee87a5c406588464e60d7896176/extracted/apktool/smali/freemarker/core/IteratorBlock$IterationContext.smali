...
.method private executedNestedContentForCollOrSeqListing(Lfreemarker/core/Environment;[Lfreemarker/core/TemplateElement;)Z
    ...
    iget-object v5, p0, Lfreemarker/core/IteratorBlock$IterationContext;->listedValue:Lfreemarker/template/TemplateModel;

    invoke-direct {v4, v5}, Lfreemarker/core/_DelayedFTLTypeDescription;-><init>(Lfreemarker/template/TemplateModel;)V
...
.method private executedNestedContentForHashListing(Lfreemarker/core/Environment;[Lfreemarker/core/TemplateElement;)Z
    ...
    invoke-interface {v4}, Lfreemarker/template/TemplateHashModelEx2$KeyValuePair;->getKey()Lfreemarker/template/TemplateModel;

    move-result-object v5

    iput-object v5, p0, Lfreemarker/core/IteratorBlock$IterationContext;->loopVar1Value:Lfreemarker/template/TemplateModel;

    invoke-interface {v4}, Lfreemarker/template/TemplateHashModelEx2$KeyValuePair;->getValue()Lfreemarker/template/TemplateModel;
    ...
    iget-object v5, p0, Lfreemarker/core/IteratorBlock$IterationContext;->loopVar1Name:Ljava/lang/String;
    ...
    invoke-interface {v0, v5}, Lfreemarker/template/TemplateHashModelEx;->get(Ljava/lang/String;)Lfreemarker/template/TemplateModel;

    move-result-object v5

    iput-object v5, p0, Lfreemarker/core/IteratorBlock$IterationContext;->loopVar2Value:Lfreemarker/template/TemplateModel;
    ...
    iput-object v5, p0, Lfreemarker/core/IteratorBlock$IterationContext;->visibleLoopVar1Name:Ljava/lang/String;
    ...
    :try_start_3
    sget-object v6, Lfreemarker/core/BreakOrContinueException;->BREAK_INSTANCE:Lfreemarker/core/BreakOrContinueException;
    :try_end_3
    .catchall {:try_start_3 .. :try_end_3} :catchall_1
    ...
    iget-boolean v5, p0, Lfreemarker/core/IteratorBlock$IterationContext;->hasNext:Z
    ...
    invoke-static {v5, p1}, Lfreemarker/core/_MessageUtil;->newKeyValuePairListingNonStringKeyExceptionMessage(Lfreemarker/template/TemplateModel;Lfreemarker/template/TemplateHashModelEx;)Lfreemarker/template/TemplateModelException;
