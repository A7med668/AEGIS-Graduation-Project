...
.method private deliberateLeftTrim()Z
    ...
    iget-boolean v5, v3, Lfreemarker/core/TrimInstruction;->left:Z

    if-nez v5, :cond_0

    iget-boolean v5, v3, Lfreemarker/core/TrimInstruction;->right:Z
    ...
    invoke-static {v5, v2}, Lfreemarker/core/TextBlock;->substring([CI)[C
    ...
    :cond_3
    invoke-static {v2, v5}, Lfreemarker/core/TextBlock;->substring([CI)[C
...
.method private deliberateRightTrim()Z
    ...
    invoke-static {v5, v1, v2}, Lfreemarker/core/TextBlock;->substring([CII)[C
    ...
    iget v7, v5, Lfreemarker/core/TemplateElement;->beginLine:I

    iget v8, p0, Lfreemarker/core/TextBlock;->endLine:I

    if-ne v7, v8, :cond_7

    invoke-virtual {v5}, Lfreemarker/core/TemplateElement;->heedsOpeningWhitespace()Z
    ...
    :cond_5
    instance-of v7, v5, Lfreemarker/core/TrimInstruction;
    ...
    :cond_6
    invoke-virtual {v5}, Lfreemarker/core/TemplateElement;->nextTerminalNode()Lfreemarker/core/TemplateElement;
    ...
    sget-object v3, Lfreemarker/template/utility/CollectionUtils;->EMPTY_CHAR_ARRAY:[C

    :cond_8
    invoke-static {v2, v3}, Lfreemarker/core/TextBlock;->concat([C[C)[C
...
.method private openingCharsToStrip()I
    ...
    :cond_1
    invoke-static {v2, v1, v0}, Lfreemarker/template/utility/StringUtil;->isTrimmableToEmpty([CII)Z
    ...
    iget v3, v2, Lfreemarker/core/TemplateElement;->endLine:I

    iget v4, p0, Lfreemarker/core/TextBlock;->beginLine:I

    if-ne v3, v4, :cond_4

    invoke-virtual {v2}, Lfreemarker/core/TemplateElement;->heedsOpeningWhitespace()Z
    ...
    :cond_3
    invoke-virtual {v2}, Lfreemarker/core/TemplateElement;->prevTerminalNode()Lfreemarker/core/TemplateElement;
...
.method private trailingCharsToStrip()I
    ...
    invoke-static {v3, v0}, Lfreemarker/template/utility/StringUtil;->isTrimmableToEmpty([CI)Z
    ...
    iget v3, v1, Lfreemarker/core/TemplateElement;->beginLine:I
