...
.method private a()Landroidx/appcompat/view/menu/k;
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->o(Landroidx/appcompat/view/menu/g;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->l:Landroid/widget/PopupWindow$OnDismissListener;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->x(Landroid/widget/PopupWindow$OnDismissListener;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->f:Landroid/view/View;

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->s(Landroid/view/View;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->i:Landroidx/appcompat/view/menu/m$a;

    invoke-interface {v0, v1}, Landroidx/appcompat/view/menu/m;->l(Landroidx/appcompat/view/menu/m$a;)V

    iget-boolean v1, p0, Landroidx/appcompat/view/menu/l;->h:Z

    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->u(Z)V

    iget p0, p0, Landroidx/appcompat/view/menu/l;->g:I

    invoke-virtual {v0, p0}, Landroidx/appcompat/view/menu/k;->v(I)V
...
.method private l(IIZZ)V
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/k;->y(Z)V
    ...
    invoke-static {p4}, Landroidx/core/view/l0;->z(Landroid/view/View;)I
    ...
    :cond_0
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/k;->w(I)V

    invoke-virtual {v0, p2}, Landroidx/appcompat/view/menu/k;->z(I)V
    ...
    invoke-virtual {v0, p3}, Landroidx/appcompat/view/menu/k;->t(Landroid/graphics/Rect;)V
...
.method public g(Z)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/view/menu/k;->u(Z)V
...
.method public j(Landroidx/appcompat/view/menu/m$a;)V
    ...
    invoke-interface {p0, p1}, Landroidx/appcompat/view/menu/m;->l(Landroidx/appcompat/view/menu/m$a;)V
