...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/e;->h:Ljava/lang/ThreadLocal;

    new-instance v0, Landroidx/recyclerview/widget/e$a;

    invoke-direct {v0}, Landroidx/recyclerview/widget/e$a;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/e;->i:Ljava/util/Comparator;
...
.method private b()V
    ...
    :cond_6
    iget-object p0, p0, Landroidx/recyclerview/widget/e;->g:Ljava/util/ArrayList;

    sget-object v0, Landroidx/recyclerview/widget/e;->i:Ljava/util/Comparator;
...
.method private c(Landroidx/recyclerview/widget/e$c;J)V
    ...
    invoke-direct {p0, v2, p1, v0, v1}, Landroidx/recyclerview/widget/e;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$f0;

    move-result-object p1

    if-eqz p1, :cond_1

    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView$f0;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView$f0;->b:Ljava/lang/ref/WeakReference;
...
.method private h(Landroidx/recyclerview/widget/RecyclerView;J)V
    ...
    invoke-virtual {p1}, Landroidx/recyclerview/widget/RecyclerView;->g1()V

    :cond_1
    iget-object v0, p1, Landroidx/recyclerview/widget/RecyclerView;->h0:Landroidx/recyclerview/widget/e$b;
    ...
    iget-object v1, p1, Landroidx/recyclerview/widget/RecyclerView;->i0:Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    invoke-direct {p0, p1, v2, p2, p3}, Landroidx/recyclerview/widget/e;->i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$f0;
    :try_end_0
...
.method private i(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$f0;
    ...
    :cond_0
    iget-object p0, p1, Landroidx/recyclerview/widget/RecyclerView;->c:Landroidx/recyclerview/widget/RecyclerView$w;
    ...
    invoke-virtual {p0, p2, v0, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$w;->N(IZJ)Landroidx/recyclerview/widget/RecyclerView$f0;

    move-result-object p2

    if-eqz p2, :cond_2

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$f0;->t()Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$f0;->u()Z

    move-result p3

    if-nez p3, :cond_1

    iget-object p3, p2, Landroidx/recyclerview/widget/RecyclerView$f0;->a:Landroid/view/View;

    invoke-virtual {p0, p3}, Landroidx/recyclerview/widget/RecyclerView$w;->G(Landroid/view/View;)V
    ...
    :cond_1
    invoke-virtual {p0, p2, v0}, Landroidx/recyclerview/widget/RecyclerView$w;->a(Landroidx/recyclerview/widget/RecyclerView$f0;Z)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :cond_2
    :goto_0
    invoke-virtual {p1, v0}, Landroidx/recyclerview/widget/RecyclerView;->S0(Z)V
...
.method public a(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    :cond_1
    :goto_0
    iget-object p0, p0, Landroidx/recyclerview/widget/e;->d:Ljava/util/ArrayList;
...
.method f(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    :cond_2
    iget-object p0, p1, Landroidx/recyclerview/widget/RecyclerView;->h0:Landroidx/recyclerview/widget/e$b;
