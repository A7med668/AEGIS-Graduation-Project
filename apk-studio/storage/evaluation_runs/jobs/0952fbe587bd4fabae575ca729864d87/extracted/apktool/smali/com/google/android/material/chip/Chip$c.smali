...
.method protected M(Landroidx/core/view/accessibility/k;)V
    .locals 1
    ...
    invoke-virtual {p1, v0}, Landroidx/core/view/accessibility/k;->b0(Z)V
    ...
    invoke-virtual {p1, v0}, Landroidx/core/view/accessibility/k;->d0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, p0}, Landroidx/core/view/accessibility/k;->B0(Ljava/lang/CharSequence;)V

    return-void
.end method

.method protected N(ILandroidx/core/view/accessibility/k;)V
    .locals 5
    ...
    invoke-virtual {p2, p1}, Landroidx/core/view/accessibility/k;->h0(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p2, p1}, Landroidx/core/view/accessibility/k;->Z(Landroid/graphics/Rect;)V

    sget-object p1, Landroidx/core/view/accessibility/k$a;->i:Landroidx/core/view/accessibility/k$a;

    invoke-virtual {p2, p1}, Landroidx/core/view/accessibility/k;->b(Landroidx/core/view/accessibility/k$a;)V
    ...
    invoke-virtual {p2, p0}, Landroidx/core/view/accessibility/k;->j0(Z)V

    goto :goto_1

    :cond_2
    invoke-virtual {p2, v0}, Landroidx/core/view/accessibility/k;->h0(Ljava/lang/CharSequence;)V

    invoke-static {}, Lcom/google/android/material/chip/Chip;->i()Landroid/graphics/Rect;

    move-result-object p0

    invoke-virtual {p2, p0}, Landroidx/core/view/accessibility/k;->Z(Landroid/graphics/Rect;)V
