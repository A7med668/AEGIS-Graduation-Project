...
.method public constructor <init>(Landroid/view/View;)V
    ...
    invoke-static {p1, p0}, Landroidx/core/view/l0;->z0(Landroid/view/View;I)V
...
.method private E(Landroid/graphics/Rect;)Z
    ...
    :cond_1
    iget-object p0, p0, Ly/a;->i:Landroid/view/View;
...
.method private G(ILandroid/graphics/Rect;)Z
    ...
    check-cast v0, Landroidx/core/view/accessibility/k;
    ...
    invoke-direct {p0, v0, v4}, Ly/a;->z(ILandroid/graphics/Rect;)V
    ...
    :cond_7
    invoke-virtual {v7, p1}, Lk/h;->g(Ljava/lang/Object;)I

    move-result p1

    invoke-virtual {v7, p1}, Lk/h;->h(I)I

    move-result v8

    :goto_6
    invoke-virtual {p0, v8}, Ly/a;->T(I)Z
...
.method private R(ILandroid/os/Bundle;)Z
    ...
    invoke-static {p0, p1, p2}, Landroidx/core/view/l0;->d0(Landroid/view/View;ILandroid/os/Bundle;)Z
...
.method private r(II)Landroid/view/accessibility/AccessibilityEvent;
    ...
    invoke-virtual {p0, p1}, Ly/a;->H(I)Landroidx/core/view/accessibility/k;
    ...
    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->w()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->N()Z

    move-result v1

    invoke-virtual {p2, v1}, Landroid/view/accessibility/AccessibilityRecord;->setScrollable(Z)V

    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->M()Z

    move-result v1

    invoke-virtual {p2, v1}, Landroid/view/accessibility/AccessibilityRecord;->setPassword(Z)V

    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->G()Z

    move-result v1

    invoke-virtual {p2, v1}, Landroid/view/accessibility/AccessibilityRecord;->setEnabled(Z)V

    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->D()Z
    ...
    :cond_1
    :goto_0
    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->n()Ljava/lang/CharSequence;
    ...
    invoke-static {p2, v0, p1}, Landroidx/core/view/accessibility/m;->c(Landroid/view/accessibility/AccessibilityRecord;Landroid/view/View;I)V
...
.method private t(I)Landroidx/core/view/accessibility/k;
    .locals 7

    invoke-static {}, Landroidx/core/view/accessibility/k;->S()Landroidx/core/view/accessibility/k;

    move-result-object v0

    const/4 v1, 0x1

    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/k;->j0(Z)V

    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/k;->l0(Z)V

    const-string v2, "android.view.View"

    invoke-virtual {v0, v2}, Landroidx/core/view/accessibility/k;->d0(Ljava/lang/CharSequence;)V

    sget-object v2, Ly/a;->n:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroidx/core/view/accessibility/k;->Z(Landroid/graphics/Rect;)V

    invoke-virtual {v0, v2}, Landroidx/core/view/accessibility/k;->a0(Landroid/graphics/Rect;)V

    iget-object v3, p0, Ly/a;->i:Landroid/view/View;

    invoke-virtual {v0, v3}, Landroidx/core/view/accessibility/k;->t0(Landroid/view/View;)V

    invoke-virtual {p0, p1, v0}, Ly/a;->N(ILandroidx/core/view/accessibility/k;)V
    ...
    invoke-virtual {v0, v3}, Landroidx/core/view/accessibility/k;->j(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->h()I
    ...
    invoke-virtual {v0, v3}, Landroidx/core/view/accessibility/k;->r0(Ljava/lang/CharSequence;)V

    iget-object v3, p0, Ly/a;->i:Landroid/view/View;

    invoke-virtual {v0, v3, p1}, Landroidx/core/view/accessibility/k;->z0(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/k;->Y(Z)V

    invoke-virtual {v0, v4}, Landroidx/core/view/accessibility/k;->a(I)V

    goto :goto_1

    :cond_2
    invoke-virtual {v0, v5}, Landroidx/core/view/accessibility/k;->Y(Z)V

    const/16 v3, 0x40

    invoke-virtual {v0, v3}, Landroidx/core/view/accessibility/k;->a(I)V
    ...
    :cond_4
    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->H()Z

    move-result v3

    if-eqz v3, :cond_5

    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/k;->a(I)V

    :cond_5
    :goto_3
    invoke-virtual {v0, p1}, Landroidx/core/view/accessibility/k;->m0(Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/accessibility/k;->k(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/accessibility/k;->j(Landroid/graphics/Rect;)V

    iget p1, v0, Landroidx/core/view/accessibility/k;->b:I
    ...
    iget v3, v0, Landroidx/core/view/accessibility/k;->b:I
    ...
    invoke-virtual {p1, v4, v2}, Landroidx/core/view/accessibility/k;->u0(Landroid/view/View;I)V

    sget-object v4, Ly/a;->n:Landroid/graphics/Rect;

    invoke-virtual {p1, v4}, Landroidx/core/view/accessibility/k;->Z(Landroid/graphics/Rect;)V

    invoke-virtual {p0, v3, p1}, Ly/a;->N(ILandroidx/core/view/accessibility/k;)V

    iget-object v3, p0, Ly/a;->e:Landroid/graphics/Rect;

    invoke-virtual {p1, v3}, Landroidx/core/view/accessibility/k;->j(Landroid/graphics/Rect;)V
    ...
    iget v3, p1, Landroidx/core/view/accessibility/k;->b:I

    goto :goto_4

    :cond_6
    invoke-virtual {p1}, Landroidx/core/view/accessibility/k;->W()V
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/accessibility/k;->a0(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/core/view/accessibility/k;->D0(Z)V
...
.method private u()Landroidx/core/view/accessibility/k;
    .locals 6

    iget-object v0, p0, Ly/a;->i:Landroid/view/View;

    invoke-static {v0}, Landroidx/core/view/accessibility/k;->T(Landroid/view/View;)Landroidx/core/view/accessibility/k;

    move-result-object v0

    iget-object v1, p0, Ly/a;->i:Landroid/view/View;

    invoke-static {v1, v0}, Landroidx/core/view/l0;->b0(Landroid/view/View;Landroidx/core/view/accessibility/k;)V
    ...
    invoke-virtual {v0}, Landroidx/core/view/accessibility/k;->m()I
    ...
    invoke-virtual {v0, v4, v5}, Landroidx/core/view/accessibility/k;->c(Landroid/view/View;I)V
...
.method private y()Lk/h;
    ...
    invoke-direct {p0, v3}, Ly/a;->t(I)Landroidx/core/view/accessibility/k;
    ...
    invoke-virtual {v1, v4, v3}, Lk/h;->i(ILjava/lang/Object;)V
...
.method private z(ILandroid/graphics/Rect;)V
    ...
    invoke-virtual {p0, p2}, Landroidx/core/view/accessibility/k;->j(Landroid/graphics/Rect;)V
...
.method H(I)Landroidx/core/view/accessibility/k;
    .locals 1
    ...
    invoke-direct {p0}, Ly/a;->u()Landroidx/core/view/accessibility/k;
    ...
    :cond_0
    invoke-direct {p0, p1}, Ly/a;->t(I)Landroidx/core/view/accessibility/k;
...
.method protected abstract M(Landroidx/core/view/accessibility/k;)V
.end method

.method protected abstract N(ILandroidx/core/view/accessibility/k;)V
.end method
...
.method public b(Landroid/view/View;)Landroidx/core/view/accessibility/l;
    ...
    :cond_0
    iget-object p0, p0, Ly/a;->j:Ly/a$c;
...
.method public g(Landroid/view/View;Landroidx/core/view/accessibility/k;)V
    ...
    invoke-virtual {p0, p2}, Ly/a;->M(Landroidx/core/view/accessibility/k;)V
