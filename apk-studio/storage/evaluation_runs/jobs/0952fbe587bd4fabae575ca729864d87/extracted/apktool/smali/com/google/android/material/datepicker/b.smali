...
.field private final f:Lj1/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILj1/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Lj1/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    invoke-static {p0, p1, v1}, Lg1/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, v1, v0}, Lj1/k;->b(Landroid/content/Context;II)Lj1/k$b;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILj1/k;Landroid/graphics/Rect;)V
...
.method c(Landroid/widget/TextView;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;)V
    ...
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lj1/k;

    invoke-virtual {v0, v2}, Lj1/g;->setShapeAppearanceModel(Lj1/k;)V

    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Lj1/k;

    invoke-virtual {v1, v2}, Lj1/g;->setShapeAppearanceModel(Lj1/k;)V
    ...
    invoke-virtual {v0, p2, v2}, Lj1/g;->e0(FLandroid/content/res/ColorStateList;)V
    ...
    invoke-static {p1, p2}, Landroidx/core/view/l0;->s0(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
