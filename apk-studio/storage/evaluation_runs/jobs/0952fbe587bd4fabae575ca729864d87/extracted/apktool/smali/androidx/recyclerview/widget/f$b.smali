...
.method public a(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/MotionEvent;)Z
    ...
    iget-object p1, p1, Landroidx/recyclerview/widget/f;->z:Landroidx/core/view/n;

    invoke-virtual {p1, p2}, Landroidx/core/view/n;->a(Landroid/view/MotionEvent;)Z
    ...
    iget-object v2, p1, Landroidx/recyclerview/widget/f;->c:Landroidx/recyclerview/widget/RecyclerView$f0;
    ...
    iget-object v3, p1, Landroidx/recyclerview/widget/f$g;->e:Landroidx/recyclerview/widget/RecyclerView$f0;

    invoke-virtual {v2, v3, v0}, Landroidx/recyclerview/widget/f;->r(Landroidx/recyclerview/widget/RecyclerView$f0;Z)V
    ...
    iget-object v4, p1, Landroidx/recyclerview/widget/f$g;->e:Landroidx/recyclerview/widget/RecyclerView$f0;

    invoke-virtual {v3, v2, v4}, Landroidx/recyclerview/widget/f$e;->c(Landroidx/recyclerview/widget/RecyclerView;Landroidx/recyclerview/widget/RecyclerView$f0;)V
    ...
    invoke-virtual {v2, v3, p1}, Landroidx/recyclerview/widget/f;->F(Landroidx/recyclerview/widget/RecyclerView$f0;I)V

    iget-object p1, p0, Landroidx/recyclerview/widget/f$b;->a:Landroidx/recyclerview/widget/f;

    iget v2, p1, Landroidx/recyclerview/widget/f;->o:I

    invoke-virtual {p1, p2, v2, v1}, Landroidx/recyclerview/widget/f;->K(Landroid/view/MotionEvent;II)V
    ...
    invoke-virtual {p1, v2, v1}, Landroidx/recyclerview/widget/f;->F(Landroidx/recyclerview/widget/RecyclerView$f0;I)V
    ...
    :cond_5
    iget-object p0, p0, Landroidx/recyclerview/widget/f$b;->a:Landroidx/recyclerview/widget/f;
...
.method public b(Landroidx/recyclerview/widget/RecyclerView;Landroid/view/MotionEvent;)V
    ...
    iget-object v3, v2, Landroidx/recyclerview/widget/f;->c:Landroidx/recyclerview/widget/RecyclerView$f0;
    ...
    invoke-virtual {p0, p2, v0, p1}, Landroidx/recyclerview/widget/f;->K(Landroid/view/MotionEvent;II)V
    ...
    invoke-virtual {v2, p2, p1, v1}, Landroidx/recyclerview/widget/f;->K(Landroid/view/MotionEvent;II)V

    iget-object p1, p0, Landroidx/recyclerview/widget/f$b;->a:Landroidx/recyclerview/widget/f;

    invoke-virtual {p1, v3}, Landroidx/recyclerview/widget/f;->z(Landroidx/recyclerview/widget/RecyclerView$f0;)V
    ...
    invoke-virtual {p1, p2, v4}, Landroidx/recyclerview/widget/f;->F(Landroidx/recyclerview/widget/RecyclerView$f0;I)V
...
.method public e(Z)V
    ...
    invoke-virtual {p0, p1, v0}, Landroidx/recyclerview/widget/f;->F(Landroidx/recyclerview/widget/RecyclerView$f0;I)V
