...
.method private i(I)Landroidx/recyclerview/widget/RecyclerView$v$a;
    .locals 1
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RecyclerView$v;->a:Landroid/util/SparseArray;
...
.method b(Landroidx/recyclerview/widget/RecyclerView$h;)V
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RecyclerView$v;->c:Ljava/util/Set;
...
.method public c()V
    ...
    invoke-static {v3}, Lw/a;->a(Landroid/view/View;)V
...
.method e(Landroidx/recyclerview/widget/RecyclerView$h;Z)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$v;->c:Ljava/util/Set;

    invoke-interface {v0, p1}, Ljava/util/Set;->remove(Ljava/lang/Object;)Z

    iget-object p1, p0, Landroidx/recyclerview/widget/RecyclerView$v;->c:Ljava/util/Set;
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView$v$a;->a:Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lw/a;->a(Landroid/view/View;)V
...
.method f(IJ)V
    ...
    invoke-direct {p0, p1}, Landroidx/recyclerview/widget/RecyclerView$v;->i(I)Landroidx/recyclerview/widget/RecyclerView$v$a;

    move-result-object p1

    iget-wide v0, p1, Landroidx/recyclerview/widget/RecyclerView$v$a;->d:J

    invoke-virtual {p0, v0, v1, p2, p3}, Landroidx/recyclerview/widget/RecyclerView$v;->l(JJ)J
...
.method public h(I)Landroidx/recyclerview/widget/RecyclerView$f0;
    ...
    check-cast p0, Landroidx/recyclerview/widget/RecyclerView$v$a;

    if-eqz p0, :cond_1

    iget-object p1, p0, Landroidx/recyclerview/widget/RecyclerView$v$a;->a:Ljava/util/ArrayList;
    ...
    iget-object p0, p0, Landroidx/recyclerview/widget/RecyclerView$v$a;->a:Ljava/util/ArrayList;
    ...
    invoke-virtual {v0}, Landroidx/recyclerview/widget/RecyclerView$f0;->s()Z
...
.method public k(Landroidx/recyclerview/widget/RecyclerView$f0;)V
    ...
    invoke-direct {p0, v0}, Landroidx/recyclerview/widget/RecyclerView$v;->i(I)Landroidx/recyclerview/widget/RecyclerView$v$a;
    ...
    iget p0, p0, Landroidx/recyclerview/widget/RecyclerView$v$a;->b:I
...
.method m(IJJ)Z
    ...
    iget-wide p0, p0, Landroidx/recyclerview/widget/RecyclerView$v$a;->d:J
...
.method n(IJJ)Z
    ...
    iget-wide p0, p0, Landroidx/recyclerview/widget/RecyclerView$v$a;->c:J
