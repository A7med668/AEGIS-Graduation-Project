...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v1}, Le2/c$a;-><init>(Le2/e;)V
    ...
    const-class v5, Ld2/q;

    aput-object v5, v0, v2

    const/4 v2, 0x4

    const-class v5, Ld2/r;

    aput-object v5, v0, v2

    const/4 v2, 0x5

    const-class v5, Ld2/s;

    aput-object v5, v0, v2

    const/4 v2, 0x6

    const-class v5, Ld2/t;

    aput-object v5, v0, v2

    const/4 v2, 0x7

    const-class v5, Ld2/u;

    aput-object v5, v0, v2

    const/16 v2, 0x8

    const-class v5, Ld2/v;

    aput-object v5, v0, v2

    const/16 v2, 0x9

    const-class v5, Ld2/w;
    ...
    const-class v6, Ld2/d;

    aput-object v6, v0, v2

    const/16 v2, 0xd

    const-class v6, Ld2/e;
    ...
    const-class v6, Ld2/g;

    aput-object v6, v0, v2

    const/16 v2, 0x10

    const-class v6, Ld2/h;

    aput-object v6, v0, v2

    const/16 v2, 0x11

    const-class v6, Ld2/i;

    aput-object v6, v0, v2

    const/16 v2, 0x12

    const-class v6, Ld2/j;

    aput-object v6, v0, v2

    const/16 v2, 0x13

    const-class v6, Ld2/k;

    aput-object v6, v0, v2

    const/16 v2, 0x14

    const-class v6, Ld2/m;

    aput-object v6, v0, v2

    const/16 v2, 0x15

    const-class v6, Ld2/n;

    aput-object v6, v0, v2

    const/16 v2, 0x16

    const-class v6, Ld2/o;

    aput-object v6, v0, v2

    invoke-static {v0}, Lu1/k;->d([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v0

    new-instance v2, Ljava/util/ArrayList;

    invoke-static {v0, v5}, Lu1/k;->g(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v5, v3}, Lt1/n;->a(Ljava/lang/Object;Ljava/lang/Object;)Lt1/j;
    ...
    :cond_1
    invoke-static {v2}, Lu1/a0;->g(Ljava/lang/Iterable;)Ljava/util/Map;

    move-result-object v0

    sput-object v0, Le2/c;->c:Ljava/util/Map;
    ...
    sput-object v0, Le2/c;->d:Ljava/util/HashMap;
    ...
    sput-object v2, Le2/c;->e:Ljava/util/HashMap;
    ...
    invoke-static {v2, v7}, Le2/i;->d(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-static {v2, v5, v1, v4, v1}, Lk2/d;->L(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {v5, v2}, Lt1/n;->a(Ljava/lang/Object;Ljava/lang/Object;)Lt1/j;

    move-result-object v2

    invoke-virtual {v2}, Lt1/j;->c()Ljava/lang/Object;

    move-result-object v5

    invoke-virtual {v2}, Lt1/j;->d()Ljava/lang/Object;
    ...
    :cond_2
    sget-object v0, Le2/c;->c:Ljava/util/Map;
    ...
    :cond_3
    sput-object v3, Le2/c;->f:Ljava/util/HashMap;
    ...
    invoke-static {v3, v5, v1, v4, v1}, Lk2/d;->L(Ljava/lang/String;CLjava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_4
    sput-object v0, Le2/c;->g:Ljava/util/Map;
...
.method public constructor <init>(Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Le2/c;->a:Ljava/lang/Class;
...
.method public a()Ljava/lang/Class;
    ...
    iget-object p0, p0, Le2/c;->a:Ljava/lang/Class;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Lc2/a;->b(Li2/b;)Ljava/lang/Class;

    move-result-object p0

    check-cast p1, Li2/b;

    invoke-static {p1}, Lc2/a;->b(Li2/b;)Ljava/lang/Class;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Le2/c;->a()Ljava/lang/Class;
