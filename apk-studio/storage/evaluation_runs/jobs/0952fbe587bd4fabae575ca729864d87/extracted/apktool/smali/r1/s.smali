...
.method public static a(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Ljava/util/List;
    ...
    sget-object p2, Lr1/s;->a:Ljava/util/List;

    goto :goto_0

    :cond_0
    sget-object p2, Lr1/s;->b:Ljava/util/List;
    ...
    invoke-virtual {v1}, Lp1/h;->b()Ljava/util/List;
    ...
    invoke-static {p0, p1, v3}, Lr1/s;->d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
...
.method public static c(Landroid/content/Context;)V
    ...
    invoke-virtual {v0, p0}, Lp1/i;->d(Ljava/lang/String;)Ljava/util/List;

    move-result-object p0

    sput-object p0, Lr1/s;->a:Ljava/util/List;
    ...
    sput-object p0, Lr1/s;->b:Ljava/util/List;

    sget-object p0, Lr1/s;->a:Ljava/util/List;
    ...
    invoke-virtual {v0}, Lp1/h;->b()Ljava/util/List;
    ...
    invoke-static {v6}, Lr1/s;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_1
    sget-object v5, Lp1/h;->h:Ljava/lang/String;
    ...
    :cond_3
    sget-object p0, Lr1/s;->b:Ljava/util/List;
...
.method private static d(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string v1, "^(http|https)://[a-z0-9.-]+/.*$"
