...
.method protected varargs doInBackground([Ljava/lang/Void;)Ljava/lang/Throwable;
    ...
    invoke-static {v2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/print/PrintAttributes;)I
    ...
    :try_start_1
    invoke-static {p1, v2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;I)Landroid/graphics/pdf/PdfDocument$Page;
    ...
    invoke-static {v3}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$Page;)Landroid/graphics/pdf/PdfDocument$PageInfo;

    move-result-object v4

    invoke-static {v4}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$PageInfo;)Landroid/graphics/Rect;
    ...
    invoke-static {v4, v2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;I)Landroid/graphics/pdf/PdfDocument$Page;

    move-result-object v2

    new-instance v5, Landroid/graphics/RectF;

    invoke-static {v2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$Page;)Landroid/graphics/pdf/PdfDocument$PageInfo;

    move-result-object v6

    invoke-static {v6}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$PageInfo;)Landroid/graphics/Rect;

    move-result-object v6

    invoke-direct {v5, v6}, Landroid/graphics/RectF;-><init>(Landroid/graphics/Rect;)V

    invoke-static {v4, v2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;Landroid/graphics/pdf/PdfDocument$Page;)V

    invoke-static {v4}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;)V
    ...
    invoke-static {v3}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/pdf/PdfDocument$Page;)Landroid/graphics/Canvas;
    ...
    invoke-static {p1, v3}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;Landroid/graphics/pdf/PdfDocument$Page;)V
    ...
    :try_start_2
    invoke-static {p1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;)V
    ...
    invoke-static {p1, v2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/pdf/PrintedPdfDocument;Ljava/io/OutputStream;)V
    :try_end_5
...
.method protected onPostExecute(Ljava/lang/Throwable;)V
    ...
    invoke-static {p1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    invoke-static {}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m()Landroid/print/PageRange;

    move-result-object v2

    aput-object v2, v0, v1

    invoke-static {p1, v0}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$WriteResultCallback;[Landroid/print/PageRange;)V
    ...
    invoke-static {p1, v0}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintDocumentAdapter$WriteResultCallback;Ljava/lang/CharSequence;)V
