...
.method public static fromRating(Ljava/lang/Object;)Landroid/support/v4/media/RatingCompat;
    ...
    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/media/Rating;

    move-result-object v1

    invoke-static {v1}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/Rating;)I
    ...
    invoke-static {v2}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/media/Rating;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/media/Rating;)F
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/Rating;)F
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/media/Rating;)Z
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/Rating;)Z
...
.method public getRating()Ljava/lang/Object;
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(F)Landroid/media/Rating;
    ...
    invoke-static {v0, v1}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(IF)Landroid/media/Rating;
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m$1(Z)Landroid/media/Rating;
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Z)Landroid/media/Rating;
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(I)Landroid/media/Rating;
