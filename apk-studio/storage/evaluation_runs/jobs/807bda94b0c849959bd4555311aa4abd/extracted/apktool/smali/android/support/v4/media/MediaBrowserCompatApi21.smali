...
.method public static connect(Ljava/lang/Object;)V
    ...
    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/media/browse/MediaBrowser;

    move-result-object p0

    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/browse/MediaBrowser;)V
...
.method public static createBrowser(Landroid/content/Context;Landroid/content/ComponentName;Ljava/lang/Object;Landroid/os/Bundle;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/media/browse/MediaBrowser$ConnectionCallback;
...
.method public static disconnect(Ljava/lang/Object;)V
    ...
    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/media/browse/MediaBrowser;)V
...
.method public static getExtras(Ljava/lang/Object;)Landroid/os/Bundle;
    ...
    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/browse/MediaBrowser;)Landroid/os/Bundle;
...
.method public static getRoot(Ljava/lang/Object;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/browse/MediaBrowser;)Ljava/lang/String;
...
.method public static getServiceComponent(Ljava/lang/Object;)Landroid/content/ComponentName;
    ...
    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/browse/MediaBrowser;)Landroid/content/ComponentName;
...
.method public static getSessionToken(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/browse/MediaBrowser;)Landroid/media/session/MediaSession$Token;
...
.method public static isConnected(Ljava/lang/Object;)Z
    ...
    invoke-static {p0}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/browse/MediaBrowser;)Z
...
.method public static subscribe(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p2}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/media/browse/MediaBrowser$SubscriptionCallback;

    move-result-object p2

    invoke-static {p0, p1, p2}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/browse/MediaBrowser;Ljava/lang/String;Landroid/media/browse/MediaBrowser$SubscriptionCallback;)V
...
.method public static unsubscribe(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    invoke-static {p0, p1}, Landroid/support/v4/media/RatingCompat$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/browse/MediaBrowser;Ljava/lang/String;)V
