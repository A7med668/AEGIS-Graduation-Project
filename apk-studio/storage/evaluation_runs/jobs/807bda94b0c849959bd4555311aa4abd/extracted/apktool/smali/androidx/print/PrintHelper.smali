...
.method private static copyAttributes(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Builder;
    ...
    invoke-static {p0}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$MediaSize;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;Landroid/print/PrintAttributes$MediaSize;)Landroid/print/PrintAttributes$Builder;

    move-result-object v0

    invoke-static {p0}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Resolution;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;Landroid/print/PrintAttributes$Resolution;)Landroid/print/PrintAttributes$Builder;

    move-result-object v0

    invoke-static {p0}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes;)Landroid/print/PrintAttributes$Margins;

    move-result-object v1

    invoke-static {v0, v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;Landroid/print/PrintAttributes$Margins;)Landroid/print/PrintAttributes$Builder;

    move-result-object v0

    invoke-static {p0}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/print/PrintAttributes;)I
    ...
    invoke-static {v0, v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/print/PrintAttributes$Builder;I)Landroid/print/PrintAttributes$Builder;
...
.method public printBitmap(Ljava/lang/String;Landroid/graphics/Bitmap;Landroidx/print/PrintHelper$OnPrintFinishCallback;)V
    ...
    invoke-static {v0}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/print/PrintManager;
    ...
    invoke-static {}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m$1()Landroid/print/PrintAttributes$MediaSize;
    ...
    :cond_1
    invoke-static {}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m()Landroid/print/PrintAttributes$MediaSize;
    ...
    invoke-static {v2, v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;Landroid/print/PrintAttributes$MediaSize;)Landroid/print/PrintAttributes$Builder;

    move-result-object v1

    iget v2, p0, Landroidx/print/PrintHelper;->mColorMode:I

    invoke-static {v1, v2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/print/PrintAttributes$Builder;I)Landroid/print/PrintAttributes$Builder;

    move-result-object v1

    invoke-static {v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;)Landroid/print/PrintAttributes;
    ...
    invoke-static {v0, p1, v8, v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintManager;Ljava/lang/String;Landroid/print/PrintDocumentAdapter;Landroid/print/PrintAttributes;)Landroid/print/PrintJob;
...
.method public printBitmap(Ljava/lang/String;Landroid/net/Uri;Landroidx/print/PrintHelper$OnPrintFinishCallback;)V
    ...
    invoke-static {p2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/print/PrintManager;
    ...
    invoke-static {p3, v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/print/PrintAttributes$Builder;I)Landroid/print/PrintAttributes$Builder;
    ...
    invoke-static {p3, v1}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;Landroid/print/PrintAttributes$MediaSize;)Landroid/print/PrintAttributes$Builder;
    ...
    :cond_3
    :goto_1
    invoke-static {p3}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;)Landroid/print/PrintAttributes;

    move-result-object p3

    invoke-static {p2, p1, v0, p3}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintManager;Ljava/lang/String;Landroid/print/PrintDocumentAdapter;Landroid/print/PrintAttributes;)Landroid/print/PrintJob;
...
.method writeBitmap(Landroid/print/PrintAttributes;ILandroid/graphics/Bitmap;Landroid/os/ParcelFileDescriptor;Landroid/os/CancellationSignal;Landroid/print/PrintDocumentAdapter$WriteResultCallback;)V
    ...
    invoke-static {v0, v2}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;Landroid/print/PrintAttributes$Margins;)Landroid/print/PrintAttributes$Builder;

    move-result-object v0

    invoke-static {v0}, Landroidx/tracing/Trace$$ExternalSyntheticApiModelOutline0;->m(Landroid/print/PrintAttributes$Builder;)Landroid/print/PrintAttributes;
