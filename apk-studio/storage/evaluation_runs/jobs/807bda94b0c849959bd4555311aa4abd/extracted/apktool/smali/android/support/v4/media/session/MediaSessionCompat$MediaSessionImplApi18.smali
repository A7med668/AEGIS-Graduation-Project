...
.method registerMediaButtonEventReceiver(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    invoke-static {v0, p1}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/media/AudioManager;Landroid/app/PendingIntent;)V
    :try_end_0
...
.method public setCallback(Landroid/support/v4/media/session/MediaSessionCompat$Callback;Landroid/os/Handler;)V
    ...
    invoke-static {p1, p2}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/RemoteControlClient;Landroid/media/RemoteControlClient$OnPlaybackPositionUpdateListener;)V
    ...
    invoke-static {p2, p1}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/RemoteControlClient;Landroid/media/RemoteControlClient$OnPlaybackPositionUpdateListener;)V
...
.method setRccState(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-static {v3, p1, v0, v1, v2}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/RemoteControlClient;IJF)V
...
.method unregisterMediaButtonEventReceiver(Landroid/app/PendingIntent;Landroid/content/ComponentName;)V
    ...
    invoke-static {p2, p1}, Landroidx/activity/ComponentDialog$$ExternalSyntheticApiModelOutline0;->m(Landroid/media/AudioManager;Landroid/app/PendingIntent;)V
