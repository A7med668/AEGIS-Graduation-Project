...
.method public static final asDeferred(Ljava/util/concurrent/CompletionStage;)Lkotlinx/coroutines/Deferred;
    ...
    invoke-static {p0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletionStage;)Ljava/util/concurrent/CompletableFuture;

    move-result-object v0

    invoke-static {v0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;)Z
    ...
    :try_start_0
    invoke-static {v0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;)Ljava/lang/Object;
    ...
    new-instance v3, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda5;

    invoke-direct {v3, v2}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda5;-><init>(Lkotlin/jvm/functions/Function2;)V

    invoke-static {p0, v3}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletionStage;
...
.method public static final await(Ljava/util/concurrent/CompletionStage;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    invoke-static {p0, v4}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletionStage;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletionStage;
...
.method public static final future(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineStart;Lkotlin/jvm/functions/Function2;)Ljava/util/concurrent/CompletableFuture;
    ...
    invoke-static {p1, p0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletableFuture;
...
.method private static final setupCancellation(Lkotlinx/coroutines/Job;Ljava/util/concurrent/CompletableFuture;)V
    ...
    new-instance v0, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda6;

    invoke-direct {v0, p0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticLambda6;-><init>(Lkotlinx/coroutines/Job;)V

    invoke-static {p1, v0}, Lkotlinx/coroutines/future/FutureKt$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/concurrent/CompletableFuture;Ljava/util/function/BiFunction;)Ljava/util/concurrent/CompletableFuture;
