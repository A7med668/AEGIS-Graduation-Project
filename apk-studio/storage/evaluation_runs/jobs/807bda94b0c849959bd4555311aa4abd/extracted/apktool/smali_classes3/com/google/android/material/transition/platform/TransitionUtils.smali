...
.method static convertToRelativeCornerSizes(Lcom/google/android/material/shape/ShapeAppearanceModel;Landroid/graphics/RectF;)Lcom/google/android/material/shape/ShapeAppearanceModel;
    ...
    new-instance v0, Lcom/google/android/material/transition/platform/TransitionUtils$$ExternalSyntheticLambda6;

    invoke-direct {v0, p1}, Lcom/google/android/material/transition/platform/TransitionUtils$$ExternalSyntheticLambda6;-><init>(Landroid/graphics/RectF;)V
...
.method static maybeAddTransition(Landroid/transition/TransitionSet;Landroid/transition/Transition;)V
    ...
    invoke-static {p0, p1}, Landroidx/fragment/app/Fragment$5$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionSet;Landroid/transition/Transition;)Landroid/transition/TransitionSet;
...
.method static maybeApplyThemeDuration(Landroid/transition/Transition;Landroid/content/Context;I)Z
    ...
    invoke-static {p0}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/Transition;)J
    ...
    invoke-static {p0, p1, p2}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/Transition;J)Landroid/transition/Transition;
...
.method static maybeApplyThemeInterpolator(Landroid/transition/Transition;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    ...
    invoke-static {p0}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/Transition;)Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p0, p1}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/Transition;Landroid/animation/TimeInterpolator;)Landroid/transition/Transition;
...
.method static maybeApplyThemePath(Landroid/transition/Transition;Landroid/content/Context;I)Z
    ...
    invoke-static {p0, p1}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/Transition;Landroid/transition/PathMotion;)V
...
.method static maybeRemoveTransition(Landroid/transition/TransitionSet;Landroid/transition/Transition;)V
    ...
    invoke-static {p0, p1}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionSet;Landroid/transition/Transition;)Landroid/transition/TransitionSet;
...
.method static resolveThemePath(Landroid/content/Context;I)Landroid/transition/PathMotion;
    ...
    check-cast p0, Landroid/transition/PathMotion;
    ...
    check-cast p1, Landroid/transition/PathMotion;
...
.method private static saveLayerAlphaCompat(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)I
    ...
    invoke-static {p0, v0, p2}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/graphics/Canvas;Landroid/graphics/RectF;I)I
