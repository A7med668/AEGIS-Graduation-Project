...
.method private buildThresholdsGroup(Z)Lcom/google/android/material/transition/platform/MaterialContainerTransform$ProgressThresholdsGroup;
    ...
    invoke-static {p0}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Lcom/google/android/material/transition/platform/MaterialContainerTransform;)Landroid/transition/PathMotion;

    move-result-object v0

    invoke-static {v0}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m$2(Ljava/lang/Object;)Z
...
.method private static captureValues(Landroid/transition/TransitionValues;Landroid/view/View;ILcom/google/android/material/shape/ShapeAppearanceModel;)V
    ...
    invoke-static {p0}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionValues;)Landroid/view/View;
    ...
    invoke-static {p0, p1}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionValues;Landroid/view/View;)V
    ...
    :goto_1
    invoke-static {p0}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionValues;)Ljava/util/Map;
...
.method public createAnimator(Landroid/view/ViewGroup;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    :cond_0
    invoke-static/range {p2 .. p2}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionValues;)Ljava/util/Map;
    ...
    :cond_1
    invoke-static/range {p3 .. p3}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionValues;)Ljava/util/Map;
    ...
    :cond_2
    invoke-static/range {p2 .. p2}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionValues;)Landroid/view/View;

    move-result-object v4

    invoke-static/range {p3 .. p3}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Landroid/transition/TransitionValues;)Landroid/view/View;
    ...
    :goto_0
    iget v2, v6, Lcom/google/android/material/transition/platform/MaterialContainerTransform;->drawingViewId:I
    ...
    invoke-static {v1, v2}, Lcom/google/android/material/transition/platform/TransitionUtils;->findAncestorById(Landroid/view/View;I)Landroid/view/View;
    ...
    invoke-static {v2, v0, v7, v3}, Lcom/google/android/material/transition/platform/MaterialContainerTransform;->calculateDrawableBounds(Landroid/view/View;Landroid/view/View;FF)Landroid/graphics/RectF;
    ...
    invoke-direct {v6, v1, v3}, Lcom/google/android/material/transition/platform/MaterialContainerTransform;->maybeApplyThemeValues(Landroid/content/Context;Z)V
    ...
    invoke-static/range {p0 .. p0}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Lcom/google/android/material/transition/platform/MaterialContainerTransform;)Landroid/transition/PathMotion;
    ...
    invoke-virtual {v1, v3, v7, v8, v0}, Lcom/google/android/material/transition/platform/MaterialContainerTransform$TransitionDrawable;->setBounds(IIII)V
    ...
    invoke-direct {v0, v6, v1}, Lcom/google/android/material/transition/platform/MaterialContainerTransform$1;-><init>(Lcom/google/android/material/transition/platform/MaterialContainerTransform;Lcom/google/android/material/transition/platform/MaterialContainerTransform$TransitionDrawable;)V
    ...
    invoke-static {v6, v8}, Lcom/google/android/material/chip/Chip$$ExternalSyntheticApiModelOutline0;->m(Lcom/google/android/material/transition/platform/MaterialContainerTransform;Landroid/transition/Transition$TransitionListener;)Landroid/transition/Transition;
