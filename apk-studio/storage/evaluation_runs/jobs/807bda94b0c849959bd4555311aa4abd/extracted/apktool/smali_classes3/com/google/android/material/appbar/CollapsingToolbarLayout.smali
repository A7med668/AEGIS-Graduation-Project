...
.method private static getToolbarTitle(Landroid/view/View;)Ljava/lang/CharSequence;
    ...
    invoke-static {p0}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/widget/Toolbar;

    move-result-object p0

    invoke-static {p0}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m(Landroid/widget/Toolbar;)Ljava/lang/CharSequence;
...
.method private updateCollapsedBounds(Z)V
    ...
    invoke-static {v1}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Z
    ...
    invoke-static {v1}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m(Ljava/lang/Object;)Landroid/widget/Toolbar;

    move-result-object v1

    invoke-static {v1}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m(Landroid/widget/Toolbar;)I

    move-result v2

    invoke-static {v1}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m$1(Landroid/widget/Toolbar;)I

    move-result v3

    invoke-static {v1}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m$2(Landroid/widget/Toolbar;)I

    move-result v4

    invoke-static {v1}, Landroidx/work/impl/utils/NetworkApi21$$ExternalSyntheticApiModelOutline0;->m$3(Landroid/widget/Toolbar;)I
