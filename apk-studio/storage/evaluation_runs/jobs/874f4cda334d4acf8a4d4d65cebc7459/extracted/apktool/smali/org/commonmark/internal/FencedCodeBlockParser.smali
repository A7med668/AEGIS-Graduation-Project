...
.field private final fenceChar:C

.field private firstLine:Ljava/lang/String;

.field private final openingFenceLength:I

.field private otherLines:Ljava/lang/StringBuilder;


# direct methods
.method static bridge synthetic -$$Nest$fgetblock(Lorg/commonmark/internal/FencedCodeBlockParser;)Lorg/commonmark/node/FencedCodeBlock;
    .locals 0
...
.method static bridge synthetic -$$Nest$smcheckOpener(Ljava/lang/CharSequence;II)Lorg/commonmark/internal/FencedCodeBlockParser;
    .locals 0
...
.method public constructor <init>(CII)V
    ...
    iput-char p1, p0, Lorg/commonmark/internal/FencedCodeBlockParser;->fenceChar:C

    iput p2, p0, Lorg/commonmark/internal/FencedCodeBlockParser;->openingFenceLength:I

    invoke-static {p1}, Ljava/lang/String;->valueOf(C)Ljava/lang/String;

    move-result-object p1

    invoke-virtual {v0, p1}, Lorg/commonmark/node/FencedCodeBlock;->setFenceCharacter(Ljava/lang/String;)V

    invoke-static {p2}, Ljava/lang/Integer;->valueOf(I)Ljava/lang/Integer;

    move-result-object p1

    invoke-virtual {v0, p1}, Lorg/commonmark/node/FencedCodeBlock;->setOpeningFenceLength(Ljava/lang/Integer;)V
...
.method private static checkOpener(Ljava/lang/CharSequence;II)Lorg/commonmark/internal/FencedCodeBlockParser;
    ...
    invoke-static {v5, p0, p1}, Lorg/commonmark/text/Characters;->find(CLjava/lang/CharSequence;I)I
...
.method private tryClosing(Ljava/lang/CharSequence;I)Z
    .locals 3

    iget-char v0, p0, Lorg/commonmark/internal/FencedCodeBlockParser;->fenceChar:C

    invoke-interface {p1}, Ljava/lang/CharSequence;->length()I

    move-result v1

    invoke-static {v0, p1, p2, v1}, Lorg/commonmark/text/Characters;->skip(CLjava/lang/CharSequence;II)I

    move-result v0

    sub-int/2addr v0, p2

    iget v1, p0, Lorg/commonmark/internal/FencedCodeBlockParser;->openingFenceLength:I
    ...
    invoke-static {p1, p2, v1}, Lorg/commonmark/text/Characters;->skipSpaceTab(Ljava/lang/CharSequence;II)I
    ...
    invoke-virtual {p1, p2}, Lorg/commonmark/node/FencedCodeBlock;->setClosingFenceLength(Ljava/lang/Integer;)V
...
.method public tryContinue(Lorg/commonmark/parser/block/ParserState;)Lorg/commonmark/parser/block/BlockContinue;
    ...
    invoke-direct {p0, v2, v0}, Lorg/commonmark/internal/FencedCodeBlockParser;->tryClosing(Ljava/lang/CharSequence;I)Z
