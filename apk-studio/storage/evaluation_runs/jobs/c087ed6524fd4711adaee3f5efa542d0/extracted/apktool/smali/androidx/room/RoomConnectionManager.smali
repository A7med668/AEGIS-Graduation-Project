...
.method public constructor <init>(Landroidx/room/DatabaseConfiguration;Landroidx/room/RoomOpenDelegate;Landroidx/room/RoomDatabase$createConnectionManager$2;)V
    ...
    new-instance v6, Lio/ktor/http/parsing/regex/GrammarRegex;

    iget p1, p2, Landroidx/room/RoomOpenDelegate;->version:I

    invoke-direct {v6, p0, p1}, Lio/ktor/http/parsing/regex/GrammarRegex;-><init>(Landroidx/room/RoomConnectionManager;I)V
    ...
    invoke-direct/range {v3 .. v8}, Landroidx/sqlite/db/SupportSQLiteOpenHelper$Configuration;-><init>(Landroid/content/Context;Ljava/lang/String;Lio/ktor/http/parsing/regex/GrammarRegex;ZZ)V
    ...
    iput-object p1, v1, Lio/ktor/events/Events;->handlers:Ljava/lang/Object;
    ...
    invoke-direct {p2, p0, v2}, Lkotlin/text/MatcherMatchResult;-><init>(Landroidx/room/RoomConnectionManager;Landroidx/sqlite/SQLiteDriver;)V
    ...
    invoke-direct {p1, p0, v2}, Lkotlin/text/MatcherMatchResult;-><init>(Landroidx/room/RoomConnectionManager;Landroidx/sqlite/SQLiteDriver;)V

    new-instance p2, Landroidx/room/coroutines/ConnectionPoolImpl;

    invoke-direct {p2, p1}, Landroidx/room/coroutines/ConnectionPoolImpl;-><init>(Lkotlin/text/MatcherMatchResult;)V
    ...
    invoke-direct {p3, p1, v5, p2}, Landroidx/room/coroutines/ConnectionPoolImpl;-><init>(Lkotlin/text/MatcherMatchResult;Ljava/lang/String;I)V
...
.method public constructor <init>(Landroidx/room/DatabaseConfiguration;Landroidx/work/Data$$ExternalSyntheticLambda0;Landroidx/room/RoomDatabase$createConnectionManager$2;)V
    ...
    invoke-direct {v0, v1, p0}, Lio/ktor/http/CodecsKt$$ExternalSyntheticLambda1;-><init>(ILjava/lang/Object;)V
    ...
    invoke-direct {p0, v0}, Landroidx/work/impl/CleanupCallback;-><init>(Lio/ktor/http/CodecsKt$$ExternalSyntheticLambda1;)V

    invoke-static {p2, p0}, Lkotlin/collections/CollectionsKt;->plus(Ljava/util/Collection;Ljava/lang/Object;)Ljava/util/ArrayList;
