...
.field public final platformFamilyTypefaceAdapter:Lio/ktor/events/Events;

.field public final platformFontLoader:Lio/ktor/events/EventDefinition;
...
# direct methods
.method public constructor <init>(Lio/ktor/events/EventDefinition;Landroidx/compose/ui/text/font/AndroidFontResolveInterceptor;)V
    .locals 5
    ...
    sget-object v2, Landroidx/compose/ui/text/font/FontListFontFamilyTypefaceAdapter;->DropExceptionHandler:Lio/ktor/util/CoroutinesUtilsKt$SilentSupervisor$$inlined$CoroutineExceptionHandler$1;
    ...
    invoke-static {v2}, Lkotlinx/coroutines/JobKt;->CoroutineScope(Lkotlin/coroutines/CoroutineContext;)Lio/ktor/http/cio/CIOMultipartDataBase;

    new-instance v2, Lio/ktor/events/Events;

    const/4 v3, 0x4

    invoke-direct {v2, v3}, Lio/ktor/events/Events;-><init>(I)V

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/compose/ui/text/font/FontFamilyResolverImpl;->platformFontLoader:Lio/ktor/events/EventDefinition;
    ...
    iput-object v2, p0, Landroidx/compose/ui/text/font/FontFamilyResolverImpl;->platformFamilyTypefaceAdapter:Lio/ktor/events/Events;

    new-instance p1, Lio/ktor/http/CodecsKt$$ExternalSyntheticLambda1;

    const/16 p2, 0xb

    invoke-direct {p1, p2, p0}, Lio/ktor/http/CodecsKt$$ExternalSyntheticLambda1;-><init>(ILjava/lang/Object;)V
...
.method public final resolve(Landroidx/compose/ui/text/font/TypefaceRequest;)Landroidx/compose/ui/text/font/TypefaceResult$Immutable;
    ...
    iget-object v4, v2, Landroidx/collection/LruCache;->lock:Lio/ktor/events/EventDefinition;
    ...
    iget-object p0, p0, Landroidx/compose/ui/text/font/FontFamilyResolverImpl;->platformFamilyTypefaceAdapter:Lio/ktor/events/Events;
    ...
    invoke-static {v1, v2, p0}, Landroidx/work/impl/AutoMigration_14_15;->createAndroidTypefaceApi28-RetOiIg(Ljava/lang/String;Landroidx/compose/ui/text/font/FontWeight;I)Landroid/graphics/Typeface;
    ...
    :cond_5
    :goto_3
    invoke-static {v3, v2, p0}, Landroidx/work/impl/AutoMigration_14_15;->createAndroidTypefaceApi28-RetOiIg(Ljava/lang/String;Landroidx/compose/ui/text/font/FontWeight;I)Landroid/graphics/Typeface;
    ...
    check-cast p0, Lio/ktor/events/EventDefinition;
...
.method public final resolve-DPcqOEQ(Landroidx/compose/ui/text/font/SystemFontFamily;Landroidx/compose/ui/text/font/FontWeight;II)Landroidx/compose/ui/text/font/TypefaceResult$Immutable;
    ...
    :goto_1
    iget-object p2, p0, Landroidx/compose/ui/text/font/FontFamilyResolverImpl;->platformFontLoader:Lio/ktor/events/EventDefinition;
