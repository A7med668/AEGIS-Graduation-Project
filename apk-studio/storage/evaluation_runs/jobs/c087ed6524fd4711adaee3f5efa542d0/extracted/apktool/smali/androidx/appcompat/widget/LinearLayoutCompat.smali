...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p1, p2, v2, v5, v9}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;
    ...
    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/LinearLayoutCompat;->setOrientation(I)V
    ...
    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/LinearLayoutCompat;->setBaselineAligned(Z)V
    ...
    invoke-virtual {v4, p0, p1}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result p0

    iput p0, v0, Landroidx/appcompat/widget/LinearLayoutCompat;->mWeightSum:F
    ...
    iput p0, v0, Landroidx/appcompat/widget/LinearLayoutCompat;->mBaselineAlignedChildIndex:I
    ...
    iput-boolean p0, v0, Landroidx/appcompat/widget/LinearLayoutCompat;->mUseLargestChild:Z
    ...
    invoke-virtual {v4, p0, v9}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result p1

    if-eqz p1, :cond_3

    invoke-static {v1, p1}, Landroidx/core/util/Preconditions;->getDrawable(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    invoke-virtual {v0, p0}, Landroidx/appcompat/widget/LinearLayoutCompat;->setDividerDrawable(Landroid/graphics/drawable/Drawable;)V

    const/16 p0, 0x8

    invoke-virtual {v4, p0, v9}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p0

    iput p0, v0, Landroidx/appcompat/widget/LinearLayoutCompat;->mShowDividers:I

    const/4 p0, 0x6

    invoke-virtual {v4, p0, v9}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I
