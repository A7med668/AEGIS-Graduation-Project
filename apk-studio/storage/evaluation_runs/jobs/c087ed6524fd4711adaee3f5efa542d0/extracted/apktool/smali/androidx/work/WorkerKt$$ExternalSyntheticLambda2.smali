...
.method public final run()V
    ...
    invoke-direct {v4, v3, v5}, Lio/ktor/network/tls/Digest$$ExternalSyntheticLambda0;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v5, v6, v4}, Landroidx/work/Worker$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v1, v3}, Landroidx/tracing/Trace;->launchFuture$default(Lkotlin/coroutines/CoroutineContext;Lkotlin/jvm/functions/Function2;)Landroidx/concurrent/futures/CallbackToFutureAdapter$SafeFuture;
    ...
    check-cast v0, Lcom/vayunmathur/library/util/DatabaseHelper;

    iget-object v1, p0, Landroidx/work/WorkerKt$$ExternalSyntheticLambda2;->f$1:Ljava/lang/Object;

    check-cast v1, Lkotlin/math/MathKt;
    ...
    :try_start_8
    iget-object v0, v0, Lcom/vayunmathur/library/util/DatabaseHelper;->context:Landroid/content/Context;

    invoke-static {v0}, Landroidx/core/view/WindowCompat;->create(Landroid/content/Context;)Landroidx/emoji2/text/FontRequestEmojiCompatConfig;
    ...
    invoke-direct {v2, v1, p0}, Landroidx/emoji2/text/EmojiCompatInitializer$BackgroundDefaultLoader$1;-><init>(Lkotlin/math/MathKt;Ljava/util/concurrent/ThreadPoolExecutor;)V

    invoke-interface {v0, v2}, Landroidx/emoji2/text/EmojiCompat$MetadataRepoLoader;->load(Lkotlin/math/MathKt;)V
    :try_end_a
    ...
    :goto_9
    invoke-virtual {v1, v0}, Lkotlin/math/MathKt;->onFailed(Ljava/lang/Throwable;)V
