...
.field public static sCompilationStatus:Lio/ktor/events/EventDefinition;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/profileinstaller/ProfileVerifier;->sCompilationStatus:Lio/ktor/events/EventDefinition;
...
.method public static writeProfileVerification(Landroid/content/Context;Z)V
    ...
    sget-object v0, Landroidx/profileinstaller/ProfileVerifier;->sCompilationStatus:Lio/ktor/events/EventDefinition;
    ...
    :try_start_9
    invoke-static {v9}, Landroidx/profileinstaller/ProfileVerifier$Cache;->readFromFile(Ljava/io/File;)Landroidx/profileinstaller/ProfileVerifier$Cache;
    ...
    invoke-direct {v0, v3}, Lio/ktor/events/EventDefinition;-><init>(I)V
    ...
    iget-wide v3, v10, Landroidx/profileinstaller/ProfileVerifier$Cache;->mPackageLastUpdateTime:J

    cmp-long v3, v3, v13

    if-nez v3, :cond_8

    iget v3, v10, Landroidx/profileinstaller/ProfileVerifier$Cache;->mResultCode:I
    ...
    iget v0, v10, Landroidx/profileinstaller/ProfileVerifier$Cache;->mResultCode:I

    if-ne v0, v11, :cond_d

    if-ne v4, v5, :cond_d

    iget-wide v2, v10, Landroidx/profileinstaller/ProfileVerifier$Cache;->mInstalledCurrentProfileSize:J
    ...
    invoke-virtual {v10, v12}, Landroidx/profileinstaller/ProfileVerifier$Cache;->equals(Ljava/lang/Object;)Z
    ...
    :cond_e
    :try_start_b
    invoke-virtual {v12, v9}, Landroidx/profileinstaller/ProfileVerifier$Cache;->writeOnFile(Ljava/io/File;)V
    :try_end_b
