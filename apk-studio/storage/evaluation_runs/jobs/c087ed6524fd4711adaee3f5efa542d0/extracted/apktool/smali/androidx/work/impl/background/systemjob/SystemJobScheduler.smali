...
.method public final cancel(Ljava/lang/String;)V
    ...
    iget-object v7, v7, Landroidx/work/impl/model/WorkGenerationalId;->workSpecId:Ljava/lang/String;
    ...
    invoke-static {v1, v5}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->cancelJobById(Landroid/app/job/JobScheduler;I)V
    ...
    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->systemIdInfoDao()Landroidx/work/impl/model/SystemIdInfoDao_Impl;
    ...
    invoke-static {p0, v2, p1, v0}, Landroidx/room/util/DBUtil;->performBlocking(Landroidx/room/RoomDatabase;ZZLkotlin/jvm/functions/Function1;)Ljava/lang/Object;
...
.method public final varargs schedule([Landroidx/work/impl/model/WorkSpec;)V
    ...
    iget-object v2, v0, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->mConfiguration:Landroidx/work/Configuration;

    new-instance v3, Landroidx/work/impl/utils/IdGenerator;

    iget-object v4, v0, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->mWorkDatabase:Landroidx/work/impl/WorkDatabase;

    const/4 v5, 0x0

    invoke-direct {v3, v4, v5}, Landroidx/work/impl/utils/IdGenerator;-><init>(Landroidx/work/impl/WorkDatabase;I)V
    ...
    invoke-virtual {v9, v10}, Landroidx/work/impl/model/WorkSpecDao_Impl;->getWorkSpec(Ljava/lang/String;)Landroidx/work/impl/model/WorkSpec;
    ...
    sget-object v12, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {v8, v12, v9}, Landroidx/work/Logger$LogcatLogger;->warning(Ljava/lang/String;Ljava/lang/String;)V
    ...
    :cond_0
    :try_start_2
    iget-object v9, v9, Landroidx/work/impl/model/WorkSpec;->state:Landroidx/work/WorkInfo$State;
    ...
    :cond_1
    invoke-static {v8}, Landroidx/room/util/DBUtil;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;

    move-result-object v9

    iget v10, v9, Landroidx/work/impl/model/WorkGenerationalId;->generation:I

    iget-object v9, v9, Landroidx/work/impl/model/WorkGenerationalId;->workSpecId:Ljava/lang/String;
    ...
    iget-object v11, v11, Landroidx/work/impl/model/SystemIdInfoDao_Impl;->__db:Landroidx/room/RoomDatabase;

    new-instance v12, Landroidx/work/impl/model/WorkSpecDao_Impl$$ExternalSyntheticLambda3;

    const/4 v13, 0x1

    invoke-direct {v12, v9, v10, v13}, Landroidx/work/impl/model/WorkSpecDao_Impl$$ExternalSyntheticLambda3;-><init>(Ljava/lang/String;II)V

    invoke-static {v11, v13, v5, v12}, Landroidx/room/util/DBUtil;->performBlocking(Landroidx/room/RoomDatabase;ZZLkotlin/jvm/functions/Function1;)Ljava/lang/Object;

    move-result-object v11

    check-cast v11, Landroidx/work/impl/model/SystemIdInfo;

    if-eqz v11, :cond_2

    iget v12, v11, Landroidx/work/impl/model/SystemIdInfo;->systemId:I
    ...
    iget v12, v2, Landroidx/work/Configuration;->maxJobSchedulerId:I

    iget-object v14, v3, Landroidx/work/impl/utils/IdGenerator;->workDatabase:Landroidx/work/impl/WorkDatabase;

    new-instance v15, Landroidx/work/impl/utils/IdGenerator$$ExternalSyntheticLambda0;

    invoke-direct {v15, v3, v12}, Landroidx/work/impl/utils/IdGenerator$$ExternalSyntheticLambda0;-><init>(Landroidx/work/impl/utils/IdGenerator;I)V

    invoke-virtual {v14}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    new-instance v12, Landroidx/work/Worker$$ExternalSyntheticLambda0;

    const/4 v5, 0x2

    invoke-direct {v12, v5, v15}, Landroidx/work/Worker$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V

    invoke-virtual {v14, v12}, Landroidx/room/RoomDatabase;->runInTransaction(Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;
    ...
    invoke-direct {v5, v9, v10, v12}, Landroidx/work/impl/model/SystemIdInfo;-><init>(Ljava/lang/String;II)V
    ...
    iget-object v10, v9, Landroidx/work/impl/model/SystemIdInfoDao_Impl;->__db:Landroidx/room/RoomDatabase;

    new-instance v11, Landroidx/compose/material3/ScrimKt$$ExternalSyntheticLambda0;

    const/16 v14, 0x9

    invoke-direct {v11, v14, v9, v5}, Landroidx/compose/material3/ScrimKt$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;Ljava/lang/Object;)V

    const/4 v5, 0x0

    invoke-static {v10, v5, v13, v11}, Landroidx/room/util/DBUtil;->performBlocking(Landroidx/room/RoomDatabase;ZZLkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    ...
    :goto_3
    invoke-virtual {v0, v8, v12}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->scheduleInternal(Landroidx/work/impl/model/WorkSpec;I)V
...
.method public final scheduleInternal(Landroidx/work/impl/model/WorkSpec;I)V
    ...
    iget-object v6, v1, Landroidx/work/Constraints;->contentUriTriggers:Ljava/util/Set;
    ...
    :cond_0
    iget-object v4, v1, Landroidx/work/Constraints;->requiredNetworkType:Landroidx/work/NetworkType;
    ...
    iget-object v9, v0, Landroidx/work/impl/background/systemjob/SystemJobInfoConverter;->mClock:Landroidx/work/SystemClock;
    ...
    invoke-static {v2, v0}, Landroidx/core/view/WindowInsetsCompat$Impl35$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/job/JobInfo$Builder;Ljava/lang/String;)V
    ...
    invoke-static {v0, v8, v7, v1}, Landroidx/room/util/DBUtil;->performBlocking(Landroidx/room/RoomDatabase;ZZLkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    ...
    sget-object v6, Landroidx/work/impl/background/systemjob/JobSchedulerExtKt;->TAG:Ljava/lang/String;
    ...
    invoke-virtual {v8, v6, v9, v0}, Landroidx/work/Logger$LogcatLogger;->error(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-static {p2, v3}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->getPendingJobs(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/ArrayList;
    ...
    invoke-static {p2, p0, v0}, Landroidx/work/OperationKt$$ExternalSyntheticLambda0;->m(Ljava/lang/StringBuilder;IC)Ljava/lang/String;
