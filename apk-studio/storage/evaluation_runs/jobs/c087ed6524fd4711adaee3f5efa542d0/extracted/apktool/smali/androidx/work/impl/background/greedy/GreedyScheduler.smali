...
.field public final mStartStopTokens:Lkotlin/text/MatcherMatchResult;
...
.field public final mWorkLauncher:Lkotlin/text/MatcherMatchResult;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/emoji2/text/MetadataRepo;Landroidx/work/impl/Processor;Lkotlin/text/MatcherMatchResult;Landroidx/emoji2/text/MetadataRepo;)V
    .locals 2
    ...
    invoke-direct {v1, v0}, Lkotlin/text/MatcherMatchResult;-><init>(Landroidx/lifecycle/ViewModelStore;)V

    iput-object v1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lkotlin/text/MatcherMatchResult;
    ...
    iget-object p1, p2, Landroidx/work/Configuration;->runnableScheduler:Lio/ktor/events/Events;
    ...
    invoke-direct {v0, p0, p1, v1}, Landroidx/work/impl/background/greedy/DelayedWorkTracker;-><init>(Landroidx/work/impl/background/greedy/GreedyScheduler;Lio/ktor/events/Events;Landroidx/work/SystemClock;)V
    ...
    invoke-direct {p1, p3}, Landroidx/work/impl/constraints/WorkConstraintsTracker;-><init>(Landroidx/emoji2/text/MetadataRepo;)V
    ...
    iput-object p5, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mWorkLauncher:Lkotlin/text/MatcherMatchResult;
...
.method public final cancel(Ljava/lang/String;)V
    ...
    iget-object v0, v0, Landroidx/work/impl/background/greedy/DelayedWorkTracker;->mRunnableScheduler:Lio/ktor/events/Events;
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {v0}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    iget-object v1, v0, Lkotlin/text/MatcherMatchResult;->input:Ljava/lang/Object;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mWorkLauncher:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const/16 v2, -0x200

    invoke-virtual {v1, v0, v2}, Lkotlin/text/MatcherMatchResult;->stopWork(Landroidx/work/impl/StartStopToken;I)V
...
.method public final onConstraintsStateChanged(Landroidx/work/impl/model/WorkSpec;Landroidx/work/impl/constraints/ConstraintsState;)V
    ...
    invoke-static {p1}, Landroidx/room/util/DBUtil;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;
    ...
    iget-object p0, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lkotlin/text/MatcherMatchResult;

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Lkotlin/text/MatcherMatchResult;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    invoke-virtual {p0, p1}, Lkotlin/text/MatcherMatchResult;->tokenFor(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
    ...
    invoke-virtual {v1, p0, p1}, Lkotlin/text/MatcherMatchResult;->startWork(Landroidx/work/impl/StartStopToken;Landroidx/work/SystemClock;)V
    ...
    invoke-virtual {p0, p1}, Lkotlin/text/MatcherMatchResult;->remove(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
    ...
    invoke-virtual {v1, p0, p1}, Lkotlin/text/MatcherMatchResult;->stopWork(Landroidx/work/impl/StartStopToken;I)V
...
.method public final onExecuted(Landroidx/work/impl/model/WorkGenerationalId;Z)V
    ...
    invoke-virtual {v0, p1}, Lkotlin/text/MatcherMatchResult;->remove(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
...
.method public final varargs schedule([Landroidx/work/impl/model/WorkSpec;)V
    ...
    invoke-static {v5}, Landroidx/room/util/DBUtil;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;

    move-result-object v6

    iget-object v7, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {v7, v6}, Lkotlin/text/MatcherMatchResult;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    iget-object v9, v8, Landroidx/work/impl/background/greedy/DelayedWorkTracker;->mRunnableScheduler:Lio/ktor/events/Events;
    ...
    iget-object v12, v9, Lio/ktor/events/Events;->handlers:Ljava/lang/Object;
    ...
    iget-object v5, v9, Lio/ktor/events/Events;->handlers:Ljava/lang/Object;
    ...
    :cond_9
    iget-object v6, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Lkotlin/text/MatcherMatchResult;

    invoke-static {v5}, Landroidx/room/util/DBUtil;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;

    move-result-object v7

    invoke-virtual {v6, v7}, Lkotlin/text/MatcherMatchResult;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    invoke-virtual {v6, v5}, Lkotlin/text/MatcherMatchResult;->tokenFor(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
    ...
    iget-object v6, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mWorkLauncher:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const/4 v7, 0x0

    invoke-virtual {v6, v5, v7}, Lkotlin/text/MatcherMatchResult;->startWork(Landroidx/work/impl/StartStopToken;Landroidx/work/SystemClock;)V
    ...
    invoke-static {v1}, Landroidx/room/util/DBUtil;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;
