...
.method public static ImageBitmap-x__-hDU$default(III)Landroidx/compose/ui/graphics/AndroidImageBitmap;
    ...
    invoke-direct {v9, v2, v1}, Landroidx/compose/ui/graphics/ColorSpaceVerificationHelper$$ExternalSyntheticLambda0;-><init>(ILkotlin/jvm/functions/Function1;)V
    ...
    invoke-direct {v10, v2, v1}, Landroidx/compose/ui/graphics/ColorSpaceVerificationHelper$$ExternalSyntheticLambda0;-><init>(ILkotlin/jvm/functions/Function1;)V
...
.method public static drawOutline-wDX37Ww$default(Landroidx/compose/ui/node/LayoutNodeDrawScope;Landroidx/compose/ui/graphics/ColorKt;J)V
    ...
    invoke-virtual/range {v0 .. v8}, Landroidx/compose/ui/node/LayoutNodeDrawScope;->drawRect-n-J9OG0(JJJFI)V
    ...
    invoke-virtual {v1, v7, v5, v6, v8}, Landroidx/compose/ui/node/LayoutNodeDrawScope;->drawPath-LG529CI(Landroidx/compose/ui/graphics/AndroidPath;JLandroidx/compose/ui/graphics/drawscope/DrawStyle;)V
    ...
    iget-object v14, v1, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope$DrawParams;->canvas:Landroidx/compose/ui/graphics/Canvas;
    ...
    invoke-interface/range {v14 .. v21}, Landroidx/compose/ui/graphics/Canvas;->drawRoundRect(FFFFFFLandroidx/compose/ui/graphics/AndroidPaint;)V
    ...
    invoke-virtual {v1, v0, v5, v6, v8}, Landroidx/compose/ui/node/LayoutNodeDrawScope;->drawPath-LG529CI(Landroidx/compose/ui/graphics/AndroidPath;JLandroidx/compose/ui/graphics/drawscope/DrawStyle;)V
...
.method public static final lerp(Landroidx/compose/ui/graphics/Shadow;Landroidx/compose/ui/graphics/Shadow;F)Landroidx/compose/ui/graphics/Shadow;
    ...
    invoke-static {p2, v1, v2, v3, v4}, Landroidx/compose/ui/graphics/ColorKt;->lerp-jxsXWHM(FJJ)J

    move-result-wide v2

    iget-wide v4, p0, Landroidx/compose/ui/graphics/Shadow;->offset:J

    iget-wide v6, p1, Landroidx/compose/ui/graphics/Shadow;->offset:J
    ...
    invoke-static {v8, v9, p2}, Lkotlin/math/MathKt;->lerp(FFF)F
    ...
    invoke-static {v4, v5, p2}, Lkotlin/math/MathKt;->lerp(FFF)F
    ...
    invoke-static {p0, p1, p2}, Lkotlin/math/MathKt;->lerp(FFF)F
...
.method public static final lerp-jxsXWHM(FJJ)J
    ...
    :cond_1
    invoke-static {v4, v6, p0}, Lkotlin/math/MathKt;->lerp(FFF)F

    move-result v2

    invoke-static {v5, v7, p0}, Lkotlin/math/MathKt;->lerp(FFF)F

    move-result v4

    invoke-static {p1, v1, p0}, Lkotlin/math/MathKt;->lerp(FFF)F

    move-result p1

    invoke-static {v3, p2, p0}, Lkotlin/math/MathKt;->lerp(FFF)F
