...
# static fields
.field public static final DEFAULT_ARGS_KEY:Lio/ktor/events/EventDefinition;

.field public static final SAVED_STATE_REGISTRY_OWNER_KEY:Lio/ktor/events/EventDefinition;

.field public static final VIEW_MODEL_KEY:Landroidx/work/impl/AutoMigration_14_15;

.field public static final VIEW_MODEL_SCOPE_LOCK:Lio/ktor/events/EventDefinition;

.field public static final VIEW_MODEL_STORE_OWNER_KEY:Landroidx/work/impl/AutoMigration_14_15;
...
.method static synthetic constructor <clinit>()V
    ...
    sput-object v0, Landroidx/lifecycle/ViewModelKt;->SAVED_STATE_REGISTRY_OWNER_KEY:Lio/ktor/events/EventDefinition;

    new-instance v0, Landroidx/work/impl/AutoMigration_14_15;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroidx/lifecycle/ViewModelKt;->VIEW_MODEL_STORE_OWNER_KEY:Landroidx/work/impl/AutoMigration_14_15;
    ...
    sput-object v0, Landroidx/lifecycle/ViewModelKt;->DEFAULT_ARGS_KEY:Lio/ktor/events/EventDefinition;
    ...
    sput-object v0, Landroidx/lifecycle/ViewModelKt;->VIEW_MODEL_SCOPE_LOCK:Lio/ktor/events/EventDefinition;

    new-instance v0, Landroidx/work/impl/AutoMigration_14_15;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Landroidx/lifecycle/ViewModelKt;->VIEW_MODEL_KEY:Landroidx/work/impl/AutoMigration_14_15;

    return-void
.end method

.method public static final attachHandleIfNeeded(Landroidx/lifecycle/ViewModel;Lkotlin/text/MatcherMatchResult;Landroidx/lifecycle/LifecycleRegistry;)V
    .locals 1
    ...
    invoke-virtual {p0, p2, p1}, Landroidx/lifecycle/SavedStateHandleController;->attachToLifecycle(Landroidx/lifecycle/LifecycleRegistry;Lkotlin/text/MatcherMatchResult;)V
    ...
    invoke-direct {p0, p2, p1}, Landroidx/lifecycle/DefaultLifecycleObserverAdapter;-><init>(Landroidx/lifecycle/LifecycleRegistry;Lkotlin/text/MatcherMatchResult;)V
    ...
    :cond_1
    :goto_0
    invoke-virtual {p1}, Lkotlin/text/MatcherMatchResult;->runOnNextRecreation()V
...
.method public static createHandle(Landroid/os/Bundle;Landroid/os/Bundle;)Landroidx/lifecycle/SavedStateHandle;
    ...
    invoke-direct {p1, v0}, Lio/ktor/network/tls/TLSConfig;-><init>(Ljava/util/Map;)V

    iput-object p1, p0, Landroidx/lifecycle/SavedStateHandle;->impl:Lio/ktor/network/tls/TLSConfig;
    ...
    new-instance v0, Lio/ktor/network/tls/TLSConfig;

    invoke-direct {v0, p0}, Lio/ktor/network/tls/TLSConfig;-><init>(Ljava/util/Map;)V

    iput-object v0, p1, Landroidx/lifecycle/SavedStateHandle;->impl:Lio/ktor/network/tls/TLSConfig;
...
.method public static final createSavedStateHandle(Landroidx/lifecycle/viewmodel/MutableCreationExtras;)Landroidx/lifecycle/SavedStateHandle;
    ...
    sget-object v0, Landroidx/lifecycle/ViewModelKt;->SAVED_STATE_REGISTRY_OWNER_KEY:Lio/ktor/events/EventDefinition;
    ...
    sget-object v2, Landroidx/lifecycle/ViewModelKt;->VIEW_MODEL_STORE_OWNER_KEY:Landroidx/work/impl/AutoMigration_14_15;
    ...
    sget-object v3, Landroidx/lifecycle/ViewModelKt;->DEFAULT_ARGS_KEY:Lio/ktor/events/EventDefinition;
    ...
    sget-object v4, Landroidx/lifecycle/ViewModelKt;->VIEW_MODEL_KEY:Landroidx/work/impl/AutoMigration_14_15;
    ...
    invoke-interface {v0}, Landroidx/savedstate/SavedStateRegistryOwner;->getSavedStateRegistry()Lkotlin/text/MatcherMatchResult;

    move-result-object v0

    const-string v4, "androidx.lifecycle.internal.SavedStateHandlesProvider"

    invoke-virtual {v0, v4}, Lkotlin/text/MatcherMatchResult;->getSavedStateProvider(Ljava/lang/String;)Landroidx/savedstate/SavedStateRegistry$SavedStateProvider;
    ...
    invoke-static {v5}, Lkotlin/math/MathKt;->bundleOf([Lkotlin/Pair;)Landroid/os/Bundle;
...
.method public static final getViewModelScope(Landroidx/lifecycle/ViewModel;)Landroidx/lifecycle/viewmodel/internal/CloseableCoroutineScope;
    ...
    sget-object v0, Landroidx/lifecycle/ViewModelKt;->VIEW_MODEL_SCOPE_LOCK:Lio/ktor/events/EventDefinition;
