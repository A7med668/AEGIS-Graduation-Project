...
.method public static final MainNavigation(Lcom/vayunmathur/library/util/NavBackStack;Lkotlin/jvm/functions/Function2;Lkotlin/jvm/functions/Function1;Landroidx/compose/runtime/GapComposer;I)V
    ...
    :cond_a
    sget-object v4, Landroidx/window/core/Version;->VERSION_0_1:Landroidx/window/core/Version;
    ...
    iget-object v4, v4, Landroidx/window/core/Version;->bigInteger$delegate:Lkotlin/SynchronizedLazyImpl;
    ...
    :cond_c
    :try_start_2
    new-instance v4, Landroidx/window/layout/adapter/sidecar/SidecarWindowBackend;

    invoke-direct {v4, v2}, Landroidx/window/layout/adapter/sidecar/SidecarWindowBackend;-><init>(Landroidx/window/layout/adapter/sidecar/SidecarCompat;)V

    sput-object v4, Landroidx/window/layout/adapter/sidecar/SidecarWindowBackend;->globalInstance:Landroidx/window/layout/adapter/sidecar/SidecarWindowBackend;
    :try_end_2
    ...
    new-instance v4, Landroidx/window/layout/WindowMetricsCalculatorCompat;

    invoke-direct {v4}, Landroidx/window/layout/WindowMetricsCalculatorCompat;-><init>()V

    new-instance v5, Landroidx/work/impl/AutoMigration_14_15;

    invoke-direct {v5}, Ljava/lang/Object;-><init>()V

    invoke-static {}, Landroidx/window/core/ExtensionsUtil;->getSafeVendorApiLevel()I

    invoke-direct {v2, v4, v1, v5}, Landroidx/window/layout/FoldingFeature$State;-><init>(Landroidx/window/layout/WindowMetricsCalculatorCompat;Landroidx/window/layout/adapter/WindowBackend;Landroidx/work/impl/AutoMigration_14_15;)V
    ...
    invoke-direct {v1, v2, v0, v3, v11}, Landroidx/work/ListenableFutureKt$launchFuture$1$2;-><init>(Ljava/lang/Object;Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V
    ...
    invoke-direct {v0, v1, v2, v4, v5}, Lkotlinx/coroutines/flow/CallbackFlowBuilder;-><init>(Lkotlin/jvm/functions/Function2;Lkotlin/coroutines/CoroutineContext;ILkotlinx/coroutines/channels/BufferOverflow;)V
    ...
    invoke-virtual {v1, v4}, Lkotlinx/coroutines/CoroutineDispatcher;->get(Lkotlin/coroutines/CoroutineContext$Key;)Lkotlin/coroutines/CoroutineContext$Element;
    ...
    invoke-static {v0, v1, v10, v3, v2}, Lkotlinx/coroutines/flow/internal/FusibleFlow;->fuse$default(Lkotlinx/coroutines/flow/internal/FusibleFlow;Lkotlinx/coroutines/android/HandlerContext;ILkotlinx/coroutines/channels/BufferOverflow;I)Lkotlinx/coroutines/flow/Flow;
    ...
    check-cast v11, Landroidx/window/layout/HardwareFoldingFeature;

    iget-object v12, v11, Landroidx/window/layout/HardwareFoldingFeature;->featureBounds:Landroidx/window/core/Bounds;

    invoke-virtual {v12}, Landroidx/window/core/Bounds;->getWidth()I

    move-result v10

    invoke-virtual {v12}, Landroidx/window/core/Bounds;->getHeight()I
    ...
    iget-object v0, v11, Landroidx/window/layout/HardwareFoldingFeature;->state:Landroidx/window/layout/FoldingFeature$State;
    ...
    :goto_e
    new-instance v18, Landroidx/compose/material3/adaptive/HingeInfo;

    invoke-virtual {v12}, Landroidx/window/core/Bounds;->toRect()Landroid/graphics/Rect;
    ...
    invoke-direct {v5, v6, v12, v13, v10}, Landroidx/compose/ui/geometry/Rect;-><init>(FFFF)V
    ...
    :goto_f
    iget-object v6, v11, Landroidx/window/layout/HardwareFoldingFeature;->featureBounds:Landroidx/window/core/Bounds;
    ...
    :goto_11
    iget-object v6, v11, Landroidx/window/layout/HardwareFoldingFeature;->type:Landroidx/window/layout/FoldingFeature$State;
    ...
    :goto_13
    invoke-virtual/range {v19 .. v19}, Landroidx/window/core/Bounds;->getWidth()I

    move-result v0

    if-eqz v0, :cond_1b

    invoke-virtual/range {v19 .. v19}, Landroidx/window/core/Bounds;->getHeight()I
    ...
    :goto_17
    invoke-direct/range {v18 .. v23}, Landroidx/compose/material3/adaptive/HingeInfo;-><init>(Landroidx/compose/ui/geometry/Rect;ZZZZ)V
    ...
    iget v2, v9, Landroidx/window/core/layout/WindowSizeClass;->minHeightDp:I
    ...
    :goto_1b
    new-instance v17, Landroidx/compose/material3/adaptive/layout/PaneScaffoldDirective;
    ...
    check-cast v5, Landroidx/compose/material3/adaptive/HingeInfo;

    iget-boolean v6, v5, Landroidx/compose/material3/adaptive/HingeInfo;->isVertical:Z

    if-eqz v6, :cond_24

    iget-boolean v6, v5, Landroidx/compose/material3/adaptive/HingeInfo;->isSeparating:Z

    if-eqz v6, :cond_24

    iget-object v5, v5, Landroidx/compose/material3/adaptive/HingeInfo;->bounds:Landroidx/compose/ui/geometry/Rect;
    ...
    invoke-direct/range {v17 .. v23}, Landroidx/compose/material3/adaptive/layout/PaneScaffoldDirective;-><init>(IFIFFLjava/util/List;)V

    move-object/from16 v0, v17

    sget-object v1, Landroidx/compose/material3/adaptive/layout/ListDetailPaneScaffoldDefaults;->PaneOrder:Landroidx/compose/material3/adaptive/layout/ThreePaneScaffoldHorizontalOrder;

    sget-object v1, Landroidx/compose/material3/adaptive/layout/AdaptStrategy$Companion;->Hide:Landroidx/compose/material3/adaptive/layout/PaneMotion$Companion;

    new-instance v2, Landroidx/compose/material3/adaptive/layout/ThreePaneScaffoldAdaptStrategies;

    invoke-direct {v2, v1, v1, v1}, Landroidx/compose/material3/adaptive/layout/ThreePaneScaffoldAdaptStrategies;-><init>(Landroidx/compose/material3/adaptive/layout/PaneMotion$Companion;Landroidx/compose/material3/adaptive/layout/PaneMotion$Companion;Landroidx/compose/material3/adaptive/layout/PaneMotion$Companion;)V
    ...
    invoke-direct {v4, v0, v2}, Landroidx/compose/material3/adaptive/navigation3/ListDetailSceneStrategy;-><init>(Landroidx/compose/material3/adaptive/layout/PaneScaffoldDirective;Landroidx/compose/material3/adaptive/layout/ThreePaneScaffoldAdaptStrategies;)V
    ...
    invoke-static {v1, v2, v4}, Lkotlinx/coroutines/flow/FlowKt;->MutableSharedFlow$default(IILkotlinx/coroutines/channels/BufferOverflow;)Lkotlinx/coroutines/flow/SharedFlowImpl;
    ...
    invoke-direct {v1, v2, v11}, Landroidx/compose/runtime/Updater$$ExternalSyntheticLambda1;-><init>(ILjava/lang/Object;)V
    ...
    new-instance v9, Lcom/vayunmathur/weather/ui/HomePageKt$$ExternalSyntheticLambda12;

    move-object/from16 v13, p0

    invoke-direct/range {v9 .. v14}, Lcom/vayunmathur/weather/ui/HomePageKt$$ExternalSyntheticLambda12;-><init>(Lcom/vayunmathur/library/util/NavResultRegistry;Landroidx/compose/material3/SnackbarHostState;Landroidx/compose/material3/adaptive/navigation3/ListDetailSceneStrategy;Lcom/vayunmathur/library/util/NavBackStack;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {v1, v0}, Lio/ktor/http/Url$$ExternalSyntheticBUOutline0;->m$3(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    new-instance v9, Landroidx/compose/material3/SnackbarHostKt$$ExternalSyntheticLambda0;
    ...
    invoke-direct/range {v9 .. v14}, Landroidx/compose/material3/SnackbarHostKt$$ExternalSyntheticLambda0;-><init>(IILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V
