...
.field public focusedBorderLogic:Lio/ktor/events/EventDefinition;
...
.method public final draw(Landroidx/compose/ui/node/LayoutNodeDrawScope;)V
    ...
    :goto_0
    iget-wide v5, v0, Landroidx/compose/material3/internal/ripple/AndroidRippleNode;->rippleSize:J

    iget v7, v0, Landroidx/compose/material3/internal/ripple/AndroidRippleNode;->targetRadius:F

    invoke-static {v7}, Lkotlin/math/MathKt;->roundToInt(F)I

    move-result v7

    iget-object v8, v0, Landroidx/compose/material3/internal/ripple/AndroidRippleNode;->color:Landroidx/compose/material3/DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1;

    invoke-virtual {v8}, Landroidx/compose/material3/DelegatingThemeAwareRippleNode$attachNewRipple$calculateColor$1;->invoke-0d7_KjU()J

    move-result-wide v8

    invoke-virtual/range {v4 .. v10}, Landroidx/compose/material3/internal/ripple/RippleHostView;->setRippleProperties-biQXAtU(JIJF)V
    ...
    :try_start_0
    iget-object v2, v9, Landroidx/emoji2/text/EmojiProcessor;->mSpanFactory:Ljava/lang/Object;
    ...
    check-cast v2, Landroidx/emoji2/text/EmojiProcessor;
    ...
    :try_start_1
    invoke-static/range {v1 .. v8}, Landroidx/compose/ui/graphics/drawscope/DrawScope;->drawCircle-VaOC9Bg$default(Landroidx/compose/ui/graphics/drawscope/DrawScope;JFJFI)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    invoke-static {v9, v12, v13}, Landroidx/work/OperationKt$$ExternalSyntheticLambda0;->m(Landroidx/emoji2/text/EmojiProcessor;J)V
    ...
    iget-object v1, v0, Landroidx/compose/material3/internal/ripple/AndroidRippleNode;->focusedBorderLogic:Lio/ktor/events/EventDefinition;
    ...
    invoke-direct {v1, v2}, Lio/ktor/events/EventDefinition;-><init>(I)V

    :cond_4
    iput-object v1, v0, Landroidx/compose/material3/internal/ripple/AndroidRippleNode;->focusedBorderLogic:Lio/ktor/events/EventDefinition;
...
.method public final handlePressInteraction(Landroidx/compose/foundation/interaction/PressInteraction;)V
    ...
    invoke-static {p0, v0, p1}, Lio/ktor/http/Url$$ExternalSyntheticBUOutline0;->m(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    invoke-direct {v10, p1, p0}, Landroidx/datastore/core/FileStorage$$ExternalSyntheticLambda1;-><init>(ILjava/lang/Object;)V

    iget-boolean v3, p0, Landroidx/compose/material3/internal/ripple/AndroidRippleNode;->bounded:Z

    invoke-virtual/range {v1 .. v10}, Landroidx/compose/material3/internal/ripple/RippleHostView;->addRipple-KOepWvA(Landroidx/compose/foundation/interaction/PressInteraction$Press;ZJIJFLandroidx/datastore/core/FileStorage$$ExternalSyntheticLambda1;)V
...
.method public final onAttach()V
    ...
    invoke-direct {v1, p0, v3, v2}, Landroidx/compose/ui/window/AndroidPopup_androidKt$Popup$5$1;-><init>(Ljava/lang/Object;Lkotlin/coroutines/Continuation;I)V
...
.method public final onRemeasured-ozmzZPI(J)V
    ...
    invoke-static {p1, p2}, Landroidx/core/util/Preconditions;->toSize-ozmzZPI(J)J
