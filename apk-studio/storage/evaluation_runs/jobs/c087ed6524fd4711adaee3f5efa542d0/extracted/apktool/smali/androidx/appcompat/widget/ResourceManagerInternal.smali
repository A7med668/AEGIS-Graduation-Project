...
.field public mHooks:Landroidx/work/impl/WorkerWrapper$Builder;
...
.method public final createDrawableIfNeeded(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_4
    iget-object v3, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mHooks:Landroidx/work/impl/WorkerWrapper$Builder;
    ...
    invoke-static {p0, p1, p2}, Landroidx/work/impl/WorkerWrapper$Builder;->getRatingBarLayerDrawable(Landroidx/appcompat/widget/ResourceManagerInternal;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
...
.method public final declared-synchronized getDrawable$1(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget p1, Landroidx/appcompat/widget/DrawableUtils;->$r8$clinit:I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final declared-synchronized getTintList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mHooks:Landroidx/work/impl/WorkerWrapper$Builder;
    ...
    :cond_1
    invoke-virtual {v0, p1, p2}, Landroidx/work/impl/WorkerWrapper$Builder;->getTintListForDrawableRes(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method public final tintDrawable(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    iget-object p0, p0, Landroidx/appcompat/widget/ResourceManagerInternal;->mHooks:Landroidx/work/impl/WorkerWrapper$Builder;
    ...
    invoke-static {p2, v0, v5}, Landroidx/work/impl/WorkerWrapper$Builder;->setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, p1, v5}, Landroidx/work/impl/WorkerWrapper$Builder;->setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p2, v0, v1}, Landroidx/work/impl/WorkerWrapper$Builder;->setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p0, p1, v1}, Landroidx/work/impl/WorkerWrapper$Builder;->setPorterDuffColorFilter(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v3, p0, Landroidx/work/impl/WorkerWrapper$Builder;->configuration:Ljava/lang/Object;

    check-cast v3, [I

    invoke-static {v3, p2}, Landroidx/work/impl/WorkerWrapper$Builder;->arrayContains([II)Z
    ...
    :cond_7
    iget-object v1, p0, Landroidx/work/impl/WorkerWrapper$Builder;->workDatabase:Ljava/lang/Object;

    check-cast v1, [I

    invoke-static {v1, p2}, Landroidx/work/impl/WorkerWrapper$Builder;->arrayContains([II)Z
    ...
    :cond_8
    iget-object p0, p0, Landroidx/work/impl/WorkerWrapper$Builder;->workSpec:Ljava/lang/Object;
