...
.field public final childDependenciesTracker:Landroidx/core/view/NestedScrollingChildHelper;
...
.method public constructor <init>(Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;)V
    ...
    iput-object v4, p0, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->childDependenciesTracker:Landroidx/core/view/NestedScrollingChildHelper;
...
.method public final configureOutlineAndClip()V
    ...
    :cond_0
    iput-boolean v4, v1, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->clip:Z

    invoke-virtual {v1}, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->applyClip()V
    ...
    :cond_1
    :goto_0
    iget-object v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->outlinePath:Landroidx/compose/ui/graphics/AndroidPath;
    ...
    iget-object v9, v5, Landroidx/compose/ui/graphics/AndroidPath;->internalPath:Landroid/graphics/Path;
    ...
    iget v7, v0, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->outsetLeft:I

    iget v8, v0, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->outsetTop:I
    ...
    iput-object v5, v0, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->outlinePath:Landroidx/compose/ui/graphics/AndroidPath;
    ...
    iput-boolean v2, v1, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->clip:Z
    ...
    :cond_7
    iput-boolean v3, v1, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->clip:Z
    ...
    invoke-static {v8, v9}, Landroidx/core/util/Preconditions;->toSize-ozmzZPI(J)J
...
.method public final discardContentIfReleasedAndHaveNoParentLayerUsages()V
    ...
    iget-object v0, p0, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->childDependenciesTracker:Landroidx/core/view/NestedScrollingChildHelper;

    iget-object v1, v0, Landroidx/core/view/NestedScrollingChildHelper;->mNestedScrollingParentTouch:Ljava/lang/Object;
    ...
    :cond_0
    iget-object v0, v0, Landroidx/core/view/NestedScrollingChildHelper;->mView:Ljava/lang/Object;
...
.method public final drawWithChildTracking(Landroidx/compose/ui/graphics/drawscope/DrawScope;)V
    ...
    iput-object v1, v0, Landroidx/core/view/NestedScrollingChildHelper;->mNestedScrollingParentNonTouch:Ljava/lang/Object;

    iget-object v1, v0, Landroidx/core/view/NestedScrollingChildHelper;->mView:Ljava/lang/Object;
    ...
    iget-object v2, v0, Landroidx/core/view/NestedScrollingChildHelper;->mTempNestedScrollConsumed:Ljava/lang/Object;
    ...
    iput-object v2, v0, Landroidx/core/view/NestedScrollingChildHelper;->mTempNestedScrollConsumed:Ljava/lang/Object;
    ...
    iput-boolean p0, v0, Landroidx/core/view/NestedScrollingChildHelper;->mIsNestedScrollingEnabled:Z

    iget-object p1, v0, Landroidx/core/view/NestedScrollingChildHelper;->mNestedScrollingParentNonTouch:Ljava/lang/Object;
    ...
    :cond_2
    iget-object p1, v0, Landroidx/core/view/NestedScrollingChildHelper;->mTempNestedScrollConsumed:Ljava/lang/Object;
...
.method public final getOutline()Landroidx/compose/ui/graphics/ColorKt;
    ...
    invoke-static/range {v6 .. v11}, Landroidx/core/view/WindowCompat;->RoundRect-gG7oq9Y(FFFFJ)Landroidx/compose/ui/geometry/RoundRect;
...
.method public final recordInternal()V
    ...
    iget-object v3, v2, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->canvasDrawScope:Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;

    iget-object v4, v2, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->renderNode:Landroid/graphics/RenderNode;

    invoke-virtual {v4}, Landroid/graphics/RenderNode;->beginRecording()Landroid/graphics/RecordingCanvas;

    move-result-object v5

    iget v6, v2, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->outsetLeft:I

    int-to-float v6, v6

    iget v7, v2, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->outsetTop:I
    ...
    :try_start_0
    iget-object v8, v2, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->canvasHolder:Landroidx/compose/ui/graphics/CanvasHolder;

    iget-object v9, v8, Landroidx/compose/ui/graphics/CanvasHolder;->androidCanvas:Landroidx/compose/ui/graphics/AndroidCanvas;

    iget-object v13, v9, Landroidx/compose/ui/graphics/AndroidCanvas;->internalCanvas:Landroid/graphics/Canvas;

    iput-object v5, v9, Landroidx/compose/ui/graphics/AndroidCanvas;->internalCanvas:Landroid/graphics/Canvas;

    iget-object v5, v3, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->drawContext:Landroidx/emoji2/text/EmojiProcessor;

    invoke-virtual {v5, v0}, Landroidx/emoji2/text/EmojiProcessor;->setDensity(Landroidx/compose/ui/unit/Density;)V

    invoke-virtual {v5, v1}, Landroidx/emoji2/text/EmojiProcessor;->setLayoutDirection(Landroidx/compose/ui/unit/LayoutDirection;)V

    iput-object p0, v5, Landroidx/emoji2/text/EmojiProcessor;->mMetadataRepo:Ljava/lang/Object;

    iget-wide v0, v2, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->size:J

    invoke-virtual {v5, v0, v1}, Landroidx/emoji2/text/EmojiProcessor;->setSize-uvyYCjk(J)V

    invoke-virtual {v5, v9}, Landroidx/emoji2/text/EmojiProcessor;->setCanvas(Landroidx/compose/ui/graphics/Canvas;)V

    iget v0, v2, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->outsetLeft:I
    :try_end_0
    ...
    iget-object p0, p0, Landroidx/compose/ui/graphics/layer/GraphicsLayer;->clipDrawBlock:Landroidx/compose/ui/node/NodeChainKt$fillVector$1;

    if-gtz v0, :cond_1

    :try_start_1
    iget v0, v2, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->outsetTop:I
    ...
    :cond_0
    invoke-virtual {p0, v3}, Landroidx/compose/ui/node/NodeChainKt$fillVector$1;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v9, v1, v5}, Landroidx/compose/ui/graphics/AndroidCanvas;->translate(FF)V
    ...
    invoke-virtual {v9, p0, v0}, Landroidx/compose/ui/graphics/AndroidCanvas;->translate(FF)V

    :goto_1
    iget-object p0, v8, Landroidx/compose/ui/graphics/CanvasHolder;->androidCanvas:Landroidx/compose/ui/graphics/AndroidCanvas;

    iput-object v13, p0, Landroidx/compose/ui/graphics/AndroidCanvas;->internalCanvas:Landroid/graphics/Canvas;
    :try_end_1
...
.method public final setPivotOffset-k-4lQ0M(J)V
    ...
    invoke-virtual {p0}, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->updatePivot()V
...
.method public final setPosition-VbeCjmY(JJ)V
    ...
    invoke-static {p3, p4}, Landroidx/core/util/Preconditions;->toSize-ozmzZPI(J)J
    ...
    iput-wide v4, p0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->size:J

    invoke-virtual {p0}, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->updatePosition()V

    if-nez p1, :cond_0

    iget-wide v4, p0, Landroidx/compose/ui/graphics/layer/GraphicsLayerV29;->pivotOffset:J
