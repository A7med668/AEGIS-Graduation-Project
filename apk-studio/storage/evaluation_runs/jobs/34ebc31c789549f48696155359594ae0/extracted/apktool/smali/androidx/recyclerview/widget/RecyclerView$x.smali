...
.method public b(II)V
    ...
    invoke-virtual {v5}, Landroidx/recyclerview/widget/RecyclerView$b0;->g()I
    ...
    iget-object v3, v0, Landroidx/recyclerview/widget/RecyclerView;->l0:Landroidx/recyclerview/widget/RecyclerView$y;

    iget-object v5, p0, Landroidx/recyclerview/widget/RecyclerView$x;->g:Landroidx/recyclerview/widget/RecyclerView$x$a;

    invoke-virtual {p0, v2, v3, v5}, Landroidx/recyclerview/widget/RecyclerView$x;->c(Landroid/view/View;Landroidx/recyclerview/widget/RecyclerView$y;Landroidx/recyclerview/widget/RecyclerView$x$a;)V
    ...
    :cond_7
    iget v5, v3, Landroidx/recyclerview/widget/m;->o:I
    ...
    iget v5, v3, Landroidx/recyclerview/widget/m;->p:I
    ...
    iput-object p1, v3, Landroidx/recyclerview/widget/m;->k:Landroid/graphics/PointF;
    ...
    iput p2, v3, Landroidx/recyclerview/widget/m;->o:I

    mul-float/2addr v5, p1

    float-to-int p1, v5

    iput p1, v3, Landroidx/recyclerview/widget/m;->p:I

    const/16 p1, 0x2710

    invoke-virtual {v3, p1}, Landroidx/recyclerview/widget/m;->g(I)I

    move-result p1

    iget p2, v3, Landroidx/recyclerview/widget/m;->o:I
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/m;->i:Landroid/view/animation/LinearInterpolator;
    ...
    iget-object p1, v0, Landroidx/recyclerview/widget/RecyclerView;->i0:Landroidx/recyclerview/widget/RecyclerView$a0;
...
.method public final d()V
    ...
    iput v0, v1, Landroidx/recyclerview/widget/m;->p:I

    iput v0, v1, Landroidx/recyclerview/widget/m;->o:I

    const/4 v2, 0x0

    iput-object v2, v1, Landroidx/recyclerview/widget/m;->k:Landroid/graphics/PointF;

    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$x;->b:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView;->l0:Landroidx/recyclerview/widget/RecyclerView$y;
