...
.method public constructor <init>(Landroid/content/Context;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    iput v0, p0, Lu/b$b;->a:F

    iput v0, p0, Lu/b$b;->b:F

    iput v0, p0, Lu/b$b;->c:F

    iput v0, p0, Lu/b$b;->d:F

    const/4 v0, -0x1

    iput v0, p0, Lu/b$b;->e:I
    ...
    iget v3, p0, Lu/b$b;->e:I

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getResourceId(II)I

    move-result v2

    iput v2, p0, Lu/b$b;->e:I
    ...
    iget v3, p0, Lu/b$b;->d:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, Lu/b$b;->d:F
    ...
    iget v3, p0, Lu/b$b;->b:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, Lu/b$b;->b:F
    ...
    iget v3, p0, Lu/b$b;->c:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, Lu/b$b;->c:F
    ...
    iget v3, p0, Lu/b$b;->a:F

    invoke-virtual {p2, v2, v3}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v2

    iput v2, p0, Lu/b$b;->a:F
