...
.field public h:Landroidx/appcompat/app/WindowDecorActionBar$d;
...
.field public mDecorToolbar:Landroidx/appcompat/widget/g0;
...
.field public final v:Lh0/s;

.field public final w:Lh0/s;

.field public final x:Lh0/u;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/WindowDecorActionBar;->y:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/view/animation/DecelerateInterpolator;

    invoke-direct {v0}, Landroid/view/animation/DecelerateInterpolator;-><init>()V

    sput-object v0, Landroidx/appcompat/app/WindowDecorActionBar;->z:Landroid/view/animation/Interpolator;
...
.method public constructor <init>(Landroid/app/Activity;Z)V
    ...
    iput-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->l:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->v:Lh0/s;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->w:Lh0/s;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->x:Lh0/u;
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/app/WindowDecorActionBar;->t(Landroid/view/View;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->f:Landroid/view/View;
...
.method public b()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->mDecorToolbar:Landroidx/appcompat/widget/g0;
...
.method public c(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->k:Z

    iget-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->l:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroidx/appcompat/app/WindowDecorActionBar;->l:Ljava/util/ArrayList;
...
.method public i(ILandroid/view/KeyEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->h:Landroidx/appcompat/app/WindowDecorActionBar$d;
    ...
    :cond_0
    iget-object v0, v0, Landroidx/appcompat/app/WindowDecorActionBar$d;->h:Landroidx/appcompat/view/menu/e;
...
.method public l(Z)V
    ...
    iget-boolean v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->g:Z
    ...
    :goto_0
    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/app/WindowDecorActionBar;->u(II)V
...
.method public o(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->s:Li/h;
...
.method public r(Li/a$a;)Li/a;
    ...
    invoke-virtual {v0}, Landroidx/appcompat/app/WindowDecorActionBar$d;->c()V
    ...
    iget-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->e:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {v0}, Landroidx/appcompat/widget/ActionBarContextView;->h()V

    new-instance v0, Landroidx/appcompat/app/WindowDecorActionBar$d;

    iget-object v1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->e:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {v1}, Landroid/view/ViewGroup;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-direct {v0, p0, v1, p1}, Landroidx/appcompat/app/WindowDecorActionBar$d;-><init>(Landroidx/appcompat/app/WindowDecorActionBar;Landroid/content/Context;Li/a$a;)V

    iget-object p1, v0, Landroidx/appcompat/app/WindowDecorActionBar$d;->h:Landroidx/appcompat/view/menu/e;

    invoke-virtual {p1}, Landroidx/appcompat/view/menu/e;->y()V

    :try_start_0
    iget-object p1, v0, Landroidx/appcompat/app/WindowDecorActionBar$d;->i:Li/a$a;

    iget-object v1, v0, Landroidx/appcompat/app/WindowDecorActionBar$d;->h:Landroidx/appcompat/view/menu/e;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->h:Landroidx/appcompat/app/WindowDecorActionBar$d;

    invoke-virtual {v0}, Landroidx/appcompat/app/WindowDecorActionBar$d;->i()V

    iget-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->e:Landroidx/appcompat/widget/ActionBarContextView;
...
.method public s(Z)V
    ...
    :cond_0
    invoke-virtual {p0, v0}, Landroidx/appcompat/app/WindowDecorActionBar;->w(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->mDecorToolbar:Landroidx/appcompat/widget/g0;

    invoke-interface {p1, v2, v4, v5}, Landroidx/appcompat/widget/g0;->s(IJ)Lh0/r;

    move-result-object p1

    iget-object v1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->e:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {v1, v0, v6, v7}, Landroidx/appcompat/widget/a;->e(IJ)Lh0/r;
    ...
    invoke-interface {p1, v0, v6, v7}, Landroidx/appcompat/widget/g0;->s(IJ)Lh0/r;

    move-result-object v0

    iget-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->e:Landroidx/appcompat/widget/ActionBarContextView;

    invoke-virtual {p1, v3, v4, v5}, Landroidx/appcompat/widget/a;->e(IJ)Lh0/r;
    ...
    iget-object v2, v1, Li/h;->a:Ljava/util/ArrayList;

    invoke-virtual {v2, p1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-object p1, p1, Lh0/r;->a:Ljava/lang/ref/WeakReference;
    ...
    :goto_2
    iget-object p1, v0, Lh0/r;->a:Ljava/lang/ref/WeakReference;
    ...
    :cond_6
    iget-object p1, v1, Li/h;->a:Ljava/util/ArrayList;
    ...
    invoke-interface {p1, v2}, Landroidx/appcompat/widget/g0;->l(I)V
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/widget/g0;->l(I)V
...
.method public final t(Landroid/view/View;)V
    ...
    :goto_0
    iput-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->mDecorToolbar:Landroidx/appcompat/widget/g0;
    ...
    iput-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->e:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/g0;->k()I
    ...
    iput-boolean v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->g:Z
    ...
    :goto_4
    iget-object v3, p0, Landroidx/appcompat/app/WindowDecorActionBar;->mDecorToolbar:Landroidx/appcompat/widget/g0;

    invoke-interface {v3, p1}, Landroidx/appcompat/widget/g0;->q(Z)V
...
.method public u(II)V
    ...
    iput-boolean v1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->g:Z

    :cond_0
    iget-object v1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->mDecorToolbar:Landroidx/appcompat/widget/g0;
    ...
    invoke-interface {v1, p1}, Landroidx/appcompat/widget/g0;->x(I)V
...
.method public final v(Z)V
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/widget/g0;->o(Landroidx/appcompat/widget/t0;)V
    ...
    invoke-interface {p1}, Landroidx/appcompat/widget/g0;->r()I
    ...
    iget-boolean v3, p0, Landroidx/appcompat/app/WindowDecorActionBar;->m:Z
    ...
    :goto_2
    invoke-interface {v0, v3}, Landroidx/appcompat/widget/g0;->w(Z)V
...
.method public final w(Z)V
    ...
    iget-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->s:Li/h;
    ...
    invoke-static {v1}, Lh0/o;->b(Landroid/view/View;)Lh0/r;

    move-result-object v1

    invoke-virtual {v1, v2}, Lh0/r;->g(F)Lh0/r;

    iget-object v3, p0, Landroidx/appcompat/app/WindowDecorActionBar;->x:Lh0/u;

    invoke-virtual {v1, v3}, Lh0/r;->f(Lh0/u;)Lh0/r;
    ...
    iget-object v1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->f:Landroid/view/View;

    if-eqz v1, :cond_6

    invoke-virtual {v1, v0}, Landroid/view/View;->setTranslationY(F)V

    iget-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->f:Landroid/view/View;

    invoke-static {v0}, Lh0/o;->b(Landroid/view/View;)Lh0/r;

    move-result-object v0

    invoke-virtual {v0, v2}, Lh0/r;->g(F)Lh0/r;
    ...
    :cond_6
    sget-object v0, Landroidx/appcompat/app/WindowDecorActionBar;->z:Landroid/view/animation/Interpolator;
    ...
    :cond_8
    iget-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->w:Lh0/s;

    if-nez v1, :cond_9

    iput-object v0, p1, Li/h;->d:Lh0/s;

    :cond_9
    iput-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->s:Li/h;
    ...
    iget-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->f:Landroid/view/View;
    ...
    :cond_b
    iget-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->w:Lh0/s;

    invoke-interface {p1, v7}, Lh0/s;->a(Landroid/view/View;)V
    ...
    invoke-virtual {p1, v2}, Lh0/r;->g(F)Lh0/r;

    iget-object v1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->x:Lh0/u;

    invoke-virtual {p1, v1}, Lh0/r;->f(Lh0/u;)Lh0/r;
    ...
    :cond_11
    sget-object p1, Landroidx/appcompat/app/WindowDecorActionBar;->y:Landroid/view/animation/Interpolator;
    ...
    :cond_13
    iget-object p1, p0, Landroidx/appcompat/app/WindowDecorActionBar;->v:Lh0/s;

    if-nez v1, :cond_14

    iput-object p1, v0, Li/h;->d:Lh0/s;

    :cond_14
    iput-object v0, p0, Landroidx/appcompat/app/WindowDecorActionBar;->s:Li/h;
