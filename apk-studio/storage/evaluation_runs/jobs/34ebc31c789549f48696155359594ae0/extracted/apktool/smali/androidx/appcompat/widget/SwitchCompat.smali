...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/widget/SwitchCompat;->Q:Landroid/util/Property;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v10, Landroidx/appcompat/R$attr;->switchStyle:I

    invoke-direct {v7, v8, v9, v10}, Landroid/widget/CompoundButton;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    const/4 v11, 0x0

    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->f:Landroid/content/res/ColorStateList;

    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->g:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->k:Landroid/content/res/ColorStateList;

    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->l:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v12, v7, Landroidx/appcompat/widget/SwitchCompat;->m:Z
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->z:Landroid/view/VelocityTracker;
    ...
    invoke-static {v7, v0}, Landroidx/appcompat/widget/w0;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    iput-object v13, v7, Landroidx/appcompat/widget/SwitchCompat;->J:Landroid/text/TextPaint;
    ...
    invoke-direct {v15, v8, v6}, Landroidx/appcompat/widget/b1;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    invoke-static/range {v0 .. v6}, Lh0/o;->o(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    sget v0, Landroidx/appcompat/R$styleable;->SwitchCompat_android_thumb:I

    invoke-virtual {v15, v0}, Landroidx/appcompat/widget/b1;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->e:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->j:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v15, v0}, Landroidx/appcompat/widget/b1;->n(I)Ljava/lang/CharSequence;

    move-result-object v0

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->s:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v15, v0, v14}, Landroidx/appcompat/widget/b1;->a(IZ)Z

    move-result v0

    iput-boolean v0, v7, Landroidx/appcompat/widget/SwitchCompat;->u:Z

    sget v0, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v15, v0, v12}, Landroidx/appcompat/widget/b1;->f(II)I

    move-result v0

    iput v0, v7, Landroidx/appcompat/widget/SwitchCompat;->o:I
    ...
    invoke-virtual {v15, v0, v12}, Landroidx/appcompat/widget/b1;->a(IZ)Z

    move-result v0

    iput-boolean v0, v7, Landroidx/appcompat/widget/SwitchCompat;->r:Z

    sget v0, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTint:I

    invoke-virtual {v15, v0}, Landroidx/appcompat/widget/b1;->c(I)Landroid/content/res/ColorStateList;

    move-result-object v0

    if-eqz v0, :cond_2

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->f:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v15, v0, v1}, Landroidx/appcompat/widget/b1;->j(II)I

    move-result v0

    invoke-static {v0, v11}, Landroidx/appcompat/widget/h0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v0

    iget-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->g:Landroid/graphics/PorterDuff$Mode;

    if-eq v2, v0, :cond_3

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->g:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v14, v7, Landroidx/appcompat/widget/SwitchCompat;->i:Z

    :cond_3
    iget-boolean v0, v7, Landroidx/appcompat/widget/SwitchCompat;->h:Z
    ...
    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->k:Landroid/content/res/ColorStateList;

    iput-boolean v14, v7, Landroidx/appcompat/widget/SwitchCompat;->m:Z
    ...
    iget-object v2, v7, Landroidx/appcompat/widget/SwitchCompat;->l:Landroid/graphics/PorterDuff$Mode;

    if-eq v2, v0, :cond_7

    iput-object v0, v7, Landroidx/appcompat/widget/SwitchCompat;->l:Landroid/graphics/PorterDuff$Mode;

    iput-boolean v14, v7, Landroidx/appcompat/widget/SwitchCompat;->n:Z

    :cond_7
    iget-boolean v0, v7, Landroidx/appcompat/widget/SwitchCompat;->m:Z
    ...
    invoke-virtual {v15, v0, v12}, Landroidx/appcompat/widget/b1;->l(II)I
    ...
    invoke-virtual {v8, v3}, Landroid/content/Context;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    iput-object v3, v7, Landroidx/appcompat/widget/SwitchCompat;->K:Landroid/content/res/ColorStateList;
    ...
    :goto_3
    invoke-virtual {v7, v2}, Landroidx/appcompat/widget/SwitchCompat;->setSwitchTypeface(Landroid/graphics/Typeface;)V
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/text/method/TransformationMethod;

    goto :goto_7

    :cond_15
    iput-object v11, v7, Landroidx/appcompat/widget/SwitchCompat;->N:Landroid/text/method/TransformationMethod;
    ...
    iput v1, v7, Landroidx/appcompat/widget/SwitchCompat;->w:I

    invoke-virtual {v0}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result v0

    iput v0, v7, Landroidx/appcompat/widget/SwitchCompat;->A:I
...
.method private getThumbScrollRange()I
    ...
    invoke-static {v0}, Landroidx/appcompat/widget/h0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public final d()V
    ...
    invoke-direct {v2, v3, v4, v5, v1}, Lh0/p;-><init>(ILjava/lang/Class;II)V

    invoke-virtual {v2, p0, v0}, Lh0/o$b;->e(Landroid/view/View;Ljava/lang/Object;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v6}, Landroidx/appcompat/widget/h0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v4}, Landroidx/appcompat/widget/h0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/h0;->b(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public setChecked(Z)V
    ...
    :goto_1
    sget-object p1, Landroidx/appcompat/widget/SwitchCompat;->Q:Landroid/util/Property;
