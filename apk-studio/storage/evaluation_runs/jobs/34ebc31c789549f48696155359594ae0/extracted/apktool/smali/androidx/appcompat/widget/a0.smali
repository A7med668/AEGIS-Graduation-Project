...
.method public constructor <init>(Landroid/widget/TextView;)V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/d0;

    return-void
.end method

.method public static c(Landroid/content/Context;Landroidx/appcompat/widget/i;I)Landroidx/appcompat/widget/z0;
    .locals 0
...
.method public final a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;)V
    ...
    invoke-static {p1, p2, v0}, Landroidx/appcompat/widget/i;->f(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;[I)V
...
.method public b()V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->b:Landroidx/appcompat/widget/z0;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->c:Landroidx/appcompat/widget/z0;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/a0;->d:Landroidx/appcompat/widget/z0;

    if-nez v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/widget/a0;->e:Landroidx/appcompat/widget/z0;
    ...
    iget-object v4, p0, Landroidx/appcompat/widget/a0;->b:Landroidx/appcompat/widget/z0;

    invoke-virtual {p0, v3, v4}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;)V

    const/4 v3, 0x1

    aget-object v3, v0, v3

    iget-object v4, p0, Landroidx/appcompat/widget/a0;->c:Landroidx/appcompat/widget/z0;

    invoke-virtual {p0, v3, v4}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;)V

    aget-object v3, v0, v1

    iget-object v4, p0, Landroidx/appcompat/widget/a0;->d:Landroidx/appcompat/widget/z0;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/a0;->e:Landroidx/appcompat/widget/z0;

    invoke-virtual {p0, v0, v3}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;)V

    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->f:Landroidx/appcompat/widget/z0;

    if-nez v0, :cond_2

    iget-object v0, p0, Landroidx/appcompat/widget/a0;->g:Landroidx/appcompat/widget/z0;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/a0;->f:Landroidx/appcompat/widget/z0;

    invoke-virtual {p0, v2, v3}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;)V

    aget-object v0, v0, v1

    iget-object v1, p0, Landroidx/appcompat/widget/a0;->g:Landroidx/appcompat/widget/z0;

    invoke-virtual {p0, v0, v1}, Landroidx/appcompat/widget/a0;->a(Landroid/graphics/drawable/Drawable;Landroidx/appcompat/widget/z0;)V
...
.method public d()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/d0;
...
.method public e(Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v13, v1, v14}, Landroidx/appcompat/widget/b1;->l(II)I

    move-result v1

    sget v2, Landroidx/appcompat/R$styleable;->AppCompatTextHelper_android_drawableLeft:I

    invoke-virtual {v13, v2}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v3

    if-eqz v3, :cond_0

    invoke-virtual {v13, v2, v12}, Landroidx/appcompat/widget/b1;->l(II)I

    move-result v2

    invoke-static {v10, v11, v2}, Landroidx/appcompat/widget/a0;->c(Landroid/content/Context;Landroidx/appcompat/widget/i;I)Landroidx/appcompat/widget/z0;

    move-result-object v2

    iput-object v2, v0, Landroidx/appcompat/widget/a0;->b:Landroidx/appcompat/widget/z0;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/a0;->c:Landroidx/appcompat/widget/z0;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/a0;->d:Landroidx/appcompat/widget/z0;
    ...
    iput-object v2, v0, Landroidx/appcompat/widget/a0;->e:Landroidx/appcompat/widget/z0;
    ...
    invoke-static {v10, v11, v3}, Landroidx/appcompat/widget/a0;->c(Landroid/content/Context;Landroidx/appcompat/widget/i;I)Landroidx/appcompat/widget/z0;

    move-result-object v3

    iput-object v3, v0, Landroidx/appcompat/widget/a0;->f:Landroidx/appcompat/widget/z0;
    ...
    iput-object v3, v0, Landroidx/appcompat/widget/a0;->g:Landroidx/appcompat/widget/z0;

    :cond_5
    iget-object v3, v13, Landroidx/appcompat/widget/b1;->b:Landroid/content/res/TypedArray;
    ...
    new-instance v5, Landroidx/appcompat/widget/b1;

    invoke-virtual {v10, v1, v4}, Landroid/content/Context;->obtainStyledAttributes(I[I)Landroid/content/res/TypedArray;

    move-result-object v1

    invoke-direct {v5, v10, v1}, Landroidx/appcompat/widget/b1;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    if-nez v3, :cond_6

    sget v4, Landroidx/appcompat/R$styleable;->TextAppearance_textAllCaps:I

    invoke-virtual {v5, v4}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v6

    if-eqz v6, :cond_6

    invoke-virtual {v5, v4, v12}, Landroidx/appcompat/widget/b1;->a(IZ)Z
    ...
    :goto_0
    invoke-virtual {v0, v10, v5}, Landroidx/appcompat/widget/a0;->m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V

    sget v7, Landroidx/appcompat/R$styleable;->TextAppearance_textLocale:I

    invoke-virtual {v5, v7}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v16

    if-eqz v16, :cond_7

    invoke-virtual {v5, v7}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v5, v15}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v17

    if-eqz v17, :cond_8

    invoke-virtual {v5, v15}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    new-instance v15, Landroidx/appcompat/widget/b1;
    ...
    invoke-direct {v15, v10, v1}, Landroidx/appcompat/widget/b1;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    if-nez v3, :cond_a

    sget v13, Landroidx/appcompat/R$styleable;->TextAppearance_textAllCaps:I

    invoke-virtual {v15, v13}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v18

    if-eqz v18, :cond_a

    invoke-virtual {v15, v13, v12}, Landroidx/appcompat/widget/b1;->a(IZ)Z
    ...
    invoke-virtual {v15, v13}, Landroidx/appcompat/widget/b1;->m(I)Ljava/lang/String;
    ...
    invoke-virtual {v15, v2}, Landroidx/appcompat/widget/b1;->o(I)Z

    move-result v13

    if-eqz v13, :cond_d

    invoke-virtual {v15, v2, v14}, Landroidx/appcompat/widget/b1;->f(II)I
    ...
    :cond_d
    invoke-virtual {v0, v10, v15}, Landroidx/appcompat/widget/a0;->m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V
    ...
    iget v3, v0, Landroidx/appcompat/widget/a0;->j:I
    ...
    :cond_12
    iget-object v13, v0, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/d0;

    iget-object v1, v13, Landroidx/appcompat/widget/d0;->j:Landroid/content/Context;
    ...
    iget-object v1, v13, Landroidx/appcompat/widget/d0;->i:Landroid/widget/TextView;
    ...
    iput v1, v13, Landroidx/appcompat/widget/d0;->a:I
    ...
    :cond_17
    invoke-virtual {v13, v7}, Landroidx/appcompat/widget/d0;->b([I)[I

    move-result-object v6

    iput-object v6, v13, Landroidx/appcompat/widget/d0;->f:[I

    invoke-virtual {v13}, Landroidx/appcompat/widget/d0;->h()Z
    ...
    invoke-virtual {v13}, Landroidx/appcompat/widget/d0;->i()Z
    ...
    iget v5, v13, Landroidx/appcompat/widget/d0;->a:I

    const/4 v7, 0x1

    if-ne v5, v7, :cond_1f

    iget-boolean v5, v13, Landroidx/appcompat/widget/d0;->g:Z

    if-nez v5, :cond_1d

    iget-object v5, v13, Landroidx/appcompat/widget/d0;->j:Landroid/content/Context;
    ...
    :cond_1c
    invoke-virtual {v13, v2, v4, v1}, Landroidx/appcompat/widget/d0;->j(FFF)V

    :cond_1d
    invoke-virtual {v13}, Landroidx/appcompat/widget/d0;->g()Z

    goto :goto_9

    :cond_1e
    iput v12, v13, Landroidx/appcompat/widget/d0;->a:I

    :cond_1f
    :goto_9
    sget-boolean v1, Lk0/b;->b:Z

    if-eqz v1, :cond_21

    iget-object v1, v0, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/d0;

    iget v2, v1, Landroidx/appcompat/widget/d0;->a:I
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/d0;
    ...
    iget-object v3, v0, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/d0;

    iget v3, v3, Landroidx/appcompat/widget/d0;->e:F

    invoke-static {v3}, Ljava/lang/Math;->round(F)I

    move-result v3

    iget-object v4, v0, Landroidx/appcompat/widget/a0;->i:Landroidx/appcompat/widget/d0;

    iget v4, v4, Landroidx/appcompat/widget/d0;->c:F
    ...
    invoke-virtual {v11, v10, v3}, Landroidx/appcompat/widget/i;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v11, v10, v4}, Landroidx/appcompat/widget/i;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v11, v10, v7}, Landroidx/appcompat/widget/i;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :cond_29
    iget-object v7, v0, Landroidx/appcompat/widget/a0;->a:Landroid/widget/TextView;
    ...
    :goto_17
    invoke-virtual {v2, v4, v3, v6, v5}, Landroid/widget/TextView;->setCompoundDrawablesRelativeWithIntrinsicBounds(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-static {v2, v3}, Landroidx/appcompat/widget/h0;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v1, v2}, Lk0/d;->b(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v3}, Lk0/d;->c(Landroid/widget/TextView;I)V
    ...
    invoke-static {v1, v4}, Lk0/d;->d(Landroid/widget/TextView;I)V
...
.method public f(Landroid/content/Context;I)V
    ...
    invoke-virtual {v1, v0, v2}, Landroidx/appcompat/widget/b1;->f(II)I
    ...
    :cond_1
    invoke-virtual {p0, p1, v1}, Landroidx/appcompat/widget/a0;->m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V
...
.method public g(Landroid/widget/TextView;Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;)V
    ...
    invoke-static {p3, p1, p2}, Lj0/a$a;->a(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;I)V
    ...
    invoke-static {p3, p1, v2, v0}, Lj0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V
    ...
    invoke-static {p1, v2, p2}, Lj0/a;->a(Ljava/lang/CharSequence;II)Z
    ...
    invoke-static {p1, v7, v6}, Lj0/a;->a(Ljava/lang/CharSequence;II)Z
    ...
    invoke-static {p3, p1, v5, v3}, Lj0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V

    goto :goto_7

    :cond_d
    :goto_6
    invoke-static {p3, v3, p2, p2}, Lj0/a;->b(Landroid/view/inputmethod/EditorInfo;Ljava/lang/CharSequence;II)V
...
.method public k(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/a0;->h:Landroidx/appcompat/widget/z0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/a0;->h:Landroidx/appcompat/widget/z0;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/a0;->b:Landroidx/appcompat/widget/z0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->c:Landroidx/appcompat/widget/z0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->d:Landroidx/appcompat/widget/z0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->e:Landroidx/appcompat/widget/z0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->f:Landroidx/appcompat/widget/z0;

    iput-object v0, p0, Landroidx/appcompat/widget/a0;->g:Landroidx/appcompat/widget/z0;
...
.method public final m(Landroid/content/Context;Landroidx/appcompat/widget/b1;)V
    ...
    invoke-virtual {p2, v0, v1}, Landroidx/appcompat/widget/b1;->j(II)I
    ...
    invoke-virtual {p2, v5, v3}, Landroidx/appcompat/widget/b1;->j(II)I
    ...
    invoke-virtual {p2, v6}, Landroidx/appcompat/widget/b1;->o(I)Z
    ...
    invoke-virtual {p2, p1}, Landroidx/appcompat/widget/b1;->o(I)Z
    ...
    invoke-virtual {p2, p1, v7}, Landroidx/appcompat/widget/b1;->j(II)I
    ...
    invoke-virtual {p2, v5, p1, v9}, Landroidx/appcompat/widget/b1;->i(IILy/b$a;)Landroid/graphics/Typeface;
