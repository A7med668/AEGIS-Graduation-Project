...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, p2, v3, v6}, Ll3/a;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Landroid/content/Context;

    move-result-object p1

    invoke-direct {p0, p1, p2, v3}, Landroidx/appcompat/widget/c;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    new-instance p1, Landroid/graphics/Rect;

    invoke-direct {p1}, Landroid/graphics/Rect;-><init>()V

    iput-object p1, p0, Lk3/n;->j:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Lk3/n;->i:Landroid/view/accessibility/AccessibilityManager;

    new-instance v0, Landroidx/appcompat/widget/n0;

    sget v1, Landroidx/appcompat/R$attr;->listPopupWindowStyle:I

    invoke-direct {v0, p1, v2, v1, v6}, Landroidx/appcompat/widget/n0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    iput-object v0, p0, Lk3/n;->h:Landroidx/appcompat/widget/n0;

    const/4 p1, 0x1

    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/n0;->s(Z)V

    iput-object p0, v0, Landroidx/appcompat/widget/n0;->s:Landroid/view/View;

    const/4 p1, 0x2

    iget-object v1, v0, Landroidx/appcompat/widget/n0;->C:Landroid/widget/PopupWindow;
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/widget/n0;->o(Landroid/widget/ListAdapter;)V

    new-instance p1, Lk3/m;

    invoke-direct {p1, p0}, Lk3/m;-><init>(Lk3/n;)V

    iput-object p1, v0, Landroidx/appcompat/widget/n0;->t:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public static a(Lk3/n;Ljava/lang/Object;)V
    .locals 1
...
.method public getHint()Ljava/lang/CharSequence;
    ...
    invoke-virtual {p0}, Lk3/n;->b()Lcom/google/android/material/textfield/TextInputLayout;
...
.method public onMeasure(II)V
    ...
    iget-object v5, p0, Lk3/n;->h:Landroidx/appcompat/widget/n0;

    invoke-virtual {v5}, Landroidx/appcompat/widget/n0;->b()Z
    ...
    :cond_1
    iget-object v5, v5, Landroidx/appcompat/widget/n0;->g:Landroidx/appcompat/widget/i0;
    ...
    :cond_4
    iget-object v0, p0, Lk3/n;->h:Landroidx/appcompat/widget/n0;
    ...
    iget-object v2, p0, Lk3/n;->j:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    iget-object v0, p0, Lk3/n;->j:Landroid/graphics/Rect;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    iget-object p1, p0, Lk3/n;->h:Landroidx/appcompat/widget/n0;
...
.method public showDropDown()V
    ...
    iget-object v0, p0, Lk3/n;->i:Landroid/view/accessibility/AccessibilityManager;
