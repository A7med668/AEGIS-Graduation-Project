...
.field public static i:Landroidx/appcompat/widget/q0;

.field public static final j:Landroidx/appcompat/widget/q0$a;
...
.field public g:Landroidx/appcompat/widget/q0$c;
...
.method public static declared-synchronized c()Landroidx/appcompat/widget/q0;
    .locals 2
...
.method public static declared-synchronized g(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
    ...
    invoke-virtual {v1, v3}, Lp/f;->a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v1, p0, v3}, Lp/f;->b(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public final declared-synchronized a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-virtual {v0, p2, p3, p1}, Lp/e;->i(JLjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v3, v4}, Landroidx/appcompat/widget/q0;->d(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/appcompat/widget/q0;->g:Landroidx/appcompat/widget/q0$c;
    ...
    invoke-virtual {p0, p1, v6}, Landroidx/appcompat/widget/q0;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, v1}, Landroidx/appcompat/widget/q0;->e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    invoke-virtual {v1, p0, p1, p2}, Landroidx/appcompat/widget/i$a;->c(Landroidx/appcompat/widget/q0;Landroid/content/Context;I)Landroid/graphics/drawable/LayerDrawable;
    ...
    invoke-virtual {p0, p1, v3, v4, v5}, Landroidx/appcompat/widget/q0;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
...
.method public final declared-synchronized d(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    :try_start_1
    invoke-virtual {v0, p2, p3, v1}, Lp/e;->f(JLjava/lang/Object;)Ljava/lang/Object;
    ...
    :cond_1
    :try_start_2
    invoke-virtual {v0, p2, p3}, Lp/e;->j(J)V
    :try_end_2
...
.method public declared-synchronized e(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0, p1, p2, v0}, Landroidx/appcompat/widget/q0;->f(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
...
.method public declared-synchronized f(Landroid/content/Context;IZ)Landroid/graphics/drawable/Drawable;
    ...
    :goto_1
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/q0;->i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    if-nez v0, :cond_3

    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/q0;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2, p3, v0}, Landroidx/appcompat/widget/q0;->j(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    sget-object p1, Landroidx/appcompat/widget/h0;->a:[I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    :cond_7
    :try_start_1
    iput-boolean v2, p0, Landroidx/appcompat/widget/q0;->f:Z
...
.method public declared-synchronized h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v0, p2, v1}, Lp/i;->e(ILjava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/q0;->a:Ljava/util/WeakHashMap;

    invoke-virtual {v2, p1, v0}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_3
    invoke-virtual {v0, p2, v1}, Lp/i;->a(ILjava/lang/Object;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final i(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/q0;->b:Lp/h;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/q0;->c:Lp/i;
    ...
    iget-object v3, p0, Landroidx/appcompat/widget/q0;->b:Lp/h;

    invoke-virtual {v3, v0, v1}, Lp/h;->getOrDefault(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/q0;->c:Lp/i;
    ...
    invoke-virtual {p0, p1, v4, v5}, Landroidx/appcompat/widget/q0;->d(Landroid/content/Context;J)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v8, p0, Landroidx/appcompat/widget/q0;->c:Lp/i;

    invoke-virtual {v8, p2, v3}, Lp/i;->a(ILjava/lang/Object;)V

    iget-object v8, p0, Landroidx/appcompat/widget/q0;->b:Lp/h;
    ...
    invoke-virtual {p0, p1, v4, v5, v6}, Landroidx/appcompat/widget/q0;->a(Landroid/content/Context;JLandroid/graphics/drawable/Drawable;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/q0;->c:Lp/i;

    invoke-virtual {p1, p2, v2}, Lp/i;->a(ILjava/lang/Object;)V
...
.method public final j(Landroid/content/Context;IZLandroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/appcompat/widget/q0;->h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/q0;->g:Landroidx/appcompat/widget/q0$c;
    ...
    invoke-virtual {v0, v6, v8, v9}, Landroidx/appcompat/widget/i$a;->e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, v5, v6, v9}, Landroidx/appcompat/widget/i$a;->e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1, v4}, Landroidx/appcompat/widget/w0;->c(Landroid/content/Context;I)I

    move-result v4

    invoke-virtual {v0, v2, v4, v9}, Landroidx/appcompat/widget/i$a;->e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    sget-object v8, Landroidx/appcompat/widget/i;->b:Landroid/graphics/PorterDuff$Mode;

    invoke-virtual {v0, v6, v7, v8}, Landroidx/appcompat/widget/i$a;->e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, v5, v7, v8}, Landroidx/appcompat/widget/i$a;->e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-virtual {v0, v2, v4, v8}, Landroidx/appcompat/widget/i$a;->e(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    :cond_7
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/widget/q0;->k(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
...
.method public k(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    sget-object v3, Landroidx/appcompat/widget/i;->b:Landroid/graphics/PorterDuff$Mode;

    iget-object v4, v0, Landroidx/appcompat/widget/i$a;->a:[I

    invoke-virtual {v0, v4, p2}, Landroidx/appcompat/widget/i$a;->a([II)Z
    ...
    :cond_0
    iget-object v4, v0, Landroidx/appcompat/widget/i$a;->c:[I
    ...
    :cond_1
    iget-object v4, v0, Landroidx/appcompat/widget/i$a;->d:[I
    ...
    invoke-static {p3}, Landroidx/appcompat/widget/h0;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, v3}, Landroidx/appcompat/widget/i;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
