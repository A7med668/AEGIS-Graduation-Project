...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/recyclerview/widget/k;->i:Ljava/lang/ThreadLocal;

    new-instance v0, Landroidx/recyclerview/widget/k$a;

    invoke-direct {v0}, Landroidx/recyclerview/widget/k$a;-><init>()V

    sput-object v0, Landroidx/recyclerview/widget/k;->j:Ljava/util/Comparator;
...
.method public a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-wide v0, p0, Landroidx/recyclerview/widget/k;->f:J
    ...
    iput-wide v0, p0, Landroidx/recyclerview/widget/k;->f:J

    invoke-virtual {p1, p0}, Landroid/view/ViewGroup;->post(Ljava/lang/Runnable;)Z

    :cond_0
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->k0:Landroidx/recyclerview/widget/k$b;
...
.method public b(J)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/k;->e:Ljava/util/ArrayList;
    ...
    iget-object v4, p0, Landroidx/recyclerview/widget/k;->e:Ljava/util/ArrayList;
    ...
    iget-object v5, v4, Landroidx/recyclerview/widget/RecyclerView;->k0:Landroidx/recyclerview/widget/k$b;
    ...
    iget-object v5, p0, Landroidx/recyclerview/widget/k;->e:Ljava/util/ArrayList;
    ...
    :cond_2
    iget-object v6, v5, Landroidx/recyclerview/widget/RecyclerView;->k0:Landroidx/recyclerview/widget/k$b;
    ...
    iget-object v9, p0, Landroidx/recyclerview/widget/k;->h:Ljava/util/ArrayList;
    ...
    iget-object v10, p0, Landroidx/recyclerview/widget/k;->h:Ljava/util/ArrayList;
    ...
    sget-object v2, Landroidx/recyclerview/widget/k;->j:Ljava/util/Comparator;
    ...
    invoke-virtual {p0, v3, v7, v5, v6}, Landroidx/recyclerview/widget/k;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$b0;

    move-result-object v3

    if-eqz v3, :cond_c

    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView$b0;->b:Ljava/lang/ref/WeakReference;

    if-eqz v5, :cond_c

    invoke-virtual {v3}, Landroidx/recyclerview/widget/RecyclerView$b0;->k()Z
    ...
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView$b0;->b:Ljava/lang/ref/WeakReference;
    ...
    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->i:Landroidx/recyclerview/widget/c;
    ...
    :cond_a
    iget-object v5, v3, Landroidx/recyclerview/widget/RecyclerView;->k0:Landroidx/recyclerview/widget/k$b;
    ...
    iget-object v6, v3, Landroidx/recyclerview/widget/RecyclerView;->l0:Landroidx/recyclerview/widget/RecyclerView$y;
    ...
    invoke-virtual {p0, v3, v7, p1, p2}, Landroidx/recyclerview/widget/k;->c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$b0;
    :try_end_0
...
.method public final c(Landroidx/recyclerview/widget/RecyclerView;IJ)Landroidx/recyclerview/widget/RecyclerView$b0;
    ...
    iget-object v3, p1, Landroidx/recyclerview/widget/RecyclerView;->i:Landroidx/recyclerview/widget/c;
    ...
    invoke-virtual {v0, p2, v1, p3, p4}, Landroidx/recyclerview/widget/RecyclerView$t;->j(IZJ)Landroidx/recyclerview/widget/RecyclerView$b0;

    move-result-object p2

    if-eqz p2, :cond_4

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$b0;->k()Z

    move-result p3

    if-eqz p3, :cond_3

    invoke-virtual {p2}, Landroidx/recyclerview/widget/RecyclerView$b0;->l()Z
...
.method public run()V
    ...
    iget-object v2, p0, Landroidx/recyclerview/widget/k;->e:Ljava/util/ArrayList;
    ...
    iget-object v6, p0, Landroidx/recyclerview/widget/k;->e:Ljava/util/ArrayList;
    ...
    iget-wide v4, p0, Landroidx/recyclerview/widget/k;->g:J
