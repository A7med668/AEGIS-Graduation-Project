...
# direct methods
.method public synthetic constructor <init>(Ld0/j;Ljava/util/ArrayList;I)V
    .locals 0

    iput p3, p0, Ld0/d;->a:I

    iput-object p1, p0, Ld0/d;->c:Ld0/j;
...
.method public final run()V
    ...
    iget-object v0, p0, Ld0/d;->b:Ljava/util/ArrayList;
    ...
    :goto_0
    iget-object v3, p0, Ld0/d;->c:Ld0/j;
    ...
    iget-object v5, v4, Ld0/Z;->a:Landroid/view/View;

    invoke-virtual {v5}, Landroid/view/View;->animate()Landroid/view/ViewPropertyAnimator;

    move-result-object v6

    iget-object v7, v3, Ld0/j;->o:Ljava/util/ArrayList;
    ...
    invoke-direct {v8, v3, v4, v5, v6}, Ld0/e;-><init>(Ld0/j;Ld0/Z;Landroid/view/View;Landroid/view/ViewPropertyAnimator;)V
    ...
    iget-object v1, v3, Ld0/j;->l:Ljava/util/ArrayList;
    ...
    :cond_1
    :goto_1
    iget-object v4, p0, Ld0/d;->c:Ld0/j;
    ...
    iget-object v9, v4, Ld0/j;->r:Ljava/util/ArrayList;

    iget-wide v10, v4, Ld0/F;->f:J

    iget-object v3, v5, Ld0/h;->a:Ld0/Z;
    ...
    :goto_2
    iget-object v3, v5, Ld0/h;->b:Ld0/Z;

    if-eqz v3, :cond_3

    iget-object v6, v3, Ld0/Z;->a:Landroid/view/View;
    ...
    iget v3, v5, Ld0/h;->e:I

    iget v8, v5, Ld0/h;->c:I
    ...
    iget v3, v5, Ld0/h;->f:I

    iget v8, v5, Ld0/h;->d:I
    ...
    invoke-direct/range {v3 .. v8}, Ld0/g;-><init>(Ld0/j;Ld0/h;Landroid/view/ViewPropertyAnimator;Landroid/view/View;I)V
    ...
    iget-object v1, v4, Ld0/j;->n:Ljava/util/ArrayList;
    ...
    iget-object v5, v3, Ld0/i;->a:Ld0/Z;

    iget v6, v3, Ld0/i;->b:I

    iget v7, v3, Ld0/i;->c:I

    iget v8, v3, Ld0/i;->d:I

    iget v3, v3, Ld0/i;->e:I
    ...
    iget-object v3, v4, Ld0/j;->p:Ljava/util/ArrayList;

    invoke-virtual {v3, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    iget-wide v10, v4, Ld0/F;->e:J
    ...
    invoke-direct/range {v3 .. v9}, Ld0/f;-><init>(Ld0/j;Ld0/Z;ILandroid/view/View;ILandroid/view/ViewPropertyAnimator;)V
    ...
    iget-object v1, v4, Ld0/j;->m:Ljava/util/ArrayList;
