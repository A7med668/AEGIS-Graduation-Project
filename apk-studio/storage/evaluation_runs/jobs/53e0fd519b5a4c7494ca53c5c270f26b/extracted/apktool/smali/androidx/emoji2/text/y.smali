...
.method public constructor <init>(Landroidx/emoji2/text/x;)V
    ...
    iput-short v0, p0, Landroidx/emoji2/text/y;->c:S

    const/high16 v0, 0x3f800000    # 1.0f

    iput v0, p0, Landroidx/emoji2/text/y;->d:F

    const-string v0, "rasterizer cannot be null"

    invoke-static {p1, v0}, LA/e;->j(Ljava/lang/Object;Ljava/lang/String;)V

    iput-object p1, p0, Landroidx/emoji2/text/y;->b:Landroidx/emoji2/text/x;
...
.method public final draw(Landroid/graphics/Canvas;Ljava/lang/CharSequence;IIFIIILandroid/graphics/Paint;)V
    ...
    :cond_0
    iget-object v3, v0, Landroidx/emoji2/text/y;->e:Landroid/text/TextPaint;
    ...
    iput-object v3, v0, Landroidx/emoji2/text/y;->e:Landroid/text/TextPaint;
    ...
    iget-short v1, v0, Landroidx/emoji2/text/y;->c:S
    ...
    :goto_4
    iget-object v2, v0, Landroidx/emoji2/text/y;->b:Landroidx/emoji2/text/x;

    iget-object v3, v2, Landroidx/emoji2/text/x;->b:Landroidx/emoji2/text/u;
    ...
    iget v2, v2, Landroidx/emoji2/text/x;->a:I

    mul-int/lit8 v13, v2, 0x2

    iget-object v2, v3, Landroidx/emoji2/text/u;->b:Ljava/lang/Object;
...
.method public final getSize(Landroid/graphics/Paint;Ljava/lang/CharSequence;IILandroid/graphics/Paint$FontMetricsInt;)I
    ...
    iget-object p3, p0, Landroidx/emoji2/text/y;->b:Landroidx/emoji2/text/x;

    invoke-virtual {p3}, Landroidx/emoji2/text/x;->b()LT/a;

    move-result-object p4

    const/16 v0, 0xe

    invoke-virtual {p4, v0}, LK/C;->a(I)I
    ...
    iget-object v3, p4, LK/C;->d:Ljava/lang/Object;
    ...
    iput p1, p0, Landroidx/emoji2/text/y;->d:F

    invoke-virtual {p3}, Landroidx/emoji2/text/x;->b()LT/a;

    move-result-object p1

    invoke-virtual {p1, v0}, LK/C;->a(I)I

    move-result p4

    if-eqz p4, :cond_1

    iget-object v0, p1, LK/C;->d:Ljava/lang/Object;
    ...
    invoke-virtual {p1, p3}, LK/C;->a(I)I

    move-result p3

    if-eqz p3, :cond_2

    iget-object p4, p1, LK/C;->d:Ljava/lang/Object;
    ...
    iget p3, p0, Landroidx/emoji2/text/y;->d:F
    ...
    iput-short p1, p0, Landroidx/emoji2/text/y;->c:S
