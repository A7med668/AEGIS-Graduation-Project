...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lv/j;->p0:Landroid/util/SparseIntArray;
...
.method public final a(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v3, Lv/j;->p0:Landroid/util/SparseIntArray;
    ...
    :pswitch_1
    iget-boolean v3, p0, Lv/j;->g:Z

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Lv/j;->g:Z
    ...
    iput-object v2, p0, Lv/j;->k0:Ljava/lang/String;

    goto/16 :goto_1

    :pswitch_3
    iget-boolean v3, p0, Lv/j;->m0:Z
    ...
    :pswitch_5
    iget v3, p0, Lv/j;->b0:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Lv/j;->b0:I

    goto/16 :goto_1

    :pswitch_6
    iget v3, p0, Lv/j;->c0:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Lv/j;->c0:I
    ...
    :pswitch_8
    iget v3, p0, Lv/j;->a0:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Lv/j;->a0:I
    ...
    invoke-static {p1, v2, v3}, Lv/n;->f(Landroid/content/res/TypedArray;II)I
    ...
    :pswitch_f
    iget v3, p0, Lv/j;->o0:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    iput v2, p0, Lv/j;->o0:I

    goto/16 :goto_1

    :pswitch_10
    iget-boolean v3, p0, Lv/j;->n0:Z

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getBoolean(IZ)Z

    move-result v2

    iput-boolean v2, p0, Lv/j;->n0:Z
    ...
    iput-object v2, p0, Lv/j;->j0:Ljava/lang/String;

    goto/16 :goto_1

    :pswitch_12
    iget v3, p0, Lv/j;->g0:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v2

    iput v2, p0, Lv/j;->g0:I

    goto/16 :goto_1

    :pswitch_13
    iget v3, p0, Lv/j;->f0:I

    invoke-virtual {p1, v2, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v2

    iput v2, p0, Lv/j;->f0:I
    ...
    invoke-static {p0, p1, v2, v3}, Lv/n;->g(Ljava/lang/Object;Landroid/content/res/TypedArray;II)V

    goto/16 :goto_1

    :pswitch_1a
    invoke-static {p0, p1, v2, v0}, Lv/n;->g(Ljava/lang/Object;Landroid/content/res/TypedArray;II)V
    ...
    iput-object v2, p0, Lv/j;->y:Ljava/lang/String;
