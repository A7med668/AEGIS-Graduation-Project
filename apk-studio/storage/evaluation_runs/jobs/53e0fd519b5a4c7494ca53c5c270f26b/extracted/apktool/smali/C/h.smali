...
# direct methods
.method public static H0(Ljava/lang/Object;Ljava/lang/String;IZ)Z
    .locals 3

    invoke-static {}, LC/h;->I0()V

    :try_start_0
    sget-object v0, LC/h;->r:Ljava/lang/reflect/Method;
...
.method public static I0()V
    ...
    :goto_0
    sput-object v1, LC/h;->q:Ljava/lang/reflect/Constructor;

    sput-object v2, LC/h;->p:Ljava/lang/Class;

    sput-object v4, LC/h;->r:Ljava/lang/reflect/Method;

    sput-object v0, LC/h;->s:Ljava/lang/reflect/Method;
...
# virtual methods
.method public t(Landroid/content/Context;LB/g;Landroid/content/res/Resources;I)Landroid/graphics/Typeface;
    .locals 8

    invoke-static {}, LC/h;->I0()V

    :try_start_0
    sget-object p4, LC/h;->q:Ljava/lang/reflect/Constructor;
    ...
    invoke-static {p1}, LA/e;->W(Landroid/content/Context;)Ljava/io/File;
    ...
    invoke-static {v5, p3, v6}, LA/e;->q(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    invoke-static {p4, v6, v7, v4}, LC/h;->H0(Ljava/lang/Object;Ljava/lang/String;IZ)Z
    ...
    :try_start_3
    sget-object p1, LC/h;->p:Ljava/lang/Class;
    ...
    sget-object p3, LC/h;->s:Ljava/lang/reflect/Method;
...
.method public u(Landroid/content/Context;[LH/l;I)Landroid/graphics/Typeface;
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0, p3, p2}, LA/e;->C(I[LH/l;)LH/l;
    ...
    :try_start_6
    invoke-virtual {p0, p1, p3}, LA/e;->v(Landroid/content/Context;Ljava/io/InputStream;)Landroid/graphics/Typeface;
