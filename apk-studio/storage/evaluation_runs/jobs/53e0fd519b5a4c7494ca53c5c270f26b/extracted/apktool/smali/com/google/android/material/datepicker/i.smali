...
.method public final b(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-object p1, p0, Lcom/google/android/material/datepicker/i;->a:Lcom/google/android/material/datepicker/r;

    iget-object p1, p1, Lcom/google/android/material/datepicker/r;->c:Lcom/google/android/material/datepicker/b;

    iget-object p3, p0, Lcom/google/android/material/datepicker/i;->c:Lcom/google/android/material/datepicker/j;

    if-gez p2, :cond_1

    iget-object p2, p3, Lcom/google/android/material/datepicker/j;->c0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_0
    invoke-static {p2}, Ld0/J;->H(Landroid/view/View;)I
    ...
    :goto_0
    iget-object v0, p1, Lcom/google/android/material/datepicker/b;->a:Lcom/google/android/material/datepicker/n;
    ...
    iput-object v2, p3, Lcom/google/android/material/datepicker/j;->Y:Lcom/google/android/material/datepicker/n;

    iget-object p1, p1, Lcom/google/android/material/datepicker/b;->a:Lcom/google/android/material/datepicker/n;
    ...
    invoke-static {v0, p3}, LG/h;->c(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;

    move-result-object p3

    invoke-static {}, LG/h;->e()Landroid/icu/util/TimeZone;

    move-result-object v0

    invoke-static {p3, v0}, LG/h;->q(Landroid/icu/text/DateFormat;Landroid/icu/util/TimeZone;)V

    invoke-static {}, LG/h;->d()Landroid/icu/text/DisplayContext;

    invoke-static {p3}, LG/h;->p(Landroid/icu/text/DateFormat;)V

    new-instance v0, Ljava/util/Date;

    invoke-direct {v0, p1, p2}, Ljava/util/Date;-><init>(J)V

    invoke-static {p3, v0}, LG/h;->k(Landroid/icu/text/DateFormat;Ljava/util/Date;)Ljava/lang/String;
