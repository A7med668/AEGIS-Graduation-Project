...
.method public constructor <init>(Landroidx/lifecycle/j;)V
    ...
    sget-object p1, Landroidx/lifecycle/e$b;->g:Landroidx/lifecycle/e$b;

    iput-object p1, p0, Landroidx/lifecycle/k;->b:Landroidx/lifecycle/e$b;
...
.method private d(Landroidx/lifecycle/j;)V
    ...
    invoke-virtual {v0}, La/b/a/b/b;->d()Ljava/util/Iterator;
    ...
    :goto_0
    iget-object v3, v2, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;

    iget-object v4, p0, Landroidx/lifecycle/k;->b:Landroidx/lifecycle/e$b;
    ...
    invoke-static {v3}, Landroidx/lifecycle/k;->f(Landroidx/lifecycle/e$b;)Landroidx/lifecycle/e$a;

    move-result-object v3

    invoke-static {v3}, Landroidx/lifecycle/k;->h(Landroidx/lifecycle/e$a;)Landroidx/lifecycle/e$b;

    move-result-object v4

    invoke-direct {p0, v4}, Landroidx/lifecycle/k;->o(Landroidx/lifecycle/e$b;)V

    invoke-virtual {v2, p1, v3}, Landroidx/lifecycle/k$b;->a(Landroidx/lifecycle/j;Landroidx/lifecycle/e$a;)V
...
.method private e(Landroidx/lifecycle/i;)Landroidx/lifecycle/e$b;
    .locals 2

    iget-object v0, p0, Landroidx/lifecycle/k;->a:La/b/a/b/a;

    invoke-virtual {v0, p1}, La/b/a/b/a;->u(Ljava/lang/Object;)Ljava/util/Map$Entry;
    ...
    iget-object p1, p1, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;
    ...
    :cond_1
    iget-object v1, p0, Landroidx/lifecycle/k;->b:Landroidx/lifecycle/e$b;

    invoke-static {v1, p1}, Landroidx/lifecycle/k;->l(Landroidx/lifecycle/e$b;Landroidx/lifecycle/e$b;)Landroidx/lifecycle/e$b;

    move-result-object p1

    invoke-static {p1, v0}, Landroidx/lifecycle/k;->l(Landroidx/lifecycle/e$b;Landroidx/lifecycle/e$b;)Landroidx/lifecycle/e$b;
...
.method private g(Landroidx/lifecycle/j;)V
    ...
    invoke-virtual {v0}, La/b/a/b/b;->g()La/b/a/b/b$d;
    ...
    invoke-direct {p0, v3}, Landroidx/lifecycle/k;->o(Landroidx/lifecycle/e$b;)V

    iget-object v3, v2, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;

    invoke-static {v3}, Landroidx/lifecycle/k;->r(Landroidx/lifecycle/e$b;)Landroidx/lifecycle/e$a;
...
.method private j()Z
    ...
    invoke-virtual {v0}, La/b/a/b/b;->e()Ljava/util/Map$Entry;
    ...
    iget-object v0, v0, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;

    iget-object v2, p0, Landroidx/lifecycle/k;->a:La/b/a/b/a;

    invoke-virtual {v2}, La/b/a/b/b;->i()Ljava/util/Map$Entry;
    ...
    iget-object v2, v2, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;

    if-ne v0, v2, :cond_1

    iget-object v0, p0, Landroidx/lifecycle/k;->b:Landroidx/lifecycle/e$b;
...
.method private q()V
    ...
    invoke-virtual {v1}, La/b/a/b/b;->i()Ljava/util/Map$Entry;
    ...
    iget-object v2, p0, Landroidx/lifecycle/k;->b:Landroidx/lifecycle/e$b;
    ...
    iget-object v1, v1, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;
...
.method public a(Landroidx/lifecycle/i;)V
    ...
    invoke-virtual {v1, p1, v0}, La/b/a/b/a;->m(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    :goto_3
    iget-object v5, v0, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;
    ...
    iget-object v4, v0, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;

    invoke-direct {p0, v4}, Landroidx/lifecycle/k;->o(Landroidx/lifecycle/e$b;)V

    iget-object v4, v0, Landroidx/lifecycle/k$b;->a:Landroidx/lifecycle/e$b;

    invoke-static {v4}, Landroidx/lifecycle/k;->r(Landroidx/lifecycle/e$b;)Landroidx/lifecycle/e$a;

    move-result-object v4

    invoke-virtual {v0, v1, v4}, Landroidx/lifecycle/k$b;->a(Landroidx/lifecycle/j;Landroidx/lifecycle/e$a;)V
...
.method public c(Landroidx/lifecycle/i;)V
    ...
    invoke-virtual {v0, p1}, La/b/a/b/a;->s(Ljava/lang/Object;)Ljava/lang/Object;
...
.method public i(Landroidx/lifecycle/e$a;)V
    ...
    invoke-static {p1}, Landroidx/lifecycle/k;->h(Landroidx/lifecycle/e$a;)Landroidx/lifecycle/e$b;

    move-result-object p1

    invoke-direct {p0, p1}, Landroidx/lifecycle/k;->m(Landroidx/lifecycle/e$b;)V
...
.method public k(Landroidx/lifecycle/e$b;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/lifecycle/k;->p(Landroidx/lifecycle/e$b;)V
