...
.field private final b:Lio/flutter/embedding/engine/i/b;
...
.field private final u:Lio/flutter/embedding/engine/i/b$b;
...
.method public constructor <init>(Landroid/view/View;Lio/flutter/embedding/engine/i/b;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/plugin/platform/i;)V
    .locals 7
    ...
    invoke-direct/range {v0 .. v6}, Lio/flutter/view/c;-><init>(Landroid/view/View;Lio/flutter/embedding/engine/i/b;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/view/AccessibilityViewEmbedder;Lio/flutter/plugin/platform/i;)V

    return-void
.end method

.method public constructor <init>(Landroid/view/View;Lio/flutter/embedding/engine/i/b;Landroid/view/accessibility/AccessibilityManager;Landroid/content/ContentResolver;Lio/flutter/view/AccessibilityViewEmbedder;Lio/flutter/plugin/platform/i;)V
    .locals 3
    ...
    iput-object v1, p0, Lio/flutter/view/c;->u:Lio/flutter/embedding/engine/i/b$b;
    ...
    iput-object p2, p0, Lio/flutter/view/c;->b:Lio/flutter/embedding/engine/i/b;
...
.method private C()V
    ...
    invoke-direct {p0, v0, v1}, Lio/flutter/view/c;->F(II)V
...
.method private D(Lio/flutter/view/c$j;ILandroid/os/Bundle;Z)Z
    .locals 3
    ...
    sget-object v0, Lio/flutter/view/c$f;->z:Lio/flutter/view/c$f;

    invoke-static {p1, v0}, Lio/flutter/view/c$j;->k(Lio/flutter/view/c$j;Lio/flutter/view/c$f;)Z

    move-result v0

    if-eqz v0, :cond_1

    iget-object p1, p0, Lio/flutter/view/c;->b:Lio/flutter/embedding/engine/i/b;

    sget-object p4, Lio/flutter/view/c$f;->z:Lio/flutter/view/c$f;
    ...
    invoke-virtual {p1, p2, p4, p3}, Lio/flutter/embedding/engine/i/b;->c(ILio/flutter/view/c$f;Ljava/lang/Object;)V
    ...
    sget-object p4, Lio/flutter/view/c$f;->A:Lio/flutter/view/c$f;

    invoke-static {p1, p4}, Lio/flutter/view/c$j;->k(Lio/flutter/view/c$j;Lio/flutter/view/c$f;)Z
    ...
    sget-object p4, Lio/flutter/view/c$f;->p:Lio/flutter/view/c$f;
    ...
    sget-object p4, Lio/flutter/view/c$f;->q:Lio/flutter/view/c$f;
...
.method private F(II)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/view/c;->G(Landroid/view/accessibility/AccessibilityEvent;)V

    return-void
.end method

.method private G(Landroid/view/accessibility/AccessibilityEvent;)V
    .locals 2
...
.method private H()V
    ...
    iget-object v0, p0, Lio/flutter/view/c;->b:Lio/flutter/embedding/engine/i/b;

    iget v1, p0, Lio/flutter/view/c;->l:I

    invoke-virtual {v0, v1}, Lio/flutter/embedding/engine/i/b;->f(I)V

    return-void
.end method

.method private I(Lio/flutter/view/c$j;)V
    .locals 2
    ...
    invoke-static {p1}, Lio/flutter/view/c$j;->S(Lio/flutter/view/c$j;)Ljava/lang/String;
    ...
    invoke-direct {p0, v0}, Lio/flutter/view/c;->G(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method private L(Lio/flutter/view/c$j;)Z
    .locals 2
    ...
    invoke-static {v0, v1}, Lio/flutter/view/c$j;->d(Lio/flutter/view/c$j;Lc/a/d/b;)Z
    ...
    invoke-static {p1, v0}, Lio/flutter/view/c$j;->d(Lio/flutter/view/c$j;Lc/a/d/b;)Z
...
.method private O(Lio/flutter/view/c$j;)V
    .locals 5

    const/4 v0, 0x0

    invoke-static {p1, v0}, Lio/flutter/view/c$j;->q(Lio/flutter/view/c$j;Lio/flutter/view/c$j;)Lio/flutter/view/c$j;
    ...
    invoke-direct {p0, v1, v2}, Lio/flutter/view/c;->F(II)V
...
.method static synthetic f(Lio/flutter/view/c;)V
    ...
    invoke-direct {p0}, Lio/flutter/view/c;->C()V
...
.method static synthetic g(Lio/flutter/view/c;II)V
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/view/c;->F(II)V
...
.method static synthetic k(Lio/flutter/view/c;)Lio/flutter/embedding/engine/i/b$b;
    .locals 0

    iget-object p0, p0, Lio/flutter/view/c;->u:Lio/flutter/embedding/engine/i/b$b;
...
.method static synthetic l(Lio/flutter/view/c;I)Lio/flutter/view/c$j;
    ...
    invoke-direct {p0, p1}, Lio/flutter/view/c;->t(I)Lio/flutter/view/c$j;
...
.method static synthetic m(Lio/flutter/view/c;I)Lio/flutter/view/c$g;
    ...
    invoke-direct {p0, p1}, Lio/flutter/view/c;->s(I)Lio/flutter/view/c$g;
...
.method static synthetic n(Lio/flutter/view/c;)Lio/flutter/embedding/engine/i/b;
    .locals 0

    iget-object p0, p0, Lio/flutter/view/c;->b:Lio/flutter/embedding/engine/i/b;
...
.method private s(I)Lio/flutter/view/c$g;
    .locals 2
...
.method private t(I)Lio/flutter/view/c$j;
    .locals 2
...
.method private u()Lio/flutter/view/c$j;
    .locals 2
...
.method private v(FF)V
    ...
    :cond_0
    invoke-direct {p0}, Lio/flutter/view/c;->u()Lio/flutter/view/c$j;
    ...
    invoke-static {v0, v1}, Lio/flutter/view/c$j;->y(Lio/flutter/view/c$j;[F)Lio/flutter/view/c$j;
    ...
    invoke-direct {p0, p2, v0}, Lio/flutter/view/c;->F(II)V
...
.method static synthetic y(Lio/flutter/view/c$j;Lio/flutter/view/c$j;)Z
    .locals 0
...
.method static synthetic z(Lio/flutter/view/c$j;)Z
    ...
    sget-object v0, Lio/flutter/view/c$h;->y:Lio/flutter/view/c$h;
...
.method public B(Landroid/view/MotionEvent;)Z
    ...
    invoke-static {v0, v2}, Lio/flutter/view/c$j;->y(Lio/flutter/view/c$j;[F)Lio/flutter/view/c$j;
    ...
    invoke-direct {p0, v0, p1}, Lio/flutter/view/c;->v(FF)V
...
.method public E()V
    ...
    invoke-virtual {p0, v0}, Lio/flutter/view/c;->K(Lio/flutter/view/c$i;)V
    ...
    iget-object v1, p0, Lio/flutter/view/c;->b:Lio/flutter/embedding/engine/i/b;

    invoke-virtual {v1, v0}, Lio/flutter/embedding/engine/i/b;->g(Lio/flutter/embedding/engine/i/b$b;)V

    return-void
.end method

.method public K(Lio/flutter/view/c$i;)V
    .locals 0
...
.method M(Ljava/nio/ByteBuffer;[Ljava/lang/String;)V
    .locals 4
    ...
    invoke-direct {p0, v0}, Lio/flutter/view/c;->s(I)Lio/flutter/view/c$g;
...
.method N(Ljava/nio/ByteBuffer;[Ljava/lang/String;)V
    .locals 9
    ...
    invoke-direct {p0, v1}, Lio/flutter/view/c;->t(I)Lio/flutter/view/c$j;

    move-result-object v1

    invoke-static {v1, p1, p2}, Lio/flutter/view/c$j;->z(Lio/flutter/view/c$j;Ljava/nio/ByteBuffer;[Ljava/lang/String;)V

    sget-object v2, Lio/flutter/view/c$h;->t:Lio/flutter/view/c$h;
    ...
    :cond_1
    sget-object v2, Lio/flutter/view/c$h;->l:Lio/flutter/view/c$h;
    ...
    :cond_2
    invoke-static {v1}, Lio/flutter/view/c$j;->A(Lio/flutter/view/c$j;)Z
    ...
    invoke-static {p2, v2}, Lio/flutter/view/c$j;->C(Lio/flutter/view/c$j;Z)Z
    ...
    :cond_5
    invoke-static {p2, v4, p1, v3}, Lio/flutter/view/c$j;->D(Lio/flutter/view/c$j;[FLjava/util/Set;Z)V

    invoke-static {p2, v1}, Lio/flutter/view/c$j;->E(Lio/flutter/view/c$j;Ljava/util/List;)V
    ...
    invoke-direct {p0, v5}, Lio/flutter/view/c;->I(Lio/flutter/view/c$j;)V
    ...
    invoke-direct {p0, v1}, Lio/flutter/view/c;->O(Lio/flutter/view/c$j;)V
    ...
    :cond_e
    invoke-direct {p0, v3}, Lio/flutter/view/c;->J(I)V
    ...
    invoke-static {p2}, Lio/flutter/view/c$j;->F(Lio/flutter/view/c$j;)Z
    ...
    invoke-static {p2}, Lio/flutter/view/c$j;->G(Lio/flutter/view/c$j;)F

    move-result v1

    invoke-static {p2}, Lio/flutter/view/c$j;->H(Lio/flutter/view/c$j;)F
    ...
    :goto_5
    sget-object v6, Lio/flutter/view/c$f;->k:Lio/flutter/view/c$f;

    invoke-static {p2, v6}, Lio/flutter/view/c$j;->J(Lio/flutter/view/c$j;Lio/flutter/view/c$f;)Z

    move-result v6

    if-nez v6, :cond_16

    sget-object v6, Lio/flutter/view/c$f;->l:Lio/flutter/view/c$f;
    ...
    :cond_14
    sget-object v6, Lio/flutter/view/c$f;->i:Lio/flutter/view/c$f;
    ...
    sget-object v6, Lio/flutter/view/c$f;->j:Lio/flutter/view/c$f;
    ...
    invoke-static {p2}, Lio/flutter/view/c$j;->L(Lio/flutter/view/c$j;)Ljava/util/List;
    ...
    sget-object v7, Lio/flutter/view/c$h;->t:Lio/flutter/view/c$h;
    ...
    invoke-static {p2}, Lio/flutter/view/c$j;->M(Lio/flutter/view/c$j;)Z
    ...
    invoke-direct {p0, v0}, Lio/flutter/view/c;->J(I)V
    ...
    invoke-static {p2, v0}, Lio/flutter/view/c$j;->N(Lio/flutter/view/c$j;Lio/flutter/view/c$h;)Z
    ...
    :cond_21
    invoke-static {p2}, Lio/flutter/view/c$j;->P(Lio/flutter/view/c$j;)Ljava/lang/String;
    ...
    :goto_a
    invoke-static {p2}, Lio/flutter/view/c$j;->m(Lio/flutter/view/c$j;)Ljava/lang/String;
    ...
    :cond_24
    invoke-static {p2}, Lio/flutter/view/c$j;->Q(Lio/flutter/view/c$j;)I
    ...
    invoke-static {p2}, Lio/flutter/view/c$j;->R(Lio/flutter/view/c$j;)I

    move-result v0

    invoke-static {p2}, Lio/flutter/view/c$j;->j(Lio/flutter/view/c$j;)I
...
.method public createAccessibilityNodeInfo(I)Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_9
    sget-object v5, Lio/flutter/view/c$h;->k:Lio/flutter/view/c$h;

    invoke-static {v3, v5}, Lio/flutter/view/c$j;->h(Lio/flutter/view/c$j;Lio/flutter/view/c$h;)Z
    ...
    sget-object v5, Lio/flutter/view/c$h;->q:Lio/flutter/view/c$h;
    ...
    sget-object v5, Lio/flutter/view/c$h;->z:Lio/flutter/view/c$h;
    ...
    :cond_c
    sget-object v5, Lio/flutter/view/c$f;->p:Lio/flutter/view/c$f;

    invoke-static {v3, v5}, Lio/flutter/view/c$j;->k(Lio/flutter/view/c$j;Lio/flutter/view/c$f;)Z
    ...
    :goto_2
    sget-object v10, Lio/flutter/view/c$f;->q:Lio/flutter/view/c$f;

    invoke-static {v3, v10}, Lio/flutter/view/c$j;->k(Lio/flutter/view/c$j;Lio/flutter/view/c$f;)Z
    ...
    :cond_e
    sget-object v10, Lio/flutter/view/c$f;->z:Lio/flutter/view/c$f;
    ...
    :cond_f
    sget-object v9, Lio/flutter/view/c$f;->A:Lio/flutter/view/c$f;

    invoke-static {v3, v9}, Lio/flutter/view/c$j;->k(Lio/flutter/view/c$j;Lio/flutter/view/c$f;)Z
    ...
    invoke-static {v3}, Lio/flutter/view/c$j;->l(Lio/flutter/view/c$j;)I

    move-result v5

    if-ltz v5, :cond_12

    invoke-static {v3}, Lio/flutter/view/c$j;->m(Lio/flutter/view/c$j;)Ljava/lang/String;
    ...
    :goto_3
    invoke-static {v3}, Lio/flutter/view/c$j;->o(Lio/flutter/view/c$j;)I
    ...
    sget-object v5, Lio/flutter/view/c$f;->r:Lio/flutter/view/c$f;
    ...
    :cond_13
    sget-object v5, Lio/flutter/view/c$f;->s:Lio/flutter/view/c$f;
    ...
    :cond_14
    sget-object v5, Lio/flutter/view/c$f;->t:Lio/flutter/view/c$f;
    ...
    invoke-static {v3, v0}, Lio/flutter/view/c$j;->k(Lio/flutter/view/c$j;Lio/flutter/view/c$f;)Z
    ...
    :cond_18
    sget-object v0, Lio/flutter/view/c$h;->u:Lio/flutter/view/c$h;
    ...
    sget-object v0, Lio/flutter/view/c$f;->y:Lio/flutter/view/c$f;
    ...
    :cond_1a
    invoke-static {v3}, Lio/flutter/view/c$j;->p(Lio/flutter/view/c$j;)Lio/flutter/view/c$j;
    ...
    invoke-static {v5}, Lio/flutter/view/c$j;->f(Lio/flutter/view/c$j;)Landroid/graphics/Rect;
    ...
    invoke-static {v3}, Lio/flutter/view/c$j;->r(Lio/flutter/view/c$j;)Lio/flutter/view/c$g;
    ...
    invoke-static {v9}, Lio/flutter/view/c$g;->a(Lio/flutter/view/c$g;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lio/flutter/view/c$j;->s(Lio/flutter/view/c$j;)Lio/flutter/view/c$g;
    ...
    sget-object v0, Lio/flutter/view/c$f;->j:Lio/flutter/view/c$f;
    ...
    sget-object v0, Lio/flutter/view/c$f;->l:Lio/flutter/view/c$f;
    ...
    invoke-direct {p0, v3}, Lio/flutter/view/c;->L(Lio/flutter/view/c$j;)Z
    ...
    sget-object v0, Lio/flutter/view/c$f;->n:Lio/flutter/view/c$f;
    ...
    invoke-static {v3}, Lio/flutter/view/c$j;->t(Lio/flutter/view/c$j;)Ljava/lang/String;
    ...
    :cond_31
    sget-object v0, Lio/flutter/view/c$h;->r:Lio/flutter/view/c$h;
    ...
    :cond_32
    :goto_e
    sget-object v0, Lio/flutter/view/c$h;->g:Lio/flutter/view/c$h;

    invoke-static {v3, v0}, Lio/flutter/view/c$j;->h(Lio/flutter/view/c$j;Lio/flutter/view/c$h;)Z

    move-result v0

    sget-object v5, Lio/flutter/view/c$h;->w:Lio/flutter/view/c$h;
    ...
    sget-object v0, Lio/flutter/view/c$h;->o:Lio/flutter/view/c$h;
    ...
    sget-object v0, Lio/flutter/view/c$h;->x:Lio/flutter/view/c$h;
    ...
    invoke-static {v3}, Lio/flutter/view/c$j;->u(Lio/flutter/view/c$j;)Ljava/util/List;
    ...
    :cond_3a
    invoke-static {v3}, Lio/flutter/view/c$j;->v(Lio/flutter/view/c$j;)Ljava/util/List;
...
.method public performAction(IILandroid/os/Bundle;)Z
    ...
    iget-object p3, p0, Lio/flutter/view/c;->b:Lio/flutter/embedding/engine/i/b;
    ...
    invoke-virtual {p3, p1, v0, p2}, Lio/flutter/embedding/engine/i/b;->c(ILio/flutter/view/c$f;Ljava/lang/Object;)V

    return v6

    :sswitch_0
    iget-object p2, p0, Lio/flutter/view/c;->b:Lio/flutter/embedding/engine/i/b;

    sget-object p3, Lio/flutter/view/c$f;->o:Lio/flutter/view/c$f;

    invoke-virtual {p2, p1, p3}, Lio/flutter/embedding/engine/i/b;->b(ILio/flutter/view/c$f;)V
    ...
    sget-object p3, Lio/flutter/view/c$f;->y:Lio/flutter/view/c$f;
    ...
    :cond_5
    invoke-static {v2}, Lio/flutter/view/c$j;->j(Lio/flutter/view/c$j;)I
    ...
    sget-object p3, Lio/flutter/view/c$f;->u:Lio/flutter/view/c$f;
    ...
    sget-object p3, Lio/flutter/view/c$f;->s:Lio/flutter/view/c$f;
    ...
    :sswitch_6
    sget-object p2, Lio/flutter/view/c$f;->l:Lio/flutter/view/c$f;

    invoke-static {v2, p2}, Lio/flutter/view/c$j;->k(Lio/flutter/view/c$j;Lio/flutter/view/c$f;)Z
    ...
    sget-object p3, Lio/flutter/view/c$f;->l:Lio/flutter/view/c$f;
    ...
    :cond_7
    sget-object p2, Lio/flutter/view/c$f;->n:Lio/flutter/view/c$f;
    ...
    invoke-static {v2}, Lio/flutter/view/c$j;->x(Lio/flutter/view/c$j;)Ljava/lang/String;

    move-result-object p2

    invoke-static {v2, p2}, Lio/flutter/view/c$j;->n(Lio/flutter/view/c$j;Ljava/lang/String;)Ljava/lang/String;

    invoke-direct {p0, p1, v4}, Lio/flutter/view/c;->F(II)V
    ...
    :sswitch_7
    sget-object p2, Lio/flutter/view/c$f;->k:Lio/flutter/view/c$f;
    ...
    sget-object p3, Lio/flutter/view/c$f;->k:Lio/flutter/view/c$f;
    ...
    :cond_a
    sget-object p2, Lio/flutter/view/c$f;->m:Lio/flutter/view/c$f;
    ...
    invoke-static {v2}, Lio/flutter/view/c$j;->w(Lio/flutter/view/c$j;)Ljava/lang/String;
    ...
    sget-object p3, Lio/flutter/view/c$f;->m:Lio/flutter/view/c$f;
    ...
    :cond_c
    invoke-direct {p0, v2, p1, p3, v3}, Lio/flutter/view/c;->D(Lio/flutter/view/c$j;ILandroid/os/Bundle;Z)Z
    ...
    :cond_d
    invoke-direct {p0, v2, p1, p3, v6}, Lio/flutter/view/c;->D(Lio/flutter/view/c$j;ILandroid/os/Bundle;Z)Z
    ...
    sget-object p3, Lio/flutter/view/c$f;->w:Lio/flutter/view/c$f;

    invoke-virtual {p2, p1, p3}, Lio/flutter/embedding/engine/i/b;->b(ILio/flutter/view/c$f;)V

    invoke-direct {p0, p1, v0}, Lio/flutter/view/c;->F(II)V
    ...
    sget-object p3, Lio/flutter/view/c$f;->v:Lio/flutter/view/c$f;
