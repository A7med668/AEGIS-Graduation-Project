...
.field final synthetic l:Landroidx/recyclerview/widget/RecyclerView;
...
.method constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->sQuinticInterpolator:Landroid/view/animation/Interpolator;

    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->i:Landroid/view/animation/Interpolator;

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->j:Z

    iput-boolean v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->k:Z
    ...
    iput-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->h:Landroid/widget/OverScroller;
...
.method private a(IIII)I
    ...
    iget-object p2, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;
...
.method private d()V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;

    invoke-virtual {v0, p0}, Landroid/view/ViewGroup;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;

    invoke-static {v0, p0}, La/g/k/s;->Y(Landroid/view/View;Ljava/lang/Runnable;)V
...
.method public c(II)V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->i:Landroid/view/animation/Interpolator;

    sget-object v1, Landroidx/recyclerview/widget/RecyclerView;->sQuinticInterpolator:Landroid/view/animation/Interpolator;

    if-eq v0, v1, :cond_0

    iput-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->i:Landroid/view/animation/Interpolator;

    new-instance v0, Landroid/widget/OverScroller;

    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_0
    iget-object v3, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->h:Landroid/widget/OverScroller;
...
.method e()V
    ...
    iget-boolean v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->j:Z
...
.method public f(IIILandroid/view/animation/Interpolator;)V
    ...
    :cond_1
    iget-object p3, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->i:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_2

    iput-object p4, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->i:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->h:Landroid/widget/OverScroller;
    ...
    iget-object p3, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;

    const/4 p4, 0x2

    invoke-virtual {p3, p4}, Landroidx/recyclerview/widget/RecyclerView;->setScrollState(I)V

    iget-object v1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->h:Landroid/widget/OverScroller;
    ...
    iget-object p1, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->h:Landroid/widget/OverScroller;
...
.method public g()V
    ...
    iget-object v0, p0, Landroidx/recyclerview/widget/RecyclerView$c0;->h:Landroid/widget/OverScroller;
...
.method public run()V
    ...
    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-boolean v2, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->k:Z

    const/4 v3, 0x1

    iput-boolean v3, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->j:Z

    invoke-virtual {v1}, Landroidx/recyclerview/widget/RecyclerView;->consumePendingUpdateOperations()V

    iget-object v1, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->h:Landroid/widget/OverScroller;
    ...
    iget v6, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->f:I

    sub-int v6, v4, v6

    iget v7, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->g:I

    sub-int v13, v5, v7

    iput v4, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->f:I

    iput v5, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->g:I

    iget-object v7, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v4, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v9, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :cond_7
    iget-object v14, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    :goto_7
    iget-object v5, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->l:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-boolean v1, v0, Landroidx/recyclerview/widget/RecyclerView$c0;->k:Z
