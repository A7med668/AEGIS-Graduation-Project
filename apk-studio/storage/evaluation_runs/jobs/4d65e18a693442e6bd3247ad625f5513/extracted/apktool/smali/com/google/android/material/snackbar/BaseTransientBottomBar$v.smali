...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/android/material/snackbar/BaseTransientBottomBar$v;->k:Landroid/view/View$OnTouchListener;
...
.method protected constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v1, Lb/c/a/b/k;->SnackbarLayout:[I

    invoke-virtual {p1, p2, v1}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Lb/c/a/b/k;->SnackbarLayout_elevation:I
    ...
    invoke-static {p0, p2}, La/g/k/s;->m0(Landroid/view/View;F)V

    :cond_0
    sget p2, Lb/c/a/b/k;->SnackbarLayout_animationMode:I

    invoke-virtual {p1, p2, v0}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p2

    iput p2, p0, Lcom/google/android/material/snackbar/BaseTransientBottomBar$v;->h:I

    sget p2, Lb/c/a/b/k;->SnackbarLayout_backgroundOverlayColorAlpha:I
    ...
    iput p2, p0, Lcom/google/android/material/snackbar/BaseTransientBottomBar$v;->i:F

    sget p2, Lb/c/a/b/k;->SnackbarLayout_actionTextColorAlpha:I

    invoke-virtual {p1, p2, v0}, Landroid/content/res/TypedArray;->getFloat(IF)F

    move-result p2

    iput p2, p0, Lcom/google/android/material/snackbar/BaseTransientBottomBar$v;->j:F

    invoke-virtual {p1}, Landroid/content/res/TypedArray;->recycle()V

    sget-object p1, Lcom/google/android/material/snackbar/BaseTransientBottomBar$v;->k:Landroid/view/View$OnTouchListener;
...
.method public setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    :cond_0
    sget-object v0, Lcom/google/android/material/snackbar/BaseTransientBottomBar$v;->k:Landroid/view/View$OnTouchListener;
