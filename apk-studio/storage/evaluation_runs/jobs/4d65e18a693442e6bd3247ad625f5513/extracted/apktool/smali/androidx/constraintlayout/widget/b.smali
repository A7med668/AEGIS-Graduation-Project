...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroidx/constraintlayout/widget/b;->f:[I

    const/4 v0, 0x0

    iput-boolean v0, p0, Landroidx/constraintlayout/widget/b;->j:Z

    iput-object p1, p0, Landroidx/constraintlayout/widget/b;->h:Landroid/content/Context;

    const/4 p1, 0x0

    invoke-virtual {p0, p1}, Landroidx/constraintlayout/widget/b;->b(Landroid/util/AttributeSet;)V
...
.method private a(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/constraintlayout/widget/b;->h:Landroid/content/Context;
    ...
    iget-object v2, p0, Landroidx/constraintlayout/widget/b;->h:Landroid/content/Context;

    invoke-virtual {v2}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v2

    iget-object v3, p0, Landroidx/constraintlayout/widget/b;->h:Landroid/content/Context;
...
.method public e(Landroidx/constraintlayout/widget/ConstraintLayout;)V
    ...
    :cond_0
    iget-object v0, p0, Landroidx/constraintlayout/widget/b;->i:La/e/a/j/j;
    ...
    :cond_1
    invoke-virtual {v0}, La/e/a/j/j;->J0()V

    const/4 v0, 0x0

    :goto_0
    iget v1, p0, Landroidx/constraintlayout/widget/b;->g:I

    if-ge v0, v1, :cond_3

    iget-object v1, p0, Landroidx/constraintlayout/widget/b;->f:[I
    ...
    iget-object v2, p0, Landroidx/constraintlayout/widget/b;->i:La/e/a/j/j;

    invoke-virtual {p1, v1}, Landroidx/constraintlayout/widget/ConstraintLayout;->f(Landroid/view/View;)La/e/a/j/f;

    move-result-object v1

    invoke-virtual {v2, v1}, La/e/a/j/j;->I0(La/e/a/j/f;)V
...
.method public f()V
    ...
    iget-object v1, p0, Landroidx/constraintlayout/widget/b;->i:La/e/a/j/j;
...
.method public getReferencedIds()[I
    ...
    iget-object v0, p0, Landroidx/constraintlayout/widget/b;->f:[I
...
.method protected onMeasure(II)V
    ...
    iget-boolean v0, p0, Landroidx/constraintlayout/widget/b;->j:Z
...
.method public setTag(ILjava/lang/Object;)V
    ...
    iget p2, p0, Landroidx/constraintlayout/widget/b;->g:I
    ...
    iput-object p2, p0, Landroidx/constraintlayout/widget/b;->f:[I

    :cond_0
    iget-object p2, p0, Landroidx/constraintlayout/widget/b;->f:[I
