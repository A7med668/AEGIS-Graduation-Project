...
.method constructor <init>()V
    ...
    sget v2, La/a/e;->abc_textfield_search_default_mtrl_alpha:I

    const/4 v3, 0x0

    aput v2, v1, v3

    sget v2, La/a/e;->abc_textfield_default_mtrl_alpha:I

    const/4 v4, 0x1

    aput v2, v1, v4

    sget v2, La/a/e;->abc_ab_share_pack_mtrl_alpha:I
    ...
    sget v6, La/a/e;->abc_ic_commit_search_api_mtrl_alpha:I

    aput v6, v2, v3

    sget v6, La/a/e;->abc_seekbar_tick_mark_material:I

    aput v6, v2, v4

    sget v6, La/a/e;->abc_ic_menu_share_mtrl_alpha:I

    aput v6, v2, v5

    sget v6, La/a/e;->abc_ic_menu_copy_mtrl_am_alpha:I

    aput v6, v2, v0

    sget v6, La/a/e;->abc_ic_menu_cut_mtrl_alpha:I

    const/4 v7, 0x4

    aput v6, v2, v7

    sget v6, La/a/e;->abc_ic_menu_selectall_mtrl_alpha:I

    const/4 v8, 0x5

    aput v6, v2, v8

    sget v6, La/a/e;->abc_ic_menu_paste_mtrl_am_alpha:I
    ...
    sget v6, La/a/e;->abc_textfield_activated_mtrl_alpha:I

    aput v6, v2, v3

    sget v6, La/a/e;->abc_textfield_search_activated_mtrl_alpha:I

    aput v6, v2, v4

    sget v6, La/a/e;->abc_cab_background_top_mtrl_alpha:I

    aput v6, v2, v5

    sget v6, La/a/e;->abc_text_cursor_material:I

    aput v6, v2, v0

    sget v6, La/a/e;->abc_text_select_handle_left_mtrl_dark:I

    aput v6, v2, v7

    sget v6, La/a/e;->abc_text_select_handle_middle_mtrl_dark:I

    aput v6, v2, v8

    sget v6, La/a/e;->abc_text_select_handle_right_mtrl_dark:I

    aput v6, v2, v9

    sget v6, La/a/e;->abc_text_select_handle_left_mtrl_light:I
    ...
    sget v2, La/a/e;->abc_popup_background_mtrl_mult:I

    aput v2, v1, v3

    sget v2, La/a/e;->abc_cab_background_internal_bg:I

    aput v2, v1, v4

    sget v2, La/a/e;->abc_menu_hardkey_panel_mtrl_mult:I
    ...
    sget v2, La/a/e;->abc_tab_indicator_material:I

    aput v2, v1, v3

    sget v2, La/a/e;->abc_textfield_search_material:I
    ...
    sget v2, La/a/e;->abc_btn_check_material:I

    aput v2, v1, v3

    sget v2, La/a/e;->abc_btn_radio_material:I

    aput v2, v1, v4

    sget v2, La/a/e;->abc_btn_check_material_anim:I

    aput v2, v1, v5

    sget v2, La/a/e;->abc_btn_radio_material_anim:I
...
.method private h(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v3}, Landroidx/appcompat/widget/r0;->a(Landroid/content/Context;I)I
    ...
    invoke-static {v2, p2}, La/g/d/a;->b(II)I
...
.method private k(Landroid/content/Context;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/r0;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v5}, Landroidx/appcompat/widget/r0;->b(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v2}, Landroidx/appcompat/widget/r0;->a(Landroid/content/Context;I)I
...
.method public c(Landroidx/appcompat/widget/m0;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    sget v0, La/a/e;->abc_cab_background_top_material:I
    ...
    sget v2, La/a/e;->abc_cab_background_top_mtrl_alpha:I
...
.method public d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget v0, La/a/e;->abc_edit_text_material:I

    if-ne p2, v0, :cond_0

    sget p2, La/a/c;->abc_tint_edittext:I

    invoke-static {p1, p2}, La/a/k/a/a;->c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    sget v0, La/a/e;->abc_switch_track_mtrl_alpha:I

    if-ne p2, v0, :cond_1

    sget p2, La/a/c;->abc_tint_switch_track:I
    ...
    :cond_2
    sget v0, La/a/e;->abc_btn_default_mtrl_shape:I
    ...
    :cond_3
    sget v0, La/a/e;->abc_btn_borderless_material:I
    ...
    :cond_4
    sget v0, La/a/e;->abc_btn_colored_material:I
    ...
    :cond_5
    sget v0, La/a/e;->abc_spinner_mtrl_am_alpha:I

    if-eq p2, v0, :cond_b

    sget v0, La/a/e;->abc_spinner_textfield_background_material:I
    ...
    sget p2, La/a/a;->colorControlNormal:I

    invoke-static {p1, p2}, Landroidx/appcompat/widget/r0;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget p2, La/a/c;->abc_tint_default:I
    ...
    sget p2, La/a/c;->abc_tint_btn_checkable:I
    ...
    :cond_9
    sget v0, La/a/e;->abc_seekbar_thumb_material:I

    if-ne p2, v0, :cond_a

    sget p2, La/a/c;->abc_tint_seek_thumb:I
    ...
    :cond_b
    :goto_0
    sget p2, La/a/c;->abc_tint_spinner:I
...
.method public e(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    ...
    invoke-static {p1, p3}, Landroidx/appcompat/widget/r0;->b(Landroid/content/Context;I)I
    ...
    invoke-static {p1, v0}, Landroidx/appcompat/widget/r0;->a(Landroid/content/Context;I)I
