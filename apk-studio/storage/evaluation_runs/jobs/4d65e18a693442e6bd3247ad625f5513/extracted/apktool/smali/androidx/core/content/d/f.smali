...
.method private static a(Landroidx/core/content/d/f$b;ILandroid/content/res/ColorStateList;)V
    ...
    sget-object v2, Landroidx/core/content/d/f;->b:Ljava/util/WeakHashMap;

    invoke-virtual {v2, p0, v1}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_0
    new-instance v2, Landroidx/core/content/d/f$a;
    ...
    invoke-direct {v2, p2, p0}, Landroidx/core/content/d/f$a;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/Configuration;)V
...
.method public static c(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    :cond_1
    invoke-static {p0, p1, p2}, Landroidx/core/content/d/f;->i(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
...
.method public static e(Landroid/content/Context;I)Landroid/graphics/Typeface;
    ...
    invoke-static/range {v0 .. v7}, Landroidx/core/content/d/f;->k(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method public static f(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;)Landroid/graphics/Typeface;
    .locals 8
...
.method public static g(Landroid/content/Context;ILandroidx/core/content/d/f$c;Landroid/os/Handler;)V
    .locals 8

    invoke-static {p2}, La/g/j/i;->c(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private static h()Landroid/util/TypedValue;
    ...
    sget-object v1, Landroidx/core/content/d/f;->a:Ljava/lang/ThreadLocal;
...
.method private static i(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p0, p1}, Landroidx/core/content/d/f;->j(Landroid/content/res/Resources;I)Z
...
.method private static j(Landroid/content/res/Resources;I)Z
    ...
    invoke-static {}, Landroidx/core/content/d/f;->h()Landroid/util/TypedValue;
...
.method private static k(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 10
    ...
    invoke-static/range {v0 .. v8}, Landroidx/core/content/d/f;->l(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
...
.method private static l(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroidx/core/content/d/f$c;Landroid/os/Handler;ZZ)Landroid/graphics/Typeface;
    .locals 15
    ...
    :cond_1
    invoke-static {v0, v4, v5}, La/g/d/d;->f(Landroid/content/res/Resources;II)Landroid/graphics/Typeface;
    ...
    invoke-static/range {v1 .. v8}, La/g/d/d;->c(Landroid/content/Context;Landroidx/core/content/d/c$a;Landroid/content/res/Resources;IILandroidx/core/content/d/f$c;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    ...
    invoke-static {p0, v0, v4, v12, v5}, La/g/d/d;->d(Landroid/content/Context;Landroid/content/res/Resources;ILjava/lang/String;I)Landroid/graphics/Typeface;
