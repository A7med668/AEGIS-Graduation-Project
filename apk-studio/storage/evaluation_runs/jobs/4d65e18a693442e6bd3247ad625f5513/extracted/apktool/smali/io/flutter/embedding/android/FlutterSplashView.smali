...
# static fields
.field private static o:Ljava/lang/String; = "FlutterSplashView"


# instance fields
.field private f:Lio/flutter/embedding/android/n;

.field private g:Lio/flutter/embedding/android/j;
...
.field private final l:Lio/flutter/embedding/android/j$d;

.field private final m:Lio/flutter/embedding/engine/renderer/b;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->l:Lio/flutter/embedding/android/j$d;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->m:Lio/flutter/embedding/engine/renderer/b;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->n:Ljava/lang/Runnable;
...
.method static synthetic a(Lio/flutter/embedding/android/FlutterSplashView;)Lio/flutter/embedding/android/j;
    .locals 0

    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->g:Lio/flutter/embedding/android/j;
...
.method static synthetic b(Lio/flutter/embedding/android/FlutterSplashView;)Lio/flutter/embedding/android/n;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->f:Lio/flutter/embedding/android/n;
...
.method static synthetic d(Lio/flutter/embedding/android/FlutterSplashView;)Landroid/view/View;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->h:Landroid/view/View;
...
.method static synthetic e(Lio/flutter/embedding/android/FlutterSplashView;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->k:Ljava/lang/String;
...
.method static synthetic f(Lio/flutter/embedding/android/FlutterSplashView;)Ljava/lang/String;
    ...
    iget-object p0, p0, Lio/flutter/embedding/android/FlutterSplashView;->j:Ljava/lang/String;
...
.method private h()Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->g:Lio/flutter/embedding/android/j;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Lio/flutter/embedding/android/j;->r()Z
    ...
    invoke-virtual {v0}, Lio/flutter/embedding/android/j;->getAttachedFlutterEngine()Lio/flutter/embedding/engine/a;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->k:Ljava/lang/String;
...
.method private j()Z
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->f:Lio/flutter/embedding/android/n;

    if-eqz v0, :cond_0

    invoke-interface {v0}, Lio/flutter/embedding/android/n;->b()Z
...
.method private k()V
    ...
    sget-object v0, Lio/flutter/embedding/android/FlutterSplashView;->o:Ljava/lang/String;
    ...
    iget-object v2, p0, Lio/flutter/embedding/android/FlutterSplashView;->j:Ljava/lang/String;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->n:Ljava/lang/Runnable;
...
# virtual methods
.method public g(Lio/flutter/embedding/android/j;Lio/flutter/embedding/android/n;)V
    .locals 2
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->m:Lio/flutter/embedding/engine/renderer/b;
    ...
    :cond_0
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->h:Landroid/view/View;
    ...
    :cond_1
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->g:Lio/flutter/embedding/android/j;

    invoke-virtual {p0, p1}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;)V

    iput-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->f:Lio/flutter/embedding/android/n;
    ...
    iget-object v1, p0, Lio/flutter/embedding/android/FlutterSplashView;->i:Landroid/os/Bundle;

    invoke-interface {p2, v0, v1}, Lio/flutter/embedding/android/n;->c(Landroid/content/Context;Landroid/os/Bundle;)Landroid/view/View;

    move-result-object p2

    iput-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->h:Landroid/view/View;

    invoke-virtual {p0, p2}, Landroid/widget/FrameLayout;->addView(Landroid/view/View;)V

    iget-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->m:Lio/flutter/embedding/engine/renderer/b;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/j;->h(Lio/flutter/embedding/engine/renderer/b;)V
    ...
    sget-object p1, Lio/flutter/embedding/android/FlutterSplashView;->o:Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->i:Landroid/os/Bundle;

    invoke-interface {p2, p1, v0}, Lio/flutter/embedding/android/n;->c(Landroid/content/Context;Landroid/os/Bundle;)Landroid/view/View;

    move-result-object p1

    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->h:Landroid/view/View;
    ...
    :cond_3
    invoke-virtual {p1}, Lio/flutter/embedding/android/j;->r()Z

    move-result p2

    if-nez p2, :cond_4

    sget-object p2, Lio/flutter/embedding/android/FlutterSplashView;->o:Ljava/lang/String;

    const-string v0, "FlutterView is not yet attached to a FlutterEngine. Showing nothing until a FlutterEngine is attached."

    invoke-static {p2, v0}, Lc/a/b;->d(Ljava/lang/String;Ljava/lang/String;)V

    iget-object p2, p0, Lio/flutter/embedding/android/FlutterSplashView;->l:Lio/flutter/embedding/android/j$d;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/android/j;->g(Lio/flutter/embedding/android/j$d;)V
...
.method protected onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->k:Ljava/lang/String;
    ...
    iput-object p1, p0, Lio/flutter/embedding/android/FlutterSplashView;->i:Landroid/os/Bundle;
...
.method protected onSaveInstanceState()Landroid/os/Parcelable;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterSplashView;->k:Ljava/lang/String;
    ...
    invoke-interface {v0}, Lio/flutter/embedding/android/n;->d()Landroid/os/Bundle;
