...
.method constructor <init>(Landroidx/core/app/h$d;)V
    ...
    iget-object v3, p1, Landroidx/core/app/h$d;->K:Ljava/lang/String;
    ...
    iget-object v0, p1, Landroidx/core/app/h$d;->S:Landroid/app/Notification;
    ...
    iget-object v4, p1, Landroidx/core/app/h$d;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v3, p1, Landroidx/core/app/h$d;->f:Ljava/lang/CharSequence;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroidx/core/app/h$d;->k:Ljava/lang/CharSequence;
    ...
    iget-object v3, p1, Landroidx/core/app/h$d;->h:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Landroidx/core/app/h$d;->j:Landroid/graphics/Bitmap;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setLargeIcon(Landroid/graphics/Bitmap;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroidx/core/app/h$d;->l:I

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroidx/core/app/h$d;->t:I
    ...
    iget-object v7, p1, Landroidx/core/app/h$d;->q:Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v7}, Landroidx/core/app/i;->b(Landroidx/core/app/h$a;)V

    goto :goto_5

    :cond_6
    iget-object v2, p1, Landroidx/core/app/h$d;->D:Landroid/os/Bundle;

    if-eqz v2, :cond_7

    iget-object v7, p0, Landroidx/core/app/i;->f:Landroid/os/Bundle;
    ...
    iget-boolean v2, p1, Landroidx/core/app/h$d;->z:Z
    ...
    :cond_a
    iget-object v2, p1, Landroidx/core/app/h$d;->y:Ljava/lang/String;
    ...
    :cond_b
    iget-object v2, p1, Landroidx/core/app/h$d;->H:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroidx/core/app/i;->c:Landroid/widget/RemoteViews;

    iget-object v2, p1, Landroidx/core/app/h$d;->I:Landroid/widget/RemoteViews;
    ...
    iget-object v2, p1, Landroidx/core/app/h$d;->c:Ljava/util/ArrayList;

    invoke-static {v2}, Landroidx/core/app/i;->f(Ljava/util/List;)Ljava/util/List;

    move-result-object v2

    iget-object v7, p1, Landroidx/core/app/h$d;->V:Ljava/util/ArrayList;

    invoke-static {v2, v7}, Landroidx/core/app/i;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v3, p1, Landroidx/core/app/h$d;->C:Ljava/lang/String;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setCategory(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroidx/core/app/h$d;->E:I

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setColor(I)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroidx/core/app/h$d;->F:I

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setVisibility(I)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroidx/core/app/h$d;->G:Landroid/app/Notification;
    ...
    iget-object v3, p1, Landroidx/core/app/h$d;->V:Ljava/util/ArrayList;

    invoke-static {v2, v3}, Landroidx/core/app/i;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_10
    iget-object v2, p1, Landroidx/core/app/h$d;->V:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v2, p1, Landroidx/core/app/h$d;->J:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroidx/core/app/i;->h:Landroid/widget/RemoteViews;

    iget-object v2, p1, Landroidx/core/app/h$d;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, Landroidx/core/app/h$d;->d:Ljava/util/ArrayList;
    ...
    invoke-static {v12}, Landroidx/core/app/j;->b(Landroidx/core/app/h$a;)Landroid/os/Bundle;
    ...
    iget-object v2, p1, Landroidx/core/app/h$d;->U:Landroid/graphics/drawable/Icon;
    ...
    iget-object v3, p1, Landroidx/core/app/h$d;->D:Landroid/os/Bundle;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setExtras(Landroid/os/Bundle;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroidx/core/app/h$d;->s:[Ljava/lang/CharSequence;
    ...
    iget-object v8, p1, Landroidx/core/app/h$d;->r:Ljava/lang/CharSequence;
    ...
    iget-object v8, p1, Landroidx/core/app/h$d;->M:Ljava/lang/String;
    ...
    check-cast v6, Landroidx/core/app/k;

    iget-object v7, p0, Landroidx/core/app/i;->a:Landroid/app/Notification$Builder;

    invoke-virtual {v6}, Landroidx/core/app/k;->h()Landroid/app/Person;
    ...
    iget-boolean v6, p1, Landroidx/core/app/h$d;->Q:Z
    ...
    iget-object v6, p1, Landroidx/core/app/h$d;->R:Landroidx/core/app/h$c;

    invoke-static {v6}, Landroidx/core/app/h$c;->i(Landroidx/core/app/h$c;)Landroid/app/Notification$BubbleMetadata;
    ...
    iget-object v2, p1, Landroidx/core/app/h$d;->N:Landroidx/core/content/b;

    if-eqz v2, :cond_1c

    iget-object v6, p0, Landroidx/core/app/i;->a:Landroid/app/Notification$Builder;
...
.method private b(Landroidx/core/app/h$a;)V
    ...
    invoke-static {v0}, Landroidx/core/app/l;->b([Landroidx/core/app/l;)[Landroid/app/RemoteInput;
...
.method private static e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v0, p0}, La/d/b;->addAll(Ljava/util/Collection;)Z

    invoke-virtual {v0, p1}, La/d/b;->addAll(Ljava/util/Collection;)Z
...
.method private static f(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {v1}, Landroidx/core/app/k;->g()Ljava/lang/String;
...
.method protected d()Landroid/app/Notification;
    ...
    invoke-direct {p0, v0}, Landroidx/core/app/i;->g(Landroid/app/Notification;)V
