...
# instance fields
.field protected f:Lio/flutter/embedding/android/e;

.field private g:Landroidx/lifecycle/k;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/FlutterActivity;->g:Landroidx/lifecycle/k;
...
.method private C()V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterActivity;->E()Lio/flutter/embedding/android/f$a;

    move-result-object v0

    sget-object v1, Lio/flutter/embedding/android/f$a;->g:Lio/flutter/embedding/android/f$a;
...
.method private D()Landroid/view/View;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterActivity;->f:Lio/flutter/embedding/android/e;
...
.method private H()Landroid/graphics/drawable/Drawable;
    ...
    :try_start_0
    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterActivity;->G()Landroid/os/Bundle;
...
.method private J()V
    ...
    iput-object v0, p0, Lio/flutter/embedding/android/FlutterActivity;->f:Lio/flutter/embedding/android/e;
...
.method public static M()Lio/flutter/embedding/android/FlutterActivity$a;
    .locals 2
...
.method public A(Lio/flutter/embedding/engine/a;)V
    ...
    invoke-static {p1}, Lio/flutter/embedding/engine/h/h/a;->a(Lio/flutter/embedding/engine/a;)V

    return-void
.end method

.method protected E()Lio/flutter/embedding/android/f$a;
    .locals 2
    ...
    :cond_0
    sget-object v0, Lio/flutter/embedding/android/f$a;->f:Lio/flutter/embedding/android/f$a;
...
.method public a()Landroidx/lifecycle/e;
    ...
    iget-object v0, p0, Lio/flutter/embedding/android/FlutterActivity;->g:Landroidx/lifecycle/k;
...
.method public f()V
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterActivity;->F()Lio/flutter/embedding/engine/a;
    ...
    invoke-direct {p0}, Lio/flutter/embedding/android/FlutterActivity;->J()V
...
.method public l()Z
    ...
    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterActivity;->m()Ljava/lang/String;

    move-result-object v2

    if-nez v2, :cond_1

    iget-object v2, p0, Lio/flutter/embedding/android/FlutterActivity;->f:Lio/flutter/embedding/android/e;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    invoke-direct {p0, v0}, Lio/flutter/embedding/android/FlutterActivity;->K(Ljava/lang/String;)Z
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Lio/flutter/embedding/android/e;->t(Landroid/os/Bundle;)V

    iget-object p1, p0, Lio/flutter/embedding/android/FlutterActivity;->g:Landroidx/lifecycle/k;

    sget-object v0, Landroidx/lifecycle/e$a;->ON_CREATE:Landroidx/lifecycle/e$a;

    invoke-virtual {p1, v0}, Landroidx/lifecycle/k;->i(Landroidx/lifecycle/e$a;)V

    invoke-direct {p0}, Lio/flutter/embedding/android/FlutterActivity;->C()V

    invoke-direct {p0}, Lio/flutter/embedding/android/FlutterActivity;->D()Landroid/view/View;
...
.method protected onDestroy()V
    ...
    invoke-virtual {v0, v1}, Landroidx/lifecycle/k;->i(Landroidx/lifecycle/e$a;)V
...
.method protected onNewIntent(Landroid/content/Intent;)V
    ...
    invoke-virtual {v0, p1}, Lio/flutter/embedding/android/e;->p(Landroid/content/Intent;)V
...
.method public onRequestPermissionsResult(I[Ljava/lang/String;[I)V
    ...
    invoke-virtual {v0, p1, p2, p3}, Lio/flutter/embedding/android/e;->s(I[Ljava/lang/String;[I)V
...
.method protected onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v0, p1}, Lio/flutter/embedding/android/e;->v(Landroid/os/Bundle;)V
...
.method public onTrimMemory(I)V
    ...
    invoke-virtual {v0, p1}, Lio/flutter/embedding/android/e;->y(I)V
...
.method public q(Landroid/app/Activity;Lio/flutter/embedding/engine/a;)Lio/flutter/plugin/platform/d;
    .locals 0

    new-instance p1, Lio/flutter/plugin/platform/d;

    invoke-virtual {p0}, Lio/flutter/embedding/android/FlutterActivity;->e()Landroid/app/Activity;

    invoke-virtual {p2}, Lio/flutter/embedding/engine/a;->n()Lio/flutter/embedding/engine/i/h;

    move-result-object p2

    invoke-direct {p1, p0, p2, p0}, Lio/flutter/plugin/platform/d;-><init>(Landroid/app/Activity;Lio/flutter/embedding/engine/i/h;Lio/flutter/plugin/platform/d$c;)V

    return-object p1
.end method

.method public r(Lio/flutter/embedding/android/h;)V
    .locals 0
...
.method public s()Ljava/lang/String;
    ...
    invoke-direct {p0}, Lio/flutter/embedding/android/FlutterActivity;->I()Z
...
.method public u()Lio/flutter/embedding/engine/d;
    .locals 1
...
.method public v()Lio/flutter/embedding/android/l;
    .locals 2
    ...
    sget-object v1, Lio/flutter/embedding/android/f$a;->f:Lio/flutter/embedding/android/f$a;

    if-ne v0, v1, :cond_0

    sget-object v0, Lio/flutter/embedding/android/l;->f:Lio/flutter/embedding/android/l;

    goto :goto_0

    :cond_0
    sget-object v0, Lio/flutter/embedding/android/l;->g:Lio/flutter/embedding/android/l;

    :goto_0
    return-object v0
.end method

.method public w()Lio/flutter/embedding/android/n;
    .locals 2

    invoke-direct {p0}, Lio/flutter/embedding/android/FlutterActivity;->H()Landroid/graphics/drawable/Drawable;
...
.method public x(Landroid/content/Context;)Lio/flutter/embedding/engine/a;
    .locals 0
...
.method public y()Lio/flutter/embedding/android/o;
    .locals 2
...
.method public z(Lio/flutter/embedding/android/i;)V
    .locals 0
