...
# interfaces
.implements Lio/flutter/embedding/engine/i/i$e;
...
# virtual methods
.method public a(Lio/flutter/embedding/engine/i/i$c;Ljava/lang/Runnable;)V
    .locals 5
    ...
    iget v1, p1, Lio/flutter/embedding/engine/i/i$c;->a:I
    ...
    iget-wide v2, p1, Lio/flutter/embedding/engine/i/i$c;->b:D
    ...
    iget-wide v3, p1, Lio/flutter/embedding/engine/i/i$c;->c:D
...
.method public d(Lio/flutter/embedding/engine/i/i$b;)J
    .locals 11
    ...
    iget v0, p1, Lio/flutter/embedding/engine/i/i$b;->e:I
    ...
    iget v1, p1, Lio/flutter/embedding/engine/i/i$b;->a:I
    ...
    iget-object v1, p1, Lio/flutter/embedding/engine/i/i$b;->b:Ljava/lang/String;
    ...
    iget-object v1, p1, Lio/flutter/embedding/engine/i/i$b;->f:Ljava/nio/ByteBuffer;

    if-eqz v1, :cond_0

    invoke-virtual {v4}, Lio/flutter/plugin/platform/f;->b()Lc/a/c/a/g;

    move-result-object v0

    iget-object v1, p1, Lio/flutter/embedding/engine/i/i$b;->f:Ljava/nio/ByteBuffer;

    invoke-interface {v0, v1}, Lc/a/c/a/g;->b(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    iget-wide v1, p1, Lio/flutter/embedding/engine/i/i$b;->c:D
    ...
    iget-wide v1, p1, Lio/flutter/embedding/engine/i/i$b;->d:D
    ...
    invoke-static {v0}, Lio/flutter/plugin/platform/j;->q(Lio/flutter/plugin/platform/j;)Lio/flutter/view/e;

    move-result-object v0

    invoke-interface {v0}, Lio/flutter/view/e;->a()Lio/flutter/view/e$a;
    ...
    iget v8, p1, Lio/flutter/embedding/engine/i/i$b;->a:I

    new-instance v10, Lio/flutter/plugin/platform/a;

    invoke-direct {v10, p0, p1}, Lio/flutter/plugin/platform/a;-><init>(Lio/flutter/plugin/platform/j$a;Lio/flutter/embedding/engine/i/i$b;)V

    move-object v5, v0

    invoke-static/range {v2 .. v10}, Lio/flutter/plugin/platform/k;->a(Landroid/content/Context;Lio/flutter/plugin/platform/c;Lio/flutter/plugin/platform/f;Lio/flutter/view/e$a;IIILjava/lang/Object;Landroid/view/View$OnFocusChangeListener;)Lio/flutter/plugin/platform/k;
    ...
    iget v3, p1, Lio/flutter/embedding/engine/i/i$b;->a:I
    ...
    iget p1, p1, Lio/flutter/embedding/engine/i/i$b;->e:I
    ...
    invoke-interface {v0}, Lio/flutter/view/e$a;->c()J
    ...
    iget-object v2, p1, Lio/flutter/embedding/engine/i/i$b;->b:Ljava/lang/String;
    ...
    iget p1, p1, Lio/flutter/embedding/engine/i/i$b;->a:I
    ...
    iget-object p1, p1, Lio/flutter/embedding/engine/i/i$b;->b:Ljava/lang/String;
    ...
    iget v2, p1, Lio/flutter/embedding/engine/i/i$b;->e:I
...
.method public g(Lio/flutter/embedding/engine/i/i$b;)V
    .locals 4
    ...
    iget-object v2, p1, Lio/flutter/embedding/engine/i/i$b;->f:Ljava/nio/ByteBuffer;

    if-eqz v2, :cond_0

    invoke-virtual {v0}, Lio/flutter/plugin/platform/f;->b()Lc/a/c/a/g;

    move-result-object v1

    iget-object v2, p1, Lio/flutter/embedding/engine/i/i$b;->f:Ljava/nio/ByteBuffer;

    invoke-interface {v1, v2}, Lc/a/c/a/g;->b(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
...
.method public h(Lio/flutter/embedding/engine/i/i$d;)V
    .locals 4

    iget v0, p1, Lio/flutter/embedding/engine/i/i$d;->a:I
    ...
    invoke-virtual {v0, v1, p1, v2}, Lio/flutter/plugin/platform/j;->X(FLio/flutter/embedding/engine/i/i$d;Z)Landroid/view/MotionEvent;
    ...
    iget p1, p1, Lio/flutter/embedding/engine/i/i$d;->a:I
...
.method public synthetic j(Lio/flutter/embedding/engine/i/i$b;Landroid/view/View;Z)V
    .locals 0
    ...
    invoke-static {p2}, Lio/flutter/plugin/platform/j;->k(Lio/flutter/plugin/platform/j;)Lio/flutter/embedding/engine/i/i;

    move-result-object p2

    iget p1, p1, Lio/flutter/embedding/engine/i/i$b;->a:I

    invoke-virtual {p2, p1}, Lio/flutter/embedding/engine/i/i;->d(I)V
