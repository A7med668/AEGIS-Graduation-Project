...
.field private g:Lio/flutter/embedding/engine/i/i;
...
.field private final r:Lio/flutter/embedding/android/k;

.field private final s:Lio/flutter/embedding/engine/i/i$e;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lio/flutter/plugin/platform/j;->s:Lio/flutter/embedding/engine/i/i$e;
    ...
    invoke-static {}, Lio/flutter/embedding/android/k;->a()Lio/flutter/embedding/android/k;

    move-result-object v0

    iput-object v0, p0, Lio/flutter/plugin/platform/j;->r:Lio/flutter/embedding/android/k;
...
.method private F()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/j;->s:Lio/flutter/embedding/engine/i/i$e;
    ...
    invoke-interface {v0, v1}, Lio/flutter/embedding/engine/i/i$e;->b(I)V
...
.method private L(Lio/flutter/plugin/platform/k;)V
    .locals 1
    ...
    :cond_0
    invoke-virtual {v0}, Lio/flutter/plugin/editing/d;->s()V
...
.method private static U(Ljava/lang/Object;F)Ljava/util/List;
    ...
    invoke-static {v1, p1}, Lio/flutter/plugin/platform/j;->T(Ljava/lang/Object;F)Landroid/view/MotionEvent$PointerCoords;
...
.method private static W(Ljava/lang/Object;)Ljava/util/List;
    ...
    invoke-static {v1}, Lio/flutter/plugin/platform/j;->V(Ljava/lang/Object;)Landroid/view/MotionEvent$PointerProperties;
...
.method private Z(Lio/flutter/plugin/platform/k;)V
    .locals 1
...
.method private b0(II)V
    ...
    invoke-static {p2, p1}, Lc/a/b;->e(Ljava/lang/String;Ljava/lang/String;)V
...
.method static synthetic e(I)Z
    ...
    invoke-static {p0}, Lio/flutter/plugin/platform/j;->a0(I)Z
...
.method static synthetic i(Lio/flutter/plugin/platform/j;Lio/flutter/plugin/platform/k;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/j;->L(Lio/flutter/plugin/platform/k;)V
...
.method static synthetic j(Lio/flutter/plugin/platform/j;Lio/flutter/plugin/platform/k;)V
    ...
    invoke-direct {p0, p1}, Lio/flutter/plugin/platform/j;->Z(Lio/flutter/plugin/platform/k;)V

    return-void
.end method

.method static synthetic k(Lio/flutter/plugin/platform/j;)Lio/flutter/embedding/engine/i/i;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/j;->g:Lio/flutter/embedding/engine/i/i;
...
.method static synthetic o(Lio/flutter/plugin/platform/j;D)I
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/j;->Y(D)I
...
.method static synthetic p(Lio/flutter/plugin/platform/j;II)V
    ...
    invoke-direct {p0, p1, p2}, Lio/flutter/plugin/platform/j;->b0(II)V

    return-void
.end method

.method static synthetic q(Lio/flutter/plugin/platform/j;)Lio/flutter/view/e;
    .locals 0

    iget-object p0, p0, Lio/flutter/plugin/platform/j;->e:Lio/flutter/view/e;
...
.method public B()V
    ...
    iget-object v0, p0, Lio/flutter/plugin/platform/j;->g:Lio/flutter/embedding/engine/i/i;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    invoke-virtual {v0, v1}, Lio/flutter/embedding/engine/i/i;->e(Lio/flutter/embedding/engine/i/i$e;)V

    :cond_0
    iput-object v1, p0, Lio/flutter/plugin/platform/j;->g:Lio/flutter/embedding/engine/i/i;

    iput-object v1, p0, Lio/flutter/plugin/platform/j;->c:Landroid/content/Context;

    iput-object v1, p0, Lio/flutter/plugin/platform/j;->e:Lio/flutter/view/e;
...
.method I(I)V
    ...
    :cond_0
    invoke-interface {v0}, Lio/flutter/plugin/platform/e;->c()Landroid/view/View;
...
.method public Q(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    invoke-interface {p3}, Lio/flutter/plugin/platform/e;->c()Landroid/view/View;
...
.method public X(FLio/flutter/embedding/engine/i/i$d;Z)Landroid/view/MotionEvent;
    .locals 20

    move-object/from16 v0, p2

    iget-wide v1, v0, Lio/flutter/embedding/engine/i/i$d;->p:J

    invoke-static {v1, v2}, Lio/flutter/embedding/android/k$a;->c(J)Lio/flutter/embedding/android/k$a;

    move-result-object v1

    move-object/from16 v2, p0

    iget-object v3, v2, Lio/flutter/plugin/platform/j;->r:Lio/flutter/embedding/android/k;

    invoke-virtual {v3, v1}, Lio/flutter/embedding/android/k;->b(Lio/flutter/embedding/android/k$a;)Landroid/view/MotionEvent;

    move-result-object v1

    iget-object v3, v0, Lio/flutter/embedding/engine/i/i$d;->f:Ljava/lang/Object;

    invoke-static {v3}, Lio/flutter/plugin/platform/j;->W(Ljava/lang/Object;)Ljava/util/List;

    move-result-object v3

    iget v4, v0, Lio/flutter/embedding/engine/i/i$d;->e:I
    ...
    iget-object v3, v0, Lio/flutter/embedding/engine/i/i$d;->g:Ljava/lang/Object;

    move/from16 v4, p1

    invoke-static {v3, v4}, Lio/flutter/plugin/platform/j;->U(Ljava/lang/Object;F)Ljava/util/List;
    ...
    iget v9, v0, Lio/flutter/embedding/engine/i/i$d;->e:I
    ...
    :cond_0
    iget-object v1, v0, Lio/flutter/embedding/engine/i/i$d;->b:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v4

    iget-object v1, v0, Lio/flutter/embedding/engine/i/i$d;->c:Ljava/lang/Number;

    invoke-virtual {v1}, Ljava/lang/Number;->longValue()J

    move-result-wide v6

    iget v8, v0, Lio/flutter/embedding/engine/i/i$d;->d:I

    iget v9, v0, Lio/flutter/embedding/engine/i/i$d;->e:I

    iget v12, v0, Lio/flutter/embedding/engine/i/i$d;->h:I

    iget v13, v0, Lio/flutter/embedding/engine/i/i$d;->i:I

    iget v14, v0, Lio/flutter/embedding/engine/i/i$d;->j:F

    iget v15, v0, Lio/flutter/embedding/engine/i/i$d;->k:F

    iget v1, v0, Lio/flutter/embedding/engine/i/i$d;->l:I

    iget v3, v0, Lio/flutter/embedding/engine/i/i$d;->m:I

    iget v2, v0, Lio/flutter/embedding/engine/i/i$d;->n:I

    iget v0, v0, Lio/flutter/embedding/engine/i/i$d;->o:I
...
.method public d(Ljava/lang/Integer;)Landroid/view/View;
    ...
    invoke-interface {p1}, Lio/flutter/plugin/platform/e;->c()Landroid/view/View;
...
.method public t(Landroid/content/Context;Lio/flutter/view/e;Lio/flutter/embedding/engine/e/a;)V
    .locals 1
    ...
    iput-object p2, p0, Lio/flutter/plugin/platform/j;->e:Lio/flutter/view/e;

    new-instance p1, Lio/flutter/embedding/engine/i/i;

    invoke-direct {p1, p3}, Lio/flutter/embedding/engine/i/i;-><init>(Lio/flutter/embedding/engine/e/a;)V

    iput-object p1, p0, Lio/flutter/plugin/platform/j;->g:Lio/flutter/embedding/engine/i/i;

    iget-object p2, p0, Lio/flutter/plugin/platform/j;->s:Lio/flutter/embedding/engine/i/i$e;

    invoke-virtual {p1, p2}, Lio/flutter/embedding/engine/i/i;->e(Lio/flutter/embedding/engine/i/i$e;)V
...
.method public y()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {p0, v0}, Lio/flutter/plugin/platform/j;->z(Lio/flutter/embedding/android/g;)Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public z(Lio/flutter/embedding/android/g;)Lio/flutter/embedding/engine/FlutterOverlaySurface;
    .locals 2
