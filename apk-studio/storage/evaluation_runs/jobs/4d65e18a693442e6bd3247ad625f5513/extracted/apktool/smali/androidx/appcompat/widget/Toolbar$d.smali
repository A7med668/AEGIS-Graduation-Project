...
.field final synthetic h:Landroidx/appcompat/widget/Toolbar;
...
.method public d(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->g:Landroidx/appcompat/view/menu/i;
...
.method public f(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->g:Landroidx/appcompat/view/menu/i;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->f:Landroidx/appcompat/view/menu/g;

    invoke-virtual {v2, v1}, Landroidx/appcompat/view/menu/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->g:Landroidx/appcompat/view/menu/i;
...
.method public i(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/i;)Z
    ...
    instance-of v0, p1, La/a/n/c;

    if-eqz v0, :cond_0

    check-cast p1, La/a/n/c;

    invoke-interface {p1}, La/a/n/c;->f()V

    :cond_0
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->h:Landroidx/appcompat/widget/Toolbar;

    iget-object v0, p1, Landroidx/appcompat/widget/Toolbar;->n:Landroid/view/View;

    invoke-virtual {p1, v0}, Landroid/view/ViewGroup;->removeView(Landroid/view/View;)V

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->h:Landroidx/appcompat/widget/Toolbar;

    iget-object v0, p1, Landroidx/appcompat/widget/Toolbar;->m:Landroid/widget/ImageButton;
    ...
    iput-object v0, p1, Landroidx/appcompat/widget/Toolbar;->n:Landroid/view/View;

    invoke-virtual {p1}, Landroidx/appcompat/widget/Toolbar;->a()V

    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->g:Landroidx/appcompat/view/menu/i;
...
.method public j(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/i;)Z
    ...
    iget-object p1, p1, Landroidx/appcompat/widget/Toolbar;->m:Landroid/widget/ImageButton;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/Toolbar;->m:Landroid/widget/ImageButton;
    ...
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->g:Landroidx/appcompat/view/menu/i;
    ...
    iget v2, v1, Landroidx/appcompat/widget/Toolbar;->s:I
    ...
    iget-object v0, v1, Landroidx/appcompat/widget/Toolbar;->n:Landroid/view/View;
    ...
    iget-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->h:Landroidx/appcompat/widget/Toolbar;

    iget-object p2, p2, Landroidx/appcompat/widget/Toolbar;->n:Landroid/view/View;

    instance-of v0, p2, La/a/n/c;

    if-eqz v0, :cond_4

    check-cast p2, La/a/n/c;

    invoke-interface {p2}, La/a/n/c;->c()V
