...
.field B:Landroidx/appcompat/widget/c$e;

.field C:Landroidx/appcompat/widget/c$a;

.field D:Landroidx/appcompat/widget/c$c;

.field private E:Landroidx/appcompat/widget/c$b;

.field final F:Landroidx/appcompat/widget/c$f;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->F:Landroidx/appcompat/widget/c$f;
...
.method static synthetic r(Landroidx/appcompat/widget/c;)Landroidx/appcompat/view/menu/g;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/b;->h:Landroidx/appcompat/view/menu/g;
...
.method static synthetic t(Landroidx/appcompat/widget/c;)Landroidx/appcompat/view/menu/n;
    ...
    iget-object p0, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/n;
...
.method private y(Landroid/view/MenuItem;)Landroid/view/View;
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/n;
...
.method public A()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c;->D:Landroidx/appcompat/widget/c$c;

    const/4 v1, 0x1

    if-eqz v0, :cond_0

    iget-object v2, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/n;
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/c;->D:Landroidx/appcompat/widget/c$c;

    return v1

    :cond_0
    iget-object v0, p0, Landroidx/appcompat/widget/c;->B:Landroidx/appcompat/widget/c$e;
...
.method public B()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/c;->C:Landroidx/appcompat/widget/c$a;
...
.method public E(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->g:Landroid/content/Context;
    ...
    :cond_0
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->h:Landroidx/appcompat/view/menu/g;
...
.method public G(Landroidx/appcompat/widget/ActionMenuView;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/n;

    iget-object v0, p0, Landroidx/appcompat/view/menu/b;->h:Landroidx/appcompat/view/menu/g;
...
.method public J()Z
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/n;

    if-eqz v1, :cond_0

    iget-object v1, p0, Landroidx/appcompat/widget/c;->D:Landroidx/appcompat/widget/c$c;
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->g:Landroid/content/Context;

    iget-object v4, p0, Landroidx/appcompat/view/menu/b;->h:Landroidx/appcompat/view/menu/g;
    ...
    iput-object v1, p0, Landroidx/appcompat/widget/c;->D:Landroidx/appcompat/widget/c$c;
    ...
    invoke-super {p0, v0}, Landroidx/appcompat/view/menu/b;->e(Landroidx/appcompat/view/menu/r;)Z
...
.method public c(Landroidx/appcompat/view/menu/i;Landroidx/appcompat/view/menu/n$a;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/n;
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/c;->E:Landroidx/appcompat/widget/c$b;
    ...
    iput-object p1, p0, Landroidx/appcompat/widget/c;->E:Landroidx/appcompat/widget/c$b;
...
.method public d(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V
    ...
    iput-boolean v3, p0, Landroidx/appcompat/widget/c;->p:Z
...
.method public e(Landroidx/appcompat/view/menu/r;)Z
    ...
    iget-object v3, p0, Landroidx/appcompat/view/menu/b;->h:Landroidx/appcompat/view/menu/g;
    ...
    iput-object v2, p0, Landroidx/appcompat/widget/c;->C:Landroidx/appcompat/widget/c$a;
...
.method public f(Z)V
    ...
    invoke-virtual {v3}, Landroidx/appcompat/view/menu/i;->b()La/g/k/b;

    move-result-object v3

    if-eqz v3, :cond_0

    invoke-virtual {v3, p0}, La/g/k/b;->i(La/g/k/b$a;)V
...
.method public g()Z
    ...
    iget-object v1, v0, Landroidx/appcompat/view/menu/b;->h:Landroidx/appcompat/view/menu/g;
    ...
    :goto_0
    iget v5, v0, Landroidx/appcompat/widget/c;->u:I

    iget v6, v0, Landroidx/appcompat/widget/c;->t:I

    invoke-static {v3, v3}, Landroid/view/View$MeasureSpec;->makeMeasureSpec(II)I

    move-result v7

    iget-object v8, v0, Landroidx/appcompat/view/menu/b;->m:Landroidx/appcompat/view/menu/n;
    ...
    :goto_2
    iget-boolean v13, v0, Landroidx/appcompat/widget/c;->y:Z
    ...
    :cond_4
    iget-boolean v9, v0, Landroidx/appcompat/widget/c;->q:Z
    ...
    iget-object v9, v0, Landroidx/appcompat/widget/c;->A:Landroid/util/SparseBooleanArray;

    invoke-virtual {v9}, Landroid/util/SparseBooleanArray;->clear()V

    iget-boolean v10, v0, Landroidx/appcompat/widget/c;->w:Z

    if-eqz v10, :cond_7

    iget v10, v0, Landroidx/appcompat/widget/c;->z:I
    ...
    :cond_11
    iget-boolean v4, v0, Landroidx/appcompat/widget/c;->w:Z
