...
.field private dynamicFeatureManager:Lio/flutter/embedding/engine/f/a;
...
.method private handlePlatformMessageResponse(I[B)V
    ...
    invoke-interface {v0, p1, p2}, Lio/flutter/embedding/engine/e/c;->c(I[B)V
...
.method private native nativeDynamicFeatureInstallFailure(ILjava/lang/String;Z)V
.end method
...
.method private native nativeUpdateAssetManager(JLandroid/content/res/AssetManager;Ljava/lang/String;)V
.end method
...
.method private updateSemantics(Ljava/nio/ByteBuffer;[Ljava/lang/String;)V
    ...
    invoke-interface {v0, p1, p2}, Lio/flutter/embedding/engine/FlutterJNI$a;->e(Ljava/nio/ByteBuffer;[Ljava/lang/String;)V
...
.method computePlatformResolvedLocale([Ljava/lang/String;)[Ljava/lang/String;
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->localizationPlugin:Lc/a/c/b/a;
    ...
    invoke-virtual {p1, v0}, Lc/a/c/b/a;->a(Ljava/util/List;)Ljava/util/Locale;
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    invoke-virtual {v0}, Lio/flutter/plugin/platform/j;->y()Lio/flutter/embedding/engine/FlutterOverlaySurface;
...
.method public dispatchSemanticsAction(ILio/flutter/view/c$f;Ljava/lang/Object;)V
    ...
    sget-object v0, Lc/a/c/a/q;->a:Lc/a/c/a/q;

    invoke-virtual {v0, p3}, Lc/a/c/a/q;->a(Ljava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :goto_0
    iget p2, p2, Lio/flutter/view/c$f;->f:I
...
.method public dynamicFeatureInstallFailure(ILjava/lang/String;Z)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    invoke-direct {p0, p1, p2, p3}, Lio/flutter/embedding/engine/FlutterJNI;->nativeDynamicFeatureInstallFailure(ILjava/lang/String;Z)V
...
.method public handlePlatformMessage(Ljava/lang/String;[BI)V
    ...
    invoke-interface {v0, p1, p2, p3}, Lio/flutter/embedding/engine/e/c;->d(Ljava/lang/String;[BI)V
...
.method public onDisplayOverlaySurface(IIIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Lio/flutter/plugin/platform/j;->P(IIIII)V
...
.method public onDisplayPlatformView(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
    ...
    iget-object v1, v0, Lio/flutter/embedding/engine/FlutterJNI;->platformViewsController:Lio/flutter/plugin/platform/j;
    ...
    invoke-virtual/range {v1 .. v9}, Lio/flutter/plugin/platform/j;->Q(IIIIIIILio/flutter/embedding/engine/mutatorsstack/FlutterMutatorsStack;)V
...
.method public requestDartDeferredLibrary(I)V
    ...
    iget-object v0, p0, Lio/flutter/embedding/engine/FlutterJNI;->dynamicFeatureManager:Lio/flutter/embedding/engine/f/a;

    if-eqz v0, :cond_0

    const/4 v1, 0x0

    invoke-interface {v0, p1, v1}, Lio/flutter/embedding/engine/f/a;->a(ILjava/lang/String;)V
    ...
    const-string v0, "No DynamicFeatureManager found. Android setup must be completed before using split AOT dynamic features."
...
.method public setDynamicFeatureManager(Lio/flutter/embedding/engine/f/a;)V
    .locals 0

    invoke-direct {p0}, Lio/flutter/embedding/engine/FlutterJNI;->ensureRunningOnMainThread()V

    iput-object p1, p0, Lio/flutter/embedding/engine/FlutterJNI;->dynamicFeatureManager:Lio/flutter/embedding/engine/f/a;

    if-eqz p1, :cond_0

    invoke-interface {p1, p0}, Lio/flutter/embedding/engine/f/a;->b(Lio/flutter/embedding/engine/FlutterJNI;)V
...
.method public updateAssetManager(Landroid/content/res/AssetManager;Ljava/lang/String;)V
    .locals 2
    ...
    invoke-direct {p0, v0, v1, p1, p2}, Lio/flutter/embedding/engine/FlutterJNI;->nativeUpdateAssetManager(JLandroid/content/res/AssetManager;Ljava/lang/String;)V
