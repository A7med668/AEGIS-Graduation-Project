...
.method public final drawCircle-VaOC9Bg(FIJJ)V
    ...
    invoke-virtual/range {p0 .. p6}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->drawCircle-VaOC9Bg(FIJJ)V
...
.method public final drawContent()V
    ...
    iget-object v1, v0, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->drawContext:Lkotlin/text/MatcherMatchResult;
...
.method public final drawDirect-eZhPAX0$ui(Landroidx/compose/ui/graphics/Canvas;JLandroidx/compose/ui/node/NodeCoordinator;Landroidx/compose/ui/node/DrawModifierNode;Landroidx/compose/ui/graphics/layer/GraphicsLayer;)V
    ...
    invoke-virtual {v3}, Lkotlin/text/MatcherMatchResult;->getDensity()Landroidx/compose/ui/unit/Density;

    move-result-object v3

    iget-object v2, v2, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->drawContext:Lkotlin/text/MatcherMatchResult;
    ...
    invoke-virtual {v2}, Lkotlin/text/MatcherMatchResult;->getSize-NH-jbRc()J
    ...
    invoke-virtual {v2, p4}, Lkotlin/text/MatcherMatchResult;->setDensity(Landroidx/compose/ui/unit/Density;)V

    invoke-virtual {v2, v1}, Lkotlin/text/MatcherMatchResult;->setLayoutDirection(Landroidx/compose/ui/unit/LayoutDirection;)V

    invoke-virtual {v2, p1}, Lkotlin/text/MatcherMatchResult;->setCanvas(Landroidx/compose/ui/graphics/Canvas;)V

    invoke-virtual {v2, p2, p3}, Lkotlin/text/MatcherMatchResult;->setSize-uvyYCjk(J)V

    iput-object p6, v2, Lkotlin/text/MatcherMatchResult;->input:Ljava/lang/Object;
    ...
    invoke-virtual {v2, v3}, Lkotlin/text/MatcherMatchResult;->setDensity(Landroidx/compose/ui/unit/Density;)V

    invoke-virtual {v2, v4}, Lkotlin/text/MatcherMatchResult;->setLayoutDirection(Landroidx/compose/ui/unit/LayoutDirection;)V

    invoke-virtual {v2, v5}, Lkotlin/text/MatcherMatchResult;->setCanvas(Landroidx/compose/ui/graphics/Canvas;)V

    invoke-virtual {v2, v6, v7}, Lkotlin/text/MatcherMatchResult;->setSize-uvyYCjk(J)V

    iput-object v8, v2, Lkotlin/text/MatcherMatchResult;->input:Ljava/lang/Object;
...
.method public final drawRect-n-J9OG0(JJIJ)V
    ...
    invoke-virtual/range {p0 .. p7}, Landroidx/compose/ui/graphics/drawscope/CanvasDrawScope;->drawRect-n-J9OG0(JJIJ)V
