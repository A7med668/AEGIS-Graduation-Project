...
.field public final calculateWindowSizeLambda:Landroidx/compose/ui/node/LayoutNode$_foldedChildren$1;
...
.method public constructor <init>(Landroidx/compose/ui/platform/ComposeViewContext;Landroid/view/View;Landroidx/compose/runtime/CompositionContext;Landroidx/lifecycle/LifecycleOwner;Landroidx/savedstate/SavedStateRegistryOwner;Landroidx/activity/ComponentActivity;)V
    ...
    new-instance p5, Lkotlin/time/Duration$Companion;

    const/4 p6, 0x6

    invoke-direct {p5, p6}, Lkotlin/time/Duration$Companion;-><init>(I)V
    ...
    invoke-direct {p4, p5, p6}, Landroidx/compose/ui/text/font/FontFamilyResolverImpl;-><init>(Lkotlin/time/Duration$Companion;Landroidx/compose/ui/text/font/AndroidFontResolveInterceptor;)V
    ...
    iput-object p1, p0, Landroidx/compose/ui/platform/ComposeViewContext;->calculateWindowSizeLambda:Landroidx/compose/ui/node/LayoutNode$_foldedChildren$1;
...
.method public final ProvideCompositionLocals$ui(Landroidx/compose/ui/platform/AndroidComposeView;Lkotlin/jvm/functions/Function2;Landroidx/compose/runtime/GapComposer;I)V
    ...
    invoke-interface {v5}, Landroidx/savedstate/SavedStateRegistryOwner;->getSavedStateRegistry()Landroidx/room/concurrent/FileLock;

    move-result-object v5

    invoke-virtual {v5, v11}, Landroidx/room/concurrent/FileLock;->consumeRestoredStateForKey(Ljava/lang/String;)Landroid/os/Bundle;
    ...
    :cond_e
    sget-object v12, Landroidx/compose/ui/platform/CompositionLocalsKt$LocalLocale$1;->INSTANCE$4:Landroidx/compose/ui/platform/CompositionLocalsKt$LocalLocale$1;
    ...
    invoke-virtual {v5, v11}, Landroidx/room/concurrent/FileLock;->getSavedStateProvider(Ljava/lang/String;)Landroidx/savedstate/SavedStateRegistry$SavedStateProvider;
    ...
    invoke-virtual {v5, v11, v10}, Landroidx/room/concurrent/FileLock;->registerSavedStateProvider(Ljava/lang/String;Landroidx/savedstate/SavedStateRegistry$SavedStateProvider;)V
    :try_end_0
    ...
    invoke-direct {v10, v8, v5, v11}, Landroidx/compose/ui/platform/DisposableSaveableStateRegistry_androidKt$DisposableSaveableStateRegistry$1;-><init>(ZLandroidx/room/concurrent/FileLock;Ljava/lang/String;)V
...
.method public final incrementViewCount$ui()V
    ...
    iget-object p0, p0, Landroidx/compose/ui/platform/ComposeViewContext;->calculateWindowSizeLambda:Landroidx/compose/ui/node/LayoutNode$_foldedChildren$1;
...
.method public final onConfigurationChanged$ui(Landroid/content/res/Configuration;)V
    ...
    new-instance v3, Lkotlin/time/Duration$Companion;

    const/4 v4, 0x6

    invoke-direct {v3, v4}, Lkotlin/time/Duration$Companion;-><init>(I)V
    ...
    invoke-direct {v2, v3, v4}, Landroidx/compose/ui/text/font/FontFamilyResolverImpl;-><init>(Lkotlin/time/Duration$Companion;Landroidx/compose/ui/text/font/AndroidFontResolveInterceptor;)V
...
.method public final resolveValuesIfNeeded()V
    ...
    invoke-static {v2}, Landroidx/recyclerview/widget/OrientationHelper$1;->getParentOrViewTreeDisjointParent(Landroid/view/View;)Landroid/view/ViewParent;
    ...
    invoke-static {v1}, Landroidx/room/util/DBUtil;->get(Landroid/view/View;)Landroidx/savedstate/SavedStateRegistryOwner;
