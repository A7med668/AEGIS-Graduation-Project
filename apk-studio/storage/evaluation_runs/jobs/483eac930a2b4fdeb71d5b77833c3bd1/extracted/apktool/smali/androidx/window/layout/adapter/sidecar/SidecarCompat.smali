...
.field public extensionCallback:Lkotlin/text/MatcherMatchResult;
...
.method public final onWindowLayoutChangeListenerRemoved(Landroid/app/Activity;)V
    ...
    :cond_3
    instance-of v4, p1, Landroidx/activity/ComponentActivity;
    ...
    iget-object v4, v4, Landroidx/activity/ComponentActivity;->onConfigurationChangedListeners:Ljava/util/concurrent/CopyOnWriteArrayList;
    ...
    :goto_1
    iget-object v2, p0, Landroidx/window/layout/adapter/sidecar/SidecarCompat;->extensionCallback:Lkotlin/text/MatcherMatchResult;

    if-eqz v2, :cond_5

    iget-object v3, v2, Lkotlin/text/MatcherMatchResult;->input:Ljava/lang/Object;
    ...
    :try_start_0
    iget-object v2, v2, Lkotlin/text/MatcherMatchResult;->groups:Ljava/lang/Object;
...
.method public final register(Landroid/os/IBinder;Landroid/app/Activity;)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/window/layout/adapter/sidecar/SidecarCompat;->extensionCallback:Lkotlin/text/MatcherMatchResult;
    ...
    invoke-virtual {p1, p2, v0}, Lkotlin/text/MatcherMatchResult;->onWindowLayoutChanged(Landroid/app/Activity;Landroidx/window/layout/WindowLayoutInfo;)V
    ...
    instance-of v0, p2, Landroidx/activity/ComponentActivity;
    ...
    iget-object p0, p2, Landroidx/activity/ComponentActivity;->onConfigurationChangedListeners:Ljava/util/concurrent/CopyOnWriteArrayList;
...
.method public final setExtensionCallback(Landroidx/core/view/MenuHostHelper;)V
    .locals 2
    ...
    iput-object v0, p0, Landroidx/window/layout/adapter/sidecar/SidecarCompat;->extensionCallback:Lkotlin/text/MatcherMatchResult;
