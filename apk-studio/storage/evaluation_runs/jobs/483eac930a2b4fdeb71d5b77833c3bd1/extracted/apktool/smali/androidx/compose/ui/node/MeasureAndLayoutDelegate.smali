...
.field public final relayoutNodes:Lkotlin/text/MatcherMatchResult;
...
.method public constructor <init>(Landroidx/compose/ui/node/LayoutNode;)V
    ...
    iput-object p1, p0, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;->relayoutNodes:Lkotlin/text/MatcherMatchResult;
...
.method public final ensureSubtreeLookaheadReplaced(Landroidx/compose/ui/node/LayoutNode;)V
    ...
    iget-object v3, p0, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;->relayoutNodes:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {v3, v2}, Lkotlin/text/MatcherMatchResult;->contains(Landroidx/compose/ui/node/LayoutNode;)Z
...
.method public final forceMeasureTheSubtreeInternal(Landroidx/compose/ui/node/LayoutNode;Z)V
    ...
    iget-object v4, p0, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;->relayoutNodes:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {v4, v3}, Lkotlin/text/MatcherMatchResult;->contains(Landroidx/compose/ui/node/LayoutNode;)Z
...
.method public final measureAndLayout(Lkotlin/jvm/functions/Function0;)Z
    ...
    iget-object v0, v1, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;->relayoutNodes:Lkotlin/text/MatcherMatchResult;
    ...
    iget-object v6, v0, Lkotlin/text/MatcherMatchResult;->matcher:Ljava/lang/Object;
    ...
    :goto_0
    :try_start_1
    iget-object v7, v0, Lkotlin/text/MatcherMatchResult;->groups:Ljava/lang/Object;
    ...
    iget-object v9, v6, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;
    ...
    iget-object v7, v6, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;
    ...
    invoke-virtual {v6, v7}, Landroidx/core/view/MenuHostHelper;->remove(Landroidx/compose/ui/node/LayoutNode;)Z
    ...
    :cond_5
    iget-object v9, v8, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;
    ...
    iget-object v7, v8, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;
    ...
    invoke-virtual {v8, v7}, Landroidx/core/view/MenuHostHelper;->remove(Landroidx/compose/ui/node/LayoutNode;)Z
    ...
    :cond_7
    iget-object v8, v7, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;
    ...
    invoke-virtual {v7, v8}, Landroidx/core/view/MenuHostHelper;->remove(Landroidx/compose/ui/node/LayoutNode;)Z
    ...
    invoke-virtual {v0, v7, v9}, Lkotlin/text/MatcherMatchResult;->add(Landroidx/compose/ui/node/LayoutNode;Landroidx/compose/ui/node/Invalidation;)V
    ...
    iget-object v8, v7, Landroidx/compose/ui/node/NodeChain;->innerCoordinator:Landroidx/compose/ui/node/InnerNodeCoordinator;
    ...
    iget-object v14, v7, Landroidx/compose/ui/node/NodeChain;->innerCoordinator:Landroidx/compose/ui/node/InnerNodeCoordinator;
...
.method public final measureAndLayout-0kLqBqw(Landroidx/compose/ui/node/LayoutNode;J)V
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;->relayoutNodes:Lkotlin/text/MatcherMatchResult;

    iget-object v3, v0, Lkotlin/text/MatcherMatchResult;->matcher:Ljava/lang/Object;

    check-cast v3, Landroidx/core/view/MenuHostHelper;

    invoke-virtual {v3, p1}, Landroidx/core/view/MenuHostHelper;->remove(Landroidx/compose/ui/node/LayoutNode;)Z
    ...
    invoke-virtual {v0, p1}, Landroidx/core/view/MenuHostHelper;->remove(Landroidx/compose/ui/node/LayoutNode;)Z
    ...
    iget-object v9, v0, Landroidx/compose/ui/node/NodeChain;->innerCoordinator:Landroidx/compose/ui/node/InnerNodeCoordinator;
...
.method public final measureOnly()V
    ...
    :try_start_0
    iget-object v4, v0, Lkotlin/text/MatcherMatchResult;->groups:Ljava/lang/Object;
...
.method public final requestRemeasure(Landroidx/compose/ui/node/LayoutNode;Z)Z
    ...
    :cond_3
    iget-object p2, p0, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;->relayoutNodes:Lkotlin/text/MatcherMatchResult;

    sget-object v0, Landroidx/compose/ui/node/Invalidation;->Measurement:Landroidx/compose/ui/node/Invalidation;

    invoke-virtual {p2, p1, v0}, Lkotlin/text/MatcherMatchResult;->add(Landroidx/compose/ui/node/LayoutNode;Landroidx/compose/ui/node/Invalidation;)V
...
.method public final updateRootConstraints-BRTryo0(J)V
    ...
    :goto_1
    iget-object p0, p0, Landroidx/compose/ui/node/MeasureAndLayoutDelegate;->relayoutNodes:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {p0, p1, p2}, Lkotlin/text/MatcherMatchResult;->add(Landroidx/compose/ui/node/LayoutNode;Landroidx/compose/ui/node/Invalidation;)V
