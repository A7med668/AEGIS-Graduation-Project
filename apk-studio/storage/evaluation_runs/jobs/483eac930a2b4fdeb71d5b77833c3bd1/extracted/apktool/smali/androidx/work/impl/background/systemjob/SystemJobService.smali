...
.field public final mStartStopTokens:Landroidx/lifecycle/ViewModelStore;

.field public mWorkLauncher:Landroidx/room/concurrent/FileLock;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mStartStopTokens:Landroidx/lifecycle/ViewModelStore;
...
.method public final onCreate()V
    ...
    invoke-direct {v2, v1, v0}, Landroidx/room/concurrent/FileLock;-><init>(Landroidx/work/impl/Processor;Landroidx/emoji2/text/MetadataRepo;)V

    iput-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mWorkLauncher:Landroidx/room/concurrent/FileLock;
...
.method public final onExecuted(Landroidx/work/impl/model/WorkGenerationalId;Z)V
    ...
    iget-object v1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mStartStopTokens:Landroidx/lifecycle/ViewModelStore;

    invoke-virtual {v1, p1}, Landroidx/lifecycle/ViewModelStore;->remove(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
...
.method public final onStartJob(Landroid/app/job/JobParameters;)Z
    ...
    invoke-virtual {p0, v3, p1}, Landroidx/work/Logger$LogcatLogger;->error(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance v2, Landroidx/work/SystemClock;
    ...
    iget-object p1, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mWorkLauncher:Landroidx/room/concurrent/FileLock;

    iget-object p0, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mStartStopTokens:Landroidx/lifecycle/ViewModelStore;

    invoke-virtual {p0, v0}, Landroidx/lifecycle/ViewModelStore;->tokenFor(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;

    move-result-object p0

    invoke-virtual {p1, p0, v2}, Landroidx/room/concurrent/FileLock;->startWork(Landroidx/work/impl/StartStopToken;Landroidx/work/SystemClock;)V
...
.method public final onStopJob(Landroid/app/job/JobParameters;)Z
    ...
    iget-object v2, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mStartStopTokens:Landroidx/lifecycle/ViewModelStore;

    invoke-virtual {v2, v0}, Landroidx/lifecycle/ViewModelStore;->remove(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
    ...
    :pswitch_0
    iget-object v3, p0, Landroidx/work/impl/background/systemjob/SystemJobService;->mWorkLauncher:Landroidx/room/concurrent/FileLock;

    invoke-virtual {v3}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-virtual {v3, v2, p1}, Landroidx/room/concurrent/FileLock;->stopWork(Landroidx/work/impl/StartStopToken;I)V
    ...
    iget-object p1, v0, Landroidx/work/impl/model/WorkGenerationalId;->workSpecId:Ljava/lang/String;
