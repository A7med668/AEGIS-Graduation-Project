...
.method public final createOutline-Pq9zytI(JLandroidx/compose/ui/unit/LayoutDirection;Landroidx/compose/ui/unit/Density;)Landroidx/compose/ui/graphics/ColorKt;
    ...
    invoke-static {v10, v5, v8, v6, v9}, Landroidx/work/OperationKt$$ExternalSyntheticLambda0;->m(Ljava/lang/String;FLjava/lang/String;FLjava/lang/String;)Ljava/lang/StringBuilder;
    ...
    invoke-static {v8, v9, v1, v2}, Landroidx/compose/ui/unit/DpKt;->Rect-tz77jQw(JJ)Landroidx/compose/ui/geometry/Rect;
...
.method public final lerp(Ljava/lang/Object;F)Ljava/lang/Object;
    .locals 6
    ...
    new-instance p1, Landroidx/compose/foundation/shape/PxCornerSize;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    new-instance v0, Landroidx/compose/foundation/shape/RoundedCornerShape;

    invoke-direct {v0, p1, p1, p1, p1}, Landroidx/compose/foundation/shape/RoundedCornerShape;-><init>(Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;)V
    ...
    new-instance v2, Landroidx/compose/foundation/shape/RoundedCornerShapeKt$lerp$1;

    iget-object v3, p0, Landroidx/compose/foundation/shape/RoundedCornerShape;->topStart:Landroidx/compose/foundation/shape/CornerSize;

    invoke-direct {v2, v3, v1, p2}, Landroidx/compose/foundation/shape/RoundedCornerShapeKt$lerp$1;-><init>(Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;F)V
    ...
    new-instance v3, Landroidx/compose/foundation/shape/RoundedCornerShapeKt$lerp$1;

    iget-object v4, p0, Landroidx/compose/foundation/shape/RoundedCornerShape;->topEnd:Landroidx/compose/foundation/shape/CornerSize;

    invoke-direct {v3, v4, v1, p2}, Landroidx/compose/foundation/shape/RoundedCornerShapeKt$lerp$1;-><init>(Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;F)V
    ...
    new-instance v4, Landroidx/compose/foundation/shape/RoundedCornerShapeKt$lerp$1;

    iget-object v5, p0, Landroidx/compose/foundation/shape/RoundedCornerShape;->bottomEnd:Landroidx/compose/foundation/shape/CornerSize;

    invoke-direct {v4, v5, v1, p2}, Landroidx/compose/foundation/shape/RoundedCornerShapeKt$lerp$1;-><init>(Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;F)V

    iget-object p1, p1, Landroidx/compose/foundation/shape/RoundedCornerShape;->bottomStart:Landroidx/compose/foundation/shape/CornerSize;

    new-instance v1, Landroidx/compose/foundation/shape/RoundedCornerShapeKt$lerp$1;

    iget-object p0, p0, Landroidx/compose/foundation/shape/RoundedCornerShape;->bottomStart:Landroidx/compose/foundation/shape/CornerSize;

    invoke-direct {v1, p0, p1, p2}, Landroidx/compose/foundation/shape/RoundedCornerShapeKt$lerp$1;-><init>(Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;F)V

    invoke-direct {v0, v2, v3, v4, v1}, Landroidx/compose/foundation/shape/RoundedCornerShape;-><init>(Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;Landroidx/compose/foundation/shape/CornerSize;)V
