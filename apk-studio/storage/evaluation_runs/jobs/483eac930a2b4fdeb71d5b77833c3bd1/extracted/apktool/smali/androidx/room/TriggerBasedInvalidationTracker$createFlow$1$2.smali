...
.method public final emit(Ljava/lang/Object;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->$resolvedTableNames:Ljava/lang/Object;
    ...
    :cond_3
    :goto_1
    iget-object p2, p0, Landroidx/room/TriggerBasedInvalidationTracker$createFlow$1$2;->$currentVersions:Ljava/lang/Object;
    ...
    new-instance v2, Lkotlinx/coroutines/flow/internal/ChannelFlowTransformLatest$flowCollect$3;
    ...
    invoke-direct {v2, v4, p0, p1, v3}, Lkotlinx/coroutines/flow/internal/ChannelFlowTransformLatest$flowCollect$3;-><init>(Lkotlinx/coroutines/flow/internal/ChannelFlowTransformLatest;Lkotlinx/coroutines/flow/FlowCollector;Ljava/lang/Object;Lkotlin/coroutines/Continuation;)V

    sget-object p0, Lkotlinx/coroutines/CoroutineStart;->UNDISPATCHED:Lkotlinx/coroutines/CoroutineStart;

    invoke-static {v0, v3, p0, v2, v1}, Lkotlinx/coroutines/JobKt;->launch$default(Lkotlinx/coroutines/CoroutineScope;Lkotlin/coroutines/CoroutineContext;Lkotlinx/coroutines/CoroutineStart;Lkotlin/jvm/functions/Function2;I)Lkotlinx/coroutines/StandaloneCoroutine;
    ...
    const-string p2, "EditEvent.endTime"
    ...
    instance-of p0, p1, Lkotlinx/datetime/LocalTime;
    ...
    invoke-virtual {p1, p0}, Lkotlinx/datetime/LocalTime;->compareTo(Ljava/lang/Object;)I
    ...
    check-cast v2, Landroidx/compose/material3/internal/CalendarModelImpl;

    check-cast v4, Lkotlin/ranges/IntRange;

    iget p2, v4, Lkotlin/ranges/IntProgression;->first:I
    ...
    invoke-virtual {v2, p0}, Landroidx/compose/material3/internal/CalendarModelImpl;->getMonth(Ljava/time/LocalDate;)Landroidx/compose/material3/internal/CalendarMonth;

    move-result-object p0

    iget-wide p0, p0, Landroidx/compose/material3/internal/CalendarMonth;->startUtcTimeMillis:J
    ...
    iget-object p1, v2, Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;->offsetMapping:Landroidx/compose/ui/text/input/OffsetMapping;
    ...
    iget-boolean v2, v4, Landroidx/compose/foundation/DefaultDebugIndication$DefaultDebugIndicationInstance;->isPressed:Z
