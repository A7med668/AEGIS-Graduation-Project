...
.method public static final nextFloat(Ljava/lang/String;II)J
    ...
    sget-object v3, Landroidx/compose/ui/graphics/vector/PathParserKt;->Mantissa64:[J
...
.method public static final rememberVectorPainter(Landroidx/compose/ui/graphics/vector/ImageVector;Landroidx/compose/runtime/GapComposer;)Landroidx/compose/ui/graphics/vector/VectorPainter;
    .locals 12
    ...
    invoke-virtual {p1, v1, v2}, Landroidx/compose/runtime/GapComposer;->changed(J)Z
    ...
    iget-wide v6, p0, Landroidx/compose/ui/graphics/vector/ImageVector;->tintColor:J

    iget v8, p0, Landroidx/compose/ui/graphics/vector/ImageVector;->tintBlendMode:I
    ...
    invoke-virtual {v2, v9}, Landroidx/compose/runtime/ParcelableSnapshotMutableState;->setValue(Ljava/lang/Object;)V
    ...
    iput-object v1, p0, Landroidx/compose/ui/graphics/vector/VectorComponent;->name:Ljava/lang/String;
...
.method public static final toPath(Ljava/util/List;Landroidx/compose/ui/graphics/AndroidPath;)V
    .locals 32
    ...
    iget v6, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeMoveTo;->dx:F
    ...
    iget v6, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeLineTo;->dy:F
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeCurveTo;->dx1:F

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeCurveTo;->dy1:F

    iget v6, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeCurveTo;->dx2:F

    iget v7, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeCurveTo;->dy2:F
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeCurveTo;->dx2:F

    add-float/2addr v4, v13

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeCurveTo;->dy2:F

    add-float/2addr v5, v14

    iget v6, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeCurveTo;->dx3:F
    ...
    :cond_c
    instance-of v6, v15, Landroidx/compose/ui/graphics/vector/PathNode$CurveTo;
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$CurveTo;->x1:F

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$CurveTo;->y1:F
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$CurveTo;->x2:F

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$CurveTo;->y2:F
    ...
    :cond_d
    instance-of v6, v15, Landroidx/compose/ui/graphics/vector/PathNode$RelativeReflectiveCurveTo;
    ...
    iget v6, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeReflectiveCurveTo;->dx1:F

    iget v7, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeReflectiveCurveTo;->dy1:F
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeReflectiveCurveTo;->dx1:F

    add-float/2addr v4, v13

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeReflectiveCurveTo;->dy1:F

    add-float/2addr v5, v14

    iget v6, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeReflectiveCurveTo;->dx2:F
    ...
    :cond_f
    instance-of v6, v15, Landroidx/compose/ui/graphics/vector/PathNode$ReflectiveCurveTo;
    ...
    iget v9, v2, Landroidx/compose/ui/graphics/vector/PathNode$ReflectiveCurveTo;->y2:F

    invoke-virtual/range {v3 .. v9}, Landroid/graphics/Path;->cubicTo(FFFFFF)V

    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$ReflectiveCurveTo;->x1:F

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$ReflectiveCurveTo;->y1:F
    ...
    :cond_11
    instance-of v6, v15, Landroidx/compose/ui/graphics/vector/PathNode$RelativeQuadTo;
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeQuadTo;->dy2:F

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeQuadTo;->dx2:F
    ...
    :cond_12
    instance-of v6, v15, Landroidx/compose/ui/graphics/vector/PathNode$QuadTo;
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$QuadTo;->y2:F

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$QuadTo;->x2:F
    ...
    :cond_13
    instance-of v6, v15, Landroidx/compose/ui/graphics/vector/PathNode$RelativeReflectiveQuadTo;
    ...
    iget v6, v5, Landroidx/compose/ui/graphics/vector/PathNode$RelativeReflectiveQuadTo;->dy:F
    ...
    :cond_15
    instance-of v6, v15, Landroidx/compose/ui/graphics/vector/PathNode$ReflectiveQuadTo;
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$ReflectiveQuadTo;->y:F
    ...
    iget v4, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeArcTo;->arcStartDx:F

    add-float/2addr v4, v13

    iget v5, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeArcTo;->arcStartDy:F
    ...
    iget v11, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeArcTo;->horizontalEllipseRadius:F

    float-to-double v0, v11

    iget v11, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeArcTo;->verticalEllipseRadius:F

    move-wide/from16 v21, v0

    float-to-double v0, v11

    iget v11, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeArcTo;->theta:F

    move-wide/from16 v23, v0

    float-to-double v0, v11

    iget-boolean v11, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeArcTo;->isMoreThanHalf:Z

    iget-boolean v2, v2, Landroidx/compose/ui/graphics/vector/PathNode$RelativeArcTo;->isPositiveArc:Z
    ...
    iget v1, v15, Landroidx/compose/ui/graphics/vector/PathNode$ArcTo;->arcStartY:F

    iget v6, v15, Landroidx/compose/ui/graphics/vector/PathNode$ArcTo;->arcStartX:F
    ...
    iget v11, v15, Landroidx/compose/ui/graphics/vector/PathNode$ArcTo;->horizontalEllipseRadius:F

    float-to-double v11, v11

    iget v13, v15, Landroidx/compose/ui/graphics/vector/PathNode$ArcTo;->verticalEllipseRadius:F

    float-to-double v13, v13

    move-object/from16 v23, v0

    iget v0, v15, Landroidx/compose/ui/graphics/vector/PathNode$ArcTo;->theta:F
    ...
    iget-boolean v0, v15, Landroidx/compose/ui/graphics/vector/PathNode$ArcTo;->isMoreThanHalf:Z

    iget-boolean v1, v15, Landroidx/compose/ui/graphics/vector/PathNode$ArcTo;->isPositiveArc:Z
