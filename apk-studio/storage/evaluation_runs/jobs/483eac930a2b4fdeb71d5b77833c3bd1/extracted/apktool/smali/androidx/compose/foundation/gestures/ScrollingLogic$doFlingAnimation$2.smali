...
.method public final invokeSuspend(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v11, v10, v12, v7}, Landroid/view/textclassifier/TextSelection$Request$Builder;-><init>(Ljava/lang/CharSequence;II)V
    ...
    invoke-virtual {v11, v7}, Landroid/view/textclassifier/TextSelection$Request$Builder;->setDefaultLocales(Landroid/os/LocaleList;)Landroid/view/textclassifier/TextSelection$Request$Builder;

    move-result-object v7

    invoke-virtual {v7, v2}, Landroid/view/textclassifier/TextSelection$Request$Builder;->setIncludeTextClassification(Z)Landroid/view/textclassifier/TextSelection$Request$Builder;

    invoke-virtual {v7}, Landroid/view/textclassifier/TextSelection$Request$Builder;->build()Landroid/view/textclassifier/TextSelection$Request;

    move-result-object v7

    invoke-interface {v1, v7}, Landroid/view/textclassifier/TextClassifier;->suggestSelection(Landroid/view/textclassifier/TextSelection$Request;)Landroid/view/textclassifier/TextSelection;
    ...
    invoke-static {v8, v11}, Landroidx/compose/ui/text/TextRangeKt;->TextRange(II)J
    ...
    invoke-virtual {v3, p0}, Lkotlinx/coroutines/sync/MutexImpl;->lock(Lkotlin/coroutines/jvm/internal/ContinuationImpl;)Ljava/lang/Object;
    ...
    iget-object v4, p0, Landroidx/compose/foundation/gestures/ScrollingLogic$doFlingAnimation$2;->this$0:Ljava/lang/Object;

    check-cast v4, Landroidx/compose/foundation/gestures/ScrollingLogic;

    invoke-direct {v1, v4, v0}, Landroidx/compose/foundation/gestures/ScrollingLogic$doFlingAnimation$2$reverseScope$1;-><init>(Landroidx/compose/foundation/gestures/ScrollingLogic;Landroidx/compose/foundation/gestures/ScrollingLogic$nestedScrollScope$1;)V

    move-object v0, v9

    check-cast v0, Lkotlin/jvm/internal/Ref$LongRef;

    iget-object v9, v4, Landroidx/compose/foundation/gestures/ScrollingLogic;->flingBehavior:Landroidx/compose/foundation/gestures/FlingBehavior;

    iget-wide v11, v0, Lkotlin/jvm/internal/Ref$LongRef;->element:J

    iget-object v13, v4, Landroidx/compose/foundation/gestures/ScrollingLogic;->orientation:Landroidx/compose/foundation/gestures/Orientation;
    ...
    :goto_4
    invoke-virtual {v4, v7}, Landroidx/compose/foundation/gestures/ScrollingLogic;->reverseIfNeeded(F)F
    ...
    invoke-interface {v9, v1, v7, p0}, Landroidx/compose/foundation/gestures/FlingBehavior;->performFling(Landroidx/compose/foundation/gestures/ScrollingLogic$doFlingAnimation$2$reverseScope$1;FLkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    iget-object v1, v6, Landroidx/compose/foundation/gestures/ScrollingLogic;->orientation:Landroidx/compose/foundation/gestures/Orientation;

    const/4 v5, 0x0

    if-ne v1, v10, :cond_a

    invoke-static {v11, v12, v0, v5, v3}, Landroidx/compose/ui/unit/Velocity;->copy-OhffZ5M$default(JFFI)J
    ...
    :cond_a
    invoke-static {v11, v12, v5, v0, v2}, Landroidx/compose/ui/unit/Velocity;->copy-OhffZ5M$default(JFFI)J
