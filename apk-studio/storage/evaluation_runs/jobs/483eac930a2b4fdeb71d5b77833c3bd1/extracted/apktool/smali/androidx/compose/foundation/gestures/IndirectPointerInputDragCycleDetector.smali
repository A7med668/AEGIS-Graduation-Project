...
.field public final offsetSmoother:Landroidx/core/content/res/ComplexColorCompat;

.field public touchSlopDetector:Landroidx/compose/foundation/gestures/TouchSlopDetector;

.field public final touchSmooth:Landroidx/core/content/res/ComplexColorCompat;
...
.method public constructor <init>(Landroidx/compose/foundation/gestures/ScrollableNode;)V
    ...
    invoke-direct {p1, v0, v1}, Landroidx/core/content/res/ComplexColorCompat;-><init>(IB)V

    new-instance v0, Landroidx/collection/MutableObjectList;

    invoke-direct {v0}, Landroidx/collection/MutableObjectList;-><init>()V

    iput-object v0, p1, Landroidx/core/content/res/ComplexColorCompat;->mShader:Ljava/lang/Object;

    iput-object p1, p0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->touchSmooth:Landroidx/core/content/res/ComplexColorCompat;
    ...
    iput-object p1, p0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->offsetSmoother:Landroidx/core/content/res/ComplexColorCompat;
...
.method public static moveToAwaitTouchSlopState-aWI9W7U$default(Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;Landroidx/compose/ui/input/indirect/IndirectPointerInputChange;JJI)V
    ...
    iget-object p2, p6, Landroidx/compose/foundation/gestures/ScrollableNode;->orientation:Landroidx/compose/foundation/gestures/Orientation;
...
.method public final getOrientation()Landroidx/compose/foundation/gestures/Orientation;
    ...
    iget-object p0, p0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->node:Landroidx/compose/foundation/gestures/ScrollableNode;
...
.method public final requireVelocityTracker$1()Landroidx/compose/ui/input/pointer/util/VelocityTracker;
    .locals 0
...
.method public final sendDragEvent-Eu1f8Dk(Landroidx/compose/ui/input/indirect/IndirectPointerInputChange;Landroidx/compose/ui/input/indirect/IndirectPointerEventPrimaryDirectionalMotionAxis;J)V
    ...
    iget-object v6, v0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->node:Landroidx/compose/foundation/gestures/ScrollableNode;

    iget-object v7, v6, Landroidx/compose/foundation/gestures/ScrollableNode;->orientation:Landroidx/compose/foundation/gestures/Orientation;
    ...
    invoke-virtual {v0}, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->requireVelocityTracker$1()Landroidx/compose/ui/input/pointer/util/VelocityTracker;

    move-result-object v7

    iget-object v8, v6, Landroidx/compose/foundation/gestures/ScrollableNode;->orientation:Landroidx/compose/foundation/gestures/Orientation;

    iget-object v12, v0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->touchSmooth:Landroidx/core/content/res/ComplexColorCompat;

    iget-object v13, v12, Landroidx/core/content/res/ComplexColorCompat;->mShader:Ljava/lang/Object;
    ...
    iput v15, v12, Landroidx/core/content/res/ComplexColorCompat;->mColor:I
    ...
    iget v4, v12, Landroidx/core/content/res/ComplexColorCompat;->mColor:I

    add-int/lit8 v5, v4, 0x1

    iput v5, v12, Landroidx/core/content/res/ComplexColorCompat;->mColor:I
    ...
    iget-object v1, v7, Landroidx/compose/ui/input/pointer/util/VelocityTracker;->platformVelocityTracker:Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->offsetSmoother:Landroidx/core/content/res/ComplexColorCompat;
    ...
    iget v7, v0, Landroidx/core/content/res/ComplexColorCompat;->mColor:I

    add-int/lit8 v8, v7, 0x1

    iput v8, v0, Landroidx/core/content/res/ComplexColorCompat;->mColor:I
    ...
    :goto_8
    iget v2, v0, Landroidx/core/content/res/ComplexColorCompat;->mColor:I

    const/4 v7, 0x3

    if-ne v2, v7, :cond_d

    iput v15, v0, Landroidx/core/content/res/ComplexColorCompat;->mColor:I
    ...
    invoke-virtual {v6, v1}, Landroidx/compose/foundation/gestures/ScrollableNode;->onDragEvent(Landroidx/compose/foundation/gestures/DragEvent;)V
...
.method public final sendDragStart-3f7A7Is(Landroidx/compose/ui/input/indirect/IndirectPointerInputChange;Landroidx/compose/ui/input/indirect/IndirectPointerInputChange;Landroidx/compose/ui/input/indirect/IndirectPointerEventPrimaryDirectionalMotionAxis;J)V
    ...
    iget-object v3, v0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->velocityTracker:Landroidx/compose/ui/input/pointer/util/VelocityTracker;
    ...
    invoke-direct {v3, v4}, Landroidx/compose/ui/input/pointer/util/VelocityTracker;-><init>(I)V

    iput-object v3, v0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->velocityTracker:Landroidx/compose/ui/input/pointer/util/VelocityTracker;
    ...
    iget-object v5, v0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->node:Landroidx/compose/foundation/gestures/ScrollableNode;

    iget-object v6, v5, Landroidx/compose/foundation/gestures/ScrollableNode;->orientation:Landroidx/compose/foundation/gestures/Orientation;

    iget-object v7, v0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->touchSmooth:Landroidx/core/content/res/ComplexColorCompat;

    iget-object v8, v7, Landroidx/core/content/res/ComplexColorCompat;->mShader:Ljava/lang/Object;

    check-cast v8, Landroidx/collection/MutableObjectList;

    iget-wide v9, v1, Landroidx/compose/ui/input/indirect/IndirectPointerInputChange;->position:J
    ...
    iget-wide v12, v1, Landroidx/compose/ui/input/indirect/IndirectPointerInputChange;->position:J
    ...
    iput v4, v7, Landroidx/core/content/res/ComplexColorCompat;->mColor:I
    ...
    iget v9, v7, Landroidx/core/content/res/ComplexColorCompat;->mColor:I

    add-int/lit8 v12, v9, 0x1

    iput v12, v7, Landroidx/core/content/res/ComplexColorCompat;->mColor:I

    invoke-virtual {v8, v9, v1}, Landroidx/collection/MutableObjectList;->set(ILjava/lang/Object;)Ljava/lang/Object;

    goto :goto_0

    :cond_2
    invoke-virtual {v8, v1}, Landroidx/collection/MutableObjectList;->add(Ljava/lang/Object;)V
    ...
    :cond_3
    iget-object v7, v8, Landroidx/collection/MutableObjectList;->content:[Ljava/lang/Object;
    ...
    iget-wide v13, v11, Landroidx/compose/ui/input/indirect/IndirectPointerInputChange;->position:J
    ...
    iget-object v10, v8, Landroidx/collection/MutableObjectList;->content:[Ljava/lang/Object;
    ...
    :cond_7
    iget v10, v2, Landroidx/compose/ui/input/indirect/IndirectPointerEventPrimaryDirectionalMotionAxis;->value:I
    ...
    iget-object v1, v3, Landroidx/compose/ui/input/pointer/util/VelocityTracker;->platformVelocityTracker:Ljava/lang/Object;

    check-cast v1, Landroidx/compose/ui/input/pointer/util/Lsq2VelocityTracker;

    invoke-virtual {v1, v10, v11, v7, v8}, Landroidx/compose/ui/input/pointer/util/Lsq2VelocityTracker;->addPosition-Uv8p0NA(JJ)V

    iget-object v1, v5, Landroidx/compose/foundation/gestures/ScrollableNode;->orientation:Landroidx/compose/foundation/gestures/Orientation;
    ...
    iget-object v3, v5, Landroidx/compose/foundation/gestures/ScrollableNode;->canDrag:Lkotlin/jvm/functions/Function1;

    new-instance v6, Landroidx/compose/ui/input/pointer/PointerType;

    invoke-direct {v6, v9}, Landroidx/compose/ui/input/pointer/PointerType;-><init>(I)V
    ...
    invoke-virtual {v5, v3}, Landroidx/compose/foundation/gestures/ScrollableNode;->onDragEvent(Landroidx/compose/foundation/gestures/DragEvent;)V

    :cond_b
    iget-object v0, v0, Landroidx/compose/foundation/gestures/IndirectPointerInputDragCycleDetector;->offsetSmoother:Landroidx/core/content/res/ComplexColorCompat;

    iput v4, v0, Landroidx/core/content/res/ComplexColorCompat;->mColor:I

    iget-object v0, v0, Landroidx/core/content/res/ComplexColorCompat;->mShader:Ljava/lang/Object;

    check-cast v0, Landroidx/collection/MutableLongList;

    iput v4, v0, Landroidx/collection/MutableLongList;->_size:I
