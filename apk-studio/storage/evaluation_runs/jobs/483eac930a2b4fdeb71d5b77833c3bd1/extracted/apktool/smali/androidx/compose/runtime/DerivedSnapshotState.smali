...
# direct methods
.method public constructor <init>(Landroidx/compose/runtime/NeverEqualPolicy;Lkotlin/jvm/functions/Function0;)V
    .locals 2
    ...
    iput-object p1, p0, Landroidx/compose/runtime/DerivedSnapshotState;->policy:Landroidx/compose/runtime/NeverEqualPolicy;
...
.method public final currentRecord(Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;Landroidx/compose/runtime/snapshots/Snapshot;ZLkotlin/jvm/functions/Function0;)Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;
    ...
    invoke-virtual {v6, v3, v0}, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->isValid(Landroidx/compose/runtime/DerivedSnapshotState;Landroidx/compose/runtime/snapshots/Snapshot;)Z
    ...
    invoke-virtual {v5}, Landroidx/compose/runtime/GapComposer$derivedStateObserver$1;->start()V
    ...
    sget-object v3, Landroidx/compose/runtime/SnapshotStateKt__DerivedStateKt;->calculationBlockNestedLevel:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {v3}, Lkotlin/text/MatcherMatchResult;->get()Ljava/lang/Object;
    ...
    invoke-virtual {v3, v4}, Lkotlin/text/MatcherMatchResult;->set(Ljava/lang/Object;)V
    ...
    sget-object v0, Landroidx/compose/runtime/SnapshotStateKt__DerivedStateKt;->calculationBlockNestedLevel:Lkotlin/text/MatcherMatchResult;
    ...
    invoke-direct {v1}, Landroidx/compose/runtime/internal/IntRef;-><init>()V

    invoke-virtual {v0, v1}, Lkotlin/text/MatcherMatchResult;->set(Ljava/lang/Object;)V

    :cond_a
    move-object v4, v1

    iget v1, v4, Landroidx/compose/runtime/internal/IntRef;->element:I
    ...
    check-cast v9, Landroidx/compose/runtime/GapComposer$derivedStateObserver$1;

    invoke-virtual {v9}, Landroidx/compose/runtime/GapComposer$derivedStateObserver$1;->start()V
    ...
    :try_start_1
    iput v0, v4, Landroidx/compose/runtime/internal/IntRef;->element:I

    new-instance v0, Landroidx/compose/runtime/DerivedSnapshotState$$ExternalSyntheticLambda0;

    const/4 v2, 0x0

    invoke-direct/range {v0 .. v5}, Landroidx/compose/runtime/DerivedSnapshotState$$ExternalSyntheticLambda0;-><init>(IILjava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)V

    move-object/from16 v2, p4

    invoke-static {v0, v2}, Landroidx/compose/runtime/snapshots/SnapshotId_jvmKt;->observe(Landroidx/compose/runtime/DerivedSnapshotState$$ExternalSyntheticLambda0;Lkotlin/jvm/functions/Function0;)Ljava/lang/Object;

    move-result-object v0

    iput v1, v4, Landroidx/compose/runtime/internal/IntRef;->element:I
    :try_end_1
    ...
    check-cast v4, Landroidx/compose/runtime/GapComposer$derivedStateObserver$1;

    invoke-virtual {v4}, Landroidx/compose/runtime/GapComposer$derivedStateObserver$1;->done()V
    ...
    iget-object v4, v6, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->result:Ljava/lang/Object;

    sget-object v7, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->Unset:Ljava/lang/Object;

    if-eq v4, v7, :cond_d

    iget-object v7, v3, Landroidx/compose/runtime/DerivedSnapshotState;->policy:Landroidx/compose/runtime/NeverEqualPolicy;

    if-eqz v7, :cond_d

    invoke-virtual {v7, v0, v4}, Landroidx/compose/runtime/NeverEqualPolicy;->equivalent(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    iput-object v5, v6, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->dependencies:Landroidx/collection/MutableObjectIntMap;

    invoke-virtual {v6, v3, v2}, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->readableHash(Landroidx/compose/runtime/DerivedSnapshotState;Landroidx/compose/runtime/snapshots/Snapshot;)I
    ...
    :cond_d
    iget-object v4, v3, Landroidx/compose/runtime/DerivedSnapshotState;->first:Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;
    ...
    :try_start_3
    invoke-static {v4, v3}, Landroidx/compose/runtime/snapshots/SnapshotKt;->newOverwritableRecordLocked(Landroidx/compose/runtime/snapshots/StateRecord;Landroidx/compose/runtime/snapshots/StateObject;)Landroidx/compose/runtime/snapshots/StateRecord;

    move-result-object v6

    invoke-virtual {v6, v4}, Landroidx/compose/runtime/snapshots/StateRecord;->assign(Landroidx/compose/runtime/snapshots/StateRecord;)V
    ...
    iput-object v5, v4, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->dependencies:Landroidx/collection/MutableObjectIntMap;

    invoke-virtual {v4, v3, v2}, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->readableHash(Landroidx/compose/runtime/DerivedSnapshotState;Landroidx/compose/runtime/snapshots/Snapshot;)I

    move-result v2

    iput v2, v4, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->resultHash:I

    iput-object v0, v4, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->result:Ljava/lang/Object;
    :try_end_4
    ...
    iput-wide v2, v4, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->validSnapshotId:J
...
.method public final toString()Ljava/lang/String;
    ...
    invoke-virtual {v0, p0, v1}, Landroidx/compose/runtime/DerivedSnapshotState$ResultRecord;->isValid(Landroidx/compose/runtime/DerivedSnapshotState;Landroidx/compose/runtime/snapshots/Snapshot;)Z
