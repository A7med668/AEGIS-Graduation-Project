...
.field public final mConstraintsTracker:Landroidx/compose/ui/graphics/vector/PathBuilder;
...
.field public final mStartStopTokens:Landroidx/room/concurrent/FileLock;

.field public final mTaskExecutor:Landroidx/emoji2/text/MetadataRepo;

.field public final mTimeLimiter:Landroidx/emoji2/text/MetadataRepo;

.field public final mWorkLauncher:Landroidx/room/concurrent/FileLock;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/emoji2/text/MetadataRepo;Landroidx/work/impl/Processor;Landroidx/room/concurrent/FileLock;Landroidx/emoji2/text/MetadataRepo;)V
    .locals 2
    ...
    invoke-direct {v1, v0}, Landroidx/room/concurrent/FileLock;-><init>(Landroidx/lifecycle/ViewModelStore;)V

    iput-object v1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Landroidx/room/concurrent/FileLock;
    ...
    iget-object p1, p2, Landroidx/work/Configuration;->runnableScheduler:Landroidx/core/view/MenuHostHelper;
    ...
    invoke-direct {v0, p0, p1, v1}, Landroidx/work/impl/background/greedy/DelayedWorkTracker;-><init>(Landroidx/work/impl/background/greedy/GreedyScheduler;Landroidx/core/view/MenuHostHelper;Landroidx/work/SystemClock;)V
    ...
    iput-object p1, v0, Landroidx/emoji2/text/MetadataRepo;->mMetadataList:Ljava/lang/Object;

    iput-object p5, v0, Landroidx/emoji2/text/MetadataRepo;->mEmojiCharArray:Ljava/lang/Object;

    new-instance p1, Ljava/lang/Object;

    invoke-direct {p1}, Ljava/lang/Object;-><init>()V

    iput-object p1, v0, Landroidx/emoji2/text/MetadataRepo;->mRootNode:Ljava/lang/Object;

    new-instance p1, Ljava/util/LinkedHashMap;

    invoke-direct {p1}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object p1, v0, Landroidx/emoji2/text/MetadataRepo;->mTypeface:Ljava/lang/Object;

    iput-object v0, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mTimeLimiter:Landroidx/emoji2/text/MetadataRepo;

    iput-object p6, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mTaskExecutor:Landroidx/emoji2/text/MetadataRepo;

    new-instance p1, Landroidx/compose/ui/graphics/vector/PathBuilder;

    invoke-direct {p1, p3}, Landroidx/compose/ui/graphics/vector/PathBuilder;-><init>(Landroidx/emoji2/text/MetadataRepo;)V

    iput-object p1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mConstraintsTracker:Landroidx/compose/ui/graphics/vector/PathBuilder;
    ...
    iput-object p5, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mWorkLauncher:Landroidx/room/concurrent/FileLock;
...
.method public final cancel(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mConfiguration:Landroidx/work/Configuration;

    invoke-static {v1, v2}, Landroidx/work/impl/utils/ProcessUtils;->isDefaultProcess(Landroid/content/Context;Landroidx/work/Configuration;)Z
    ...
    invoke-virtual {p0, v0, p1}, Landroidx/work/Logger$LogcatLogger;->info(Ljava/lang/String;Ljava/lang/String;)V

    return-void

    :cond_1
    iget-boolean v1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mRegisteredExecutionListener:Z

    if-nez v1, :cond_2

    iget-object v1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mProcessor:Landroidx/work/impl/Processor;
    ...
    iget-object v0, v0, Landroidx/work/impl/background/greedy/DelayedWorkTracker;->mRunnableScheduler:Landroidx/core/view/MenuHostHelper;
    ...
    :cond_3
    iget-object v0, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Landroidx/room/concurrent/FileLock;
    ...
    invoke-virtual {v0, p1}, Landroidx/lifecycle/ViewModelStore;->remove(Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mTimeLimiter:Landroidx/emoji2/text/MetadataRepo;

    invoke-virtual {v1, v0}, Landroidx/emoji2/text/MetadataRepo;->cancel(Landroidx/work/impl/StartStopToken;)V

    iget-object v1, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mWorkLauncher:Landroidx/room/concurrent/FileLock;

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const/16 v2, -0x200

    invoke-virtual {v1, v0, v2}, Landroidx/room/concurrent/FileLock;->stopWork(Landroidx/work/impl/StartStopToken;I)V
...
.method public final onConstraintsStateChanged(Landroidx/work/impl/model/WorkSpec;Landroidx/work/impl/constraints/ConstraintsState;)V
    ...
    invoke-static {p1}, Lkotlin/text/CharsKt;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;
    ...
    iget-object v2, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mTimeLimiter:Landroidx/emoji2/text/MetadataRepo;

    sget-object v3, Landroidx/work/impl/background/greedy/GreedyScheduler;->TAG:Ljava/lang/String;

    iget-object p0, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Landroidx/room/concurrent/FileLock;

    if-eqz v0, :cond_0

    invoke-virtual {p0, p1}, Landroidx/room/concurrent/FileLock;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    invoke-virtual {p0, p1}, Landroidx/room/concurrent/FileLock;->tokenFor(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;

    move-result-object p0

    invoke-virtual {v2, p0}, Landroidx/emoji2/text/MetadataRepo;->track(Landroidx/work/impl/StartStopToken;)V

    invoke-virtual {v1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const/4 p1, 0x0

    invoke-virtual {v1, p0, p1}, Landroidx/room/concurrent/FileLock;->startWork(Landroidx/work/impl/StartStopToken;Landroidx/work/SystemClock;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/room/concurrent/FileLock;->remove(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;

    move-result-object p0

    if-eqz p0, :cond_1

    invoke-virtual {v2, p0}, Landroidx/emoji2/text/MetadataRepo;->cancel(Landroidx/work/impl/StartStopToken;)V
    ...
    invoke-virtual {v1, p0, p1}, Landroidx/room/concurrent/FileLock;->stopWork(Landroidx/work/impl/StartStopToken;I)V
...
.method public final onExecuted(Landroidx/work/impl/model/WorkGenerationalId;Z)V
    ...
    invoke-virtual {v0, p1}, Landroidx/room/concurrent/FileLock;->remove(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;
...
.method public final varargs schedule([Landroidx/work/impl/model/WorkSpec;)V
    ...
    iget-object v7, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Landroidx/room/concurrent/FileLock;

    invoke-virtual {v7, v6}, Landroidx/room/concurrent/FileLock;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    iget-object v9, v8, Landroidx/work/impl/background/greedy/DelayedWorkTracker;->mRunnableScheduler:Landroidx/core/view/MenuHostHelper;
    ...
    iget-object v12, v9, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;
    ...
    :cond_5
    new-instance v11, Landroidx/work/impl/ToContinuation;

    const/4 v12, 0x4

    invoke-direct {v11, v12, v8, v5, v3}, Landroidx/work/impl/ToContinuation;-><init>(ILjava/lang/Object;Ljava/lang/Object;Z)V
    ...
    iget-object v5, v9, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;
    ...
    :cond_6
    sget-object v6, Landroidx/work/Constraints;->NONE:Landroidx/work/Constraints;

    iget-object v7, v5, Landroidx/work/impl/model/WorkSpec;->constraints:Landroidx/work/Constraints;
    ...
    :cond_9
    iget-object v6, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mStartStopTokens:Landroidx/room/concurrent/FileLock;

    invoke-static {v5}, Lkotlin/text/CharsKt;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;

    move-result-object v7

    invoke-virtual {v6, v7}, Landroidx/room/concurrent/FileLock;->contains(Landroidx/work/impl/model/WorkGenerationalId;)Z
    ...
    invoke-virtual {v6, v5}, Landroidx/room/concurrent/FileLock;->tokenFor(Landroidx/work/impl/model/WorkGenerationalId;)Landroidx/work/impl/StartStopToken;

    move-result-object v5

    iget-object v6, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mTimeLimiter:Landroidx/emoji2/text/MetadataRepo;

    invoke-virtual {v6, v5}, Landroidx/emoji2/text/MetadataRepo;->track(Landroidx/work/impl/StartStopToken;)V

    iget-object v6, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mWorkLauncher:Landroidx/room/concurrent/FileLock;

    invoke-virtual {v6}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    const/4 v7, 0x0

    invoke-virtual {v6, v5, v7}, Landroidx/room/concurrent/FileLock;->startWork(Landroidx/work/impl/StartStopToken;Landroidx/work/SystemClock;)V
    ...
    invoke-static {v1}, Lkotlin/text/CharsKt;->generationalId(Landroidx/work/impl/model/WorkSpec;)Landroidx/work/impl/model/WorkGenerationalId;
    ...
    iget-object v3, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mConstraintsTracker:Landroidx/compose/ui/graphics/vector/PathBuilder;

    iget-object v4, p0, Landroidx/work/impl/background/greedy/GreedyScheduler;->mTaskExecutor:Landroidx/emoji2/text/MetadataRepo;

    iget-object v4, v4, Landroidx/emoji2/text/MetadataRepo;->mEmojiCharArray:Ljava/lang/Object;

    check-cast v4, Lkotlinx/coroutines/CoroutineDispatcher;

    invoke-static {v3, v1, v4, p0}, Landroidx/work/impl/constraints/WorkConstraintsTrackerKt;->listen(Landroidx/compose/ui/graphics/vector/PathBuilder;Landroidx/work/impl/model/WorkSpec;Lkotlinx/coroutines/CoroutineDispatcher;Landroidx/work/impl/constraints/OnConstraintsStateChangedListener;)Lkotlinx/coroutines/StandaloneCoroutine;
