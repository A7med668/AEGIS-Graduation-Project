...
# static fields
.field public static final utcTimeZoneId:Ljava/time/ZoneId;
...
.field public final weekdayNames:Ljava/util/ArrayList;
...
.method public constructor <init>(Ljava/util/Locale;)V
    ...
    iput-object p1, p0, Landroidx/compose/material3/internal/CalendarModelImpl;->locale:Ljava/util/Locale;

    new-instance v0, Ljava/util/LinkedHashMap;

    invoke-direct {v0}, Ljava/util/LinkedHashMap;-><init>()V

    iput-object v0, p0, Landroidx/compose/material3/internal/CalendarModelImpl;->formatterCache:Ljava/util/LinkedHashMap;
    ...
    sget-object v0, Landroidx/compose/material3/internal/CalendarModelImpl$EntriesMappings;->entries$0:Lkotlin/enums/EnumEntriesList;

    new-instance v1, Ljava/util/ArrayList;

    invoke-virtual {v0}, Lkotlin/enums/EnumEntriesList;->getSize()I
    ...
    invoke-virtual {v0, v3}, Lkotlin/enums/EnumEntriesList;->get(I)Ljava/lang/Object;
    ...
    :cond_0
    iput-object v1, p0, Landroidx/compose/material3/internal/CalendarModelImpl;->weekdayNames:Ljava/util/ArrayList;
...
# virtual methods
.method public final getCanonicalDate(J)Landroidx/compose/material3/internal/CalendarDate;
    .locals 6
...
.method public final getMonth(J)Landroidx/compose/material3/internal/CalendarMonth;
    .locals 0
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/material3/internal/CalendarModelImpl;->getMonth(Ljava/time/LocalDate;)Landroidx/compose/material3/internal/CalendarMonth;
...
.method public final getMonth(Ljava/time/LocalDate;)Landroidx/compose/material3/internal/CalendarMonth;
    .locals 8
...
.method public final getToday()Landroidx/compose/material3/internal/CalendarDate;
    .locals 6
...
.method public final parse(Ljava/lang/String;Ljava/lang/String;Ljava/util/Locale;)Landroidx/compose/material3/internal/CalendarDate;
    .locals 6

    iget-object p0, p0, Landroidx/compose/material3/internal/CalendarModelImpl;->formatterCache:Ljava/util/LinkedHashMap;

    invoke-static {p2, p3, p0}, Landroidx/compose/material3/internal/Icons$Filled;->getCachedDateTimeFormatter(Ljava/lang/String;Ljava/util/Locale;Ljava/util/Map;)Ljava/time/format/DateTimeFormatter;
