...
.field public v:Lb/i/m/u;

.field public w:Lb/i/m/u;

.field public x:Lb/i/m/u;

.field public y:Lb/i/m/u;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Lb/i/m/u;->b:Lb/i/m/u;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Lb/i/m/u;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Lb/i/m/u;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;

    iput-object p2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lb/i/m/u;
    ...
    new-instance p1, Lb/i/m/i;

    invoke-direct {p1}, Lb/i/m/i;-><init>()V

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:Lb/i/m/i;
...
.method public a()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Lb/b/p/d0;

    invoke-interface {v0}, Lb/b/p/d0;->a()Z
...
.method public b(Landroid/view/Menu;Lb/b/o/i/m$a;)V
    ...
    invoke-interface {v0, p1, p2}, Lb/b/p/d0;->b(Landroid/view/Menu;Lb/b/o/i/m$a;)V
...
.method public c()Z
    ...
    invoke-interface {v0}, Lb/b/p/d0;->c()Z
...
.method public d()V
    ...
    invoke-interface {v0}, Lb/b/p/d0;->d()V
...
.method public e()Z
    ...
    invoke-interface {v0}, Lb/b/p/d0;->e()Z
...
.method public f()Z
    ...
    invoke-interface {v0}, Lb/b/p/d0;->f()Z
...
.method public g()Z
    ...
    invoke-interface {v0}, Lb/b/p/d0;->g()Z
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:Lb/i/m/i;
...
.method public getTitle()Ljava/lang/CharSequence;
    ...
    invoke-interface {v0}, Lb/b/p/d0;->getTitle()Ljava/lang/CharSequence;
...
.method public h(I)V
    ...
    :cond_1
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Lb/b/p/d0;

    invoke-interface {p1}, Lb/b/p/d0;->r()V
    ...
    invoke-interface {p1}, Lb/b/p/d0;->l()V
...
.method public j()V
    ...
    invoke-interface {v0}, Lb/b/p/d0;->h()V
...
.method public onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-direct {v0, p1}, Lb/i/m/u;-><init>(Landroid/view/WindowInsets;)V
    ...
    invoke-virtual {v0}, Lb/i/m/u;->c()I

    move-result v2

    invoke-virtual {v0}, Lb/i/m/u;->a()I
    ...
    invoke-static {p0, v0, v1}, Lb/i/m/l;->d(Landroid/view/View;Lb/i/m/u;Landroid/graphics/Rect;)Lb/i/m/u;
    ...
    iget-object v5, v0, Lb/i/m/u;->a:Lb/i/m/u$h;

    invoke-virtual {v5, v2, v3, v4, v1}, Lb/i/m/u$h;->g(IIII)Lb/i/m/u;

    move-result-object v1

    iput-object v1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Lb/i/m/u;

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Lb/i/m/u;

    invoke-virtual {v2, v1}, Lb/i/m/u;->equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Lb/i/m/u;

    iput-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->w:Lb/i/m/u;
    ...
    :cond_2
    iget-object p1, v0, Lb/i/m/u;->a:Lb/i/m/u$h;

    invoke-virtual {p1}, Lb/i/m/u$h;->a()Lb/i/m/u;

    move-result-object p1

    iget-object p1, p1, Lb/i/m/u;->a:Lb/i/m/u$h;

    invoke-virtual {p1}, Lb/i/m/u$h;->c()Lb/i/m/u;

    move-result-object p1

    iget-object p1, p1, Lb/i/m/u;->a:Lb/i/m/u$h;

    invoke-virtual {p1}, Lb/i/m/u$h;->b()Lb/i/m/u;
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-static {p0}, Lb/i/m/l;->U(Landroid/view/View;)V
...
.method public onMeasure(II)V
    ...
    invoke-static {p0}, Lb/i/m/l;->y(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->v:Lb/i/m/u;

    iput-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;
    ...
    iget-object v4, v6, Lb/i/m/u;->a:Lb/i/m/u$h;

    invoke-virtual {v4, v2, v5, v2, v2}, Lb/i/m/u$h;->g(IIII)Lb/i/m/u;
    ...
    :cond_4
    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;

    invoke-virtual {v4}, Lb/i/m/u;->b()I

    move-result v4

    iget-object v6, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;

    invoke-virtual {v6}, Lb/i/m/u;->d()I

    move-result v6

    add-int/2addr v6, v5

    iget-object v5, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;

    invoke-virtual {v5}, Lb/i/m/u;->c()I

    move-result v5

    iget-object v7, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;

    invoke-virtual {v7}, Lb/i/m/u;->a()I

    move-result v7

    add-int/2addr v7, v2

    invoke-static {v4, v6, v5, v7}, Lb/i/f/b;->a(IIII)Lb/i/f/b;
    ...
    new-instance v5, Lb/i/m/u$b;

    invoke-direct {v5, v4}, Lb/i/m/u$b;-><init>(Lb/i/m/u;)V

    goto :goto_2

    :cond_5
    new-instance v5, Lb/i/m/u$a;

    invoke-direct {v5, v4}, Lb/i/m/u$a;-><init>(Lb/i/m/u;)V

    :goto_2
    invoke-virtual {v5, v2}, Lb/i/m/u$c;->c(Lb/i/f/b;)V

    invoke-virtual {v5}, Lb/i/m/u$c;->a()Lb/i/m/u;

    move-result-object v2

    :goto_3
    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lb/i/m/u;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;

    invoke-virtual {v2, v4}, Lb/i/m/u;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_6

    iget-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->x:Lb/i/m/u;

    iput-object v2, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->y:Lb/i/m/u;

    iget-object v4, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->d:Landroidx/appcompat/widget/ContentFrameLayout;

    invoke-virtual {v2}, Lb/i/m/u;->g()Landroid/view/WindowInsets;
    ...
    new-instance v4, Lb/i/m/u;

    invoke-direct {v4, v2}, Lb/i/m/u;-><init>(Landroid/view/WindowInsets;)V
...
.method public onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->F:Lb/i/m/i;
    ...
    check-cast p1, Lb/b/k/u;

    iget-object p2, p1, Lb/b/k/u;->u:Lb/b/o/g;

    if-eqz p2, :cond_0

    invoke-virtual {p2}, Lb/b/o/g;->a()V

    const/4 p2, 0x0

    iput-object p2, p1, Lb/b/k/u;->u:Lb/b/o/g;
...
.method public onWindowSystemUiVisibilityChanged(I)V
    ...
    check-cast v6, Lb/b/k/u;

    iput-boolean v5, v6, Lb/b/k/u;->p:Z
    ...
    :cond_2
    check-cast v4, Lb/b/k/u;

    iget-boolean p1, v4, Lb/b/k/u;->r:Z

    if-nez p1, :cond_4

    iput-boolean v3, v4, Lb/b/k/u;->r:Z

    invoke-virtual {v4, v3}, Lb/b/k/u;->n(Z)V
    ...
    iget-boolean v1, p1, Lb/b/k/u;->r:Z

    if-eqz v1, :cond_4

    iput-boolean v2, p1, Lb/b/k/u;->r:Z

    invoke-virtual {p1, v3}, Lb/b/k/u;->n(Z)V
...
.method public onWindowVisibilityChanged(I)V
    ...
    check-cast v0, Lb/b/k/u;

    iput p1, v0, Lb/b/k/u;->o:I
...
.method public s()V
    ...
    :goto_0
    iput-object v0, p0, Landroidx/appcompat/widget/ActionBarOverlayLayout;->f:Lb/b/p/d0;
...
.method public setIcon(I)V
    ...
    invoke-interface {v0, p1}, Lb/b/p/d0;->setIcon(I)V
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-interface {v0, p1}, Lb/b/p/d0;->setIcon(Landroid/graphics/drawable/Drawable;)V
...
.method public setLogo(I)V
    ...
    invoke-interface {v0, p1}, Lb/b/p/d0;->n(I)V
...
.method public setWindowCallback(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Lb/b/p/d0;->setWindowCallback(Landroid/view/Window$Callback;)V
