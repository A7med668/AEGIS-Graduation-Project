...
# interfaces
.implements Lb/b/o/i/n$a;
.implements Landroid/widget/AbsListView$SelectionBoundsAdjuster;


# instance fields
.field public b:Lb/b/o/i/i;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v2, Lb/b/j;->MenuView:[I

    const/4 v3, 0x0

    invoke-static {v1, p2, v2, v0, v3}, Lb/b/p/x0;->q(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lb/b/p/x0;

    move-result-object p2

    sget v0, Lb/b/j;->MenuView_android_itemBackground:I

    invoke-virtual {p2, v0}, Lb/b/p/x0;->g(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->k:Landroid/graphics/drawable/Drawable;

    sget v0, Lb/b/j;->MenuView_android_itemTextAppearance:I

    const/4 v1, -0x1

    invoke-virtual {p2, v0, v1}, Lb/b/p/x0;->l(II)I

    move-result v0

    iput v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->l:I

    sget v0, Lb/b/j;->MenuView_preserveIconSpacing:I

    invoke-virtual {p2, v0, v3}, Lb/b/p/x0;->a(IZ)Z
    ...
    sget v0, Lb/b/j;->MenuView_subMenuArrow:I
    ...
    sget v1, Lb/b/a;->dropDownListViewStyle:I
    ...
    iget-object p2, p2, Lb/b/p/x0;->b:Landroid/content/res/TypedArray;
...
.method public d(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b:Lb/b/o/i/i;

    invoke-virtual {p1}, Lb/b/o/i/i;->m()Z
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b:Lb/b/o/i/i;

    invoke-virtual {v2}, Lb/b/o/i/i;->e()C
    ...
    :cond_1
    iget-object v4, v2, Lb/b/o/i/i;->n:Lb/b/o/i/g;

    iget-object v4, v4, Lb/b/o/i/g;->a:Landroid/content/Context;
    ...
    iget-object v6, v2, Lb/b/o/i/i;->n:Lb/b/o/i/g;

    iget-object v6, v6, Lb/b/o/i/g;->a:Landroid/content/Context;
    ...
    sget v6, Lb/b/h;->abc_prepend_shortcut_label:I
    ...
    invoke-virtual {v6}, Lb/b/o/i/g;->n()Z

    move-result v6

    if-eqz v6, :cond_3

    iget v2, v2, Lb/b/o/i/i;->k:I

    goto :goto_1

    :cond_3
    iget v2, v2, Lb/b/o/i/i;->i:I

    :goto_1
    const/high16 v6, 0x10000

    sget v7, Lb/b/h;->abc_menu_meta_shortcut_label:I

    invoke-virtual {v4, v7}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v7

    invoke-static {v5, v2, v6, v7}, Lb/b/o/i/i;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const/16 v6, 0x1000

    sget v7, Lb/b/h;->abc_menu_ctrl_shortcut_label:I
    ...
    sget v7, Lb/b/h;->abc_menu_alt_shortcut_label:I
    ...
    sget v7, Lb/b/h;->abc_menu_shift_shortcut_label:I
    ...
    sget v7, Lb/b/h;->abc_menu_sym_shortcut_label:I
    ...
    sget v6, Lb/b/h;->abc_menu_function_shortcut_label:I

    invoke-virtual {v4, v6}, Landroid/content/res/Resources;->getString(I)Ljava/lang/String;

    move-result-object v6

    invoke-static {v5, v2, v0, v6}, Lb/b/o/i/i;->c(Ljava/lang/StringBuilder;IILjava/lang/String;)V
...
.method public e(Lb/b/o/i/i;I)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b:Lb/b/o/i/i;

    invoke-virtual {p1}, Lb/b/o/i/i;->isVisible()Z
    ...
    invoke-interface {p0}, Lb/b/o/i/n$a;->c()Z

    move-result p2

    if-eqz p2, :cond_1

    invoke-virtual {p1}, Lb/b/o/i/i;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    :cond_1
    iget-object p2, p1, Lb/b/o/i/i;->e:Ljava/lang/CharSequence;

    :goto_1
    invoke-virtual {p0, p2}, Landroidx/appcompat/view/menu/ListMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Lb/b/o/i/i;->isCheckable()Z
    ...
    invoke-virtual {p1}, Lb/b/o/i/i;->e()C

    invoke-virtual {p0, p2}, Landroidx/appcompat/view/menu/ListMenuItemView;->d(Z)V

    invoke-virtual {p1}, Lb/b/o/i/i;->getIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, p1, Lb/b/o/i/i;->q:Ljava/lang/CharSequence;
...
.method public getItemData()Lb/b/o/i/i;
    .locals 1

    iget-object v0, p0, Landroidx/appcompat/view/menu/ListMenuItemView;->b:Lb/b/o/i/i;
...
.method public setCheckable(Z)V
    ...
    invoke-virtual {v0}, Lb/b/o/i/i;->h()Z
    ...
    invoke-virtual {p1}, Lb/b/o/i/i;->isChecked()Z
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object v0, v0, Lb/b/o/i/i;->n:Lb/b/o/i/g;

    iget-boolean v0, v0, Lb/b/o/i/g;->s:Z
