...
.field public static final z:Lb/i/l/c;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lb/i/l/c<",
...
.field public t:Lb/i/m/j;

.field public final u:Lb/i/m/i;
...
.method public static constructor <clinit>()V
    ...
    new-instance v0, Lb/i/l/d;

    const/16 v1, 0xc

    invoke-direct {v0, v1}, Lb/i/l/d;-><init>(I)V

    sput-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v5, Lb/h/a;->coordinatorLayoutStyle:I
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c:Lb/h/d/a;
    ...
    new-instance v0, Lb/i/m/i;

    invoke-direct {v0}, Lb/i/m/i;-><init>()V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:Lb/i/m/i;

    const/4 v7, 0x0

    sget-object v0, Lb/h/c;->CoordinatorLayout:[I

    if-nez v5, :cond_0

    sget v1, Lb/h/b;->Widget_Support_CoordinatorLayout:I
    ...
    sget-object v2, Lb/h/c;->CoordinatorLayout:[I

    if-nez v5, :cond_1

    const/4 v5, 0x0

    sget v6, Lb/h/b;->Widget_Support_CoordinatorLayout:I
    ...
    :cond_2
    :goto_1
    sget v0, Lb/h/c;->CoordinatorLayout_keylines:I
    ...
    :cond_3
    sget v0, Lb/h/c;->CoordinatorLayout_statusBarBackground:I

    invoke-virtual {v8, v0}, Landroid/content/res/TypedArray;->getDrawable(I)Landroid/graphics/drawable/Drawable;

    move-result-object v0

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->r:Landroid/graphics/drawable/Drawable;
...
.method public static a()Landroid/graphics/Rect;
    ...
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;
...
.method public static s(Landroid/content/Context;Landroid/util/AttributeSet;Ljava/lang/String;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;
    .locals 5
    ...
    invoke-static {v0, p2}, Lc/a/a/a/a;->c(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public c(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p3}, Lb/h/d/b;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public d(Landroid/view/View;)Ljava/util/List;
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c:Lb/h/d/a;

    iget-object v1, v0, Lb/h/d/a;->b:Lb/f/h;

    iget v1, v1, Lb/f/h;->d:I
    ...
    iget-object v4, v0, Lb/h/d/a;->b:Lb/f/h;

    invoke-virtual {v4, v3}, Lb/f/h;->k(I)Ljava/lang/Object;
...
.method public e(Landroid/view/View;)Ljava/util/List;
    ...
    iget-object v0, v0, Lb/h/d/a;->b:Lb/f/h;
...
.method public final f(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    .locals 6
...
.method public final getLastWindowInsets()Lb/i/m/u;
    .locals 1

    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Lb/i/m/u;
...
.method public getNestedScrollAxes()I
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:Lb/i/m/i;

    invoke-virtual {v0}, Lb/i/m/i;->a()I
...
.method public h(Landroid/view/View;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;
    .locals 6
    ...
    invoke-virtual {v1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->i()V
    ...
    invoke-virtual {p1, v0}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->f(Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;)V
    ...
    invoke-virtual {v4}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->i()V
    ...
    invoke-static {v4}, Lc/a/a/a/a;->e(Ljava/lang/String;)Ljava/lang/StringBuilder;
...
.method public i(Landroid/view/View;Landroid/view/View;II)V
    ...
    iget-object p1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->u:Lb/i/m/i;

    const/4 v0, 0x1

    if-ne p4, v0, :cond_0

    iput p3, p1, Lb/i/m/i;->b:I

    goto :goto_0

    :cond_0
    iput p3, p1, Lb/i/m/i;->a:I
...
.method public j(Landroid/view/View;II)Z
    ...
    invoke-static {p0, p1, v0}, Lb/h/d/b;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    sget-object p2, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {p2, v0}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
...
.method public m(Landroid/view/View;I)V
    ...
    iput v1, v0, Lb/i/m/i;->b:I

    goto :goto_0

    :cond_0
    iput v1, v0, Lb/i/m/i;->a:I
...
.method public onAttachedToWindow()V
    ...
    invoke-static {p0}, Lb/i/m/l;->o(Landroid/view/View;)Z
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {v0}, Lb/i/m/u;->d()I
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p0}, Lb/i/m/l;->r(Landroid/view/View;)I
    ...
    :cond_1
    invoke-virtual {p0, p4, p1}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->q(Landroid/view/View;I)V
...
.method public onMeasure(II)V
    ...
    iget-object v4, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c:Lb/h/d/a;

    iget-object v5, v4, Lb/h/d/a;->b:Lb/f/h;

    iget v5, v5, Lb/f/h;->d:I
    ...
    iget-object v9, v4, Lb/h/d/a;->b:Lb/f/h;

    invoke-virtual {v9, v6}, Lb/f/h;->k(I)Ljava/lang/Object;
    ...
    :goto_3
    iget-boolean v1, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->o:Z

    if-eq v0, v1, :cond_8

    if-eqz v0, :cond_6

    iget-boolean v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Z

    if-eqz v0, :cond_5

    iget-object v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->n:Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
    ...
    iput-object v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->n:Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;
    ...
    iget-object v1, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->n:Landroidx/coordinatorlayout/widget/CoordinatorLayout$g;

    invoke-virtual {v0, v1}, Landroid/view/ViewTreeObserver;->addOnPreDrawListener(Landroid/view/ViewTreeObserver$OnPreDrawListener;)V

    :cond_5
    iput-boolean v2, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->o:Z
    ...
    :cond_7
    iput-boolean v8, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->o:Z
    ...
    invoke-static/range {p0 .. p0}, Lb/i/m/l;->r(Landroid/view/View;)I
    ...
    iget-object v3, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Lb/i/m/u;
    ...
    iget-object v0, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Lb/i/m/u;

    invoke-virtual {v0}, Lb/i/m/u;->b()I

    move-result v0

    iget-object v2, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Lb/i/m/u;

    invoke-virtual {v2}, Lb/i/m/u;->c()I
    ...
    iget-object v8, v7, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Lb/i/m/u;

    invoke-virtual {v8}, Lb/i/m/u;->a()I
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {p0, v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h(Landroid/view/View;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;
...
.method public final p(I)V
    ...
    invoke-static {v7, v0, v3}, Lb/h/d/b;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v0 .. v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    ...
    invoke-static {v15, v3}, Lb/i/m/l;->J(Landroid/view/View;I)V

    :cond_3
    if-eqz v4, :cond_4

    invoke-static {v15, v4}, Lb/i/m/l;->K(Landroid/view/View;I)V
    ...
    sget-object v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    move-object/from16 v2, v20

    invoke-virtual {v1, v2}, Lb/i/l/c;->b(Ljava/lang/Object;)Z

    invoke-virtual {v14}, Landroid/graphics/Rect;->setEmpty()V

    sget-object v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {v1, v14}, Lb/i/l/c;->b(Ljava/lang/Object;)Z

    invoke-virtual {v0}, Landroid/graphics/Rect;->setEmpty()V

    sget-object v1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {v1, v0}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
    ...
    sget-object v3, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {v3, v5}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v7, v15, v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->x(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, v4}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
    ...
    :cond_1c
    invoke-virtual {v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->h()V
    ...
    invoke-virtual {v0, v11}, Lb/i/l/c;->b(Ljava/lang/Object;)Z

    invoke-virtual {v12}, Landroid/graphics/Rect;->setEmpty()V

    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {v0, v12}, Lb/i/l/c;->b(Ljava/lang/Object;)Z

    invoke-virtual {v2}, Landroid/graphics/Rect;->setEmpty()V

    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {v0, v2}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
...
.method public q(Landroid/view/View;I)V
    ...
    :try_start_0
    invoke-static {p0, v1, v0}, Lb/h/d/b;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-virtual/range {v4 .. v10}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->f(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;II)V
    ...
    sget-object p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {p1, v0}, Lb/i/l/c;->b(Ljava/lang/Object;)Z

    invoke-virtual {v2}, Landroid/graphics/Rect;->setEmpty()V

    sget-object p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {p1, v2}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p2, v2}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Lb/i/m/u;
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->p:Lb/i/m/u;

    invoke-virtual {v2}, Lb/i/m/u;->b()I
    ...
    invoke-virtual {v2}, Lb/i/m/u;->d()I
    ...
    invoke-virtual {v2}, Lb/i/m/u;->a()I
    ...
    invoke-virtual {p1, v7}, Lb/i/l/c;->b(Ljava/lang/Object;)Z

    invoke-virtual {v8}, Landroid/graphics/Rect;->setEmpty()V

    sget-object p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->z:Lb/i/l/c;

    invoke-virtual {p1, v8}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
...
.method public setStatusBarBackgroundResource(I)V
    ...
    invoke-static {v0, p1}, Lb/i/e/a;->c(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method public final t(Landroid/view/MotionEvent;I)Z
    ...
    :cond_1
    sget-object v5, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->y:Ljava/util/Comparator;
    ...
    :cond_5
    invoke-virtual {v13, v0, v11, v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->A(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z

    goto :goto_7

    :cond_6
    invoke-virtual {v13, v0, v11, v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->j(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v11}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->c()F
...
.method public final u()V
    ...
    iget-object v5, v0, Lb/h/d/a;->a:Lb/i/l/c;

    invoke-virtual {v5, v4}, Lb/i/l/c;->b(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, v3}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h(Landroid/view/View;)Landroidx/coordinatorlayout/widget/CoordinatorLayout$f;
    ...
    :cond_10
    :goto_8
    iget-object v5, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c:Lb/h/d/a;

    invoke-virtual {v5, v3}, Lb/h/d/a;->a(Ljava/lang/Object;)V
    ...
    invoke-virtual {v8, p0, v3, v6}, Landroidx/coordinatorlayout/widget/CoordinatorLayout$c;->d(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    iget-object v8, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c:Lb/h/d/a;

    iget-object v8, v8, Lb/h/d/a;->b:Lb/f/h;

    invoke-virtual {v8, v6}, Lb/f/h;->e(Ljava/lang/Object;)I
    ...
    invoke-virtual {v8, v6}, Lb/h/d/a;->a(Ljava/lang/Object;)V

    :cond_16
    iget-object v8, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c:Lb/h/d/a;

    iget-object v9, v8, Lb/h/d/a;->b:Lb/f/h;
    ...
    invoke-virtual {v9, v3}, Lb/f/h;->e(Ljava/lang/Object;)I
    ...
    invoke-virtual {v9, v6, v7}, Lb/f/h;->getOrDefault(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v9, v8, Lb/h/d/a;->a:Lb/i/l/c;

    invoke-virtual {v9}, Lb/i/l/c;->a()Ljava/lang/Object;
    ...
    invoke-virtual {v8, v6, v9}, Lb/f/h;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->c:Lb/h/d/a;

    iget-object v3, v1, Lb/h/d/a;->c:Ljava/util/ArrayList;

    invoke-virtual {v3}, Ljava/util/ArrayList;->clear()V

    iget-object v3, v1, Lb/h/d/a;->d:Ljava/util/HashSet;

    invoke-virtual {v3}, Ljava/util/HashSet;->clear()V

    iget-object v3, v1, Lb/h/d/a;->b:Lb/f/h;
    ...
    iget-object v4, v1, Lb/h/d/a;->b:Lb/f/h;

    invoke-virtual {v4, v2}, Lb/f/h;->h(I)Ljava/lang/Object;

    move-result-object v4

    iget-object v5, v1, Lb/h/d/a;->c:Ljava/util/ArrayList;

    iget-object v6, v1, Lb/h/d/a;->d:Ljava/util/HashSet;

    invoke-virtual {v1, v4, v5, v6}, Lb/h/d/a;->b(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/HashSet;)V
    ...
    :cond_20
    iget-object v1, v1, Lb/h/d/a;->c:Ljava/util/ArrayList;
...
.method public final w(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Lb/i/m/l;->J(Landroid/view/View;I)V
...
.method public final x(Landroid/view/View;I)V
    ...
    invoke-static {p1, v1}, Lb/i/m/l;->K(Landroid/view/View;I)V
...
.method public final y()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lb/i/m/j;
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lb/i/m/j;

    :cond_0
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lb/i/m/j;

    invoke-static {p0, v0}, Lb/i/m/l;->e0(Landroid/view/View;Lb/i/m/j;)V
