...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    invoke-direct {p0, p1, v0}, Lb/b/p/i0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lb/b/p/i0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v0, p0, Lb/b/p/i0;->b:Z

    const/4 v1, -0x1

    iput v1, p0, Lb/b/p/i0;->c:I

    const/4 v2, 0x0

    iput v2, p0, Lb/b/p/i0;->d:I

    const v3, 0x800033

    iput v3, p0, Lb/b/p/i0;->f:I
    ...
    sget-object v6, Lb/b/j;->LinearLayoutCompat:[I
    ...
    invoke-static/range {v4 .. v10}, Lb/i/m/l;->V(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-virtual {p0, p2}, Lb/b/p/i0;->setOrientation(I)V
    ...
    invoke-virtual {p0, p2}, Lb/b/p/i0;->setGravity(I)V
    ...
    invoke-virtual {p0, p2}, Lb/b/p/i0;->setBaselineAligned(Z)V
    ...
    iput-boolean p2, p0, Lb/b/p/i0;->i:Z
    ...
    invoke-static {p1, p3}, Lb/b/l/a/a;->b(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    invoke-virtual {p0, p1}, Lb/b/p/i0;->setDividerDrawable(Landroid/graphics/drawable/Drawable;)V

    sget p1, Lb/b/j;->LinearLayoutCompat_showDividers:I

    invoke-virtual {v3, p1, v2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p1

    iput p1, p0, Lb/b/p/i0;->o:I

    sget p1, Lb/b/j;->LinearLayoutCompat_dividerPadding:I

    invoke-virtual {v3, p1, v2}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result p1

    iput p1, p0, Lb/b/p/i0;->p:I
...
.method public g(Landroid/graphics/Canvas;I)V
    ...
    iget-object v0, p0, Lb/b/p/i0;->l:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->getPaddingLeft()I

    move-result v1

    iget v2, p0, Lb/b/p/i0;->p:I
    ...
    iget v3, p0, Lb/b/p/i0;->p:I

    sub-int/2addr v2, v3

    iget v3, p0, Lb/b/p/i0;->n:I

    add-int/2addr v3, p2

    invoke-virtual {v0, v1, p2, v2, v3}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object p2, p0, Lb/b/p/i0;->l:Landroid/graphics/drawable/Drawable;
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Lb/b/p/i0;->i()Lb/b/p/i0$a;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Lb/b/p/i0;->j(Landroid/util/AttributeSet;)Lb/b/p/i0$a;
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0, p1}, Lb/b/p/i0;->k(Landroid/view/ViewGroup$LayoutParams;)Lb/b/p/i0$a;
...
.method public getBaseline()I
    ...
    :cond_2
    iget v2, p0, Lb/b/p/i0;->d:I

    iget v3, p0, Lb/b/p/i0;->e:I

    const/4 v4, 0x1

    if-ne v3, v4, :cond_5

    iget v3, p0, Lb/b/p/i0;->f:I
...
.method public i()Lb/b/p/i0$a;
    ...
    new-instance v0, Lb/b/p/i0$a;

    invoke-direct {v0, v1, v1}, Lb/b/p/i0$a;-><init>(II)V
    ...
    invoke-direct {v0, v2, v1}, Lb/b/p/i0$a;-><init>(II)V
...
.method public j(Landroid/util/AttributeSet;)Lb/b/p/i0$a;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Lb/b/p/i0$a;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    return-object v0
.end method

.method public k(Landroid/view/ViewGroup$LayoutParams;)Lb/b/p/i0$a;
    .locals 1

    new-instance v0, Lb/b/p/i0$a;

    invoke-direct {v0, p1}, Lb/b/p/i0$a;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lb/b/p/i0;->getVirtualChildCount()I
    ...
    invoke-virtual {p0, v2}, Lb/b/p/i0;->o(I)Z
    ...
    iget v4, p0, Lb/b/p/i0;->n:I

    sub-int/2addr v3, v4

    invoke-virtual {p0, p1, v3}, Lb/b/p/i0;->g(Landroid/graphics/Canvas;I)V
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lb/b/p/i0;->o(I)Z
    ...
    :goto_1
    invoke-virtual {p0, p1, v0}, Lb/b/p/i0;->g(Landroid/graphics/Canvas;I)V
    ...
    invoke-static {p0}, Lb/b/p/d1;->b(Landroid/view/View;)Z
    ...
    iget v5, p0, Lb/b/p/i0;->m:I

    sub-int/2addr v4, v5

    :goto_3
    invoke-virtual {p0, p1, v4}, Lb/b/p/i0;->h(Landroid/graphics/Canvas;I)V
    ...
    :goto_5
    invoke-virtual {p0, p1, v0}, Lb/b/p/i0;->h(Landroid/graphics/Canvas;I)V
...
.method public onLayout(ZIIII)V
    ...
    invoke-virtual/range {p0 .. p0}, Lb/b/p/i0;->getVirtualChildCount()I

    move-result v12

    iget v13, v0, Lb/b/p/i0;->f:I
    ...
    invoke-virtual/range {p0 .. p0}, Lb/b/p/i0;->q()I
    ...
    check-cast v15, Lb/b/p/i0$a;

    iget v4, v15, Lb/b/p/i0$a;->b:I
    ...
    :goto_3
    invoke-virtual {v0, v7}, Lb/b/p/i0;->o(I)Z

    move-result v8

    if-eqz v8, :cond_6

    iget v8, v0, Lb/b/p/i0;->n:I
    ...
    invoke-virtual/range {p0 .. p0}, Lb/b/p/i0;->m()I
    ...
    invoke-virtual/range {p0 .. p0}, Lb/b/p/i0;->n()I
    ...
    invoke-virtual/range {p0 .. p0}, Lb/b/p/i0;->l()I
    ...
    :cond_8
    invoke-static/range {p0 .. p0}, Lb/b/p/d1;->b(Landroid/view/View;)Z
    ...
    iget v11, v0, Lb/b/p/i0;->f:I

    and-int/2addr v6, v11

    and-int/lit8 v11, v11, 0x70

    iget-boolean v12, v0, Lb/b/p/i0;->b:Z

    iget-object v13, v0, Lb/b/p/i0;->j:[I

    iget-object v14, v0, Lb/b/p/i0;->k:[I
    ...
    :cond_14
    :goto_9
    invoke-virtual {v0, v9}, Lb/b/p/i0;->o(I)Z

    move-result v9

    if-eqz v9, :cond_15

    iget v9, v0, Lb/b/p/i0;->m:I
...
.method public onMeasure(II)V
    ...
    iget v0, v6, Lb/b/p/i0;->c:I

    iget-boolean v9, v6, Lb/b/p/i0;->i:Z
    ...
    :cond_1
    invoke-virtual {v6, v14}, Lb/b/p/i0;->o(I)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lb/b/p/i0;->p(Landroid/view/View;IIII)V
    ...
    iget v0, v6, Lb/b/p/i0;->g:I

    iput v0, v6, Lb/b/p/i0;->d:I

    :cond_8
    if-ge v14, v10, :cond_a

    iget v0, v13, Lb/b/p/i0$a;->a:F
    ...
    iget v2, v6, Lb/b/p/i0;->g:I

    move/from16 v10, v31

    if-lez v2, :cond_11

    invoke-virtual {v6, v10}, Lb/b/p/i0;->o(I)Z
    ...
    iget v3, v6, Lb/b/p/i0;->n:I

    add-int/2addr v2, v3

    iput v2, v6, Lb/b/p/i0;->g:I
    ...
    check-cast v9, Lb/b/p/i0$a;

    iget v9, v9, Lb/b/p/i0$a;->a:F
    ...
    check-cast v11, Lb/b/p/i0$a;

    iget v13, v11, Lb/b/p/i0$a;->a:F
    ...
    iget-object v0, v6, Lb/b/p/i0;->j:[I

    const/4 v12, 0x4

    if-eqz v0, :cond_2a

    iget-object v0, v6, Lb/b/p/i0;->k:[I
    ...
    iput-object v0, v6, Lb/b/p/i0;->j:[I

    new-array v0, v12, [I

    iput-object v0, v6, Lb/b/p/i0;->k:[I

    :cond_2b
    iget-object v13, v6, Lb/b/p/i0;->j:[I

    iget-object v14, v6, Lb/b/p/i0;->k:[I
    ...
    iget-boolean v5, v6, Lb/b/p/i0;->b:Z

    iget-boolean v4, v6, Lb/b/p/i0;->i:Z
    ...
    :cond_2e
    invoke-virtual {v6, v3}, Lb/b/p/i0;->o(I)Z
    ...
    check-cast v2, Lb/b/p/i0$a;

    iget v0, v2, Lb/b/p/i0$a;->a:F
    ...
    iget v12, v1, Lb/b/p/i0$a;->b:I

    if-gez v12, :cond_3a

    iget v12, v6, Lb/b/p/i0;->f:I
    ...
    invoke-virtual {v6, v9}, Lb/b/p/i0;->o(I)Z
    ...
    iget v4, v6, Lb/b/p/i0;->m:I

    add-int/2addr v3, v4

    iput v3, v6, Lb/b/p/i0;->g:I
    ...
    iget v5, v5, Lb/b/p/i0$a;->b:I

    if-gez v5, :cond_5a

    iget v5, v6, Lb/b/p/i0;->f:I
...
.method public setBaselineAligned(Z)V
    ...
    iput-boolean p1, p0, Lb/b/p/i0;->b:Z
...
.method public setDividerDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iput-object p1, p0, Lb/b/p/i0;->l:Landroid/graphics/drawable/Drawable;
    ...
    iput v1, p0, Lb/b/p/i0;->m:I

    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result v1

    iput v1, p0, Lb/b/p/i0;->n:I

    goto :goto_0

    :cond_1
    iput v0, p0, Lb/b/p/i0;->m:I

    iput v0, p0, Lb/b/p/i0;->n:I
...
.method public setMeasureWithLargestChildEnabled(Z)V
    ...
    iput-boolean p1, p0, Lb/b/p/i0;->i:Z
