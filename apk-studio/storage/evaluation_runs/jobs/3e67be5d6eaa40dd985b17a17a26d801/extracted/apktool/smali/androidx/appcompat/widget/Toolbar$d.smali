...
# instance fields
.field public b:Lb/b/o/i/g;

.field public c:Lb/b/o/i/i;
...
.method public c(Lb/b/o/i/g;Lb/b/o/i/i;)Z
    ...
    invoke-virtual {p2}, Lb/b/o/i/i;->getActionView()Landroid/view/View;

    move-result-object v0

    iput-object v0, p1, Landroidx/appcompat/widget/Toolbar;->j:Landroid/view/View;

    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->c:Lb/b/o/i/i;
    ...
    iput-boolean p1, p2, Lb/b/o/i/i;->C:Z

    iget-object p2, p2, Lb/b/o/i/i;->n:Lb/b/o/i/g;

    const/4 v0, 0x0

    invoke-virtual {p2, v0}, Lb/b/o/i/g;->q(Z)V
    ...
    instance-of v0, p2, Lb/b/o/b;

    if-eqz v0, :cond_6

    check-cast p2, Lb/b/o/b;

    invoke-interface {p2}, Lb/b/o/b;->a()V
...
.method public h(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->c:Lb/b/o/i/i;

    if-eqz p1, :cond_2

    iget-object p1, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Lb/b/o/i/g;
    ...
    iget-object v2, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Lb/b/o/i/g;

    invoke-virtual {v2, v1}, Lb/b/o/i/g;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Landroidx/appcompat/widget/Toolbar$d;->c:Lb/b/o/i/i;
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->c:Lb/b/o/i/i;

    invoke-virtual {p0, p1, v0}, Landroidx/appcompat/widget/Toolbar$d;->k(Lb/b/o/i/g;Lb/b/o/i/i;)Z
...
.method public j(Landroid/content/Context;Lb/b/o/i/g;)V
    ...
    invoke-virtual {p1, v0}, Lb/b/o/i/g;->d(Lb/b/o/i/i;)Z

    :cond_0
    iput-object p2, p0, Landroidx/appcompat/widget/Toolbar$d;->b:Lb/b/o/i/g;
...
.method public k(Lb/b/o/i/g;Lb/b/o/i/i;)Z
    ...
    instance-of v0, p1, Lb/b/o/b;

    if-eqz v0, :cond_0

    check-cast p1, Lb/b/o/b;

    invoke-interface {p1}, Lb/b/o/b;->f()V
    ...
    iput-object v0, p0, Landroidx/appcompat/widget/Toolbar$d;->c:Lb/b/o/i/i;
    ...
    invoke-virtual {p2, p1}, Lb/b/o/i/g;->q(Z)V
