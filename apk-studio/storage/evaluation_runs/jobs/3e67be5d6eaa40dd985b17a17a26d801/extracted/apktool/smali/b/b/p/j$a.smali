.class public Lb/b/p/j$a;
.super Ljava/lang/Object;
.source ""

# interfaces
.implements Lb/b/p/n0$e;
...
.method public constructor <init>()V
    ...
    iput-object v1, p0, Lb/b/p/j$a;->a:[I
    ...
    iput-object v2, p0, Lb/b/p/j$a;->b:[I
    ...
    iput-object v2, p0, Lb/b/p/j$a;->c:[I
    ...
    iput-object v1, p0, Lb/b/p/j$a;->d:[I
    ...
    iput-object v1, p0, Lb/b/p/j$a;->e:[I
    ...
    iput-object v1, p0, Lb/b/p/j$a;->f:[I
...
.method public final b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Lb/b/p/s0;->c(Landroid/content/Context;I)I

    move-result v2

    sget v3, Lb/b/a;->colorButtonNormal:I

    invoke-static {p1, v3}, Lb/b/p/s0;->b(Landroid/content/Context;I)I

    move-result p1

    sget-object v3, Lb/b/p/s0;->b:[I
    ...
    sget-object p1, Lb/b/p/s0;->d:[I

    const/4 v3, 0x1

    aput-object p1, v1, v3

    invoke-static {v2, p2}, Lb/i/f/a;->a(II)I

    move-result p1

    aput p1, v0, v3

    sget-object p1, Lb/b/p/s0;->c:[I
...
.method public c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {p1, v2}, Lb/b/p/s0;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    sget-object v1, Lb/b/p/s0;->e:[I

    aput-object v1, v0, v4

    sget v1, Lb/b/a;->colorControlActivated:I

    invoke-static {p1, v1}, Lb/b/p/s0;->c(Landroid/content/Context;I)I
    ...
    :cond_2
    sget-object v2, Lb/b/p/s0;->b:[I

    aput-object v2, v0, v1

    sget v2, Lb/b/a;->colorSwitchThumbNormal:I

    invoke-static {p1, v2}, Lb/b/p/s0;->b(Landroid/content/Context;I)I
    ...
    invoke-virtual {p0, p1, p2}, Lb/b/p/j$a;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {p0, p1, v1}, Lb/b/p/j$a;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_7
    iget-object v0, p0, Lb/b/p/j$a;->b:[I

    invoke-virtual {p0, v0, p2}, Lb/b/p/j$a;->a([II)Z
    ...
    invoke-static {p1, p2}, Lb/b/p/s0;->d(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    :cond_8
    iget-object v0, p0, Lb/b/p/j$a;->e:[I
    ...
    :cond_9
    iget-object v0, p0, Lb/b/p/j$a;->f:[I
...
.method public final d(Landroid/graphics/drawable/Drawable;ILandroid/graphics/PorterDuff$Mode;)V
    ...
    invoke-static {p1}, Lb/b/p/e0;->a(Landroid/graphics/drawable/Drawable;)Z
    ...
    sget-object p3, Lb/b/p/j;->b:Landroid/graphics/PorterDuff$Mode;

    :cond_1
    invoke-static {p2, p3}, Lb/b/p/j;->c(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuffColorFilter;
