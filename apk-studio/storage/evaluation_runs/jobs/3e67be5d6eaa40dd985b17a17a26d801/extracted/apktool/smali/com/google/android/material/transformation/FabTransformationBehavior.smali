...
.method public D(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    sget v1, Lc/c/a/b/a;->mtrl_fab_transformation_sheet_expand_spec:I

    goto :goto_0

    :cond_0
    sget v1, Lc/c/a/b/a;->mtrl_fab_transformation_sheet_collapse_spec:I
    ...
    invoke-static {v0, v1}, Lc/c/a/b/l/g;->b(Landroid/content/Context;I)Lc/c/a/b/l/g;

    move-result-object v0

    iput-object v0, v12, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lc/c/a/b/l/g;

    new-instance v0, Lc/c/a/b/l/i;

    const/16 v1, 0x11

    const/4 v13, 0x0

    invoke-direct {v0, v1, v13, v13}, Lc/c/a/b/l/i;-><init>(IFF)V

    iput-object v0, v12, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc/c/a/b/l/i;
    ...
    iget-object v2, v12, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc/c/a/b/l/i;

    invoke-virtual {v8, v9, v10, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->F(Landroid/view/View;Landroid/view/View;Lc/c/a/b/l/i;)F

    move-result v2

    iget-object v3, v12, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc/c/a/b/l/i;

    invoke-virtual {v8, v9, v10, v3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->G(Landroid/view/View;Landroid/view/View;Lc/c/a/b/l/i;)F
    ...
    check-cast v5, Lc/c/a/b/l/h;

    iget-object v4, v4, Landroid/util/Pair;->second:Ljava/lang/Object;

    check-cast v4, Lc/c/a/b/l/h;
    ...
    invoke-virtual {v5, v2}, Lc/c/a/b/l/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v4, v3}, Lc/c/a/b/l/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v14, v2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v14, v3}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    instance-of v2, v10, Lc/c/a/b/t/c;
    ...
    :cond_6
    sget-object v5, Lc/c/a/b/l/d;->b:Landroid/util/Property;
    ...
    :cond_7
    sget-object v6, Lc/c/a/b/l/d;->b:Landroid/util/Property;
    ...
    :goto_3
    new-instance v6, Lc/c/a/b/h0/a;

    invoke-direct {v6, v8, v10}, Lc/c/a/b/h0/a;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Landroid/view/View;)V
    ...
    iget-object v6, v12, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lc/c/a/b/l/g;

    const-string v7, "iconFade"

    invoke-virtual {v6, v7}, Lc/c/a/b/l/g;->d(Ljava/lang/String;)Lc/c/a/b/l/h;

    move-result-object v6

    invoke-virtual {v6, v5}, Lc/c/a/b/l/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v14, v5}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    new-instance v5, Lc/c/a/b/h0/b;

    invoke-direct {v5, v8, v3, v4}, Lc/c/a/b/h0/b;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lc/c/a/b/t/c;Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v8, v9, v10, v3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->F(Landroid/view/View;Landroid/view/View;Lc/c/a/b/l/i;)F
    ...
    iget-object v4, v12, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc/c/a/b/l/i;
    ...
    invoke-virtual {v8, v9, v10, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->G(Landroid/view/View;Landroid/view/View;Lc/c/a/b/l/i;)F
    ...
    new-instance v12, Lc/c/a/b/t/c$e;

    invoke-direct {v12, v3, v4, v5}, Lc/c/a/b/t/c$e;-><init>(FFF)V

    invoke-interface {v2, v12}, Lc/c/a/b/t/c;->setRevealInfo(Lc/c/a/b/t/c$e;)V

    :cond_a
    if-eqz p4, :cond_b

    invoke-interface {v2}, Lc/c/a/b/t/c;->getRevealInfo()Lc/c/a/b/t/c$e;

    move-result-object v5

    iget v5, v5, Lc/c/a/b/t/c$e;->c:F

    :cond_b
    const/4 v12, 0x0

    invoke-static {v3, v4, v12, v12}, Lc/c/a/a/c/l/q;->u(FFFF)F

    move-result v13

    invoke-static {v3, v4, v0, v12}, Lc/c/a/a/c/l/q;->u(FFFF)F

    move-result v16

    invoke-static {v3, v4, v0, v1}, Lc/c/a/a/c/l/q;->u(FFFF)F

    move-result v0

    invoke-static {v3, v4, v12, v1}, Lc/c/a/a/c/l/q;->u(FFFF)F
    ...
    :goto_5
    invoke-static {v2, v3, v4, v13}, Lc/c/a/a/c/l/q;->l(Lc/c/a/b/t/c;FFF)Landroid/animation/Animator;

    move-result-object v0

    new-instance v1, Lc/c/a/b/h0/c;

    invoke-direct {v1, v8, v2}, Lc/c/a/b/h0/c;-><init>(Lcom/google/android/material/transformation/FabTransformationBehavior;Lc/c/a/b/t/c;)V

    invoke-virtual {v0, v1}, Landroid/animation/Animator;->addListener(Landroid/animation/Animator$AnimatorListener;)V

    iget-wide v12, v6, Lc/c/a/b/l/h;->a:J
    ...
    iget v0, v0, Lc/c/a/b/t/c$e;->c:F

    invoke-static {v2, v3, v4, v5}, Lc/c/a/a/c/l/q;->l(Lc/c/a/b/t/c;FFF)Landroid/animation/Animator;

    move-result-object v1

    iget-wide v8, v6, Lc/c/a/b/l/h;->a:J
    ...
    iget-wide v12, v6, Lc/c/a/b/l/h;->b:J

    iget-object v0, v7, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lc/c/a/b/l/g;

    move-object/from16 v16, v1

    iget-object v1, v0, Lc/c/a/b/l/g;->a:Lb/f/h;
    ...
    invoke-virtual {v1, v11}, Lb/f/h;->k(I)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lc/c/a/b/l/h;

    move-object/from16 v19, v14

    move-object/from16 v22, v15

    iget-wide v14, v1, Lc/c/a/b/l/h;->a:J

    move-object/from16 v23, v0

    iget-wide v0, v1, Lc/c/a/b/l/h;->b:J
    ...
    :goto_8
    invoke-virtual {v1, v0}, Lc/c/a/b/l/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v7, v0}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    new-instance v0, Lc/c/a/b/t/a;

    invoke-direct {v0, v2}, Lc/c/a/b/t/a;-><init>(Lc/c/a/b/t/c;)V
    ...
    invoke-static {v0, v7}, Lc/c/a/a/c/l/q;->N(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method public final E(FFZLcom/google/android/material/transformation/FabTransformationBehavior$b;)Landroid/util/Pair;
    ...
    :cond_2
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lc/c/a/b/l/g;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Lc/c/a/b/l/g;->d(Ljava/lang/String;)Lc/c/a/b/l/h;

    move-result-object p1

    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lc/c/a/b/l/g;
    ...
    :goto_1
    invoke-virtual {p2, p3}, Lc/c/a/b/l/g;->d(Ljava/lang/String;)Lc/c/a/b/l/h;
...
.method public final F(Landroid/view/View;Landroid/view/View;Lc/c/a/b/l/i;)F
    .locals 3
...
.method public final G(Landroid/view/View;Landroid/view/View;Lc/c/a/b/l/i;)F
    .locals 3
...
.method public final H(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lc/c/a/b/l/h;FF)F
    .locals 8

    iget-wide v0, p2, Lc/c/a/b/l/h;->a:J

    iget-wide v2, p2, Lc/c/a/b/l/h;->b:J

    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lc/c/a/b/l/g;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Lc/c/a/b/l/g;->d(Ljava/lang/String;)Lc/c/a/b/l/h;

    move-result-object p1

    iget-wide v4, p1, Lc/c/a/b/l/h;->a:J

    iget-wide v6, p1, Lc/c/a/b/l/h;->b:J
    ...
    invoke-virtual {p2}, Lc/c/a/b/l/h;->b()Landroid/animation/TimeInterpolator;
    ...
    invoke-static {p3, p4, p1}, Lc/c/a/b/l/a;->a(FFF)F
...
.method public final J(Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$b;Ljava/util/List;)V
    ...
    :cond_0
    instance-of v0, p1, Lc/c/a/b/t/c;

    sget v0, Lc/c/a/b/f;->mtrl_child_content_container:I
    ...
    :cond_1
    instance-of v0, p1, Lc/c/a/b/h0/e;

    if-nez v0, :cond_2

    instance-of v0, p1, Lc/c/a/b/h0/d;
    ...
    sget-object p2, Lc/c/a/b/l/c;->a:Landroid/util/Property;
    ...
    invoke-virtual {p2, p1}, Lc/c/a/b/l/h;->a(Landroid/animation/Animator;)V
...
.method public final K(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$b;Ljava/util/List;)V
    ...
    instance-of v0, p2, Lc/c/a/b/t/c;
    ...
    :cond_0
    check-cast p2, Lc/c/a/b/t/c;

    invoke-static {p1}, Lb/i/m/l;->j(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    invoke-interface {p2, p1}, Lc/c/a/b/t/c;->setCircularRevealScrimColor(I)V

    :cond_2
    sget-object p1, Lc/c/a/b/t/c$d;->a:Landroid/util/Property;
    ...
    :cond_3
    sget-object p3, Lc/c/a/b/t/c$d;->a:Landroid/util/Property;
    ...
    :goto_1
    sget-object p2, Lc/c/a/b/l/b;->a:Lc/c/a/b/l/b;

    invoke-virtual {p1, p2}, Landroid/animation/ObjectAnimator;->setEvaluator(Landroid/animation/TypeEvaluator;)V

    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->a:Lc/c/a/b/l/g;
...
.method public final L(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$b;Ljava/util/List;)V
    ...
    invoke-static {p2}, Lb/i/m/l;->m(Landroid/view/View;)F
...
.method public final M(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$b;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    iget-object v0, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc/c/a/b/l/i;

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->F(Landroid/view/View;Landroid/view/View;Lc/c/a/b/l/i;)F

    move-result v0

    iget-object v1, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$b;->b:Lc/c/a/b/l/i;

    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->G(Landroid/view/View;Landroid/view/View;Lc/c/a/b/l/i;)F
    ...
    invoke-virtual {p0, p5, v2, v0, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->H(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lc/c/a/b/l/h;FF)F

    move-result v0

    invoke-virtual {p0, p5, v1, p1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->H(Lcom/google/android/material/transformation/FabTransformationBehavior$b;Lc/c/a/b/l/h;FF)F
    ...
    :goto_0
    invoke-virtual {v2, p3}, Lc/c/a/b/l/h;->a(Landroid/animation/Animator;)V

    invoke-virtual {v1, p4}, Lc/c/a/b/l/h;->a(Landroid/animation/Animator;)V
