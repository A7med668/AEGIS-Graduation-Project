...
.method public constructor <init>(Landroid/view/View;)V
    ...
    invoke-static {p1}, Lb/i/m/l;->p(Landroid/view/View;)I
...
# virtual methods
.method public b(Landroid/view/View;)Lb/i/m/v/c;
    .locals 0
...
.method public final j(I)Z
    ...
    invoke-virtual {p0, p1, v0}, Lb/k/b/a;->s(II)Z
...
.method public final l(I)Lb/i/m/v/b;
    .locals 7
    ...
    new-instance v1, Lb/i/m/v/b;

    invoke-direct {v1, v0}, Lb/i/m/v/b;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V

    iget-object v0, v1, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    iget-object v3, v1, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    iput v3, v1, Lb/i/m/v/b;->b:I

    iget-object v4, v1, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;

    invoke-virtual {v4, v0}, Landroid/view/accessibility/AccessibilityNodeInfo;->setParent(Landroid/view/View;)V

    invoke-virtual {p0, p1, v1}, Lb/k/b/a;->q(ILb/i/m/v/b;)V

    invoke-virtual {v1}, Lb/i/m/v/b;->g()Ljava/lang/CharSequence;

    move-result-object v0

    if-nez v0, :cond_1

    invoke-virtual {v1}, Lb/i/m/v/b;->e()Ljava/lang/CharSequence;
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lb/k/b/a;->e:Landroid/graphics/Rect;
    ...
    new-instance v0, Lb/i/m/v/b;

    invoke-direct {v0, p1}, Lb/i/m/v/b;-><init>(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    iput v3, v0, Lb/i/m/v/b;->b:I

    iget-object v6, v0, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    invoke-virtual {p0, p1, v0}, Lb/k/b/a;->q(ILb/i/m/v/b;)V

    iget-object p1, p0, Lb/k/b/a;->e:Landroid/graphics/Rect;

    iget-object v4, v0, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    iget p1, v0, Lb/i/m/v/b;->b:I

    goto :goto_4

    :cond_6
    iget-object p1, v0, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    iget-object p1, v1, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public final n(ILandroid/graphics/Rect;)Z
    ...
    invoke-virtual {v0, v3}, Lb/k/b/a;->m(Ljava/util/List;)V

    new-instance v4, Lb/f/i;

    const/16 v5, 0xa

    invoke-direct {v4, v5}, Lb/f/i;-><init>(I)V
    ...
    invoke-virtual {v0, v6}, Lb/k/b/a;->l(I)Lb/i/m/v/b;
    ...
    invoke-virtual {v0, v15}, Lb/k/b/a;->o(I)Lb/i/m/v/b;

    move-result-object v2

    iget-object v2, v2, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    iget-boolean v11, v4, Lb/f/i;->b:Z
    ...
    invoke-static {v14, v6, v1}, La/a/a/a/a;->O(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    :cond_10
    invoke-static {v14, v7, v1}, La/a/a/a/a;->O(Landroid/graphics/Rect;Landroid/graphics/Rect;I)Z
    ...
    :cond_11
    invoke-static {v1, v14, v6, v7}, La/a/a/a/a;->b(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v1, v14, v7, v6}, La/a/a/a/a;->b(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_13
    invoke-static {v1, v14, v6}, La/a/a/a/a;->W(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v14, v6}, La/a/a/a/a;->X(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v1, v14, v7}, La/a/a/a/a;->W(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v14, v7}, La/a/a/a/a;->X(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v2}, Lb/i/m/l;->r(Landroid/view/View;)I
    ...
    iget-boolean v13, v4, Lb/f/i;->b:Z
    ...
    :goto_13
    invoke-virtual {v0, v7}, Lb/k/b/a;->r(I)Z
...
.method public o(I)Lb/i/m/v/b;
    ...
    invoke-static {p1, v0}, Lb/i/m/l;->M(Landroid/view/View;Lb/i/m/v/b;)V

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    invoke-virtual {p0, p1}, Lb/k/b/a;->m(Ljava/util/List;)V

    iget-object v1, v0, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    iget-object v5, v0, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_3
    invoke-virtual {p0, p1}, Lb/k/b/a;->l(I)Lb/i/m/v/b;
...
.method public abstract q(ILb/i/m/v/b;)V
.end method
...
.method public final s(II)Z
    ...
    invoke-virtual {p0, p1}, Lb/k/b/a;->o(I)Lb/i/m/v/b;
    ...
    invoke-virtual {v0}, Lb/i/m/v/b;->g()Ljava/lang/CharSequence;

    move-result-object v3

    invoke-interface {v2, v3}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    invoke-virtual {v0}, Lb/i/m/v/b;->e()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p2, v2}, Landroid/view/accessibility/AccessibilityEvent;->setContentDescription(Ljava/lang/CharSequence;)V

    iget-object v2, v0, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
    ...
    :cond_3
    :goto_0
    iget-object v0, v0, Lb/i/m/v/b;->a:Landroid/view/accessibility/AccessibilityNodeInfo;
...
.method public final t(I)V
    ...
    invoke-virtual {p0, p1, v1}, Lb/k/b/a;->s(II)Z

    const/16 p1, 0x100

    invoke-virtual {p0, v0, p1}, Lb/k/b/a;->s(II)Z
