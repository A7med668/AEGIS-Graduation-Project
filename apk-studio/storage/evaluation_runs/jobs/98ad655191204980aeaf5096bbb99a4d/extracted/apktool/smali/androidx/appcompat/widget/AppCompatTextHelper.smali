...
.method public final loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v10, v7, v3, v8, v12}, Landroidx/core/view/MenuHostHelper;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/core/view/MenuHostHelper;
    ...
    iget-object v1, v13, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;
    ...
    :cond_5
    invoke-virtual {v13}, Landroidx/core/view/MenuHostHelper;->recycle()V
    ...
    invoke-direct {v3, v10, v2}, Landroidx/core/view/MenuHostHelper;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    :goto_0
    invoke-virtual {v0, v10, v3}, Landroidx/appcompat/widget/AppCompatTextHelper;->updateTypefaceAndStyle(Landroid/content/Context;Landroidx/core/view/MenuHostHelper;)V
    ...
    invoke-virtual {v3, v15}, Landroidx/core/view/MenuHostHelper;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v3, v5}, Landroidx/core/view/MenuHostHelper;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-direct {v3, v10, v5}, Landroidx/core/view/MenuHostHelper;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    invoke-virtual {v3, v6}, Landroidx/core/view/MenuHostHelper;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v3, v14}, Landroidx/core/view/MenuHostHelper;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    iput v2, v12, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->mAutoSizeTextType:I
    ...
    :cond_23
    invoke-static {v8}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->cleanupAutoSizePresetSizes([I)[I

    move-result-object v2

    iput-object v2, v12, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->mAutoSizeTextSizesInPx:[I
    ...
    :cond_28
    invoke-virtual {v12, v4, v5, v1}, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->validateAndSetAutoSizeTextTypeUniformConfiguration(FFF)V
    ...
    iget v3, v12, Landroidx/appcompat/widget/AppCompatTextViewAutoSizeHelper;->mAutoSizeStepGranularityInPx:F
    ...
    invoke-static {v9, v1, v2, v3, v4}, Landroidx/appcompat/widget/AppCompatTextHelper$Api26Impl;->setAutoSizeTextTypeUniformWithConfiguration(Landroid/widget/TextView;IIII)V
    ...
    invoke-static {v9, v1, v4}, Landroidx/appcompat/widget/AppCompatTextHelper$Api26Impl;->setAutoSizeTextTypeUniformWithPresetSizes(Landroid/widget/TextView;[II)V
    ...
    invoke-static {v10, v3}, Landroidx/core/math/MathUtils;->getColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v9, v3}, Landroidx/core/widget/TextViewCompat$Api23Impl;->setCompoundDrawableTintList(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V
    ...
    :cond_47
    instance-of v3, v9, Landroidx/core/widget/TintableCompoundDrawablesView;
    ...
    invoke-static {v9, v3}, Lkotlin/ResultKt;->setFirstBaselineToTopHeight(Landroid/widget/TextView;I)V

    :cond_4b
    if-eq v4, v7, :cond_4c

    invoke-static {v9, v4}, Lkotlin/ResultKt;->setLastBaselineToBottomHeight(Landroid/widget/TextView;I)V
    ...
    invoke-static {v9, v1}, Lkotlin/ResultKt;->setLineHeight(Landroid/widget/TextView;I)V
    ...
    invoke-static {v9, v5, v2}, Landroidx/core/widget/TextViewCompat$Api34Impl;->setLineHeight(Landroid/widget/TextView;IF)V
...
.method public final onSetTextAppearance(Landroid/content/Context;I)V
    ...
    invoke-direct {v1, p1, p2}, Landroidx/core/view/MenuHostHelper;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    invoke-virtual {v1, v2}, Landroidx/core/view/MenuHostHelper;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    :cond_4
    invoke-virtual {p0, p1, v1}, Landroidx/appcompat/widget/AppCompatTextHelper;->updateTypefaceAndStyle(Landroid/content/Context;Landroidx/core/view/MenuHostHelper;)V
