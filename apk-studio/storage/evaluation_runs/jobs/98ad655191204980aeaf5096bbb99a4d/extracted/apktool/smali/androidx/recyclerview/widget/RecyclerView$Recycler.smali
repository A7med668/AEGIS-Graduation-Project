...
.method public final addViewHolderToRecycledViewPool(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Z)V
    ...
    :goto_0
    invoke-static {v4, v1}, Landroidx/core/view/ViewCompat;->setAccessibilityDelegate(Landroid/view/View;Landroidx/core/view/AccessibilityDelegateCompat;)V
    ...
    iget-object p2, v0, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {p2, p1}, Lkotlin/text/MatcherMatchResult;->removeViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
...
.method public final convertPreLayoutPositionToPostLayout(I)I
    ...
    :cond_0
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Landroidx/core/provider/FontRequest;

    const/4 v1, 0x0

    invoke-virtual {v0, p1, v1}, Landroidx/core/provider/FontRequest;->findPositionOffset(II)I
    ...
    invoke-static {v2, p1, v3}, Landroidx/compose/foundation/lazy/LazyListScope$-CC;->m(Ljava/lang/String;ILjava/lang/String;)Ljava/lang/StringBuilder;
...
.method public final recycleAndClearCachedViews()V
    ...
    iget-object v0, v0, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/compose/ui/text/input/GapBuffer;
    ...
    iput v1, v0, Landroidx/compose/ui/text/input/GapBuffer;->gapEnd:I
...
.method public final recycleViewHolderInternal(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v6, v3, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/compose/ui/text/input/GapBuffer;

    iget v7, p1, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mPosition:I

    iget-object v8, v6, Landroidx/compose/ui/text/input/GapBuffer;->buffer:Ljava/lang/Object;

    check-cast v8, [I

    if-eqz v8, :cond_4

    iget v8, v6, Landroidx/compose/ui/text/input/GapBuffer;->gapEnd:I
    ...
    iget-object v10, v6, Landroidx/compose/ui/text/input/GapBuffer;->buffer:Ljava/lang/Object;
    ...
    iget-object v7, v3, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/compose/ui/text/input/GapBuffer;

    iget-object v8, v7, Landroidx/compose/ui/text/input/GapBuffer;->buffer:Ljava/lang/Object;

    check-cast v8, [I

    if-eqz v8, :cond_6

    iget v8, v7, Landroidx/compose/ui/text/input/GapBuffer;->gapEnd:I
    ...
    iget-object v10, v7, Landroidx/compose/ui/text/input/GapBuffer;->buffer:Ljava/lang/Object;
    ...
    :goto_6
    iget-object v3, v3, Landroidx/recyclerview/widget/RecyclerView;->mViewInfoStore:Lkotlin/text/MatcherMatchResult;

    invoke-virtual {v3, p1}, Lkotlin/text/MatcherMatchResult;->removeViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
...
.method public final tryGetViewHolderForPositionByDeadline(JI)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-boolean v6, v5, Landroidx/recyclerview/widget/RecyclerView$State;->mInPreLayout:Z
    ...
    iget-object v6, v1, Landroidx/recyclerview/widget/RecyclerView$Recycler;->mChangedScrap:Ljava/util/ArrayList;
    ...
    iget-object v11, v1, Landroidx/recyclerview/widget/RecyclerView$Recycler;->mChangedScrap:Ljava/util/ArrayList;
    ...
    invoke-virtual {v11, v9}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->addFlags(I)V
    ...
    iget-object v10, v4, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Landroidx/core/provider/FontRequest;

    invoke-virtual {v10, v0, v8}, Landroidx/core/provider/FontRequest;->findPositionOffset(II)I
    ...
    iget-object v13, v1, Landroidx/recyclerview/widget/RecyclerView$Recycler;->mChangedScrap:Ljava/util/ArrayList;
    ...
    invoke-virtual {v13, v9}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->addFlags(I)V
    ...
    :goto_4
    iget-object v10, v1, Landroidx/recyclerview/widget/RecyclerView$Recycler;->mCachedViews:Ljava/util/ArrayList;

    iget-object v12, v1, Landroidx/recyclerview/widget/RecyclerView$Recycler;->mAttachedScrap:Ljava/util/ArrayList;
    ...
    iget-boolean v15, v5, Landroidx/recyclerview/widget/RecyclerView$State;->mInPreLayout:Z
    ...
    :cond_7
    invoke-virtual {v14, v9}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->addFlags(I)V
    ...
    :cond_9
    iget-object v11, v4, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:Landroidx/core/view/MenuHostHelper;

    iget-object v13, v11, Landroidx/core/view/MenuHostHelper;->mProviderToLifecycleContainers:Ljava/lang/Object;
    ...
    iget-object v7, v11, Landroidx/core/view/MenuHostHelper;->mOnInvalidateMenuCallback:Ljava/lang/Object;

    check-cast v7, Landroidx/recyclerview/widget/RecyclerView$4;

    invoke-virtual {v7}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-static/range {v16 .. v16}, Landroidx/recyclerview/widget/RecyclerView;->getChildViewHolderInt(Landroid/view/View;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iget-object v13, v11, Landroidx/core/view/MenuHostHelper;->mOnInvalidateMenuCallback:Ljava/lang/Object;
    ...
    iget-object v14, v11, Landroidx/core/view/MenuHostHelper;->mMenuProviders:Ljava/lang/Object;

    check-cast v14, Landroidx/recyclerview/widget/ChildHelper$Bucket;

    invoke-virtual {v14, v13}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->get(I)Z

    move-result v15

    if-eqz v15, :cond_f

    invoke-virtual {v14, v13}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->clear(I)V

    invoke-virtual {v11, v7}, Landroidx/core/view/MenuHostHelper;->unhideViewInternal(Landroid/view/View;)V
    ...
    check-cast v11, Landroidx/recyclerview/widget/ChildHelper$Bucket;

    invoke-virtual {v11, v13}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->get(I)Z
    ...
    :cond_d
    invoke-virtual {v11, v13}, Landroidx/recyclerview/widget/ChildHelper$Bucket;->countOnesBefore(I)I
    ...
    invoke-virtual {v11, v13}, Landroidx/core/view/MenuHostHelper;->detachViewFromParent(I)V

    invoke-virtual {v1, v7}, Landroidx/recyclerview/widget/RecyclerView$Recycler;->scrapView(Landroid/view/View;)V
    ...
    iget-boolean v7, v5, Landroidx/recyclerview/widget/RecyclerView$State;->mInPreLayout:Z

    goto :goto_c

    :cond_14
    iget v7, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mPosition:I
    ...
    iget v7, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemViewType:I
    ...
    iget-boolean v9, v7, Landroidx/recyclerview/widget/RecyclerView$Adapter;->mHasStableIds:Z

    if-eqz v9, :cond_17

    iget-wide v13, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemId:J

    iget v9, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mPosition:I

    invoke-virtual {v7, v9}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->getItemId(I)J
    ...
    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->isScrap()Z
    ...
    iget-object v7, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mScrapContainer:Landroidx/recyclerview/widget/RecyclerView$Recycler;

    invoke-virtual {v7, v11}, Landroidx/recyclerview/widget/RecyclerView$Recycler;->unscrapView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iget v7, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mFlags:I

    and-int/lit8 v7, v7, -0x21

    iput v7, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mFlags:I

    :cond_19
    :goto_d
    invoke-virtual {v1, v11}, Landroidx/recyclerview/widget/RecyclerView$Recycler;->recycleViewHolderInternal(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    iget-object v7, v4, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Landroidx/core/provider/FontRequest;

    invoke-virtual {v7, v0, v8}, Landroidx/core/provider/FontRequest;->findPositionOffset(II)I
    ...
    iget-boolean v13, v9, Landroidx/recyclerview/widget/RecyclerView$Adapter;->mHasStableIds:Z

    if-eqz v13, :cond_24

    invoke-virtual {v9, v7}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->getItemId(I)J
    ...
    iget-wide v2, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemId:J
    ...
    iget v2, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemViewType:I

    if-nez v2, :cond_1d

    const/16 v2, 0x20

    invoke-virtual {v11, v2}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->addFlags(I)V
    ...
    iget-boolean v2, v5, Landroidx/recyclerview/widget/RecyclerView$State;->mInPreLayout:Z

    if-nez v2, :cond_23

    iget v2, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mFlags:I

    and-int/lit8 v2, v2, -0xf

    or-int/lit8 v2, v2, 0x2

    iput v2, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mFlags:I
    ...
    iput-object v11, v3, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mScrapContainer:Landroidx/recyclerview/widget/RecyclerView$Recycler;

    iput-boolean v8, v3, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mInChangeScrap:Z

    iget v11, v3, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mFlags:I

    and-int/lit8 v11, v11, -0x21

    iput v11, v3, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mFlags:I
    ...
    iget-wide v11, v3, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemId:J
    ...
    iget v9, v3, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemViewType:I
    ...
    iput v7, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mPosition:I
    ...
    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->resetInternal()V
    ...
    sget v11, Landroidx/core/os/TraceCompat;->$r8$clinit:I

    invoke-static {v10}, Landroid/os/Trace;->beginSection(Ljava/lang/String;)V

    invoke-virtual {v7, v4}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->onCreateViewHolder(Landroid/view/ViewGroup;)Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
    ...
    iput v8, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemViewType:I
    :try_end_1
    ...
    iput-object v10, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    :goto_18
    iput-wide v12, v2, Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool$ScrapData;->mCreateRunningAverageNs:J
    ...
    invoke-virtual {v11, v2}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->hasAnyOfTheFlags(I)Z
    ...
    iget-boolean v2, v5, Landroidx/recyclerview/widget/RecyclerView$State;->mRunSimpleAnimations:Z

    if-eqz v2, :cond_30

    invoke-static {v11}, Landroidx/recyclerview/widget/RecyclerView$ItemAnimator;->buildAdapterChangeFlagsForAnimations(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V
    ...
    invoke-virtual {v2, v11}, Landroidx/compose/material3/FabPlacement;->setFrom(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;)V

    invoke-virtual {v4, v11, v2}, Landroidx/recyclerview/widget/RecyclerView;->recordAnimationInfoIfBouncedHiddenView(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;Landroidx/compose/material3/FabPlacement;)V
    ...
    invoke-virtual {v11}, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->isBound()Z

    move-result v2

    if-eqz v2, :cond_31

    iput v0, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mPreLayoutPosition:I
    ...
    :cond_34
    :goto_1d
    iget-object v2, v4, Landroidx/recyclerview/widget/RecyclerView;->mAdapterHelper:Landroidx/core/provider/FontRequest;

    invoke-virtual {v2, v0, v8}, Landroidx/core/provider/FontRequest;->findPositionOffset(II)I

    move-result v2

    iput-object v4, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mOwnerRecyclerView:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v12, v1, Landroidx/recyclerview/widget/RecyclerView$Recycler;->mRecyclerPool:Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool;

    invoke-virtual {v12, v7}, Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool;->getScrapDataForType(I)Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool$ScrapData;

    move-result-object v7

    iget-wide v12, v7, Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool$ScrapData;->mBindRunningAverageNs:J
    ...
    iput v2, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mPosition:I

    iget-boolean v12, v7, Landroidx/recyclerview/widget/RecyclerView$Adapter;->mHasStableIds:Z

    if-eqz v12, :cond_36

    invoke-virtual {v7, v2}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->getItemId(I)J

    move-result-wide v12

    iput-wide v12, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemId:J

    :cond_36
    iget v12, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mFlags:I
    ...
    iput v12, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mFlags:I
    ...
    invoke-virtual {v7, v11, v2}, Landroidx/recyclerview/widget/RecyclerView$Adapter;->onBindViewHolder(Landroidx/recyclerview/widget/RecyclerView$ViewHolder;I)V

    iget-object v2, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mPayloads:Ljava/util/ArrayList;
    ...
    iput-boolean v7, v2, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->mInsetsDirty:Z
    ...
    iget-object v2, v1, Landroidx/recyclerview/widget/RecyclerView$Recycler;->mRecyclerPool:Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool;

    iget v7, v11, Landroidx/recyclerview/widget/RecyclerView$ViewHolder;->mItemViewType:I

    sub-long/2addr v12, v9

    invoke-virtual {v2, v7}, Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool;->getScrapDataForType(I)Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool$ScrapData;

    move-result-object v2

    iget-wide v9, v2, Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool$ScrapData;->mBindRunningAverageNs:J
    ...
    :goto_1e
    iput-wide v12, v2, Landroidx/recyclerview/widget/RecyclerView$RecycledViewPool$ScrapData;->mBindRunningAverageNs:J

    iget-object v2, v4, Landroidx/recyclerview/widget/RecyclerView;->mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
    ...
    :cond_3c
    iget-object v7, v7, Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate;->mItemDelegate:Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate$ItemDelegate;
    ...
    iget-object v10, v7, Landroidx/recyclerview/widget/RecyclerViewAccessibilityDelegate$ItemDelegate;->mOriginalItemDelegates:Ljava/util/WeakHashMap;

    invoke-virtual {v10, v3, v9}, Ljava/util/WeakHashMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    :cond_3f
    invoke-static {v3, v7}, Landroidx/core/view/ViewCompat;->setAccessibilityDelegate(Landroid/view/View;Landroidx/core/view/AccessibilityDelegateCompat;)V
    ...
    :goto_25
    iput-object v11, v4, Landroidx/recyclerview/widget/RecyclerView$LayoutParams;->mViewHolder:Landroidx/recyclerview/widget/RecyclerView$ViewHolder;
