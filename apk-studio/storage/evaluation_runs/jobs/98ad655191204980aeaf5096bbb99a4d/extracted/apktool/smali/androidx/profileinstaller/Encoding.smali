...
.method static synthetic constructor <clinit>()V
    ...
    sput-object v1, Landroidx/profileinstaller/Encoding;->EMPTY_DIAGNOSTICS:Landroidx/transition/Transition$1;
...
.method public static generateDexKey(Ljava/lang/String;Ljava/lang/String;[B)Ljava/lang/String;
    ...
    :cond_9
    :goto_4
    invoke-static {p0, v3, p1}, Landroidx/compose/foundation/lazy/LazyListScope$-CC;->m(Ljava/lang/StringBuilder;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public static read(Ljava/io/InputStream;I)[B
    ...
    invoke-static {p0, p1}, Landroidx/compose/foundation/lazy/LazyListScope$-CC;->m(Ljava/lang/String;I)Ljava/lang/String;
...
.method public static transcodeAndWriteBody(Ljava/io/ByteArrayOutputStream;[B[Landroidx/profileinstaller/DexProfileData;)Z
    ...
    invoke-static {v0, v6, v7, v11}, Landroidx/profileinstaller/Encoding;->writeUInt(Ljava/io/ByteArrayOutputStream;JI)V
    ...
    iget-object v7, v5, Landroidx/profileinstaller/DexProfileData;->apkName:Ljava/lang/String;

    iget-object v8, v5, Landroidx/profileinstaller/DexProfileData;->dexName:Ljava/lang/String;

    invoke-static {v7, v8, v4}, Landroidx/profileinstaller/Encoding;->generateDexKey(Ljava/lang/String;Ljava/lang/String;[B)Ljava/lang/String;
...
.method public static writeProfile(Landroid/content/Context;Ljava/util/concurrent/Executor;Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;Z)V
    ...
    invoke-interface {v8, v4, v14}, Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;->onResultReceived(ILjava/io/Serializable;)V
    ...
    invoke-virtual {v10, v2, v0}, Landroidx/profileinstaller/DeviceProfileWriter;->result(ILjava/io/Serializable;)V
    ...
    invoke-virtual {v10, v3, v14}, Landroidx/profileinstaller/DeviceProfileWriter;->result(ILjava/io/Serializable;)V
    ...
    sget-object v4, Landroidx/profileinstaller/Encoding;->MAGIC_PROF:[B

    const/4 v5, 0x6

    :try_start_7
    invoke-virtual {v10, v9, v11}, Landroidx/profileinstaller/DeviceProfileWriter;->openStreamFromAssets(Landroid/content/res/AssetManager;Ljava/lang/String;)Ljava/io/FileInputStream;
    ...
    invoke-virtual {v10, v9, v5}, Landroidx/profileinstaller/DeviceProfileWriter;->openStreamFromAssets(Landroid/content/res/AssetManager;Ljava/lang/String;)Ljava/io/FileInputStream;
    ...
    invoke-static {v5, v3, v2, v0}, Landroidx/profileinstaller/Encoding;->readMeta(Ljava/io/FileInputStream;[B[B[Landroidx/profileinstaller/DexProfileData;)[Landroidx/profileinstaller/DexProfileData;
    ...
    invoke-static {v7, v6, v0}, Landroidx/profileinstaller/Encoding;->transcodeAndWriteBody(Ljava/io/ByteArrayOutputStream;[B[Landroidx/profileinstaller/DexProfileData;)Z
    ...
    :goto_1f
    invoke-interface {v2, v4, v0}, Landroidx/profileinstaller/ProfileInstaller$DiagnosticsCallback;->onResultReceived(ILjava/io/Serializable;)V
    ...
    :try_start_20
    invoke-virtual {v5, v6, v14}, Landroidx/profileinstaller/DeviceProfileWriter;->result(ILjava/io/Serializable;)V
    :try_end_20
    ...
    :goto_2b
    :try_start_27
    invoke-virtual {v5, v2, v0}, Landroidx/profileinstaller/DeviceProfileWriter;->result(ILjava/io/Serializable;)V
    :try_end_27
