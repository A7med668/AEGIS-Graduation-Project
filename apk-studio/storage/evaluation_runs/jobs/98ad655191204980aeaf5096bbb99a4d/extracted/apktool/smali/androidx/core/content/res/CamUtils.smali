...
.method public static getNamedComplexColor(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;Ljava/lang/String;I)Landroidx/room/RoomOpenHelper;
    .locals 3
    ...
    new-instance p1, Landroidx/room/RoomOpenHelper;

    invoke-direct {p1, p3, p3, p0}, Landroidx/room/RoomOpenHelper;-><init>(Landroid/graphics/Shader;Landroid/content/res/ColorStateList;I)V
    ...
    :try_start_0
    invoke-static {p1, p0, p2}, Landroidx/room/RoomOpenHelper;->createFromXml(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroidx/room/RoomOpenHelper;
    ...
    :cond_1
    new-instance p0, Landroidx/room/RoomOpenHelper;

    invoke-direct {p0, p3, p3, v0}, Landroidx/room/RoomOpenHelper;-><init>(Landroid/graphics/Shader;Landroid/content/res/ColorStateList;I)V
...
.method public static rebase(Landroid/content/res/Resources$Theme;)V
    ...
    :try_start_0
    sget-boolean v1, Landroidx/core/content/res/CamUtils;->sRebaseMethodFetched:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    sput-object v2, Landroidx/core/content/res/CamUtils;->sRebaseMethod:Ljava/lang/reflect/Method;
...
.method public callbackFailAsync(I)V
    ...
    new-instance v1, Llive/mehiz/mpvkt/ui/player/PlayerObserver$$ExternalSyntheticLambda1;

    const/4 v2, 0x2

    invoke-direct {v1, p1, v2, p0}, Llive/mehiz/mpvkt/ui/player/PlayerObserver$$ExternalSyntheticLambda1;-><init>(IILjava/lang/Object;)V
