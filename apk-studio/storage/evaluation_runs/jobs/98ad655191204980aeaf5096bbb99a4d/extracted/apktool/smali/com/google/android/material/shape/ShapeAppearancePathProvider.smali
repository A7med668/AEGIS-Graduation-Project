...
# virtual methods
.method public final calculatePath(Lcom/google/android/material/shape/ShapeAppearanceModel;FLandroid/graphics/RectF;Lorg/koin/core/logger/EmptyLogger;Landroid/graphics/Path;)V
    .locals 20
    ...
    iget-object v11, v0, Lcom/google/android/material/shape/ShapeAppearancePathProvider;->edgeTransforms:[Landroid/graphics/Matrix;
    ...
    iget-object v13, v1, Lcom/google/android/material/shape/ShapeAppearanceModel;->topRightCorner:Lkotlin/UnsignedKt;

    goto :goto_2

    :cond_3
    iget-object v13, v1, Lcom/google/android/material/shape/ShapeAppearanceModel;->topLeftCorner:Lkotlin/UnsignedKt;

    goto :goto_2

    :cond_4
    iget-object v13, v1, Lcom/google/android/material/shape/ShapeAppearanceModel;->bottomLeftCorner:Lkotlin/UnsignedKt;

    goto :goto_2

    :cond_5
    iget-object v13, v1, Lcom/google/android/material/shape/ShapeAppearanceModel;->bottomRightCorner:Lkotlin/UnsignedKt;
    ...
    invoke-interface {v10, v2}, Lcom/google/android/material/shape/CornerSize;->getCornerSize(Landroid/graphics/RectF;)F

    move-result v10

    move/from16 v9, p2

    invoke-virtual {v13, v12, v9, v10}, Lkotlin/UnsignedKt;->getCornerPath(Lcom/google/android/material/shape/ShapePath;FF)V
    ...
    iget v9, v7, Lcom/google/android/material/shape/ShapePath;->endX:F
    ...
    iget v12, v9, Lcom/google/android/material/shape/ShapePath;->startX:F
    ...
    invoke-virtual {v9, v10, v4}, Lcom/google/android/material/shape/ShapePath;->applyToPath(Landroid/graphics/Matrix;Landroid/graphics/Path;)V
    ...
    iget-object v12, v3, Lorg/koin/core/logger/EmptyLogger;->level:Ljava/lang/Object;
    ...
    iget v2, v9, Lcom/google/android/material/shape/ShapePath;->endShadowAngle:F

    invoke-virtual {v9, v2}, Lcom/google/android/material/shape/ShapePath;->addConnectingShadowIfNecessary(F)V
    ...
    invoke-direct {v9, v10, v2}, Lcom/google/android/material/shape/ShapePath$1;-><init>(Ljava/util/ArrayList;Landroid/graphics/Matrix;)V

    iget-object v2, v12, Lcom/google/android/material/shape/MaterialShapeDrawable;->cornerShadowOperation:[Lcom/google/android/material/shape/ShapePath$ShadowCompatOperation;
    ...
    iget v12, v9, Lcom/google/android/material/shape/ShapePath;->endX:F
    ...
    iget v13, v12, Lcom/google/android/material/shape/ShapePath;->endX:F
    ...
    invoke-virtual {v13, v10, v12, v10}, Lcom/google/android/material/shape/ShapePath;->reset(FFF)V
    ...
    invoke-virtual {v13, v9, v10}, Lcom/google/android/material/shape/ShapePath;->lineTo(FF)V
    ...
    invoke-virtual {v13, v10, v9}, Lcom/google/android/material/shape/ShapePath;->applyToPath(Landroid/graphics/Matrix;Landroid/graphics/Path;)V
    ...
    invoke-virtual {v0, v9, v2}, Lcom/google/android/material/shape/ShapeAppearancePathProvider;->pathOverlapsCorner(Landroid/graphics/Path;I)Z
    ...
    iget v2, v13, Lcom/google/android/material/shape/ShapePath;->startX:F

    const/4 v9, 0x0

    aput v2, v14, v9

    iget v2, v13, Lcom/google/android/material/shape/ShapePath;->startY:F
    ...
    invoke-virtual {v13, v2, v5}, Lcom/google/android/material/shape/ShapePath;->applyToPath(Landroid/graphics/Matrix;Landroid/graphics/Path;)V
    ...
    invoke-virtual {v13, v2, v4}, Lcom/google/android/material/shape/ShapePath;->applyToPath(Landroid/graphics/Matrix;Landroid/graphics/Path;)V
    ...
    iget-object v9, v3, Lorg/koin/core/logger/EmptyLogger;->level:Ljava/lang/Object;

    check-cast v9, Lcom/google/android/material/shape/MaterialShapeDrawable;

    iget-object v12, v9, Lcom/google/android/material/shape/MaterialShapeDrawable;->containsIncompatibleShadowOp:Ljava/util/BitSet;
    ...
    iget v10, v13, Lcom/google/android/material/shape/ShapePath;->endShadowAngle:F

    invoke-virtual {v13, v10}, Lcom/google/android/material/shape/ShapePath;->addConnectingShadowIfNecessary(F)V
    ...
    iget-object v12, v13, Lcom/google/android/material/shape/ShapePath;->shadowCompatOperations:Ljava/util/ArrayList;
    ...
    invoke-direct {v12, v2, v10}, Lcom/google/android/material/shape/ShapePath$1;-><init>(Ljava/util/ArrayList;Landroid/graphics/Matrix;)V

    iget-object v2, v9, Lcom/google/android/material/shape/MaterialShapeDrawable;->edgeShadowOperation:[Lcom/google/android/material/shape/ShapePath$ShadowCompatOperation;
