...
.field public final mCheckedHelper:Landroidx/savedstate/SavedStateRegistry;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p1, p0}, Landroidx/savedstate/SavedStateRegistry;-><init>(Landroid/widget/TextView;)V

    iput-object p1, p0, Landroidx/appcompat/widget/AppCompatCheckedTextView;->mCheckedHelper:Landroidx/savedstate/SavedStateRegistry;
    ...
    invoke-static {p1, p2, v2, v6, v7}, Landroidx/core/view/MenuHostHelper;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/core/view/MenuHostHelper;
    ...
    invoke-virtual {p1, v0}, Landroidx/core/view/MenuHostHelper;->getColorStateList(I)Landroid/content/res/ColorStateList;
...
.method public final drawableStateChanged()V
    ...
    :cond_1
    iget-object v0, p0, Landroidx/appcompat/widget/AppCompatCheckedTextView;->mCheckedHelper:Landroidx/savedstate/SavedStateRegistry;

    if-eqz v0, :cond_2

    invoke-virtual {v0}, Landroidx/savedstate/SavedStateRegistry;->applyCheckMarkTint()V
...
.method public getCustomSelectionActionModeCallback()Landroid/view/ActionMode$Callback;
    ...
    invoke-static {v0}, Lkotlin/ResultKt;->unwrapCustomSelectionActionModeCallback(Landroid/view/ActionMode$Callback;)Landroid/view/ActionMode$Callback;
...
.method public getSupportCheckMarkTintList()Landroid/content/res/ColorStateList;
    ...
    iget-object v0, v0, Landroidx/savedstate/SavedStateRegistry;->restoredState:Landroid/os/Parcelable;
...
.method public getSupportCheckMarkTintMode()Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Landroidx/savedstate/SavedStateRegistry;->recreatorProvider:Ljava/lang/Object;
...
.method public final onCreateInputConnection(Landroid/view/inputmethod/EditorInfo;)Landroid/view/inputmethod/InputConnection;
    ...
    invoke-static {v0, p1, p0}, Lkotlin/math/MathKt;->onCreateInputConnection(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Landroid/view/View;)V
...
.method public setCheckMarkDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/AppCompatCheckedTextView;->mCheckedHelper:Landroidx/savedstate/SavedStateRegistry;

    if-eqz p1, :cond_1

    iget-boolean v0, p1, Landroidx/savedstate/SavedStateRegistry;->isAllowingSavingState:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p1, Landroidx/savedstate/SavedStateRegistry;->isAllowingSavingState:Z
    ...
    invoke-virtual {p1}, Landroidx/savedstate/SavedStateRegistry;->applyCheckMarkTint()V
...
.method public setCustomSelectionActionModeCallback(Landroid/view/ActionMode$Callback;)V
    ...
    invoke-static {p1, p0}, Lkotlin/ResultKt;->wrapCustomSelectionActionModeCallback(Landroid/view/ActionMode$Callback;Landroid/widget/TextView;)Landroid/view/ActionMode$Callback;
...
.method public setSupportCheckMarkTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-boolean p1, v0, Landroidx/savedstate/SavedStateRegistry;->attached:Z
...
.method public setSupportCheckMarkTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, v0, Landroidx/savedstate/SavedStateRegistry;->recreatorProvider:Ljava/lang/Object;
