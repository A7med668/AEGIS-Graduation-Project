...
.field public sheetDelegate:Lkotlin/UnsignedKt;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-static {p1, v4, v5}, Lkotlin/ResultKt;->getColorStateList(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
...
.method public final onLayoutChild(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
    ...
    :cond_0
    iget-object v3, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->viewRef:Ljava/lang/ref/WeakReference;
    ...
    iput-object v3, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->viewRef:Ljava/lang/ref/WeakReference;
    ...
    invoke-static {v5, v5, v5, v6}, Landroidx/core/view/animation/PathInterpolatorCompat$Api21Impl;->createPathInterpolator(FFFF)Landroid/view/animation/Interpolator;

    move-result-object v6

    const v7, 0x7f03032c

    invoke-static {v3, v7, v6}, Lkotlin/ResultKt;->resolveThemeInterpolator(Landroid/content/Context;ILandroid/view/animation/Interpolator;)Landroid/animation/TimeInterpolator;

    const v6, 0x7f03031b

    const/16 v7, 0x12c

    invoke-static {v3, v6, v7}, Lkotlin/ResultKt;->resolveThemeDuration(Landroid/content/Context;II)I
    ...
    :cond_2
    iget-object v3, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->backgroundTint:Landroid/content/res/ColorStateList;

    if-eqz v3, :cond_3

    invoke-static {p2, v3}, Landroidx/core/view/ViewCompat;->setBackgroundTintList(Landroid/view/View;Landroid/content/res/ColorStateList;)V
    ...
    invoke-static {p2, v3}, Landroidx/core/view/ViewCompat;->setAccessibilityPaneTitle(Landroid/view/View;Ljava/lang/CharSequence;)V
    ...
    :goto_2
    iget-object v7, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->sheetDelegate:Lkotlin/UnsignedKt;

    if-eqz v7, :cond_9

    invoke-virtual {v7}, Lkotlin/UnsignedKt;->getSheetEdge()I
    ...
    :cond_9
    iget-object v7, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->shapeAppearanceModel:Lcom/google/android/material/shape/ShapeAppearanceModel;

    const/4 v8, 0x0

    if-nez v3, :cond_c

    new-instance v3, Lcom/google/android/material/sidesheet/LeftSheetDelegate;

    invoke-direct {v3, p0, v1}, Lcom/google/android/material/sidesheet/LeftSheetDelegate;-><init>(Lcom/google/android/material/sidesheet/SideSheetBehavior;I)V

    iput-object v3, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->sheetDelegate:Lkotlin/UnsignedKt;
    ...
    invoke-direct {v7, v5}, Lcom/google/android/material/shape/AbsoluteCornerSize;-><init>(F)V

    iput-object v7, v3, Lcom/google/android/material/shape/ShapeAppearanceModel$Builder;->topRightCornerSize:Lcom/google/android/material/shape/CornerSize;

    new-instance v7, Lcom/google/android/material/shape/AbsoluteCornerSize;

    invoke-direct {v7, v5}, Lcom/google/android/material/shape/AbsoluteCornerSize;-><init>(F)V

    iput-object v7, v3, Lcom/google/android/material/shape/ShapeAppearanceModel$Builder;->bottomRightCornerSize:Lcom/google/android/material/shape/CornerSize;
    ...
    invoke-direct {v3, p0, v0}, Lcom/google/android/material/sidesheet/LeftSheetDelegate;-><init>(Lcom/google/android/material/sidesheet/SideSheetBehavior;I)V
    ...
    iput-object v7, v3, Lcom/google/android/material/shape/ShapeAppearanceModel$Builder;->topLeftCornerSize:Lcom/google/android/material/shape/CornerSize;

    new-instance v7, Lcom/google/android/material/shape/AbsoluteCornerSize;

    invoke-direct {v7, v5}, Lcom/google/android/material/shape/AbsoluteCornerSize;-><init>(F)V

    iput-object v7, v3, Lcom/google/android/material/shape/ShapeAppearanceModel$Builder;->bottomLeftCornerSize:Lcom/google/android/material/shape/CornerSize;
    ...
    invoke-direct {v2, v3, p1, v5}, Landroidx/customview/widget/ViewDragHelper;-><init>(Landroid/content/Context;Landroid/view/ViewGroup;Lkotlin/UnsignedKt;)V

    iput-object v2, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->viewDragHelper:Landroidx/customview/widget/ViewDragHelper;

    :cond_10
    iget-object v2, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->sheetDelegate:Lkotlin/UnsignedKt;

    invoke-virtual {v2, p2}, Lkotlin/UnsignedKt;->getOuterEdge(Landroid/view/View;)I
    ...
    iget-object p3, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->sheetDelegate:Lkotlin/UnsignedKt;

    invoke-virtual {p3, p1}, Lkotlin/UnsignedKt;->getParentInnerEdge(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)I
    ...
    iget-object v3, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->sheetDelegate:Lkotlin/UnsignedKt;

    invoke-virtual {v3, p3}, Lkotlin/UnsignedKt;->calculateInnerMargin(Landroid/view/ViewGroup$MarginLayoutParams;)I
    ...
    invoke-virtual {p3}, Lkotlin/UnsignedKt;->getHiddenOffset()I
    ...
    invoke-virtual {p3, p2}, Lkotlin/UnsignedKt;->getOuterEdge(Landroid/view/View;)I
    ...
    invoke-static {p2}, Landroidx/compose/foundation/lazy/LazyListScope$-CC;->m(Ljava/lang/Object;)V
...
.method public final startSettling$1(Landroid/view/View;IZ)V
    ...
    iget-object v0, p0, Lcom/google/android/material/sidesheet/SideSheetBehavior;->sheetDelegate:Lkotlin/UnsignedKt;

    invoke-virtual {v0}, Lkotlin/UnsignedKt;->getHiddenOffset()I
    ...
    invoke-static {p3, p2}, Landroidx/compose/foundation/lazy/LazyListScope$-CC;->m(Ljava/lang/String;I)Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lkotlin/UnsignedKt;->getExpandedOffset()I
