...
.method public static synthetic getChildren$ui_release$default(Landroidx/compose/ui/semantics/SemanticsNode;ZI)Ljava/util/List;
    .locals 2
    ...
    :cond_1
    invoke-virtual {p0, v0, p1, v1}, Landroidx/compose/ui/semantics/SemanticsNode;->getChildren$ui_release(ZZZ)Ljava/util/List;
...
.method public final fillOneLayerOfSemanticsWrappers(Landroidx/compose/ui/node/LayoutNode;Ljava/util/ArrayList;Z)V
    ...
    invoke-static {v2, v3}, Landroidx/core/math/MathUtils;->SemanticsNode(Landroidx/compose/ui/node/LayoutNode;Z)Landroidx/compose/ui/semantics/SemanticsNode;
...
.method public final findCoordinatorToGetBounds$ui_release()Landroidx/compose/ui/node/NodeCoordinator;
    ...
    invoke-static {v0}, Landroidx/core/math/MathUtils;->getOuterMergingSemantics(Landroidx/compose/ui/node/LayoutNode;)Landroidx/compose/ui/node/SemanticsModifierNode;
...
.method public final findOneLayerOfMergingSemanticsNodes(Ljava/util/List;)V
    ...
    invoke-virtual {v3, p1}, Landroidx/compose/ui/semantics/SemanticsNode;->findOneLayerOfMergingSemanticsNodes(Ljava/util/List;)V
...
.method public final getParent()Landroidx/compose/ui/semantics/SemanticsNode;
    ...
    :cond_7
    invoke-static {v3, v2}, Landroidx/core/math/MathUtils;->SemanticsNode(Landroidx/compose/ui/node/LayoutNode;Z)Landroidx/compose/ui/semantics/SemanticsNode;
...
.method public final getReplacedChildren$ui_release()Ljava/util/List;
    ...
    invoke-static {p0, v1, v0}, Landroidx/compose/ui/semantics/SemanticsNode;->getChildren$ui_release$default(Landroidx/compose/ui/semantics/SemanticsNode;ZI)Ljava/util/List;
...
.method public final unmergedChildren$ui_release(ZZ)Ljava/util/List;
    ...
    invoke-static {p2, p1}, Landroidx/core/os/HandlerCompat;->getOrNull(Landroidx/compose/ui/semantics/SemanticsConfiguration;Landroidx/compose/ui/semantics/SemanticsPropertyKey;)Ljava/lang/Object;
    ...
    invoke-direct {v1, v2, p1}, Lkotlin/collections/AbstractMap$toString$1;-><init>(ILjava/lang/Object;)V
    ...
    iget-object v1, p2, Landroidx/compose/ui/semantics/SemanticsConfiguration;->props:Ljava/util/LinkedHashMap;
    ...
    invoke-direct {v1, p1, v2}, Landroidx/compose/material3/IconKt$Icon$semantics$1$1;-><init>(Ljava/lang/String;I)V
