...
.method public final getFont(Landroid/content/Context;)Landroid/graphics/Typeface;
    ...
    invoke-static/range {v1 .. v7}, Landroidx/core/content/res/ResourcesCompat;->loadFont(Landroid/content/Context;ILandroid/util/TypedValue;ILandroidx/core/content/res/CamUtils;ZZ)Landroid/graphics/Typeface;
...
.method public final getFontAsync(Landroid/content/Context;Lkotlin/UnsignedKt;)V
    .locals 8
    ...
    invoke-virtual {p2, p1, v0}, Lkotlin/UnsignedKt;->onFontRetrieved(Landroid/graphics/Typeface;Z)V
    ...
    invoke-direct {v5, p0, p2}, Lcom/google/android/material/resources/TextAppearance$1;-><init>(Lcom/google/android/material/resources/TextAppearance;Lkotlin/UnsignedKt;)V
    ...
    invoke-virtual {v5, p1}, Landroidx/core/content/res/CamUtils;->callbackFailAsync(I)V
    ...
    invoke-virtual {p2, p1}, Lkotlin/UnsignedKt;->onFontRetrievalFailed(I)V
    ...
    invoke-virtual {p2, v0}, Lkotlin/UnsignedKt;->onFontRetrievalFailed(I)V
...
.method public final updateDrawState(Landroid/content/Context;Landroid/text/TextPaint;Lkotlin/UnsignedKt;)V
    .locals 2

    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/resources/TextAppearance;->updateMeasureState(Landroid/content/Context;Landroid/text/TextPaint;Lkotlin/UnsignedKt;)V
...
.method public final updateMeasureState(Landroid/content/Context;Landroid/text/TextPaint;Lkotlin/UnsignedKt;)V
    .locals 1
    ...
    invoke-direct {v0, p0, p1, p2, p3}, Lcom/google/android/material/resources/TextAppearance$2;-><init>(Lcom/google/android/material/resources/TextAppearance;Landroid/content/Context;Landroid/text/TextPaint;Lkotlin/UnsignedKt;)V

    invoke-virtual {p0, p1, v0}, Lcom/google/android/material/resources/TextAppearance;->getFontAsync(Landroid/content/Context;Lkotlin/UnsignedKt;)V
...
.method public final updateTextPaintMeasureState(Landroid/content/Context;Landroid/text/TextPaint;Landroid/graphics/Typeface;)V
    ...
    invoke-static {p1, p3}, Lkotlin/ResultKt;->maybeCopyWithFontWeightAdjustment(Landroid/content/res/Configuration;Landroid/graphics/Typeface;)Landroid/graphics/Typeface;
