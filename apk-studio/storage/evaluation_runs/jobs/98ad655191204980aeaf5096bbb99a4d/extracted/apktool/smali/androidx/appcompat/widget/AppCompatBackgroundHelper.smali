...
.method public final loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v1, p1, v4, p2, v8}, Landroidx/core/view/MenuHostHelper;->obtainStyledAttributes(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroidx/core/view/MenuHostHelper;
    ...
    invoke-virtual {v1, p1}, Landroidx/core/view/MenuHostHelper;->getColorStateList(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v9, v2, p2}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result p2

    const/4 v2, 0x0

    invoke-static {p2, v2}, Landroidx/appcompat/widget/DrawableUtils;->parseTintMode(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object p2

    sget v2, Landroid/os/Build$VERSION;->SDK_INT:I

    invoke-static {v0, p2}, Landroidx/core/view/ViewCompat$Api21Impl;->setBackgroundTintMode(Landroid/view/View;Landroid/graphics/PorterDuff$Mode;)V
