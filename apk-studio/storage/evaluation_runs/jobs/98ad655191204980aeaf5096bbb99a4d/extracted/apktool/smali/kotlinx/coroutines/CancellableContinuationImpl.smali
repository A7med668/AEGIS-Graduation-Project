...
.method public static resumedState(Lkotlinx/coroutines/NotCompleted;Ljava/lang/Object;ILkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    ...
    instance-of p2, p0, Lkotlinx/coroutines/InvokeOnCancel;
    ...
    instance-of v0, p0, Lkotlinx/coroutines/InvokeOnCancel;

    if-eqz v0, :cond_3

    check-cast p0, Lkotlinx/coroutines/InvokeOnCancel;
    ...
    invoke-direct/range {v0 .. v5}, Lkotlinx/coroutines/CompletedContinuation;-><init>(Ljava/lang/Object;Lkotlinx/coroutines/InvokeOnCancel;Lkotlin/jvm/functions/Function1;Ljava/util/concurrent/CancellationException;I)V
...
# virtual methods
.method public final callCancelHandler(Lkotlinx/coroutines/InvokeOnCancel;Ljava/lang/Throwable;)V
    .locals 2

    :try_start_0
    invoke-virtual {p1, p2}, Lkotlinx/coroutines/InvokeOnCancel;->invoke(Ljava/lang/Throwable;)V
    :try_end_0
...
.method public final cancel(Ljava/lang/Throwable;)Z
    ...
    instance-of v4, v1, Lkotlinx/coroutines/InvokeOnCancel;
    ...
    instance-of v2, v0, Lkotlinx/coroutines/InvokeOnCancel;

    if-eqz v2, :cond_4

    check-cast v1, Lkotlinx/coroutines/InvokeOnCancel;

    invoke-virtual {p0, v1, p1}, Lkotlinx/coroutines/CancellableContinuationImpl;->callCancelHandler(Lkotlinx/coroutines/InvokeOnCancel;Ljava/lang/Throwable;)V
...
.method public final cancelCompletedResult$kotlinx_coroutines_core(Ljava/lang/Object;Ljava/util/concurrent/CancellationException;)V
    ...
    invoke-static {v0, v2, p2, v1}, Lkotlinx/coroutines/CompletedContinuation;->copy$default(Lkotlinx/coroutines/CompletedContinuation;Lkotlinx/coroutines/InvokeOnCancel;Ljava/util/concurrent/CancellationException;I)Lkotlinx/coroutines/CompletedContinuation;
    ...
    iget-object p1, v0, Lkotlinx/coroutines/CompletedContinuation;->cancelHandler:Lkotlinx/coroutines/InvokeOnCancel;

    if-eqz p1, :cond_3

    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/CancellableContinuationImpl;->callCancelHandler(Lkotlinx/coroutines/InvokeOnCancel;Ljava/lang/Throwable;)V
...
.method public final dispatchResume(I)V
    ...
    :try_start_0
    invoke-static {p0, v2, v0}, Lkotlinx/coroutines/JobKt;->resume(Lkotlinx/coroutines/DispatchedTask;Lkotlin/coroutines/Continuation;Z)V
    ...
    :cond_5
    invoke-static {p0, v2, v1}, Lkotlinx/coroutines/JobKt;->resume(Lkotlinx/coroutines/DispatchedTask;Lkotlin/coroutines/Continuation;Z)V
...
.method public final installParentHandle()Lkotlinx/coroutines/DisposableHandle;
    ...
    invoke-static {v0, v4, v2, v3}, Lkotlinx/coroutines/JobKt;->invokeOnCompletion$default(Lkotlinx/coroutines/Job;ZLkotlinx/coroutines/JobNode;I)Lkotlinx/coroutines/DisposableHandle;
...
.method public final invokeOnCancellation(Lkotlin/jvm/functions/Function1;)V
    ...
    instance-of v0, p1, Lkotlinx/coroutines/InvokeOnCancel;

    if-eqz v0, :cond_0

    check-cast p1, Lkotlinx/coroutines/InvokeOnCancel;
    ...
    invoke-direct {v0, v1, p1}, Lkotlinx/coroutines/InvokeOnCancel;-><init>(ILjava/lang/Object;)V
...
.method public final invokeOnCancellationImpl(Ljava/lang/Object;)V
    ...
    :cond_2
    instance-of v1, v7, Lkotlinx/coroutines/InvokeOnCancel;
    ...
    invoke-virtual {p0, p1, v3}, Lkotlinx/coroutines/CancellableContinuationImpl;->callCancelHandler(Lkotlinx/coroutines/InvokeOnCancel;Ljava/lang/Throwable;)V
    ...
    iget-object v4, v1, Lkotlinx/coroutines/CompletedContinuation;->cancelHandler:Lkotlinx/coroutines/InvokeOnCancel;
    ...
    check-cast v2, Lkotlinx/coroutines/InvokeOnCancel;

    iget-object v4, v1, Lkotlinx/coroutines/CompletedContinuation;->cancelCause:Ljava/lang/Throwable;

    if-eqz v4, :cond_b

    invoke-virtual {p0, v2, v4}, Lkotlinx/coroutines/CancellableContinuationImpl;->callCancelHandler(Lkotlinx/coroutines/InvokeOnCancel;Ljava/lang/Throwable;)V
    ...
    invoke-static {v1, v2, v3, v4}, Lkotlinx/coroutines/CompletedContinuation;->copy$default(Lkotlinx/coroutines/CompletedContinuation;Lkotlinx/coroutines/InvokeOnCancel;Ljava/util/concurrent/CancellationException;I)Lkotlinx/coroutines/CompletedContinuation;
    ...
    check-cast v3, Lkotlinx/coroutines/InvokeOnCancel;
    ...
    invoke-direct/range {v1 .. v6}, Lkotlinx/coroutines/CompletedContinuation;-><init>(Ljava/lang/Object;Lkotlinx/coroutines/InvokeOnCancel;Lkotlin/jvm/functions/Function1;Ljava/util/concurrent/CancellationException;I)V
...
.method public final releaseClaimedReusableContinuation$kotlinx_coroutines_core()V
    ...
    sget-object v4, Lkotlinx/coroutines/internal/AtomicKt;->REUSABLE_CLAIMED:Lkotlinx/coroutines/internal/Symbol;
...
.method public final resume(Ljava/lang/Object;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-virtual {p0, v0, p1, p2}, Lkotlinx/coroutines/CancellableContinuationImpl;->resumeImpl(ILjava/lang/Object;Lkotlin/jvm/functions/Function1;)V

    return-void
.end method

.method public final resumeImpl(ILjava/lang/Object;Lkotlin/jvm/functions/Function1;)V
    .locals 4
    ...
    invoke-static {v2, p2, p1, p3}, Lkotlinx/coroutines/CancellableContinuationImpl;->resumedState(Lkotlinx/coroutines/NotCompleted;Ljava/lang/Object;ILkotlin/jvm/functions/Function1;)Ljava/lang/Object;
    ...
    sget-object p1, Lkotlinx/coroutines/CancelledContinuation;->_resumed$FU:Ljava/util/concurrent/atomic/AtomicIntegerFieldUpdater;
...
.method public final resumeUndispatched(Lkotlinx/coroutines/CoroutineDispatcher;)V
    ...
    :goto_2
    invoke-virtual {p0, p1, v0, v3}, Lkotlinx/coroutines/CancellableContinuationImpl;->resumeImpl(ILjava/lang/Object;Lkotlin/jvm/functions/Function1;)V
...
.method public final resumeWith(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, v0, p1, v1}, Lkotlinx/coroutines/CancellableContinuationImpl;->resumeImpl(ILjava/lang/Object;Lkotlin/jvm/functions/Function1;)V
