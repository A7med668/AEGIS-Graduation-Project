...
.method public final moveFocus(ILandroid/graphics/Rect;)Z
    ...
    :goto_1
    sget-object v9, Landroidx/customview/widget/ExploreByTouchHelper;->NODE_ADAPTER:Landroidx/collection/internal/Lock;

    sget-object v10, Landroidx/customview/widget/ExploreByTouchHelper;->SPARSE_VALUES_ADAPTER:Landroidx/collection/internal/Lock;
    ...
    invoke-static {v1, v3, v7}, Lkotlin/ResultKt;->isCandidate(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_f
    invoke-static {v1, v3, v2}, Lkotlin/ResultKt;->isCandidate(ILandroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_10
    invoke-static {v1, v3, v7, v2}, Lkotlin/ResultKt;->beamBeats(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_11
    invoke-static {v1, v3, v2, v7}, Lkotlin/ResultKt;->beamBeats(ILandroid/graphics/Rect;Landroid/graphics/Rect;Landroid/graphics/Rect;)Z
    ...
    :cond_12
    invoke-static {v1, v3, v7}, Lkotlin/ResultKt;->majorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v3, v7}, Lkotlin/ResultKt;->minorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    invoke-static {v1, v3, v2}, Lkotlin/ResultKt;->majorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I

    move-result v12

    invoke-static {v1, v3, v2}, Lkotlin/ResultKt;->minorAxisDistance(ILandroid/graphics/Rect;Landroid/graphics/Rect;)I
    ...
    iget-object v7, v5, Landroidx/collection/SparseArrayCompat;->values:[Ljava/lang/Object;
    ...
    invoke-direct {v3, v2, v9}, Landroidx/customview/widget/FocusStrategy$SequentialComparator;-><init>(ZLandroidx/collection/internal/Lock;)V
