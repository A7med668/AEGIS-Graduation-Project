...
.field public final mCallback:Lkotlin/UnsignedKt;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/ViewGroup;Lkotlin/UnsignedKt;)V
    .locals 2
    ...
    iput-object p3, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Lkotlin/UnsignedKt;
...
.method public final captureChildView(Landroid/view/View;I)V
    ...
    iget-object v0, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Lkotlin/UnsignedKt;

    invoke-virtual {v0, p1, p2}, Lkotlin/UnsignedKt;->onViewCaptured(Landroid/view/View;I)V
...
.method public final checkTouchSlop(Landroid/view/View;FF)Z
    ...
    :cond_0
    iget-object v1, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Lkotlin/UnsignedKt;

    invoke-virtual {v1, p1}, Lkotlin/UnsignedKt;->getViewHorizontalDragRange(Landroid/view/View;)I
    ...
    :goto_0
    invoke-virtual {v1}, Lkotlin/UnsignedKt;->getViewVerticalDragRange()I
...
.method public final continueSettling()Z
    ...
    :cond_2
    iget-object v6, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Lkotlin/UnsignedKt;

    iget-object v7, p0, Landroidx/customview/widget/ViewDragHelper;->mCapturedView:Landroid/view/View;

    invoke-virtual {v6, v7, v4, v5}, Lkotlin/UnsignedKt;->onViewPositionChanged(Landroid/view/View;II)V
    ...
    iget-object v0, p0, Landroidx/customview/widget/ViewDragHelper;->mSetIdleRunnable:Landroidx/fragment/app/Fragment$1;
...
.method public final findTopChildUnder(II)Landroid/view/View;
    ...
    iget-object v2, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Lkotlin/UnsignedKt;
...
.method public final forceSettleCapturedViewAt(IIII)Z
    ...
    invoke-virtual {v6, p2}, Lkotlin/UnsignedKt;->getViewHorizontalDragRange(Landroid/view/View;)I
    ...
    invoke-virtual {v6}, Lkotlin/UnsignedKt;->getViewVerticalDragRange()I
...
.method public final processTouchEvent(Landroid/view/MotionEvent;)V
    ...
    iget-object v5, p0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Lkotlin/UnsignedKt;
    ...
    invoke-virtual {v5, p1, v0, v0}, Lkotlin/UnsignedKt;->onViewReleased(Landroid/view/View;FF)V
    ...
    invoke-virtual {v5, v7, v2}, Lkotlin/UnsignedKt;->clampViewPositionHorizontal(Landroid/view/View;I)I
    ...
    invoke-virtual {v5, v4, v3}, Lkotlin/UnsignedKt;->clampViewPositionVertical(Landroid/view/View;I)I
    ...
    invoke-virtual {v5, v0, v2, v3}, Lkotlin/UnsignedKt;->onViewPositionChanged(Landroid/view/View;II)V
...
.method public final releaseViewForPointerUp()V
    ...
    invoke-virtual {v2, v3, v0, v4}, Lkotlin/UnsignedKt;->onViewReleased(Landroid/view/View;FF)V
...
.method public final setDragState(I)V
    ...
    invoke-virtual {v0, p1}, Lkotlin/UnsignedKt;->onViewDragStateChanged(I)V
...
.method public final shouldInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v13, v0, Landroidx/customview/widget/ViewDragHelper;->mCallback:Lkotlin/UnsignedKt;

    invoke-virtual {v13, v7, v12}, Lkotlin/UnsignedKt;->clampViewPositionHorizontal(Landroid/view/View;I)I
    ...
    invoke-virtual {v13, v7, v15}, Lkotlin/UnsignedKt;->clampViewPositionVertical(Landroid/view/View;I)I

    move-result v15

    invoke-virtual {v13, v7}, Lkotlin/UnsignedKt;->getViewHorizontalDragRange(Landroid/view/View;)I

    move-result v16

    invoke-virtual {v13}, Lkotlin/UnsignedKt;->getViewVerticalDragRange()I
...
.method public final tryCaptureViewForDrag(Landroid/view/View;I)Z
    ...
    invoke-virtual {v0, p1, p2}, Lkotlin/UnsignedKt;->tryCaptureView(Landroid/view/View;I)Z
