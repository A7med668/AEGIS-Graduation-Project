...
.method public final postFromTraversal(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    :cond_0
    iget-object p1, p1, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/compose/ui/text/input/GapBuffer;

    iput p2, p1, Landroidx/compose/ui/text/input/GapBuffer;->capacity:I

    iput p3, p1, Landroidx/compose/ui/text/input/GapBuffer;->gapStart:I
...
.method public final prefetch(J)V
    ...
    iget-object v8, v7, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/compose/ui/text/input/GapBuffer;

    invoke-virtual {v8, v7, v4}, Landroidx/compose/ui/text/input/GapBuffer;->collectPrefetchPositionsFromView(Landroidx/recyclerview/widget/RecyclerView;Z)V

    iget v7, v8, Landroidx/compose/ui/text/input/GapBuffer;->gapEnd:I
    ...
    :cond_2
    iget-object v9, v8, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/compose/ui/text/input/GapBuffer;

    iget v10, v9, Landroidx/compose/ui/text/input/GapBuffer;->capacity:I

    invoke-static {v10}, Ljava/lang/Math;->abs(I)I

    move-result v10

    iget v11, v9, Landroidx/compose/ui/text/input/GapBuffer;->gapStart:I
    ...
    :goto_2
    iget v12, v9, Landroidx/compose/ui/text/input/GapBuffer;->gapEnd:I
    ...
    :goto_3
    iget-object v13, v9, Landroidx/compose/ui/text/input/GapBuffer;->buffer:Ljava/lang/Object;
    ...
    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView;->mChildHelper:Landroidx/core/view/MenuHostHelper;
    ...
    :cond_c
    iget-object v7, v6, Landroidx/recyclerview/widget/RecyclerView;->mPrefetchRegistry:Landroidx/compose/ui/text/input/GapBuffer;

    invoke-virtual {v7, v6, v0}, Landroidx/compose/ui/text/input/GapBuffer;->collectPrefetchPositionsFromView(Landroidx/recyclerview/widget/RecyclerView;Z)V
    ...
    :goto_8
    iget v9, v7, Landroidx/compose/ui/text/input/GapBuffer;->gapEnd:I

    mul-int/lit8 v9, v9, 0x2

    if-ge v8, v9, :cond_d

    iget-object v9, v7, Landroidx/compose/ui/text/input/GapBuffer;->buffer:Ljava/lang/Object;
