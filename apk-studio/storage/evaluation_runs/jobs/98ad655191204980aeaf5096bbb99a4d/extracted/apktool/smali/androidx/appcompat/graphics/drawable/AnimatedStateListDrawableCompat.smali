...
.field public mTransition:Landroidx/activity/EdgeToEdgeBase;
...
.method public final jumpToCurrentState()V
    ...
    iget-object v0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/activity/EdgeToEdgeBase;

    if-eqz v0, :cond_0

    invoke-virtual {v0}, Landroidx/activity/EdgeToEdgeBase;->stop()V

    const/4 v0, 0x0

    iput-object v0, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/activity/EdgeToEdgeBase;
...
.method public final onStateChange([I)Z
    ...
    iget-object v3, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/activity/EdgeToEdgeBase;
    ...
    invoke-virtual {v3}, Landroidx/activity/EdgeToEdgeBase;->canReverse()Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {v3}, Landroidx/activity/EdgeToEdgeBase;->reverse()V
    ...
    invoke-virtual {v3}, Landroidx/activity/EdgeToEdgeBase;->stop()V

    :cond_3
    const/4 v3, 0x0

    iput-object v3, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/activity/EdgeToEdgeBase;
    ...
    :goto_2
    invoke-virtual {v3}, Landroidx/activity/EdgeToEdgeBase;->start()V
...
.method public final setConstantState(Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/graphics/drawable/StateListDrawableCompat;->mStateListState:Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat$AnimatedStateListState;
...
.method public final setVisible(ZZ)Z
    ...
    iget-object v1, p0, Landroidx/appcompat/graphics/drawable/AnimatedStateListDrawableCompat;->mTransition:Landroidx/activity/EdgeToEdgeBase;
    ...
    invoke-virtual {v1}, Landroidx/activity/EdgeToEdgeBase;->start()V
