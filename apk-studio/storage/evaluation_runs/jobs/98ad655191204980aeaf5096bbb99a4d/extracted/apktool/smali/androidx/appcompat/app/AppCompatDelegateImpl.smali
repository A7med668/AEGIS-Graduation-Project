...
.method public final applyApplicationSpecificConfig(ZZ)Z
    ...
    :cond_3
    invoke-static {v4, v0, v6, v7, v2}, Landroidx/appcompat/app/AppCompatDelegateImpl;->createOverrideAppConfiguration(Landroid/content/Context;ILandroidx/core/os/LocaleListCompat;Landroid/content/res/Configuration;Z)Landroid/content/res/Configuration;

    move-result-object v8

    iget-boolean v0, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mActivityHandlesConfigFlagsChecked:Z
    ...
    :goto_5
    iget-object v5, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mEffectiveConfiguration:Landroid/content/res/Configuration;
    ...
    invoke-static {v5}, Landroidx/appcompat/app/AppCompatDelegateImpl;->getConfigurationLocales(Landroid/content/res/Configuration;)Landroidx/core/os/LocaleListCompat;
    ...
    iget-boolean v5, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mBaseContextAttached:Z
    ...
    iget-boolean v5, v1, Landroidx/appcompat/app/AppCompatDelegateImpl;->mCreated:Z
    ...
    new-instance v10, Landroidx/fragment/app/Fragment$$ExternalSyntheticLambda0;

    const/16 v15, 0x8

    invoke-direct {v10, v15, v5}, Landroidx/fragment/app/Fragment$$ExternalSyntheticLambda0;-><init>(ILjava/lang/Object;)V
    ...
    invoke-static {v10, v6}, Landroidx/appcompat/app/AppCompatDelegateImpl$Api24Impl;->setLocales(Landroid/content/res/Configuration;Landroidx/core/os/LocaleListCompat;)V

    goto :goto_b

    :cond_11
    iget-object v0, v6, Landroidx/core/os/LocaleListCompat;->mImpl:Landroidx/core/os/LocaleListInterface;

    invoke-interface {v0, v2}, Landroidx/core/os/LocaleListInterface;->get(I)Ljava/util/Locale;

    move-result-object v13

    invoke-virtual {v10, v13}, Landroid/content/res/Configuration;->setLocale(Ljava/util/Locale;)V
    ...
    sget-boolean v0, Landroidx/activity/EdgeToEdgeBase;->sResourcesImplFieldFetched:Z
    ...
    sput-object v0, Landroidx/activity/EdgeToEdgeBase;->sResourcesImplField:Ljava/lang/reflect/Field;
    ...
    :goto_d
    sput-boolean v14, Landroidx/activity/EdgeToEdgeBase;->sResourcesImplFieldFetched:Z

    :cond_14
    sget-object v0, Landroidx/activity/EdgeToEdgeBase;->sResourcesImplField:Ljava/lang/reflect/Field;
    ...
    :cond_16
    sget-boolean v0, Landroidx/activity/EdgeToEdgeBase;->sDrawableCacheFieldFetched:Z
    ...
    sput-object v0, Landroidx/activity/EdgeToEdgeBase;->sDrawableCacheField:Ljava/lang/reflect/Field;
    ...
    :goto_10
    sput-boolean v13, Landroidx/activity/EdgeToEdgeBase;->sDrawableCacheFieldFetched:Z

    :cond_17
    sget-object v0, Landroidx/activity/EdgeToEdgeBase;->sDrawableCacheField:Ljava/lang/reflect/Field;
    ...
    invoke-static {v7}, Landroidx/activity/EdgeToEdgeBase;->flushThemedResourcesCache(Ljava/lang/Object;)V
...
.method public final ensureSubDecor()V
    ...
    check-cast v5, Landroidx/appcompat/widget/ToolbarWidgetWrapper;

    iget-boolean v6, v5, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->mTitleSet:Z

    if-nez v6, :cond_13

    iput-object v4, v5, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->mTitle:Ljava/lang/CharSequence;

    iget v6, v5, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->mDisplayOpts:I

    and-int/lit8 v6, v6, 0x8

    if-eqz v6, :cond_13

    iget-object v6, v5, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->mToolbar:Landroidx/appcompat/widget/Toolbar;

    invoke-virtual {v6, v4}, Landroidx/appcompat/widget/Toolbar;->setTitle(Ljava/lang/CharSequence;)V

    iget-boolean v5, v5, Landroidx/appcompat/widget/ToolbarWidgetWrapper;->mTitleSet:Z
    ...
    invoke-static {v5, v4}, Landroidx/core/view/ViewCompat;->setAccessibilityPaneTitle(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final onCreateView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    invoke-direct {v7, v10, v4, v15}, Landroidx/appcompat/widget/AppCompatImageView;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {v6, v7, v3}, Landroidx/emoji2/text/flatbuffer/Table;->set(Landroid/view/View;Ljava/lang/Object;)V
    ...
    invoke-virtual {v4, v7, v2}, Landroidx/emoji2/text/flatbuffer/Table;->set(Landroid/view/View;Ljava/lang/Object;)V
