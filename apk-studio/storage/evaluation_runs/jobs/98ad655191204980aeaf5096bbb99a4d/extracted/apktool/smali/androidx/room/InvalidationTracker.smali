...
# instance fields
.field public volatile cleanupStatement:Landroidx/sqlite/db/framework/FrameworkSQLiteStatement;
...
.field public final refreshRunnable:Landroidx/fragment/app/Fragment$1;
...
.method public varargs constructor <init>(Llive/mehiz/mpvkt/database/MpvKtDatabase;Ljava/util/HashMap;Ljava/util/HashMap;[Ljava/lang/String;)V
    .locals 5
    ...
    iput-object p1, p0, Landroidx/room/InvalidationTracker;->database:Llive/mehiz/mpvkt/database/MpvKtDatabase;
    ...
    invoke-static {p4, p3}, Lkotlin/collections/MapsKt__MapsKt;->getValue(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-object p1, p0, Landroidx/room/InvalidationTracker;->refreshRunnable:Landroidx/fragment/app/Fragment$1;
...
.method public final ensureInitialization$room_runtime_release()Z
    ...
    iget-object v0, p0, Landroidx/room/InvalidationTracker;->database:Llive/mehiz/mpvkt/database/MpvKtDatabase;
...
.method public final startTrackingTable(Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;I)V
    .locals 6
    ...
    invoke-static {v0, v3}, Landroidx/room/InvalidationTracker$Companion;->getTriggerName$room_runtime_release(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final syncTriggers$room_runtime_release(Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;)V
    .locals 13
    ...
    invoke-virtual {p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->inTransaction()Z
    ...
    :cond_1
    :try_start_5
    invoke-virtual {p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->isWriteAheadLoggingEnabled()Z

    move-result v3

    if-eqz v3, :cond_2

    invoke-virtual {p1}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->beginTransactionNonExclusive()V
    ...
    invoke-static {v6, v10}, Landroidx/room/InvalidationTracker$Companion;->getTriggerName$room_runtime_release(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {p1, v10}, Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;->execSQL(Ljava/lang/String;)V
    ...
    :cond_4
    invoke-virtual {p0, p1, v6}, Landroidx/room/InvalidationTracker;->startTrackingTable(Landroidx/sqlite/db/framework/FrameworkSQLiteDatabase;I)V
