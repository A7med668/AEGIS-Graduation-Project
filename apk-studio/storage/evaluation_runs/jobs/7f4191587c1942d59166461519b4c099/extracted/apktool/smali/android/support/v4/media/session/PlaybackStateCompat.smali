...
.method constructor <init>(IJJFJILjava/lang/CharSequence;JLjava/util/List;JLandroid/os/Bundle;)V
    ...
    iput-wide v3, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mBufferedPosition:J

    move/from16 v5, p6

    iput v5, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mSpeed:F

    move-wide/from16 v6, p7

    iput-wide v6, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mActions:J

    move/from16 v8, p9

    iput v8, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mErrorCode:I

    move-object/from16 v9, p10

    iput-object v9, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mErrorMessage:Ljava/lang/CharSequence;

    move-wide/from16 v10, p11

    iput-wide v10, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mUpdateTime:J
    ...
    iput-object v12, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mCustomActions:Ljava/util/List;
    ...
    iput-object v2, p0, Landroid/support/v4/media/session/PlaybackStateCompat;->mExtras:Landroid/os/Bundle;
...
.method public static fromPlaybackState(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    iput-object v0, v6, Landroid/support/v4/media/session/PlaybackStateCompat;->mStateObj:Ljava/lang/Object;
