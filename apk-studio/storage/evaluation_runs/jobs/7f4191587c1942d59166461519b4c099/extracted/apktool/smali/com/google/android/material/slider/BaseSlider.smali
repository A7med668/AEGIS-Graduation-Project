...
.method private drawActiveTrack(Landroid/graphics/Canvas;II)V
    ...
    invoke-direct {p0, v4}, Lcom/google/android/material/slider/BaseSlider;->valueToX(F)F
    ...
    :cond_3
    sget-object v4, Lcom/google/android/material/slider/BaseSlider$3;->$SwitchMap$com$google$android$material$slider$BaseSlider$FullCornerDirection:[I
    ...
    :cond_4
    iget-object v4, p0, Lcom/google/android/material/slider/BaseSlider;->trackRect:Landroid/graphics/RectF;
    ...
    invoke-virtual {v4, v5, v8, v7, v9}, Landroid/graphics/RectF;->set(FFFF)V

    iget-object v4, p0, Lcom/google/android/material/slider/BaseSlider;->activeTrackPaint:Landroid/graphics/Paint;

    iget-object v6, p0, Lcom/google/android/material/slider/BaseSlider;->trackRect:Landroid/graphics/RectF;

    invoke-direct {p0, p1, v4, v6, v1}, Lcom/google/android/material/slider/BaseSlider;->updateTrack(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/RectF;Lcom/google/android/material/slider/BaseSlider$FullCornerDirection;)V
...
.method private drawInactiveTrack(Landroid/graphics/Canvas;II)V
    ...
    iget v11, p0, Lcom/google/android/material/slider/BaseSlider;->trackHeight:I
    ...
    iget-object v3, p0, Lcom/google/android/material/slider/BaseSlider;->trackRect:Landroid/graphics/RectF;
    ...
    invoke-direct {p0, p1, v2, v3, v4}, Lcom/google/android/material/slider/BaseSlider;->updateTrack(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/RectF;Lcom/google/android/material/slider/BaseSlider$FullCornerDirection;)V
    ...
    iget v5, p0, Lcom/google/android/material/slider/BaseSlider;->thumbTrackGapSize:I
    ...
    iget v12, p0, Lcom/google/android/material/slider/BaseSlider;->trackHeight:I
    ...
    invoke-direct {p0, p1, v1, v2, v4}, Lcom/google/android/material/slider/BaseSlider;->updateTrack(Landroid/graphics/Canvas;Landroid/graphics/Paint;Landroid/graphics/RectF;Lcom/google/android/material/slider/BaseSlider$FullCornerDirection;)V
...
.method private maybeDrawCompatHalo(Landroid/graphics/Canvas;II)V
    ...
    invoke-virtual {v2, p1, v1, v3, v4}, Landroid/graphics/Canvas;->drawCircle(FFFLandroid/graphics/Paint;)V
...
.method private processAttributes(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v2, v6}, Lcom/google/android/material/internal/ViewUtils;->dpToPx(Landroid/content/Context;I)F
    ...
    invoke-static {v1, v3, v15}, Lcom/google/android/material/resources/MaterialResources;->getColorStateList(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    :cond_8
    sget v5, Lcom/google/android/material/R$color;->material_slider_inactive_tick_marks_color:I

    invoke-static {v1, v5}, Landroidx/appcompat/content/res/AppCompatResources;->getColorStateList(Landroid/content/Context;I)Landroid/content/res/ColorStateList;

    move-result-object v5

    :goto_7
    invoke-virtual {v0, v5}, Lcom/google/android/material/slider/BaseSlider;->setTickInactiveTintList(Landroid/content/res/ColorStateList;)V
    ...
    :cond_9
    sget v4, Lcom/google/android/material/R$color;->material_slider_active_tick_marks_color:I
    ...
    :goto_8
    invoke-virtual {v0, v4}, Lcom/google/android/material/slider/BaseSlider;->setTickActiveTintList(Landroid/content/res/ColorStateList;)V

    sget v4, Lcom/google/android/material/R$styleable;->Slider_thumbTrackGapSize:I

    invoke-virtual {v3, v4, v7}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v4

    invoke-virtual {v0, v4}, Lcom/google/android/material/slider/BaseSlider;->setThumbTrackGapSize(I)V

    sget v4, Lcom/google/android/material/R$styleable;->Slider_trackStopIndicatorSize:I

    invoke-virtual {v3, v4, v7}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v4

    invoke-virtual {v0, v4}, Lcom/google/android/material/slider/BaseSlider;->setTrackStopIndicatorSize(I)V

    sget v4, Lcom/google/android/material/R$styleable;->Slider_trackInsideCornerSize:I

    invoke-virtual {v3, v4, v7}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v4

    invoke-virtual {v0, v4}, Lcom/google/android/material/slider/BaseSlider;->setTrackInsideCornerSize(I)V

    sget v4, Lcom/google/android/material/R$styleable;->Slider_thumbRadius:I

    invoke-virtual {v3, v4, v7}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v4

    sget v7, Lcom/google/android/material/R$styleable;->Slider_thumbWidth:I

    mul-int/lit8 v1, v4, 0x2

    invoke-virtual {v3, v7, v1}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v1

    sget v7, Lcom/google/android/material/R$styleable;->Slider_thumbHeight:I
    ...
    sget v7, Lcom/google/android/material/R$styleable;->Slider_haloRadius:I
    ...
    invoke-virtual {v0, v7}, Lcom/google/android/material/slider/BaseSlider;->setHaloRadius(I)V

    sget v7, Lcom/google/android/material/R$styleable;->Slider_thumbElevation:I

    const/4 v1, 0x0

    invoke-virtual {v3, v7, v1}, Landroid/content/res/TypedArray;->getDimension(IF)F
    ...
    iget v7, v0, Lcom/google/android/material/slider/BaseSlider;->trackStopIndicatorSize:I
