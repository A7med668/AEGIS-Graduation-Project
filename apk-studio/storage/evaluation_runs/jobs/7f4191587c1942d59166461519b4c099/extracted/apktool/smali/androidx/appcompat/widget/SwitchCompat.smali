...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iget-object p1, v5, Landroidx/appcompat/widget/SwitchCompat;->mThumbDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget-object p1, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {v4, p1}, Landroidx/appcompat/widget/TintTypedArray;->getText(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v4, p1, v2}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    invoke-virtual {v4, p1, v1}, Landroidx/appcompat/widget/TintTypedArray;->getDimensionPixelSize(II)I
    ...
    invoke-virtual {v4, p1, v1}, Landroidx/appcompat/widget/TintTypedArray;->getBoolean(IZ)Z
    ...
    :cond_2
    sget p2, Landroidx/appcompat/R$styleable;->SwitchCompat_thumbTintMode:I

    const/4 p3, -0x1

    invoke-virtual {v4, p2, p3}, Landroidx/appcompat/widget/TintTypedArray;->getInt(II)I
    ...
    :cond_3
    iget-boolean v7, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTint:Z

    if-nez v7, :cond_4

    iget-boolean v7, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasThumbTintMode:Z
    ...
    :cond_5
    sget v7, Landroidx/appcompat/R$styleable;->SwitchCompat_trackTint:I
    ...
    iput-object v7, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackTintList:Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v4, v9, p3}, Landroidx/appcompat/widget/TintTypedArray;->getInt(II)I
    ...
    iget-object v0, v5, Landroidx/appcompat/widget/SwitchCompat;->mTrackTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_7
    iget-boolean v0, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasTrackTint:Z

    if-nez v0, :cond_8

    iget-boolean v0, v5, Landroidx/appcompat/widget/SwitchCompat;->mHasTrackTintMode:Z
    ...
    invoke-virtual {p0, v6, v0}, Landroidx/appcompat/widget/SwitchCompat;->setSwitchTextAppearance(Landroid/content/Context;I)V
    ...
    iput-object v1, v5, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Landroidx/appcompat/widget/AppCompatTextHelper;

    iget-object v1, v5, Landroidx/appcompat/widget/SwitchCompat;->mTextHelper:Landroidx/appcompat/widget/AppCompatTextHelper;

    invoke-virtual {v1, v8, v10}, Landroidx/appcompat/widget/AppCompatTextHelper;->loadFromAttributes(Landroid/util/AttributeSet;I)V
    ...
    iput v2, v5, Landroidx/appcompat/widget/SwitchCompat;->mTouchSlop:I

    invoke-virtual {v1}, Landroid/view/ViewConfiguration;->getScaledMinimumFlingVelocity()I

    move-result v2

    iput v2, v5, Landroidx/appcompat/widget/SwitchCompat;->mMinFlingVelocity:I
    ...
    invoke-virtual {v2, v8, v10}, Landroidx/appcompat/widget/AppCompatEmojiTextHelper;->loadFromAttributes(Landroid/util/AttributeSet;I)V
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    :cond_3
    invoke-direct {v0}, Landroidx/appcompat/widget/SwitchCompat;->getTargetCheckedState()Z
    ...
    invoke-virtual {v0}, Landroidx/appcompat/widget/SwitchCompat;->getDrawableState()[I
    ...
    :cond_6
    invoke-virtual {v0}, Landroidx/appcompat/widget/SwitchCompat;->getWidth()I
...
.method protected onLayout(ZIIII)V
    ...
    iget-object v3, p1, Landroidx/appcompat/widget/SwitchCompat;->mThumbDrawable:Landroid/graphics/drawable/Drawable;

    if-eqz v3, :cond_1

    iget-object v3, p1, Landroidx/appcompat/widget/SwitchCompat;->mTempRect:Landroid/graphics/Rect;

    iget-object v4, p1, Landroidx/appcompat/widget/SwitchCompat;->mTrackDrawable:Landroid/graphics/drawable/Drawable;
    ...
    :goto_0
    iget-object v4, p1, Landroidx/appcompat/widget/SwitchCompat;->mThumbDrawable:Landroid/graphics/drawable/Drawable;
    ...
    iget v4, p1, Landroidx/appcompat/widget/SwitchCompat;->mSwitchWidth:I
    ...
    iget v3, p1, Landroidx/appcompat/widget/SwitchCompat;->mSwitchWidth:I
    ...
    iget v5, p1, Landroidx/appcompat/widget/SwitchCompat;->mSwitchHeight:I
    ...
    iget v6, p1, Landroidx/appcompat/widget/SwitchCompat;->mSwitchHeight:I
    ...
    :goto_2
    iput v3, p1, Landroidx/appcompat/widget/SwitchCompat;->mSwitchLeft:I

    iput v6, p1, Landroidx/appcompat/widget/SwitchCompat;->mSwitchTop:I

    iput v5, p1, Landroidx/appcompat/widget/SwitchCompat;->mSwitchBottom:I

    iput v4, p1, Landroidx/appcompat/widget/SwitchCompat;->mSwitchRight:I
