...
.method playTransition(Landroid/view/ViewGroup;)V
    ...
    invoke-virtual {v6, v2}, Landroidx/collection/ArrayMap;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v4, v3, Landroidx/transition/Transition$AnimationInfo;->mWindowId:Landroid/view/WindowId;
    ...
    iget-object v4, v3, Landroidx/transition/Transition$AnimationInfo;->mValues:Landroidx/transition/TransitionValues;

    iget-object v5, v3, Landroidx/transition/Transition$AnimationInfo;->mView:Landroid/view/View;

    const/4 v9, 0x1

    invoke-virtual {v0, v5, v9}, Landroidx/transition/Transition;->getTransitionValues(Landroid/view/View;Z)Landroidx/transition/TransitionValues;

    move-result-object v10

    invoke-virtual {v0, v5, v9}, Landroidx/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroidx/transition/TransitionValues;
    ...
    iget-object v12, v0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/TransitionValuesMaps;
    ...
    :cond_1
    iget-object v13, v3, Landroidx/transition/Transition$AnimationInfo;->mTransition:Landroidx/transition/Transition;

    invoke-virtual {v13, v4, v11}, Landroidx/transition/Transition;->isTransitionRequired(Landroidx/transition/TransitionValues;Landroidx/transition/TransitionValues;)Z
    ...
    iget-object v14, v3, Landroidx/transition/Transition$AnimationInfo;->mTransition:Landroidx/transition/Transition;
    ...
    invoke-virtual {v6, v2}, Landroidx/collection/ArrayMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iput-boolean v9, v14, Landroidx/transition/Transition;->mEnded:Z

    sget-object v9, Landroidx/transition/Transition$TransitionNotification;->ON_END:Landroidx/transition/Transition$TransitionNotification;

    invoke-virtual {v14, v9, v12}, Landroidx/transition/Transition;->notifyListeners(Landroidx/transition/Transition$TransitionNotification;Z)V
    ...
    :cond_7
    iget-object v2, v0, Landroidx/transition/Transition;->mStartValues:Landroidx/transition/TransitionValuesMaps;

    iget-object v3, v0, Landroidx/transition/Transition;->mEndValues:Landroidx/transition/TransitionValuesMaps;

    iget-object v4, v0, Landroidx/transition/Transition;->mStartValuesList:Ljava/util/ArrayList;

    iget-object v5, v0, Landroidx/transition/Transition;->mEndValuesList:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$SeekController;
    ...
    invoke-virtual {v0}, Landroidx/transition/Transition;->prepareAnimatorsForSeeking()V

    iget-object v1, v0, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$SeekController;

    invoke-virtual {v1}, Landroidx/transition/Transition$SeekController;->initPlayTime()V

    iget-object v1, v0, Landroidx/transition/Transition;->mSeekController:Landroidx/transition/Transition$SeekController;

    invoke-virtual {v1}, Landroidx/transition/Transition$SeekController;->ready()V
...
.method setCurrentPlayTimeMillis(JJ)V
    ...
    invoke-static {v12, v3, v4}, Landroidx/transition/Transition$Impl26;->setCurrentPlayTime(Landroid/animation/Animator;J)V
    ...
    invoke-virtual {v0, v3, v5}, Landroidx/transition/Transition;->notifyListeners(Landroidx/transition/Transition$TransitionNotification;Z)V
