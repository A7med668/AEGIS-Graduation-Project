...
# direct methods
.method public static synthetic $r8$lambda$BjnX4GnGzOVkMyDjMUkrTEr9dSk(Landroidx/navigation/NavController;Lcom/google/android/material/navigation/NavigationView;Landroid/view/MenuItem;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$JbaX5YNjBzNGuGP9Jb6usWbn8kg(Landroidx/navigation/NavController;ZLandroid/view/MenuItem;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$Nww4beg16bjrBnUeMHgngyRkH1s(Landroidx/navigation/NavController;ZLcom/google/android/material/navigation/NavigationView;Landroid/view/MenuItem;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$V9YrolDrnkK2QvdoHywqT8Azass(Landroidx/navigation/NavController;Landroidx/navigation/ui/AppBarConfiguration;Landroid/view/View;)V
    .locals 0
...
.method public static synthetic $r8$lambda$WstRxbcmMw_4X03-oLYYK21cjjU(Landroidx/navigation/NavController;Landroid/view/MenuItem;)Z
    .locals 0
...
.method public static synthetic $r8$lambda$XnvHlNOEz8fcdliYvIqxGDPD53s(Landroidx/navigation/NavController;Landroidx/navigation/ui/AppBarConfiguration;Landroid/view/View;)V
    .locals 0
...
.method public static final navigateUp(Landroidx/navigation/NavController;Landroidx/navigation/ui/AppBarConfiguration;)Z
    ...
    invoke-interface {v2}, Landroidx/navigation/ui/AppBarConfiguration$OnNavigateUpListener;->onNavigateUp()Z
...
.method public static final onNavDestinationSelected(Landroid/view/MenuItem;Landroidx/navigation/NavController;)Z
    ...
    invoke-static {v4, v5}, Landroidx/navigation/ui/NavigationUI;->matchDestination$navigation_ui_release(Landroidx/navigation/NavDestination;I)Z
    ...
    const-string v6, "Ignoring onNavDestinationSelected for MenuItem "
...
.method public static final onNavDestinationSelected(Landroid/view/MenuItem;Landroidx/navigation/NavController;Z)Z
    ...
    invoke-virtual {v2, v0}, Landroidx/navigation/NavOptions$Builder;->setEnterAnim(I)Landroidx/navigation/NavOptions$Builder;
    ...
    invoke-virtual {v0, v3}, Landroidx/navigation/NavOptions$Builder;->setPopEnterAnim(I)Landroidx/navigation/NavOptions$Builder;

    move-result-object v0

    sget v3, Landroidx/navigation/ui/R$anim;->nav_default_pop_exit_anim:I

    invoke-virtual {v0, v3}, Landroidx/navigation/NavOptions$Builder;->setPopExitAnim(I)Landroidx/navigation/NavOptions$Builder;
    ...
    invoke-virtual {v0, v3}, Landroidx/navigation/NavGraph$Companion;->findStartDestination(Landroidx/navigation/NavGraph;)Landroidx/navigation/NavDestination;
    ...
    invoke-virtual {p1, v0, v5, v3}, Landroidx/navigation/NavController;->navigate(ILandroid/os/Bundle;Landroidx/navigation/NavOptions;)V
    ...
    invoke-static {v0, v5}, Landroidx/navigation/ui/NavigationUI;->matchDestination$navigation_ui_release(Landroidx/navigation/NavDestination;I)Z
    ...
    invoke-virtual {v1, v5, v6}, Landroidx/navigation/NavDestination$Companion;->getDisplayName(Landroid/content/Context;I)Ljava/lang/String;
    ...
    const-string v1, "Leave the saveState parameter out entirely to use the non-experimental version of this API, which saves the state by default"
...
.method public static final setupWithNavController(Landroidx/appcompat/widget/Toolbar;Landroidx/navigation/NavController;Landroidx/navigation/ui/AppBarConfiguration;)V
    ...
    new-instance v0, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda1;

    invoke-direct {v0, p1, p2}, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda1;-><init>(Landroidx/navigation/NavController;Landroidx/navigation/ui/AppBarConfiguration;)V
...
.method public static final setupWithNavController(Lcom/google/android/material/appbar/CollapsingToolbarLayout;Landroidx/appcompat/widget/Toolbar;Landroidx/navigation/NavController;Landroidx/navigation/ui/AppBarConfiguration;)V
    ...
    new-instance v0, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda3;

    invoke-direct {v0, p2, p3}, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda3;-><init>(Landroidx/navigation/NavController;Landroidx/navigation/ui/AppBarConfiguration;)V
...
.method public static final setupWithNavController(Lcom/google/android/material/navigation/NavigationBarView;Landroidx/navigation/NavController;)V
    ...
    new-instance v0, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda4;

    invoke-direct {v0, p1}, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda4;-><init>(Landroidx/navigation/NavController;)V
    ...
    new-instance v1, Landroidx/navigation/ui/NavigationUI$setupWithNavController$9;

    invoke-direct {v1, v0, p1}, Landroidx/navigation/ui/NavigationUI$setupWithNavController$9;-><init>(Ljava/lang/ref/WeakReference;Landroidx/navigation/NavController;)V
...
.method public static final setupWithNavController(Lcom/google/android/material/navigation/NavigationBarView;Landroidx/navigation/NavController;Z)V
    ...
    invoke-direct {v0, p1, p2}, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda0;-><init>(Landroidx/navigation/NavController;Z)V
    ...
    new-instance v1, Landroidx/navigation/ui/NavigationUI$setupWithNavController$12;

    invoke-direct {v1, v0, p1}, Landroidx/navigation/ui/NavigationUI$setupWithNavController$12;-><init>(Ljava/lang/ref/WeakReference;Landroidx/navigation/NavController;)V
...
.method public static final setupWithNavController(Lcom/google/android/material/navigation/NavigationView;Landroidx/navigation/NavController;)V
    ...
    new-instance v0, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda5;

    invoke-direct {v0, p1, p0}, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda5;-><init>(Landroidx/navigation/NavController;Lcom/google/android/material/navigation/NavigationView;)V
    ...
    new-instance v1, Landroidx/navigation/ui/NavigationUI$setupWithNavController$4;

    invoke-direct {v1, v0, p1}, Landroidx/navigation/ui/NavigationUI$setupWithNavController$4;-><init>(Ljava/lang/ref/WeakReference;Landroidx/navigation/NavController;)V
...
.method public static final setupWithNavController(Lcom/google/android/material/navigation/NavigationView;Landroidx/navigation/NavController;Z)V
    ...
    new-instance v0, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda2;

    invoke-direct {v0, p1, p2, p0}, Landroidx/navigation/ui/NavigationUI$$ExternalSyntheticLambda2;-><init>(Landroidx/navigation/NavController;ZLcom/google/android/material/navigation/NavigationView;)V
    ...
    new-instance v1, Landroidx/navigation/ui/NavigationUI$setupWithNavController$7;

    invoke-direct {v1, v0, p1}, Landroidx/navigation/ui/NavigationUI$setupWithNavController$7;-><init>(Ljava/lang/ref/WeakReference;Landroidx/navigation/NavController;)V
...
.method private static final setupWithNavController$lambda$3(Landroidx/navigation/NavController;Lcom/google/android/material/navigation/NavigationView;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p1}, Lcom/google/android/material/navigation/NavigationView;->getParent()Landroid/view/ViewParent;
...
.method private static final setupWithNavController$lambda$5(Landroidx/navigation/NavController;ZLcom/google/android/material/navigation/NavigationView;Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {p2}, Lcom/google/android/material/navigation/NavigationView;->getParent()Landroid/view/ViewParent;
