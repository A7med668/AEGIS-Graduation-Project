...
.method private createKeyVector(II)Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;
    ...
    :goto_0
    iget-object v2, v0, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->stack:Ljava/util/ArrayList;
    ...
    iget-object v2, v0, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->bb:Landroidx/emoji2/text/flatbuffer/ReadWriteBuf;
    ...
    invoke-static/range {v10 .. v15}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->access$500(IIJII)I
    ...
    :cond_0
    invoke-direct {v0, v9}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->align(I)I

    move-result v2

    int-to-long v5, v1

    invoke-direct {v0, v5, v6, v2}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->writeInt(JI)V

    iget-object v5, v0, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->bb:Landroidx/emoji2/text/flatbuffer/ReadWriteBuf;
    ...
    iget v7, v7, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->key:I
    ...
    iget v8, v8, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->key:I

    int-to-long v10, v8

    invoke-direct {v0, v10, v11, v2}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->writeOffset(JI)V
    ...
    invoke-static {v7, v3}, Landroidx/emoji2/text/flatbuffer/FlexBuffers;->toTypedVector(II)I
    ...
    invoke-direct/range {v6 .. v11}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;-><init>(IIIJ)V
...
.method private createVector(IIIZZLandroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;)Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;
    ...
    invoke-static {v1, v5, v3}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->access$200(Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;II)I
    ...
    iget-object v7, p0, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->bb:Landroidx/emoji2/text/flatbuffer/ReadWriteBuf;
    ...
    invoke-static {v2, v7, v8}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->access$200(Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;II)I
    ...
    iget v5, v7, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->type:I

    invoke-static {v5}, Landroidx/emoji2/text/flatbuffer/FlexBuffers;->isTypedVectorElementType(I)Z
    ...
    const-string v7, "TypedVector does not support this element type"

    invoke-direct {v3, v7}, Landroidx/emoji2/text/flatbuffer/FlexBuffers$FlexBufferException;-><init>(Ljava/lang/String;)V
    ...
    :cond_9
    :goto_3
    invoke-direct {p0, v10}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->align(I)I

    move-result v2

    if-eqz v1, :cond_a

    iget-wide v6, v1, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->iValue:J

    invoke-direct {p0, v6, v7, v2}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->writeOffset(JI)V

    const-wide/16 v6, 0x1

    iget v8, v1, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->minBitWidth:I

    shl-long/2addr v6, v8

    invoke-direct {p0, v6, v7, v2}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->writeInt(JI)V
    ...
    invoke-direct {p0, v8, v2}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->writeAny(Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;I)V
    ...
    iget-object v8, p0, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->bb:Landroidx/emoji2/text/flatbuffer/ReadWriteBuf;

    iget-object v9, p0, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->stack:Ljava/util/ArrayList;
    ...
    invoke-static {v9, v10}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->access$400(Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;I)B

    move-result v9

    invoke-interface {v8, v9}, Landroidx/emoji2/text/flatbuffer/ReadWriteBuf;->put(B)V
    ...
    :cond_d
    new-instance v7, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;
    ...
    :cond_f
    invoke-static {v5, v3}, Landroidx/emoji2/text/flatbuffer/FlexBuffers;->toTypedVector(II)I
    ...
    invoke-direct/range {v7 .. v12}, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;-><init>(IIIJ)V
...
.method public endMap(Ljava/lang/String;I)I
    ...
    :goto_0
    iget-object v3, v0, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->stack:Ljava/util/ArrayList;
    ...
    iget-wide v3, p2, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->iValue:J
...
.method public endVector(Ljava/lang/String;IZZ)I
    ...
    iget-object p4, v0, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder;->stack:Ljava/util/ArrayList;
    ...
    iget-wide p3, p2, Landroidx/emoji2/text/flatbuffer/FlexBuffersBuilder$Value;->iValue:J
