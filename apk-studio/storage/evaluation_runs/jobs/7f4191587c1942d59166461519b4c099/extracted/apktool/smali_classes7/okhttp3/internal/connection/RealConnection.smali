...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    iput-object v9, v1, Lokhttp3/internal/connection/RealConnection;->socket:Ljava/net/Socket;
    ...
    sget-object v9, Lokhttp3/Protocol;->Companion:Lokhttp3/Protocol$Companion;

    invoke-virtual {v9, v14}, Lokhttp3/Protocol$Companion;->get(Ljava/lang/String;)Lokhttp3/Protocol;
    ...
    :goto_1
    iput-object v9, v1, Lokhttp3/internal/connection/RealConnection;->protocol:Lokhttp3/Protocol;
    :try_end_1
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    iget-object v0, v1, Lokhttp3/internal/connection/RealConnection;->protocol:Lokhttp3/Protocol;
    ...
    invoke-direct {v3, v9}, Lokhttp3/internal/connection/ConnectionSpecSelector;-><init>(Ljava/util/List;)V
    ...
    :try_start_2
    iget-object v0, v12, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;
    :try_end_2
    ...
    :try_start_3
    invoke-direct {v12, v13, v14, v2, v6}, Lokhttp3/internal/connection/RealConnection;->connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    :try_end_3
    ...
    :try_start_4
    invoke-direct {v12, v10, v15, v2, v6}, Lokhttp3/internal/connection/RealConnection;->establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;ILokhttp3/Call;Lokhttp3/EventListener;)V

    iget-object v0, v12, Lokhttp3/internal/connection/RealConnection;->route:Lokhttp3/Route;

    invoke-virtual {v0}, Lokhttp3/Route;->socketAddress()Ljava/net/InetSocketAddress;

    move-result-object v0

    iget-object v1, v12, Lokhttp3/internal/connection/RealConnection;->route:Lokhttp3/Route;

    invoke-virtual {v1}, Lokhttp3/Route;->proxy()Ljava/net/Proxy;

    move-result-object v1

    iget-object v3, v12, Lokhttp3/internal/connection/RealConnection;->protocol:Lokhttp3/Protocol;

    invoke-virtual {v6, v2, v0, v1, v3}, Lokhttp3/EventListener;->connectEnd(Lokhttp3/Call;Ljava/net/InetSocketAddress;Ljava/net/Proxy;Lokhttp3/Protocol;)V
    :try_end_4
    ...
    iput-wide v0, v12, Lokhttp3/internal/connection/RealConnection;->idleAtNs:J
    ...
    :goto_8
    iget-object v1, v12, Lokhttp3/internal/connection/RealConnection;->socket:Ljava/net/Socket;
    ...
    :cond_8
    iget-object v1, v12, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;
    ...
    iput-object v8, v12, Lokhttp3/internal/connection/RealConnection;->socket:Ljava/net/Socket;

    iput-object v8, v12, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    move-object v1, v8

    check-cast v1, Lokio/BufferedSource;

    iput-object v8, v12, Lokhttp3/internal/connection/RealConnection;->source:Lokio/BufferedSource;

    move-object v1, v8

    check-cast v1, Lokio/BufferedSink;

    iput-object v8, v12, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/BufferedSink;

    move-object v1, v8

    check-cast v1, Lokhttp3/Handshake;

    iput-object v8, v12, Lokhttp3/internal/connection/RealConnection;->handshake:Lokhttp3/Handshake;

    move-object v1, v8

    check-cast v1, Lokhttp3/Protocol;

    iput-object v8, v12, Lokhttp3/internal/connection/RealConnection;->protocol:Lokhttp3/Protocol;

    move-object v1, v8

    check-cast v1, Lokhttp3/internal/http2/Http2Connection;

    iput-object v8, v12, Lokhttp3/internal/connection/RealConnection;->http2Connection:Lokhttp3/internal/http2/Http2Connection;

    iput v7, v12, Lokhttp3/internal/connection/RealConnection;->allocationLimit:I
    ...
    :cond_a
    invoke-virtual {v11, v6}, Lokhttp3/internal/connection/RouteException;->addConnectException(Ljava/io/IOException;)V
    ...
    invoke-virtual {v10, v6}, Lokhttp3/internal/connection/ConnectionSpecSelector;->connectionFailed(Ljava/io/IOException;)Z
...
.method public final newWebSocketStreams$okhttp(Lokhttp3/internal/connection/Exchange;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v2 .. v8}, Lokhttp3/internal/connection/RealConnection$newWebSocketStreams$1;-><init>(Lokhttp3/internal/connection/Exchange;Lokio/BufferedSource;Lokio/BufferedSink;ZLokio/BufferedSource;Lokio/BufferedSink;)V
