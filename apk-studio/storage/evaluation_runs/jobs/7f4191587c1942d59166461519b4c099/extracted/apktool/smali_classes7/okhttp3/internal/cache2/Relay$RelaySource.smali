...
.method public close()V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/cache2/Relay;->getSourceCount()I

    move-result v5

    add-int/lit8 v5, v5, -0x1

    invoke-virtual {v4, v5}, Lokhttp3/internal/cache2/Relay;->setSourceCount(I)V
    ...
    invoke-virtual {v4}, Lokhttp3/internal/cache2/Relay;->getFile()Ljava/io/RandomAccessFile;
    ...
    invoke-virtual {v4, v0}, Lokhttp3/internal/cache2/Relay;->setFile(Ljava/io/RandomAccessFile;)V
...
.method public read(Lokio/Buffer;J)J
    ...
    invoke-virtual {v5, v8}, Lokio/Timeout;->waitUntilNotified(Ljava/lang/Object;)V
    ...
    invoke-virtual {v5, v8}, Lokhttp3/internal/cache2/Relay;->setUpstreamReader(Ljava/lang/Thread;)V
    :try_end_2
    ...
    invoke-virtual {v7, v15}, Lokhttp3/internal/cache2/Relay;->setUpstreamReader(Ljava/lang/Thread;)V
    ...
    invoke-virtual {v7}, Lokhttp3/internal/cache2/Relay;->getBuffer()Lokio/Buffer;

    move-result-object v7

    iget-object v11, v1, Lokhttp3/internal/cache2/Relay$RelaySource;->this$0:Lokhttp3/internal/cache2/Relay;

    invoke-virtual {v11}, Lokhttp3/internal/cache2/Relay;->getUpstreamBuffer()Lokio/Buffer;

    move-result-object v11

    invoke-virtual {v7, v11, v4, v5}, Lokio/Buffer;->write(Lokio/Buffer;J)V
    ...
    invoke-virtual {v7}, Lokhttp3/internal/cache2/Relay;->getBufferMaxSize()J
    ...
    invoke-virtual {v13}, Lokhttp3/internal/cache2/Relay;->getBufferMaxSize()J

    move-result-wide v13

    sub-long/2addr v11, v13

    invoke-virtual {v7, v11, v12}, Lokio/Buffer;->skip(J)V

    :cond_8
    iget-object v7, v1, Lokhttp3/internal/cache2/Relay$RelaySource;->this$0:Lokhttp3/internal/cache2/Relay;

    invoke-virtual {v7}, Lokhttp3/internal/cache2/Relay;->getUpstreamPos()J

    move-result-wide v11

    add-long/2addr v11, v4

    invoke-virtual {v7, v11, v12}, Lokhttp3/internal/cache2/Relay;->setUpstreamPos(J)V
    ...
    invoke-virtual {v6, v15}, Lokhttp3/internal/cache2/Relay;->setUpstreamReader(Ljava/lang/Thread;)V
