...
.method public final decode(Lokio/BufferedSource;JLokio/BufferedSink;)V
    ...
    invoke-virtual {v8}, Lokhttp3/internal/http2/Huffman$Node;->getChildren()[Lokhttp3/internal/http2/Huffman$Node;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-virtual {v8}, Lokhttp3/internal/http2/Huffman$Node;->getSymbol()I

    move-result v0

    invoke-interface {p4, v0}, Lokio/BufferedSink;->writeByte(I)Lokio/BufferedSink;

    invoke-virtual {v8}, Lokhttp3/internal/http2/Huffman$Node;->getTerminalBitCount()I
