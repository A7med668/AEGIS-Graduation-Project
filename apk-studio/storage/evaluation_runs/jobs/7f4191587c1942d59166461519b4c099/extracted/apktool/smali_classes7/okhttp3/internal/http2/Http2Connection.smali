...
.method public constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    invoke-virtual {v0, v3, v7, v8}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method private final newStream(ILjava/util/List;Z)Lokhttp3/internal/http2/Http2Stream;
    ...
    iget-object v10, v2, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;
    ...
    :try_start_1
    iget v0, v2, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I
    :try_end_1
    ...
    invoke-virtual {v2, v0}, Lokhttp3/internal/http2/Http2Connection;->shutdown(Lokhttp3/internal/http2/ErrorCode;)V
    :try_end_2
    ...
    :goto_0
    :try_start_3
    iget-boolean v0, v2, Lokhttp3/internal/http2/Http2Connection;->isShutdown:Z
    ...
    iput v0, v2, Lokhttp3/internal/http2/Http2Connection;->nextStreamId:I
    ...
    iget-wide v13, v2, Lokhttp3/internal/http2/Http2Connection;->writeBytesTotal:J
    :try_end_3
    ...
    :try_start_4
    iget-wide v4, v2, Lokhttp3/internal/http2/Http2Connection;->writeBytesMaximum:J
    ...
    iget-object v0, v2, Lokhttp3/internal/http2/Http2Connection;->streams:Ljava/util/Map;
    ...
    invoke-virtual {v0, v3, v1, v7}, Lokhttp3/internal/http2/Http2Writer;->headers(ZILjava/util/List;)V

    goto :goto_3

    :cond_5
    iget-boolean v0, v2, Lokhttp3/internal/http2/Http2Connection;->client:Z

    if-nez v0, :cond_7

    iget-object v0, v2, Lokhttp3/internal/http2/Http2Connection;->writer:Lokhttp3/internal/http2/Http2Writer;

    invoke-virtual {v0, v6, v1, v7}, Lokhttp3/internal/http2/Http2Writer;->pushPromise(IILjava/util/List;)V
...
.method public final pushDataLater$okhttp(ILokio/BufferedSource;IZ)V
    ...
    invoke-interface {v0, v8, v1, v2}, Lokio/BufferedSource;->read(Lokio/Buffer;J)J

    iget-object v11, p0, Lokhttp3/internal/http2/Http2Connection;->pushQueue:Lokhttp3/internal/concurrent/TaskQueue;
    ...
    invoke-virtual {v11, v1, v12, v13}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final pushHeadersLater$okhttp(ILjava/util/List;Z)V
    ...
    new-instance v2, Lokhttp3/internal/http2/Http2Connection$pushHeadersLater$$inlined$execute$1;
    ...
    invoke-virtual {v0, v2, v11, v12}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final pushRequestLater$okhttp(ILjava/util/List;)V
    ...
    new-instance v2, Lokhttp3/internal/http2/Http2Connection$pushRequestLater$$inlined$execute$1;
    ...
    invoke-virtual {v0, v2, v10, v11}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final sendDegradedPingLater$okhttp()V
    ...
    new-instance v2, Lokhttp3/internal/http2/Http2Connection$sendDegradedPingLater$$inlined$execute$1;
    ...
    invoke-virtual {v0, v2, v8, v9}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final start(ZLokhttp3/internal/concurrent/TaskRunner;)V
    ...
    invoke-virtual {v0, v1, v7, v8}, Lokhttp3/internal/concurrent/TaskQueue;->schedule(Lokhttp3/internal/concurrent/Task;J)V
...
.method public final writeSynResetLater$okhttp(ILokhttp3/internal/http2/ErrorCode;)V
    ...
    new-instance v2, Lokhttp3/internal/http2/Http2Connection$writeSynResetLater$$inlined$execute$1;
...
.method public final writeWindowUpdateLater$okhttp(IJ)V
    ...
    new-instance v2, Lokhttp3/internal/http2/Http2Connection$writeWindowUpdateLater$$inlined$execute$1;
