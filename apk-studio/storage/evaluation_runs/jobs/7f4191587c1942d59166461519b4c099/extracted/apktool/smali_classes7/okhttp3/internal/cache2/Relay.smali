...
.method private final writeHeader(Lokio/ByteString;JJ)V
    ...
    invoke-virtual {v1, p2, p3}, Lokio/Buffer;->writeLong(J)Lokio/Buffer;

    invoke-virtual {v1, p4, p5}, Lokio/Buffer;->writeLong(J)Lokio/Buffer;
    ...
    new-instance v4, Lokhttp3/internal/cache2/FileOperator;
    ...
    invoke-direct {v4, v0}, Lokhttp3/internal/cache2/FileOperator;-><init>(Ljava/nio/channels/FileChannel;)V

    const-wide/16 v5, 0x0

    const-wide/16 v8, 0x20

    invoke-virtual/range {v4 .. v9}, Lokhttp3/internal/cache2/FileOperator;->write(JLokio/Buffer;J)V
...
.method public final commit(J)V
    ...
    :try_start_0
    iput-boolean p2, v2, Lokhttp3/internal/cache2/Relay;->complete:Z
