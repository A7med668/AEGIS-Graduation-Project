...
.method private final writeOrCountBytes(Lokio/BufferedSink;Z)J
    ...
    iget-object v8, v0, Lokhttp3/MultipartBody;->parts:Ljava/util/List;
    ...
    invoke-virtual {v8}, Lokhttp3/MultipartBody$Part;->headers()Lokhttp3/Headers;

    move-result-object v9

    invoke-virtual {v8}, Lokhttp3/MultipartBody$Part;->body()Lokhttp3/RequestBody;

    move-result-object v10

    invoke-static {v1}, Lkotlin/jvm/internal/Intrinsics;->checkNotNull(Ljava/lang/Object;)V

    sget-object v11, Lokhttp3/MultipartBody;->DASHDASH:[B

    invoke-interface {v1, v11}, Lokio/BufferedSink;->write([B)Lokio/BufferedSink;

    iget-object v11, v0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {v1, v11}, Lokio/BufferedSink;->write(Lokio/ByteString;)Lokio/BufferedSink;
    ...
    invoke-interface {v1, v13}, Lokio/BufferedSink;->writeUtf8(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    :cond_5
    invoke-virtual {v10, v1}, Lokhttp3/RequestBody;->writeTo(Lokio/BufferedSink;)V
    ...
    iget-object v5, v0, Lokhttp3/MultipartBody;->boundaryByteString:Lokio/ByteString;

    invoke-interface {v1, v5}, Lokio/BufferedSink;->write(Lokio/ByteString;)Lokio/BufferedSink;
