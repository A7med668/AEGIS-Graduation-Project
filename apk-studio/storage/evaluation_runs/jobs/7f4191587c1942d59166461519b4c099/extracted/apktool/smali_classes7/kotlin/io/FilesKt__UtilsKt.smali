...
.method public static final copyRecursively(Ljava/io/File;Ljava/io/File;ZLkotlin/jvm/functions/Function2;)Z
    ...
    move-result v0
    :try_end_0
    .catch Lkotlin/io/TerminateException; {:try_start_0 .. :try_end_0} :catch_2
    ...
    :try_end_1
    .catch Lkotlin/io/TerminateException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    move-result v5
    :try_end_2
    .catch Lkotlin/io/TerminateException; {:try_start_2 .. :try_end_2} :catch_2
    ...
    new-instance v7, Lkotlin/io/FileAlreadyExistsException;

    nop

    const-string v8, "The destination file already exists."

    invoke-direct {v7, v6, v3, v8}, Lkotlin/io/FileAlreadyExistsException;-><init>(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)V

    invoke-interface {p3, v3, v7}, Lkotlin/jvm/functions/Function2;->invoke(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v7

    sget-object v8, Lkotlin/io/OnErrorAction;->TERMINATE:Lkotlin/io/OnErrorAction;
    :try_end_3
    .catch Lkotlin/io/TerminateException; {:try_start_3 .. :try_end_3} :catch_0
    ...
    move-result v5
    :try_end_4
    .catch Lkotlin/io/TerminateException; {:try_start_4 .. :try_end_4} :catch_2
    ...
    :try_end_5
    .catch Lkotlin/io/TerminateException; {:try_start_5 .. :try_end_5} :catch_0
    ...
    :try_end_6
    .catch Lkotlin/io/TerminateException; {:try_start_6 .. :try_end_6} :catch_1
