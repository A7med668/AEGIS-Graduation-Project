...
.method public static final doMapping(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    invoke-direct {v1, v3, v0, v2}, Li7/b;-><init>(III)V

    invoke-virtual {v1}, Li7/b;->iterator()Ljava/util/Iterator;
    ...
    iget-boolean v4, v1, Li7/c;->l:Z

    if-eqz v4, :cond_9

    check-cast v0, Lq6/x;

    invoke-virtual {v0}, Lq6/x;->nextInt()I

    move-result v4

    iget-boolean v5, v1, Li7/c;->l:Z
    ...
    invoke-direct {v8, v6, v7, v2}, Li7/b;-><init>(III)V

    invoke-virtual {v8}, Li7/b;->iterator()Ljava/util/Iterator;
    ...
    iget-boolean v8, v7, Li7/c;->l:Z

    if-eqz v8, :cond_7

    check-cast v6, Lq6/x;

    invoke-virtual {v6}, Lq6/x;->nextInt()I

    move-result v8

    iget-boolean v9, v7, Li7/c;->l:Z
...
.method public static final featureDistSquared(Landroidx/graphics/shapes/Feature;Landroidx/graphics/shapes/Feature;)F
    ...
    invoke-static {p0}, Lq6/l;->H0(Ljava/util/List;)Ljava/lang/Object;
...
.method public static final featureMapper(Ljava/util/List;Ljava/util/List;)Landroidx/graphics/shapes/DoubleMapper;
    ...
    invoke-virtual {p0}, Lq6/f;->c()I

    move-result v0

    invoke-virtual {p1}, Lq6/f;->c()I
    ...
    invoke-direct {v0, p0, p1}, Lp6/i;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
    ...
    :goto_2
    iget-object p0, v0, Lp6/i;->a:Ljava/lang/Object;

    check-cast p0, Ljava/util/List;

    iget-object p1, v0, Lp6/i;->b:Ljava/lang/Object;
    ...
    invoke-direct {v6, v4, v5}, Lp6/i;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V

    invoke-virtual {v0, v6}, Lr6/c;->add(Ljava/lang/Object;)Z
    ...
    new-array v0, v2, [Lp6/i;

    invoke-virtual {p0, v0}, Lr6/c;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    invoke-direct {p1, p0}, Landroidx/graphics/shapes/DoubleMapper;-><init>([Lp6/i;)V
