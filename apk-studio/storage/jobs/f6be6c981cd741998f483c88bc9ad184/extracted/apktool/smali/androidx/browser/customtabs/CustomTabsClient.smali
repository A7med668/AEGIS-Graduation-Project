...
# direct methods
.method public constructor <init>(Landroid/support/customtabs/f;Landroid/content/ComponentName;Landroid/content/Context;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:Landroid/support/customtabs/f;
...
.method private createCallbackWrapper(Landroidx/browser/customtabs/CustomTabsCallback;)Landroid/support/customtabs/b;
    .locals 1
...
.method private newSessionInternal(Landroidx/browser/customtabs/CustomTabsCallback;Landroid/app/PendingIntent;)Landroidx/browser/customtabs/CustomTabsSession;
    ...
    invoke-direct {p0, p1}, Landroidx/browser/customtabs/CustomTabsClient;->createCallbackWrapper(Landroidx/browser/customtabs/CustomTabsCallback;)Landroid/support/customtabs/b;
    ...
    iget-object v2, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:Landroid/support/customtabs/f;

    invoke-interface {v2, p1, v1}, Landroid/support/customtabs/f;->newSessionWithExtras(Landroid/support/customtabs/c;Landroid/os/Bundle;)Z
    ...
    :cond_0
    iget-object v1, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:Landroid/support/customtabs/f;

    invoke-interface {v1, p1}, Landroid/support/customtabs/f;->newSession(Landroid/support/customtabs/c;)Z
    ...
    invoke-direct {v0, v1, p1, v2, p2}, Landroidx/browser/customtabs/CustomTabsSession;-><init>(Landroid/support/customtabs/f;Landroid/support/customtabs/c;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
...
.method public extraCommand(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    :try_start_0
    iget-object v0, p0, Landroidx/browser/customtabs/CustomTabsClient;->mService:Landroid/support/customtabs/f;

    invoke-interface {v0, p1, p2}, Landroid/support/customtabs/f;->extraCommand(Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public warmup(J)Z
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/customtabs/f;->warmup(J)Z
