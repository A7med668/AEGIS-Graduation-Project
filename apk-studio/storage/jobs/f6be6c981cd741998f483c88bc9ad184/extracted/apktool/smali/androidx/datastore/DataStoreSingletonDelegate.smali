...
# direct methods
.method public constructor <init>(Ljava/lang/String;Landroidx/datastore/core/okio/OkioSerializer;Landroidx/datastore/core/handlers/ReplaceFileCorruptionHandler;Ld7/l;Lo7/a0;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p4, p0, Landroidx/datastore/DataStoreSingletonDelegate;->produceMigrations:Ld7/l;

    iput-object p5, p0, Landroidx/datastore/DataStoreSingletonDelegate;->scope:Lo7/a0;
...
.method public getValue(Landroid/content/Context;Lj7/k;)Landroidx/datastore/core/DataStore;
    ...
    invoke-direct/range {v1 .. v7}, Landroidx/datastore/core/okio/OkioStorage;-><init>(Lw8/o;Landroidx/datastore/core/okio/OkioSerializer;Ld7/p;Ld7/a;ILkotlin/jvm/internal/g;)V
    ...
    iget-object v3, p0, Landroidx/datastore/DataStoreSingletonDelegate;->produceMigrations:Ld7/l;

    invoke-virtual {p1}, Ljava/lang/Object;->getClass()Ljava/lang/Class;

    invoke-interface {v3, p1}, Ld7/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Ljava/util/List;

    iget-object v3, p0, Landroidx/datastore/DataStoreSingletonDelegate;->scope:Lo7/a0;

    invoke-virtual {v0, v1, v2, p1, v3}, Landroidx/datastore/core/DataStoreFactory;->create(Landroidx/datastore/core/Storage;Landroidx/datastore/core/handlers/ReplaceFileCorruptionHandler;Ljava/util/List;Lo7/a0;)Landroidx/datastore/core/DataStore;
...
.method public bridge synthetic getValue(Ljava/lang/Object;Lj7/k;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/datastore/DataStoreSingletonDelegate;->getValue(Landroid/content/Context;Lj7/k;)Landroidx/datastore/core/DataStore;
