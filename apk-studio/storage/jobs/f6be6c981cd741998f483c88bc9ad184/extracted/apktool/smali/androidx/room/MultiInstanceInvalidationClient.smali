...
.field private final coroutineScope:Lo7/a0;

.field private final invalidatedTables:Lr7/b0;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroidx/room/InvalidationTracker;)V
    ...
    iput-object p1, p0, Landroidx/room/MultiInstanceInvalidationClient;->coroutineScope:Lo7/a0;
    ...
    invoke-static {p1, p1}, Lr7/k0;->a(II)Lr7/j0;

    move-result-object p1

    iput-object p1, p0, Landroidx/room/MultiInstanceInvalidationClient;->invalidatedTables:Lr7/b0;
...
.method public static final synthetic access$getCoroutineScope$p(Landroidx/room/MultiInstanceInvalidationClient;)Lo7/a0;
    .locals 0

    iget-object p0, p0, Landroidx/room/MultiInstanceInvalidationClient;->coroutineScope:Lo7/a0;

    return-object p0
.end method

.method public static final synthetic access$getInvalidatedTables$p(Landroidx/room/MultiInstanceInvalidationClient;)Lr7/b0;
    .locals 0

    iget-object p0, p0, Landroidx/room/MultiInstanceInvalidationClient;->invalidatedTables:Lr7/b0;
...
# virtual methods
.method public final createFlow([Ljava/lang/String;)Lr7/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "([",
    ...
    iget-object v0, p0, Landroidx/room/MultiInstanceInvalidationClient;->invalidatedTables:Lr7/b0;

    new-instance v1, Landroidx/room/MultiInstanceInvalidationClient$createFlow$$inlined$mapNotNull$1;

    invoke-direct {v1, v0, p1}, Landroidx/room/MultiInstanceInvalidationClient$createFlow$$inlined$mapNotNull$1;-><init>(Lr7/h;[Ljava/lang/String;)V
