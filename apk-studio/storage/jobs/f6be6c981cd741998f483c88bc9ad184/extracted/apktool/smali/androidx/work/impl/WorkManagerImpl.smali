...
.field private final mWorkManagerScope:Lo7/a0;
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/utils/taskexecutor/TaskExecutor;Landroidx/work/impl/WorkDatabase;Ljava/util/List;Landroidx/work/impl/Processor;Landroidx/work/impl/constraints/trackers/Trackers;)V
    ...
    invoke-static {p3}, Landroidx/work/impl/WorkManagerImplExtKt;->createWorkManagerScope(Landroidx/work/impl/utils/taskexecutor/TaskExecutor;)Lo7/a0;

    move-result-object p6

    iput-object p6, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:Lo7/a0;
    ...
    invoke-static {p6, p1, p2, p4}, Landroidx/work/impl/UnfinishedWorkListenerKt;->maybeLaunchUnfinishedWorkListener(Lo7/a0;Landroid/content/Context;Landroidx/work/Configuration;Landroidx/work/impl/WorkDatabase;)V

    return-void
.end method

.method public static synthetic a(Landroidx/work/impl/WorkManagerImpl;)Lp6/x;
    .locals 0

    invoke-direct {p0}, Landroidx/work/impl/WorkManagerImpl;->lambda$rescheduleEligibleWork$0()Lp6/x;
...
.method private synthetic lambda$rescheduleEligibleWork$0()Lp6/x;
    .locals 3
...
.method public getLastCancelAllTimeMillis()Lm1/b;
    ...
    invoke-static {v1, v0, v2}, Landroidx/work/ListenableFutureKt;->executeAsync(Ljava/util/concurrent/Executor;Ljava/lang/String;Ld7/a;)Lm1/b;
...
.method public getWorkInfoByIdFlow(Ljava/util/UUID;)Lr7/h;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowDataForIds(Landroidx/work/impl/model/WorkSpecDao;Ljava/util/UUID;)Lr7/h;
...
.method public getWorkInfosByTagFlow(Ljava/lang/String;)Lr7/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {v1}, Landroidx/work/impl/utils/taskexecutor/TaskExecutor;->getTaskCoroutineDispatcher()Lo7/w;

    move-result-object v1

    invoke-static {v0, v1, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForTag(Landroidx/work/impl/model/WorkSpecDao;Lo7/w;Ljava/lang/String;)Lr7/h;
...
.method public getWorkInfosFlow(Landroidx/work/WorkQuery;)Lr7/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1, p1}, Landroidx/work/impl/model/RawWorkInfoDaoKt;->getWorkInfoPojosFlow(Landroidx/work/impl/model/RawWorkInfoDao;Lo7/w;Landroidx/sqlite/db/SupportSQLiteQuery;)Lr7/h;
...
.method public getWorkInfosForUniqueWorkFlow(Ljava/lang/String;)Lr7/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v0, v1, p1}, Landroidx/work/impl/model/WorkSpecDaoKt;->getWorkStatusPojoFlowForName(Landroidx/work/impl/model/WorkSpecDao;Lo7/w;Ljava/lang/String;)Lr7/h;
...
.method public getWorkManagerScope()Lo7/a0;
    .locals 1

    iget-object v0, p0, Landroidx/work/impl/WorkManagerImpl;->mWorkManagerScope:Lo7/a0;
...
.method public rescheduleEligibleWork()V
    ...
    invoke-static {v0, v2, v1}, Landroidx/work/TracerKt;->traced(Landroidx/work/Tracer;Ljava/lang/String;Ld7/a;)Ljava/lang/Object;
