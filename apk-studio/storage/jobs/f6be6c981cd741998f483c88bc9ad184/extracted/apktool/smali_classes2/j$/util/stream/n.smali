...
# direct methods
.method public static T(Lj$/util/stream/a;Lj$/util/Spliterator;)Lj$/util/stream/l2;
    .locals 6
    ...
    invoke-virtual {v0, p0, p1}, Lj$/util/stream/w3;->b(Lj$/util/stream/a;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-direct {p1, p0}, Lj$/util/stream/l2;-><init>(Ljava/util/Collection;)V
...
.method public final J(Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)Lj$/util/stream/h2;
    ...
    invoke-virtual {p1, p2, v1, p3}, Lj$/util/stream/a;->B(Lj$/util/Spliterator;ZLjava/util/function/IntFunction;)Lj$/util/stream/h2;
    ...
    :cond_0
    sget-object p3, Lj$/util/stream/z6;->ORDERED:Lj$/util/stream/z6;

    iget v0, p1, Lj$/util/stream/a;->f:I

    invoke-virtual {p3, v0}, Lj$/util/stream/z6;->j(I)Z

    move-result p3

    if-eqz p3, :cond_1

    invoke-static {p1, p2}, Lj$/util/stream/n;->T(Lj$/util/stream/a;Lj$/util/Spliterator;)Lj$/util/stream/l2;
    ...
    invoke-direct {v3, v2, v1}, Lj$/util/stream/q0;-><init>(Ljava/util/function/Consumer;Z)V

    invoke-virtual {v3, p1, p2}, Lj$/util/stream/r0;->g(Lj$/util/stream/a;Lj$/util/Spliterator;)V
    ...
    invoke-direct {p2, p1}, Lj$/util/stream/l2;-><init>(Ljava/util/Collection;)V
...
.method public final K(Lj$/util/stream/a;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-virtual {p1}, Lj$/util/stream/l2;->spliterator()Lj$/util/Spliterator;
    ...
    invoke-direct {v0, p1, p2}, Lj$/util/stream/i7;-><init>(Lj$/util/Spliterator;Lj$/util/concurrent/ConcurrentHashMap;)V
...
.method public final M(ILj$/util/stream/m5;)Lj$/util/stream/m5;
    ...
    invoke-direct {p1, p2}, Lj$/util/stream/l;-><init>(Lj$/util/stream/m5;)V
    ...
    invoke-direct {p1, p2}, Lj$/util/stream/m;-><init>(Lj$/util/stream/m5;)V
