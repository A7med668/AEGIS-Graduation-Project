...
.method public static synthetic convert(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    :cond_0
    instance-of v0, p0, Lj$/util/stream/x6;

    if-eqz v0, :cond_1

    check-cast p0, Lj$/util/stream/x6;

    iget-object p0, p0, Lj$/util/stream/x6;->a:Ljava/util/stream/Stream;
...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findAny()Lj$/util/b0;

    move-result-object v0

    invoke-static {v0}, Lj$/util/c;->m(Lj$/util/b0;)Ljava/util/Optional;
...
.method public final synthetic findFirst()Ljava/util/Optional;
    ...
    invoke-interface {v0}, Lj$/util/stream/Stream;->findFirst()Lj$/util/b0;
...
.method public final synthetic flatMap(Ljava/util/function/Function;)Ljava/util/stream/Stream;
    ...
    invoke-static {p1}, Lj$/util/stream/w3;->O(Ljava/util/function/Function;)Lj$/util/q;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->b(Lj$/util/q;)Lj$/util/stream/Stream;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->p(Lj$/util/q;)Lj$/util/stream/e0;
...
.method public final synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->r(Lj$/util/q;)Lj$/util/stream/IntStream;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->l(Lj$/util/q;)Lj$/util/stream/n1;
...
.method public final synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->mapToDouble(Ljava/util/function/ToDoubleFunction;)Lj$/util/stream/e0;
...
.method public final synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->mapToLong(Ljava/util/function/ToLongFunction;)Lj$/util/stream/n1;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->max(Ljava/util/Comparator;)Lj$/util/b0;

    move-result-object p1

    invoke-static {p1}, Lj$/util/c;->m(Lj$/util/b0;)Ljava/util/Optional;
...
.method public final synthetic min(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->min(Ljava/util/Comparator;)Lj$/util/b0;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->reduce(Ljava/util/function/BinaryOperator;)Lj$/util/b0;
