...
.method public synthetic constructor <init>(Lj$/util/Spliterator;I)V
    ...
    iput p2, p0, Lj$/util/stream/u8;->f:I
...
.method public synthetic constructor <init>(Lj$/util/Spliterator;Lj$/util/stream/y8;I)V
    ...
    iput p3, p0, Lj$/util/stream/u8;->f:I
...
.method public final accept(D)V
    ...
    iput-wide p1, p0, Lj$/util/stream/u8;->e:D
...
.method public final b(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    iget v0, p0, Lj$/util/stream/u8;->f:I
    ...
    invoke-direct {v0, p1, p0, v1}, Lj$/util/stream/u8;-><init>(Lj$/util/Spliterator;Lj$/util/stream/y8;I)V
...
.method public final bridge synthetic forEachRemaining(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lj$/util/stream/u8;->forEachRemaining(Ljava/util/function/DoubleConsumer;)V
...
.method public bridge synthetic tryAdvance(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0, p1}, Lj$/util/stream/u8;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
...
.method public final tryAdvance(Ljava/util/function/DoubleConsumer;)Z
    ...
    invoke-interface {p1, p0}, Lj$/util/v0;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
    ...
    :cond_0
    iget-wide v0, p0, Lj$/util/stream/u8;->e:D
    ...
    check-cast v1, Lj$/util/v0;

    invoke-interface {v1, p0}, Lj$/util/v0;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
    ...
    iget-wide v1, p0, Lj$/util/stream/u8;->e:D
    ...
    invoke-interface {v1, p1}, Lj$/util/v0;->tryAdvance(Ljava/util/function/DoubleConsumer;)Z
...
.method public bridge synthetic trySplit()Lj$/util/Spliterator;
    ...
    :pswitch_0
    invoke-virtual {p0}, Lj$/util/stream/u8;->trySplit()Lj$/util/v0;
...
.method public trySplit()Lj$/util/v0;
    .locals 1
    ...
    invoke-super {p0}, Lj$/util/stream/y8;->trySplit()Lj$/util/v0;
