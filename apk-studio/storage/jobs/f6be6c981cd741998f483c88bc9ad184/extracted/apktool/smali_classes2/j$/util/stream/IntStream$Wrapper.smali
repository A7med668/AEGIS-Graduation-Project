...
.method public final synthetic asDoubleStream()Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asDoubleStream()Lj$/util/stream/e0;
...
.method public final synthetic asLongStream()Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->asLongStream()Lj$/util/stream/n1;
...
.method public final synthetic average()Ljava/util/OptionalDouble;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->average()Lj$/util/c0;
...
.method public final synthetic findAny()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findAny()Lj$/util/d0;

    move-result-object v0

    invoke-static {v0}, Lj$/util/c;->o(Lj$/util/d0;)Ljava/util/OptionalInt;
...
.method public final synthetic findFirst()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->findFirst()Lj$/util/d0;
...
.method public final flatMap(Ljava/util/function/IntFunction;)Ljava/util/stream/IntStream;
    ...
    iput-object p1, v1, Lj$/util/stream/m0;->a:Ljava/util/function/IntFunction;

    invoke-interface {v0, v1}, Lj$/util/stream/IntStream;->o(Lj$/util/stream/m0;)Lj$/util/stream/IntStream;
...
.method public final synthetic iterator()Ljava/util/PrimitiveIterator$OfInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->iterator()Lj$/util/m0;
    ...
    invoke-direct {v1, v0}, Lj$/util/l0;-><init>(Lj$/util/m0;)V
...
.method public final synthetic mapToDouble(Ljava/util/function/IntToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->f()Lj$/util/stream/e0;
...
.method public final synthetic mapToLong(Ljava/util/function/IntToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {p1}, Lj$/util/stream/IntStream;->i()Lj$/util/stream/n1;
...
.method public final synthetic max()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->max()Lj$/util/d0;
...
.method public final synthetic min()Ljava/util/OptionalInt;
    ...
    invoke-interface {v0}, Lj$/util/stream/IntStream;->min()Lj$/util/d0;
...
.method public final synthetic reduce(Ljava/util/function/IntBinaryOperator;)Ljava/util/OptionalInt;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/IntStream;->reduce(Ljava/util/function/IntBinaryOperator;)Lj$/util/d0;

    move-result-object p1

    invoke-static {p1}, Lj$/util/c;->o(Lj$/util/d0;)Ljava/util/OptionalInt;
...
.method public final synthetic spliterator()Ljava/util/Spliterator$OfInt;
    ...
    invoke-static {v0}, Lj$/util/x0;->a(Lj$/util/y0;)Ljava/util/Spliterator$OfInt;
