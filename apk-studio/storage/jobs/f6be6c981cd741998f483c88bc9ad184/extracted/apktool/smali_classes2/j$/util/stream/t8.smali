...
.method public constructor <init>(Lj$/util/stream/a;Lj$/util/stream/a;Lj$/util/Spliterator;Ljava/util/function/IntFunction;)V
    ...
    iput-object p1, p0, Lj$/util/stream/t8;->j:Lj$/util/stream/a;

    iput-object p4, p0, Lj$/util/stream/t8;->k:Ljava/util/function/IntFunction;
    ...
    iput-boolean p1, p0, Lj$/util/stream/t8;->l:Z

    return-void
.end method

.method public constructor <init>(Lj$/util/stream/t8;Lj$/util/Spliterator;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lj$/util/stream/b;-><init>(Lj$/util/stream/b;Lj$/util/Spliterator;)V

    iget-object p2, p1, Lj$/util/stream/t8;->j:Lj$/util/stream/a;

    iput-object p2, p0, Lj$/util/stream/t8;->j:Lj$/util/stream/a;

    iget-object p2, p1, Lj$/util/stream/t8;->k:Ljava/util/function/IntFunction;

    iput-object p2, p0, Lj$/util/stream/t8;->k:Ljava/util/function/IntFunction;

    iget-boolean p1, p1, Lj$/util/stream/t8;->l:Z
...
.method public final a()Ljava/lang/Object;
    ...
    iget-object v3, p0, Lj$/util/stream/t8;->k:Ljava/util/function/IntFunction;

    invoke-virtual {v0, v1, v2, v3}, Lj$/util/stream/a;->I(JLjava/util/function/IntFunction;)Lj$/util/stream/z1;

    move-result-object v0

    iget-object v1, p0, Lj$/util/stream/t8;->j:Lj$/util/stream/a;
    ...
    iput-boolean v1, p0, Lj$/util/stream/t8;->n:Z
    ...
    iput-wide v1, p0, Lj$/util/stream/t8;->m:J
...
.method public final c(Lj$/util/Spliterator;)Lj$/util/stream/d;
    ...
    invoke-direct {v0, p0, p1}, Lj$/util/stream/t8;-><init>(Lj$/util/stream/t8;Lj$/util/Spliterator;)V
...
.method public final f()V
    ...
    iget-boolean v0, p0, Lj$/util/stream/t8;->l:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lj$/util/stream/t8;->o:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lj$/util/stream/t8;->j:Lj$/util/stream/a;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    :cond_0
    check-cast v0, Lj$/util/stream/t8;

    iget-boolean v0, v0, Lj$/util/stream/t8;->n:Z

    iget-object v1, p0, Lj$/util/stream/d;->e:Lj$/util/stream/d;

    check-cast v1, Lj$/util/stream/t8;

    iget-boolean v1, v1, Lj$/util/stream/t8;->n:Z

    or-int/2addr v0, v1

    iput-boolean v0, p0, Lj$/util/stream/t8;->n:Z
    ...
    iget-boolean v3, v0, Lj$/util/stream/t8;->n:Z

    if-eqz v3, :cond_2

    iget-wide v1, v0, Lj$/util/stream/t8;->m:J
    ...
    iget-wide v3, v0, Lj$/util/stream/t8;->m:J

    iget-object v5, p0, Lj$/util/stream/d;->e:Lj$/util/stream/d;

    check-cast v5, Lj$/util/stream/t8;

    iget-wide v6, v5, Lj$/util/stream/t8;->m:J

    add-long/2addr v3, v6

    iput-wide v3, p0, Lj$/util/stream/t8;->m:J
    ...
    :cond_3
    iget-wide v3, v5, Lj$/util/stream/t8;->m:J
    ...
    iput-boolean v0, p0, Lj$/util/stream/t8;->o:Z
