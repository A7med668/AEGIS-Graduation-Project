...
.method public constructor <init>(Ljava/util/function/LongBinaryOperator;)V
    ...
    iput-object p1, p0, Lj$/util/stream/q4;->c:Ljava/util/function/LongBinaryOperator;
...
.method public final accept(J)V
    ...
    iget-boolean v0, p0, Lj$/util/stream/q4;->a:Z

    if-eqz v0, :cond_0

    const/4 v0, 0x0

    iput-boolean v0, p0, Lj$/util/stream/q4;->a:Z

    iput-wide p1, p0, Lj$/util/stream/q4;->b:J

    return-void

    :cond_0
    iget-object v0, p0, Lj$/util/stream/q4;->c:Ljava/util/function/LongBinaryOperator;

    iget-wide v1, p0, Lj$/util/stream/q4;->b:J
...
.method public final c(J)V
    ...
    iput-boolean p1, p0, Lj$/util/stream/q4;->a:Z
...
.method public final get()Ljava/lang/Object;
    ...
    :cond_0
    iget-wide v0, p0, Lj$/util/stream/q4;->b:J

    new-instance v2, Lj$/util/e0;

    invoke-direct {v2, v0, v1}, Lj$/util/e0;-><init>(J)V
...
.method public final i(Lj$/util/stream/r4;)V
    ...
    iget-boolean v0, p1, Lj$/util/stream/q4;->a:Z

    if-nez v0, :cond_0

    iget-wide v0, p1, Lj$/util/stream/q4;->b:J

    invoke-virtual {p0, v0, v1}, Lj$/util/stream/q4;->accept(J)V
