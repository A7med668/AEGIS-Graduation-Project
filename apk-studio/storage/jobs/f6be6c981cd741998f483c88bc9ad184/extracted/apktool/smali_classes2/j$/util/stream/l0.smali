...
# instance fields
.field public final j:Lj$/util/stream/f0;

.field public final k:Z


# direct methods
.method public constructor <init>(Lj$/util/stream/f0;ZLj$/util/stream/a;Lj$/util/Spliterator;)V
    .locals 0

    invoke-direct {p0, p3, p4}, Lj$/util/stream/b;-><init>(Lj$/util/stream/a;Lj$/util/Spliterator;)V

    iput-boolean p2, p0, Lj$/util/stream/l0;->k:Z

    iput-object p1, p0, Lj$/util/stream/l0;->j:Lj$/util/stream/f0;

    return-void
.end method

.method public constructor <init>(Lj$/util/stream/l0;Lj$/util/Spliterator;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lj$/util/stream/b;-><init>(Lj$/util/stream/b;Lj$/util/Spliterator;)V

    iget-boolean p2, p1, Lj$/util/stream/l0;->k:Z

    iput-boolean p2, p0, Lj$/util/stream/l0;->k:Z

    iget-object p1, p1, Lj$/util/stream/l0;->j:Lj$/util/stream/f0;
...
.method public final a()Ljava/lang/Object;
    ...
    iget-object v1, p0, Lj$/util/stream/l0;->j:Lj$/util/stream/f0;

    iget-object v1, v1, Lj$/util/stream/f0;->d:Ljava/util/function/Supplier;

    invoke-interface {v1}, Ljava/util/function/Supplier;->get()Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Lj$/util/stream/g8;
    ...
    iget-boolean v1, p0, Lj$/util/stream/l0;->k:Z
...
.method public final h()Ljava/lang/Object;
    ...
    iget-object v0, p0, Lj$/util/stream/l0;->j:Lj$/util/stream/f0;

    iget-object v0, v0, Lj$/util/stream/f0;->b:Ljava/lang/Object;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-boolean v0, p0, Lj$/util/stream/l0;->k:Z
    ...
    iget-object v3, p0, Lj$/util/stream/l0;->j:Lj$/util/stream/f0;

    iget-object v3, v3, Lj$/util/stream/f0;->c:Ljava/util/function/Predicate;
