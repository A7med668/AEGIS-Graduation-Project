...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "<init>",
        "(Lti/l;Lti/l;Lti/l;FZJFFZLandroidx/compose/foundation/S;Lkotlin/jvm/internal/i;)V",
        "c",
        "()Landroidx/compose/foundation/MagnifierNode;",
        "node",
        "d",
...
.field public final j:Landroidx/compose/foundation/S;
...
.method private constructor <init>(Lti/l;Lti/l;Lti/l;FZJFFZLandroidx/compose/foundation/S;)V
    ...
    iput-object p1, p0, Landroidx/compose/foundation/MagnifierElement;->a:Lti/l;

    iput-object p2, p0, Landroidx/compose/foundation/MagnifierElement;->b:Lti/l;

    iput-object p3, p0, Landroidx/compose/foundation/MagnifierElement;->c:Lti/l;
    ...
    iput-object p11, p0, Landroidx/compose/foundation/MagnifierElement;->j:Landroidx/compose/foundation/S;
...
.method public synthetic constructor <init>(Lti/l;Lti/l;Lti/l;FZJFFZLandroidx/compose/foundation/S;ILkotlin/jvm/internal/i;)V
    ...
    invoke-direct/range {v3 .. v15}, Landroidx/compose/foundation/MagnifierElement;-><init>(Lti/l;Lti/l;Lti/l;FZJFFZLandroidx/compose/foundation/S;Lkotlin/jvm/internal/i;)V
...
.method public synthetic constructor <init>(Lti/l;Lti/l;Lti/l;FZJFFZLandroidx/compose/foundation/S;Lkotlin/jvm/internal/i;)V
    ...
    invoke-direct/range {p0 .. p11}, Landroidx/compose/foundation/MagnifierElement;-><init>(Lti/l;Lti/l;Lti/l;FZJFFZLandroidx/compose/foundation/S;)V
...
.method public bridge synthetic b(Landroidx/compose/ui/m$c;)V
    ...
    invoke-virtual {p0, p1}, Landroidx/compose/foundation/MagnifierElement;->d(Landroidx/compose/foundation/MagnifierNode;)V
...
.method public c()Landroidx/compose/foundation/MagnifierNode;
    ...
    iget-object v1, p0, Landroidx/compose/foundation/MagnifierElement;->a:Lti/l;

    iget-object v2, p0, Landroidx/compose/foundation/MagnifierElement;->b:Lti/l;
    ...
    iget-object v3, p0, Landroidx/compose/foundation/MagnifierElement;->c:Lti/l;

    iget-object v11, p0, Landroidx/compose/foundation/MagnifierElement;->j:Landroidx/compose/foundation/S;

    new-instance v0, Landroidx/compose/foundation/MagnifierNode;

    const/4 v12, 0x0

    invoke-direct/range {v0 .. v12}, Landroidx/compose/foundation/MagnifierNode;-><init>(Lti/l;Lti/l;Lti/l;FZJFFZLandroidx/compose/foundation/S;Lkotlin/jvm/internal/i;)V

    return-object v0
.end method

.method public d(Landroidx/compose/foundation/MagnifierNode;)V
    .locals 12
    ...
    iget-boolean v4, p0, Landroidx/compose/foundation/MagnifierElement;->e:Z

    iget-wide v5, p0, Landroidx/compose/foundation/MagnifierElement;->f:J

    iget v7, p0, Landroidx/compose/foundation/MagnifierElement;->g:F

    iget v8, p0, Landroidx/compose/foundation/MagnifierElement;->h:F

    iget-boolean v9, p0, Landroidx/compose/foundation/MagnifierElement;->i:Z

    iget-object v10, p0, Landroidx/compose/foundation/MagnifierElement;->c:Lti/l;

    iget-object v11, p0, Landroidx/compose/foundation/MagnifierElement;->j:Landroidx/compose/foundation/S;

    move-object v0, p1

    invoke-virtual/range {v0 .. v11}, Landroidx/compose/foundation/MagnifierNode;->G2(Lti/l;Lti/l;FZJFFZLti/l;Landroidx/compose/foundation/S;)V
...
.method public equals(Ljava/lang/Object;)Z
    ...
    iget-object v3, p1, Landroidx/compose/foundation/MagnifierElement;->a:Lti/l;
    ...
    :cond_2
    iget-object v1, p0, Landroidx/compose/foundation/MagnifierElement;->b:Lti/l;

    iget-object v3, p1, Landroidx/compose/foundation/MagnifierElement;->b:Lti/l;
    ...
    invoke-static {v3, v4, v5, v6}, Lm0/l;->h(JJ)Z
    ...
    :cond_8
    iget-object v1, p0, Landroidx/compose/foundation/MagnifierElement;->c:Lti/l;

    iget-object v3, p1, Landroidx/compose/foundation/MagnifierElement;->c:Lti/l;
    ...
    :cond_9
    iget-object v1, p0, Landroidx/compose/foundation/MagnifierElement;->j:Landroidx/compose/foundation/S;

    iget-object p1, p1, Landroidx/compose/foundation/MagnifierElement;->j:Landroidx/compose/foundation/S;
...
.method public hashCode()I
    ...
    iget-object v0, p0, Landroidx/compose/foundation/MagnifierElement;->a:Lti/l;
    ...
    invoke-static {v3, v4}, Lm0/l;->k(J)I
